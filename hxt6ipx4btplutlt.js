import { r as b, R as nt, j as C } from "./lip667d8t42poxum.js";
import {
  g as K,
  e3 as V,
  gx as ot,
...
function ht(i, e) {
  var o = U();
  function s() {
    U() - o >= e ? i.call(null) : (c.id = requestAnimationFrame(s));
  }
  var c = { id: requestAnimationFrame(s) };
  return c;
}
var W = -1;
function $(i) {
  if ((i === void 0 && (i = !1), W === -1 || i)) {
...
function pt(i) {
  var e,
    ...
    S = i.getStartIndexForOffset,
    p = i.getStopIndexForStartIndex,
    _ = i.initInstanceProps,
    y = i.shouldResetStyleCacheOnItemSizeChange,
    I = i.validateProps;
  return (
    (e = (function (w) {
      ct(O, w);
      function O(f) {
        var t;
        return (
          (t = w.call(this, f) || this),
          (t._instanceProps = _(t.props, B(t))),
          (t._outerRef = void 0),
          ...
          (t.state = {
            ...
            scrollOffset:
              typeof t.props.initialScrollOffset == "number"
                ? t.props.initialScrollOffset
                : 0,
            scrollUpdateWasRequested: !1,
          }),
          (t._callOnItemsRendered = void 0),
          (t._callOnItemsRendered = F(function (r, n, l, u) {
          ...
          (t._callOnScroll = F(function (r, n, l) {
          ...
          (t._getItemStyle = function (r) {
            var n = t.props,
              l = n.direction,
              u = n.itemSize,
              h = n.layout,
              a = t._getItemStyleCache(y && u, y && h, y && l),
              d;
            if (a.hasOwnProperty(r)) d = a[r];
            else {
              var m = o(t.props, r, t._instanceProps),
                x = c(t.props, r, t._instanceProps),
          ...
          (t._getItemStyleCache = F(function (r, n, l) {
            return {};
          })),
          (t._onScrollHorizontal = function (r) {
            ...
            t.setState(function (a) {
              if (a.scrollOffset === u) return null;
          ...
          (t._resetIsScrollingDebounced = function () {
            t._resetIsScrollingTimeoutId !== null &&
              A(t._resetIsScrollingTimeoutId),
              (t._resetIsScrollingTimeoutId = ht(t._resetIsScrolling, mt));
          }),
      ...
      O.getDerivedStateFromProps = function (t, r) {
        return gt(t, r), I(t), null;
      };
      var v = O.prototype;
      return (
        (v.scrollTo = function (t) {
          (t = Math.max(0, t)),
            this.setState(function (r) {
              return r.scrollOffset === t
                ...
                : {
                    scrollDirection:
                      r.scrollOffset < t ? "forward" : "backward",
                    scrollOffset: t,
        ...
        (v.scrollToItem = function (t, r) {
          ...
          if (this._outerRef) {
            ...
            u === "vertical"
              ? (a = d.scrollWidth > d.clientWidth ? $() : 0)
              : (a = d.scrollHeight > d.clientHeight ? $() : 0);
          }
        ...
        (v.componentWillUnmount = function () {
          this._resetIsScrollingTimeoutId !== null &&
            A(this._resetIsScrollingTimeoutId);
        }),
        (v.render = function () {
          var t = this.props,
            r = t.children,
        ...
        (v._callPropsCallbacks = function () {
          ...
          if (typeof this.props.onScroll == "function") {
            var a = this.state,
              d = a.scrollDirection,
              m = a.scrollOffset,
              x = a.scrollUpdateWasRequested;
            this._callOnScroll(d, m, x);
          }
        }),
        (v._getRangeToRender = function () {
          ...
          var d = S(this.props, a, this._instanceProps),
            ...
            x = !u || h === "backward" ? Math.max(1, n) : 1,
            z = !u || h === "forward" ? Math.max(1, n) : 1;
          return [
            Math.max(0, d - x),
            Math.max(0, Math.min(r - 1, m + z)),
            d,
            m,
          ];
        }),
...
var gt = function (e, o) {
  ...
  St = pt({
    ...
    getOffsetForIndexAndAlignment: function (e, o, s, c, g, S) {
      var p = e.direction,
        _ = e.height,
        y = e.itemCount,
        I = e.itemSize,
        w = e.layout,
        O = e.width,
        v = p === "horizontal" || w === "horizontal",
        f = v ? O : _,
        t = Math.max(0, y * I - f),
        r = Math.min(t, o * I),
        n = Math.max(0, o * I - f + I + S);
      switch (
        (s === "smart" &&
          (c >= n - f && c <= r + f ? (s = "auto") : (s = "center")),
        s)
      ) {
        case "start":
          return r;
        ...
        case "auto":
        default:
          return c >= n && c <= r ? c : c < n ? n : r;
      }
    },
    getStartIndexForOffset: function (e, o) {
      var s = e.itemCount,
        c = e.itemSize;
      return Math.max(0, Math.min(s - 1, Math.floor(o / c)));
    },
    getStopIndexForStartIndex: function (e, o, s) {
      var c = e.direction,
        ...
        _ = e.layout,
        y = e.width,
        I = c === "horizontal" || _ === "horizontal",
        w = o * p,
        O = I ? y : g,
        v = Math.ceil((O + s - w) / p);
      return Math.max(0, Math.min(S - 1, o + v - 1));
    },
...
function vt({ onChange: i, value: e }) {
  const o = K(),
    s = V(o),
    c = b.useMemo(() => ot(s.locale), [s.locale]),
    g = b.useMemo(() => st.filter((p) => p !== e), [e]),
    S = 480;
  return C.jsx("div", {
    children: C.jsxs(T.Root, {
      value: e,
      onValueChange: i,
      children: [
        C.jsxs(T.Trigger, {
          children: [C.jsx(T.Value, {}), C.jsx(T.Icon, {})],
        }),
        C.jsx(T.Portal, {
          children: C.jsxs(T.Content, {
            position: "popper",
            style: { maxHeight: S, width: 200 },
            children: [
              C.jsx(T.Item, { value: e, children: c(e) }),
              C.jsx(T.Separator, {}),
              C.jsx(St, {
                ...
                overscanCount: 20,
                itemKey: (p) => g[p],
                children: ({ index: p, style: _ }) => {
                  const y = g[p];
                  return C.jsx(T.Item, { value: y, style: _, children: c(y) });
                },
              }),
            ],
          }),
...
const xt = nt.memo(vt);
function zt(i, e) {
  const { layer: o } = lt("3768341700"),
    s = o.get("is_country_selector_enabled", !1),
    c = s,
    g = at();
  let S = "";
  "userCountry" in g && (S = g.userCountry);
  const p = G({ country: S, shouldUseDefaultCountryCode: !c });
  let _ = { country: p, currency: Y(p) };
  if (i?.hasPaidSubscription() && e) {
    const I = i?.mustGetSubscriptionBillingCurrency("AccountPaymentModal");
    I && (_ = { currency: I });
  }
  return {
    userCountry: S,
    isCountrySelectorEnabled: c,
    countryWithFallback: p,
    initialBillingDetails: _,
  };
}
function Tt({
  country: i,
...
function bt() {
  const i = K(),
    ...
    [s, c] = b.useState(G({ country: o, shouldUseDefaultCountryCode: !1 }));
  return { country: s, setCountry: c, userCountry: o };
}
function H({
  country: i,
  currentAccount: e,
...
function yt(i) {
  return { country: i, currency: Y(i) };
}
export { xt as M, bt as a, Tt as b, zt as u };
//# sourceMappingURL=hxt6ipx4btplutlt.js.map
