var F,
  ...
  b = function (t) {
    document.visibilityState === "hidden" &&
      m > -1 &&
      ((m = t.type === "visibilitychange" ? t.timeStamp : 0), Z());
  },
  x = function () {
            ...
            u.forEach(function (c) {
              c.name === "first-contentful-paint" &&
                ...
                c.startTime < i.firstHiddenTime &&
                  ((n.value = Math.max(c.startTime - w(), 0)),
                  n.entries.push(c),
                  r(!0)));
            });
          });
              ...
              o.forEach(function (d) {
                if (!d.hadRecentInput) {
                  var X = a[0],
                    Y = a[a.length - 1];
                  n &&
                  d.startTime - Y.startTime < 1e3 &&
                  d.startTime - X.startTime < 5e3
                    ? ((n += d.value), a.push(d))
                    : ((n = d.value), (a = [d]));
                }
              }),
    ...
    if (
      ...
      if (r || l.length < 10 || t.duration > e.latency) {
        ...
        l.sort(function (n, a) {
          ...
          l.length > 10 &&
            l.splice(10).forEach(function (n) {
  ...
  U = function (t) {
    ...
    return (
      (t = I(t)),
      document.visibilityState === "hidden" ? t() : ((r = e(t)), y(t)),
      r
    );
  },
  N = [200, 500],
        ...
        var i,
          ...
          a = function (c) {
            U(function () {
              ...
              o &&
                o.latency !== n.value &&
                ((n.value = o.latency), (n.entries = o.entries), i());
            });
          },
          u = h("event", a, {
            durationThreshold:
              (r = e.durationThreshold) !== null && r !== void 0 ? r : 40,
          });
    ...
    (e = e || {}),
      E(function () {
            ...
            e.reportAllChanges || (o = o.slice(-1)),
              o.forEach(function (d) {
                d.startTime < i.firstHiddenTime &&
                  ((n.value = Math.max(d.startTime - w(), 0)),
                  (n.entries = [d]),
                  r());
              });
          },
        ...
        if (u) {
          ...
          var c = I(function () {
            A[n.id] ||
              (a(u.takeRecords()), u.disconnect(), (A[n.id] = !0), r(!0));
          });
  ...
  dt = function (t, e) {
    ...
    ot(function () {
      var n = M();
      n &&
        ((r.value = Math.max(n.responseStart - w(), 0)),
        (r.entries = [n]),
        i(!0),
        v(function () {
