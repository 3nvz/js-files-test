import { gr as k, gs as A } from "./hgyrt6j47bbfyjrt.js";
import { r as d } from "./lip667d8t42poxum.js";
import { i as I } from "./eef33l65z4kyipsv.js";
var B = function (e) {
    var t = d.useRef(e);
    return (
      I(function () {
...
function $(n, e, t, r) {
  ...
  var c = o.scrollHeight - i,
    h = c * t;
  l === "border-box" && (h = h + i + s), (u = Math.max(h, u));
  var g = c * r;
  return l === "border-box" && (g = g + i + s), (u = Math.min(g, u)), [u, c];
}
var w = function () {},
  _ = function (e, t) {
  ...
  O = function (e) {
    ...
    return { sizingStyle: r, paddingSize: s, borderSize: a };
  },
  Y = O;
function E(n, e, t) {
  var r = B(t);
...
var G = function (e) {
  ...
  Z = function (e, t) {
    ...
    return (
      ...
      G(b),
      U(b),
      d.createElement("textarea", A({}, h, { onChange: T, ref: p }))
    );
  },
  K = d.forwardRef(Z);
export { K as i };
//# sourceMappingURL=j1lsvoc2k14t9qu3.js.map
