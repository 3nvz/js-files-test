...
import { u as Se, L as be } from "./imxvx5fflgp7b780.js";
import { T as Ie } from "./ids1x0zqamf6ahba.js";
import { g as ye } from "./btagl6w1gub4aw61.js";
  ...
  Me = (e) => {
    const a = new URLSearchParams(window.location.search).get(Ne),
      t = P(
        e,
        (r) =>
          w.findNode(r, ({ message: o }) => {
            const i = o.metadata?.canvas;
            return (
              i?.create_source === $.HIVE && (a ? i?.textdoc_id === a : !0)
            );
...
function De(e, s) {
  const [a, t, r, o] = P(e, (d) => [
      w.getRequestId(d),
      w.getConversationLastTurn(d),
      w.isMessageTurnEnded(d),
      w.getVariantIds(d).length > 1,
    ]),
    i = ge(a),
    u = te(),
    [p, c] = l.useMemo(() => {
      ...
      let d;
      return (
        !r && t && (d = fe(t.messageGroups, (h) => h.type !== xe)),
        Oe({
          groupedMessage: d,
          isRequestActive: i,
          latestTextdocId: u,
...
function Oe({ groupedMessage: e, isRequestActive: s, latestTextdocId: a }) {
  switch (e?.type) {
    case ve.Canmore: {
      ...
      if (
        i &&
        (o.function === ce.CreateTextdoc
          ? (o.content ?? "").length > Fe || o.status === R.WAITING
          : o.status === R.STREAMING)
      )
        return [
          o.messageId,
          {
...
const I = {
  ...
  ke = ({ clientThreadId: e, focusedObject: s, onClose: a }) => {
    const {
        chatWidth: t,
        canvasWidthCalc: r,
        handleDrag: o,
      ...
      [v, C] = l.useState(!1),
      T = ue(({ rect: m }) => m),
      { windowHeight: d, windowWidth: h } = we((m) => m, {
        windowWidth: 0,
        windowHeight: 0,
      });
    let g = T ?? {
    ...
    return n.jsxs(n.Fragment, {
      children: [
        ...
        n.jsxs(f.div, {
          ...
          children: [
            n.jsx(f.div, {
              ...
              className:
                "bg-token-main-surface-primary pointer-events-none absolute start-0 top-0 z-20 h-full w-full",
            }),
            n.jsx(f.div, {
        ...
        n.jsx(f.div, {
          ...
          className:
            "pointer-events-none absolute start-0 top-0 z-10 h-full w-full bg-black/[0.025] dark:bg-transparent",
        }),
        n.jsx(f.div, {
          className:
            "absolute start-0 z-20 h-full overflow-hidden transition-shadow",
          initial: {
            borderRadius: S,
          ...
          children: n.jsx(f.div, {
            className:
              "dark:border-token-border-medium h-full overflow-hidden border-s border-gray-100",
            initial: {
              borderRadius: S,
            },
            animate: {
            ...
            children: n.jsxs("div", {
              ...
              children: [
                n.jsx(f.div, {
                  drag: "x",
                  className:
                    "bg-token-text-quaternary absolute start-[-2px] z-10 h-full w-[4px] cursor-ew-resize opacity-0",
                  whileHover: {
                    opacity: 0.5,
                  },
                  whileDrag: {
  ...
  He = l.memo(ke),
  Le = ({ clientThreadId: e, focusedObject: s, onClose: a }) =>
    n.jsx(Te, {
      children: n.jsx(f.div, {
        className:
          "fixed inset-0 z-40 overflow-hidden shadow-xl md:border-gray-100 md:dark:border-gray-700",
        initial: {
          scale: 0.98,
        },
        animate: {
...
export { bt as CanvasFocusedViewManager };
