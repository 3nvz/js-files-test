...
import { r as c, R as S } from "./lip667d8t42poxum.js";
function Le(v, t) {
  var g = bt(v);
  if (Me) {
    var m = Me(v);
    t &&
      (m = St(m).call(m, function (p) {
...
function Fe(v) {
  var t = v.mode,
    ...
    H = t === C ? r : E,
    M = t !== C ? r : E;
  return { atBottom: E, atEnd: H, atStart: M, atTop: r };
}
function U(v, t) {
  return v === (t === C ? 0 : "100%");
}
var ue = function (t) {
  var g = t.checkInterval,
    ...
    s = c.useMemo(
      function () {
        return rt("<ScrollToBottom>", { force: h });
      },
      [h],
    );
  r = r === C ? C : _t;
  var L = c.useRef(0),
    ...
    re = c.useCallback(
      function () {
        ...
        s(function () {
          var a;
          return d((a = ["%cSpineTo%c: %conEnd%c is fired."])).call(
            a,
            l(n("magenta")),
            l(n("orange")),
            [{ animateTo: e }],
            ...
            d(
              (u = [
                "%cscrollTo%c: Will scroll to %c".concat(
                  typeof e == "number" ? e + "px" : e.replace(/%/g, "%%"),
                  "%c",
                ),
              ]),
            ).call(u, l(n("lime", "")), l(n("purple"))),
            { behavior: o, nextAnimateTo: e, target: i },
          ];
        }),
          o === "auto"
            ? (re(),
              i &&
                (i.scrollTop =
                  e === "100%" ? i.scrollHeight - i.offsetHeight : e))
            : (o !== "smooth" &&
                console.warn(
    ...
    D = c.useCallback(
      function () {
        ...
        s(function () {
          var o;
          return d((o = ["%cscrollToBottom%c: Called"])).call(
            o,
            l(n("yellow", "")),
          );
        }),
    ...
    V = c.useCallback(
      function () {
        ...
        s(function () {
          var o;
          return d((o = ["%cscrollToTop%c: Called"])).call(
            o,
            l(n("yellow", "")),
          );
        }),
    ...
    _e = c.useCallback(
      function () {
        ...
        s(function () {
          var i;
          return d((i = ["%cscrollToEnd%c: Called"])).call(
            i,
            l(n("yellow", "")),
          );
        }),
    ...
    Be = c.useCallback(
      function () {
        ...
        s(function () {
          var i;
          return d((i = ["%cscrollToStart%c: Called"])).call(
            i,
            l(n("yellow", "")),
          );
        }),
      ...
      function () {
        ...
        if (e) {
          if (z.current === "auto") {
            s(function () {
              var I;
              return d((I = ["%ctarget changed%c: Initial scroll"])).call(
                I,
                l(n("blue")),
              );
            }),
              ...
              return [
                d(
                  (I = [
                    d(
                      (j = d(
                        (F = "%cscrollToSticky%c: Will animate from %c".concat(
                          a,
                          "px%c to %c",
                        )),
                      ).call(
                        F,
                        typeof T == "number" ? T + "px" : T.replace(/%/g, "%%"),
                        "%c (%c",
                      )),
                    ).call(j, (T === "100%" ? y : T) + a, "px%c)"),
                  ]),
                ).call(
                  I,
                  l(n("orange")),
          ...
          if ((le && (A.current = j), ne && (q.current = F), !le && !ne)) {
            ...
            B.current !== Y &&
              (s(function () {
                ...
                return [
                  d(
                    (P = ["%conScroll%c: %csetSticky%c(%c".concat(Y, "%c)")]),
                  ).call(P, l(n("red")), l(n("red")), l(n("purple"))),
                  d(
                    (ke = [
                      d(
                        (Ie = d(
                          (Pe = "(animating = %c".concat(
                            y,
                            "%c && isEnd = %c",
                          )),
                        ).call(Pe, U(i, r), "%c) || atEnd = %c")),
                      ).call(Ie, R, "%c"),
                    ]),
                  ).call(ke, l(n("purple")), l(n("purple")), l(n("purple")), [
                    {
                      animating: y,
                      animateTo: i,
                      atEnd: R,
            ...
            B.current &&
              (s(function () {
                ...
                return [
                  ...
                  ).call(P, l(n("red")), l(n("orange")), [
                    { offsetHeightChanged: le, scrollHeightChanged: ne },
                  ]),
                  {
                    nextOffsetHeight: j,
                    prevOffsetHeight: Re,
              ...
              G());
          var tt = u.scrollTop;
          ie((a = K.current)).call(a, function (P) {
            return P({ scrollTop: tt });
          });
        }
      },
          ...
          a = Nt(
            function () {
              var o = w.current,
                i = $.current !== null;
              B.current
                ? Fe({ mode: r, target: o }).atEnd
                  ? (e = !1)
                  : e
                    ? se() - e > Bt &&
                      (i ||
                        ((Z.current = o.scrollTop),
                        s(function () {
                          var u;
                          return d(
                            (u = [
  ...
  var Ne = c.useMemo(
    ...
    oe = c.useMemo(
      function () {
        return { atBottom: de, atEnd: pe, atStart: Ee, atTop: Te, mode: r };
      },
      [de, pe, Ee, Te, r],
    ),
    ae = c.useMemo(
      function () {
        var e = O !== null;
        return { animating: e, animatingToEnd: e && U(O, r), sticky: te };
      },
      [O, r, te],
    ),
    Ae = c.useMemo(
  ...
  return (
    c.useEffect(
      function () {
        if (b) {
          ...
          return (
            b.addEventListener("focus", e, { capture: !0, passive: !0 }),
            function () {
    ...
    s(function () {
      var e;
      return [
        d((e = ["%cRender%c: Render"])).call(e, l(n("cyan", ""))),
        { animateTo: O, animating: O !== null, sticky: te, target: b },
      ];
    }),
    S.createElement(
      ct.Provider,
...
var Rt = { position: "relative" },
  fe = function (t) {
    ...
    return S.createElement(
      "div",
      { className: Ct(E, (m || "") + "") },
      S.createElement(wt, { className: (h || "") + "" }, g),
      S.createElement(Et, { className: (p || "") + "" }),
    );
  };
fe.defaultProps = {
  children: void 0,
...
var Ue = function (t) {
  ...
  return S.createElement(
    ...
    S.createElement(
      fe,
      { className: p, followButtonClassName: r, scrollViewClassName: z },
      m,
    ),
  );
};
...
yt();
export { Ue as B };
//# sourceMappingURL=ltfattuf7qy8hfqt.js.map
