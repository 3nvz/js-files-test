...
import {
    S as O
} from "./e59f7y6b0ew7ftb0.js";
import {
    S as q
} from "./kweqtgafphozzl00.js";

function K({
    voice: s
}) {
    const [r, o] = d.useState(!1), a = b(), t = I(), g = s.voice, l = s.preview_url, i = d.useRef({
        playPromise: null
    }).current, c = E(f => f.isPlaying && f.sourceUrl === l), S = N(), m = d.useCallback(async () => {
        if (!t) return;
        const f = {
            voice: g,
            source: l
        ...
        try {
            ...
            j.previews.error(D, f), S.danger(a.formatMessage({
                id: "DeIYxH",
                defaultMessage: "Something went wrong playing preview"
            }))
        }
    }, [a, t, l, g, i, S]), h = d.useCallback(() => {
...
function Z() {
    const {
        ...
        value: r,
        setValue: o
    } = P(V.VoiceName), a = H(), t = J(), g = s ? "" : W(r, t), l = a.find(({
        voice: i
    }) => i === g);
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsx("div", {
                    ...
                    children: [l ? e.jsxs(e.Fragment, {
                        ...
                        onValueChange: i => o(i),
                        disabled: s,
                        children: [e.jsxs(n.Trigger, {
                            children: [e.jsx(n.Value, {}), e
                                .jsx(n.Icon, {})
                            ]
                        }), e.jsx(n.Portal, {
