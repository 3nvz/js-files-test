...
import { x as Eo, k as Ao, R as mn, r as Ar } from "./lip667d8t42poxum.js";
var Qn = { exports: {} },
  Co = Qn.exports,
  Cr;
function Io() {
        ...
        (function (z, C) {
          ...
          function xe(e, n, t, r) {
            Nt(
              ...
              n,
              N(
                t && Y(t, "get") && typeof t.get == "function"
 ...
 ` + i
                      ...
                      : typeof o == "object" &&
                        ((this.message = ""
                          ...
                          .concat(o.message)),
                        (this.inner = o))
                    : ((this.message = Mr[n] || t), (this.inner = null));
              }
              return Le(r).from(Nr), (e[n] = r), e;
            }, {});
          (S.Syntax = SyntaxError),
            (S.Type = TypeError),
            (S.Range = RangeError);
                  ...
                  return (
                    r &&
                      (this.onsuccess = this.onsuccess
                        ...
                        : r),
                    o &&
                      (this.onerror = this.onerror ? De(o, this.onerror) : o),
                    i !== void 0 ? i : t
                  );
                };
          }
                  ...
                  (this.onsuccess = this.onerror = null),
                    ...
                    t &&
                      (this.onsuccess = this.onsuccess
                        ...
                        : t),
                    r &&
                      (this.onerror = this.onerror ? De(r, this.onerror) : r);
                };
          }
          function zr(e, n) {
            return e === V
                  ...
                  return (
                    ...
                    o &&
                      (this.onsuccess = this.onsuccess
                        ...
                        : o),
                    i &&
                      (this.onerror = this.onerror ? De(i, this.onerror) : i),
          ...
          var it = {
            get: function () {
              ...
              function t(r, o) {
                ...
                return (
                  this._consoleTask && (f._consoleTask = this._consoleTask), f
                );
              }
          ...
          Ue(A.prototype, {
            ...
            typeof Symbol < "u" &&
              Symbol.toStringTag &&
              xe(A.prototype, Symbol.toStringTag, "Dexie.Promise"),
            (ke.env = Jt()),
            Ue(A, {
              all: function () {
          ...
          function Ge() {
            return J.id || (J.id = ++Gr), ++J.awaits, (J.echoes += Qt), J.id;
          }
          function Pe() {
            return (
              !!J.awaits &&
              (--J.awaits == 0 && (J.id = 0), (J.echoes = J.awaits * Qt), !0)
            );
          }
          function In(e) {
            return J.echoes && e && e.constructor === on
              ? (Ge(),
                e.then(
                  function (n) {
                    return Pe(), n;
          ...
          function Ee(e, n) {
            var t,
              r = I;
            (n ? !J.echoes || (An++ && e === I) : !An || (--An && e === I)) ||
              queueMicrotask(
                n
                  ? function (o) {
                      ++Cn,
                        (J.echoes && --J.echoes != 0) ||
                          (J.echoes = J.awaits = J.id = 0),
                        En.push(I),
                        Ee(o, !0);
                    }.bind(null, e)
                  : Hr,
              ...
              e !== I &&
                ...
                tt &&
                  ...
                  (n = e.env),
                  (r.global || e.global) &&
                    (Object.defineProperty(F, "Promise", n.PromiseProp),
                    (t.all = n.all),
                    (t.race = n.race),
                    (t.resolve = n.resolve),
                    (t.reject = n.reject),
          ...
          function ct(e) {
            Promise === on && J.echoes === 0
              ? An === 0
                ? e()
                : enqueueNativeMicroTask(e)
              : setTimeout(e, 0);
          }
          ("" + ce).indexOf("[native code]") === -1 && (Ge = Pe = V);
          var H = A.reject,
            qe = "￿",
            me =
            ...
            try {
              ...
              switch (t) {
                ...
                case "binary":
                  return (function (o, i) {
                    for (
                      var a = o.length, u = i.length, f = a < u ? a : u, c = 0;
                      c < f;
                      ++c
                    )
          ...
          var ir =
            ((G.prototype._trans = function (e, n, t) {
                  ...
                  r && r.db._novip === this.db._novip
                    ...
                    : (function c(p, s, y, l) {
                        ...
                        if (p._state.openComplete)
                          return H(new S.DatabaseClosed(p._state.dbOpenError));
                        if (!p._state.isBeingOpened) {
                          if (!p._state.autoOpen)
                            return H(new S.DatabaseClosed());
                          p.open().catch(V);
                        }
            ...
            (G.prototype.get = function (e, n) {
              ...
              return e && e.constructor === Object
                ...
                : e == null
                  ? H(new S.Type("Invalid argument to Table.get()"))
            ...
            (G.prototype.where = function (e) {
              ...
              var u = n.reduce(
                ...
                u = u[1];
              return a
                ? this.where(a.name).equals(e[a.keyPath]).filter(u)
                : t
                  ? this.filter(u)
                  : this.where(n).equals("");
            }),
            ...
            (G.prototype.mapToClass = function (e) {
              ...
              (this.schema.mappedClass = e).prototype instanceof tr &&
                ((function (f, c) {
            ...
            (G.prototype.update = function (e, n) {
              return typeof e != "object" || K(e)
                ? this.where(":id").equals(e).modify(n)
                : ((e = ye(e, this.schema.primKey.keyPath)),
                  e === void 0
                    ? H(
                        new S.InvalidArgument(
          ...
          function cn(e, n) {
            return Le(n).from({ prototype: e }), n;
          }
          function He(e, n) {
            return (
              ...
              var i = {},
                a = function (u, f, c) {
                  ...
                  (o &&
                    ...
                    ((s = "" + (p = f.primaryKey)) == "[object ArrayBuffer]" &&
                      (s = "" + new Uint8Array(p)),
                    Y(i, s) || ((i[s] = !0), n(u, f, c)));
                };
              return Promise.all([
                e.or._iterate(a, t),
                ur(ar(e, r, t), e.algorithm, a, !e.keysOnly && e.valueMapper),
              ]);
            }
            return ur(
              ar(e, r, t),
          ...
          var Xr =
            ((U.prototype._read = function (e, n) {
              var t = this._ctx;
              return t.error
              ...
              return this._read(function (t) {
                ...
                if (He(r, !0))
                  return o
                    .count({
                      trans: t,
                      query: { index: Dn(r, o.schema), range: r.range },
                    })
                    .then(function (a) {
                      ...
                      return f
                        ...
                        .then(function (x) {
                          for (
                            ...
                            var T = x[_],
                              j = { value: Se(T), primKey: h[b + _] };
                            a.call(j, j.value, j) !== !1 &&
                              (j.value == null
                                ? E.push(h[b + _])
                                : p || M(s(T), s(j.value)) === 0
                                  ? (k.push(j.value), p && O.push(h[b + _]))
                                  : (E.push(h[b + _]), P.push(j.value)));
                          }
            ...
            (U.prototype.delete = function () {
              var e = this._ctx,
                n = e.range;
              return He(e) && (e.isPrimKey || n.type === 3)
                ? this._write(function (t) {
                    var r = e.table.core.schema.primaryKey,
                      o = n;
                    return e.table.core
                      .count({ trans: t, query: { index: r, range: o } })
                      .then(function (i) {
                        return e.table.core
                          .mutate({ trans: t, type: "deleteRange", range: o })
                          .then(function (a) {
                            var u = a.failures;
                            if (
          ...
          function ue(e, n, t) {
            return (
              (e = e instanceof lr ? new e.Collection(e) : e),
          ...
          function jn(e, n, t, r) {
            ...
            var l = 0;
            return (
              e._addAlgorithm(function (d, v, h) {
                var m = d.key;
                ...
                for (var b = null, w = l; w < s; ++w) {
                  var x = (function (P, k, O, E, _, T) {
                    for (
                      var j = Math.min(P.length, E.length), B = -1, R = 0;
                      R < j;
                      ++R
                    ) {
                      var le = k[R];
                      if (le !== E[R])
                        return _(P[R], O[R]) < 0
                          ? P.substr(0, R) + O[R] + O.substr(R + 1)
                          : _(P[R], E[R]) < 0
                            ? P.substr(0, R) + E[R] + O.substr(R + 1)
                            : 0 <= B
                              ? P.substr(0, B) + k[B] + O.substr(B + 1)
                              : null;
                      _(P[R], le) < 0 && (B = R);
                    }
                    return j < E.length && T === "next"
                      ? P + O.substr(P.length)
                      : j < P.length && T === "prev"
                        ? P.substr(0, O.length)
                        : B < 0
                          ? null
                          : P.substr(0, B) + E[B] + O.substr(B + 1);
                  })(m, g, u[w], f[w], a, c);
                  x === null && b === null
                    ? (l = w + 1)
                    : (b === null || 0 < a(b, x)) && (b = x);
          ...
          var lr =
            ...
            (Z.prototype.inAnyRange = function (m, n) {
              ...
              if (
                !m.every(function (g) {
                  return (
                    g[0] !== void 0 && g[1] !== void 0 && o(g[0], g[1]) <= 0
                  );
                })
              )
                return ue(
            ...
            eo =
              ...
              (de.prototype.create = function (e) {
                ...
                return (
                  ...
                  (e.onabort = Q(function (o) {
                    fn(o),
                      n.active && n._reject(new S.Abort(e.error)),
                      (n.active = !1),
                      n.on("abort").fire(o);
                  })),
                  (e.oncomplete = Q(function () {
                    (n.active = !1),
                      n._resolve(),
                      "mutatedParts" in e &&
                        Ce.storagemutated.fire(e.mutatedParts);
                  })),
                  this
                );
              }),
              (de.prototype._promise = function (e, n, t) {
                ...
                if (e === "readwrite" && this.mode !== "readwrite")
                  return H(new S.ReadOnly("Transaction is readonly"));
                  ...
                  function (v) {
                    return new Promise(function (h, m) {
                      ...
                      l
                        ? (((k = x
                            ? E.getAll(_, k)
                            : E.getAllKeys(_, k)).onsuccess = function (T) {
                            return h({ result: T.target.result });
                          }),
                          (k.onerror = he(m)))
                        : ((g = 0),
                          (b =
                        ...
                        return (
                          ...
                          (p = p.filter(function (m) {
                            ...
                            ? (p.forEach(function (m) {
                                v.push(function () {
                                  ...
                                  if (x && m._cfg.version > y) {
                                    ...
                                    w.del.forEach(function (E) {
                                      ...
                                      qn(s, [s.Transaction.prototype], L(P), P),
                                      (l.schema = P);
                                    var k,
                                      O = Zn(x);
                                    return (
                              ...
                              (function m() {
                                return v.length
                                  ? A.resolve(v.shift()(l.idbtrans)).then(m)
                                  : A.resolve();
                              })().then(function () {
                                dr(h, d);
                              }))
          ...
          function dr(e, n) {
            L(e).forEach(function (t) {
              n.db.objectStoreNames.contains(t) ||
                (fe && console.debug("Dexie: Creating missing table", t),
          ...
          function Fn(e, n, t) {
            var r = {};
            return (
              bn(n.objectStoreNames, 0).forEach(function (o) {
                for (
                  var i = t.objectStore(o),
                    a = vt(
                      fr((c = i.keyPath)),
                      c || "",
                      !0,
          ...
          var uo =
            ((Nn.prototype._parseStoresSpec = function (e, n) {
              L(e).forEach(function (t) {
                if (e[t] !== null) {
                  var r = pr(e[t]),
                    o = r.shift();
            ...
            (Nn.prototype.upgrade = function (e) {
              return (
                (this._cfg.contentUpgrade = nt(
                  this._cfg.contentUpgrade || V,
                  e,
                )),
                this
              );
          ...
          function xt(e, n) {
            ...
            return (
              t ||
                (t = e._dbNamesDB =
                  new be(Sn, { addons: [], indexedDB: e, IDBKeyRange: n }))
                  .version(1)
                  .stores({ dbnames: "name" }),
              t.table("dbnames")
            );
          ...
          function yn(e, n, t) {
            ...
            if (!isNaN(r)) {
              ...
              if (Pt(e)) return N(e, { from: n, to: t, d: 1 });
              var o = e.l,
                r = e.r;
              if (M(t, e.from) < 0)
                return (
          ...
          function yr(e, n) {
            ...
            if (r.done) return !1;
            for (
              var o = r.value, i = Un(e), a = i.next(o.from), u = a.value;
              !r.done && !a.done;

            ) {
              if (M(u.from, o.to) <= 0 && 0 <= M(u.to, o.from)) return !0;
              M(o.from, u.from) < 0
                ? (o = (r = t.next(u.from)).value)
                  ...
                  : (e[t] = (function r(o) {
                      ...
                      for (i in o)
                        Y(o, i) &&
                          ((a = o[i]),
                          (u[i] =
                            !a || typeof a != "object" || $t.has(a.constructor)
                              ? a
                              : r(a)));
                      return u;
                    })(n[t]));
          ...
          function gr(e, n, t, r) {
            for (
              ...
              for (
                var u = a[i], f = u[0], c = [], p = 0, s = u[1];
                p < s.length;
                p++
              ) {
                var y = s[p];
                Et(n, y.obsSet)
                  ? y.subscribers.forEach(function (h) {
                      return t.add(h);
                    })
                  : r && c.push(y);
              }
              ...
              return new A(function (y, l) {
                ...
                (v.onerror = he(l)),
                  ...
                  (v.onsuccess = Q(function () {
                    ...
                    if (0 < P.length)
                      try {
                        ...
                        if (n.autoSchema)
                          ...
                          (Mn(e, e._dbSchema, k),
                          ((w = wt(Fn(0, (w = e).idbdb, k), w._dbSchema)).add
                            .length ||
                    ...
                    Qe.push(e),
                      (x.onversionchange = Q(function (O) {
                        (n.vcFired = !0), e.on("versionchange").fire(O);
                      })),
                      (x.onclose = Q(function (O) {
                        e.on("close").fire(O);
                      })),
                      s &&
                        ((w = e._deps),
                  ...
                  s &&
                    ...
                    e.tables.forEach(function (l) {
                      l.schema.indexes.forEach(function (d) {
                        ...
                        (y["idb://".concat(e.name, "/").concat(l.name, "/")] =
                          y[
                            "idb://"
                              .concat(e.name, "/")
                              .concat(l.name, "/:dels")
                          ...
                          query: {
                            ...
                            range:
                              ...
                              (l = l.keyTail),
                              {
                                ...
                                lower: zn(
                                  y.lower,
                                  y.lowerOpen ? e.MAX_KEY : e.MIN_KEY,
                                  l,
                                ),
                                lowerOpen: !0,
                                upper: zn(
                                  y.upper,
                                  y.upperOpen ? e.MIN_KEY : e.MAX_KEY,
                                  l,
                                ),
                                upperOpen: !0,
                              }),
                        ...
                        return Object.create(m, {
                          continue: {
                            value: function (g) {
                              g != null
                                ? m.continue(
                                    zn(g, s.reverse ? e.MAX_KEY : e.MIN_KEY, l),
                                  )
                                : s.unique
                                  ? m.continue(
                                      m.key
                            ...
                            var g = h.map(function (b, w) {
                              ...
                              return (
                                s.type === "delete"
                                  ? u.fire.call(E, b, O, v)
                                  : s.type === "add" || O === void 0
                                    ? ((x = f.fire.call(E, b, s.values[w], v)),
                                      b == null &&
                                        x != null &&
                                        ((s.keys[w] = b = x),
                                        r.outbound ||
                                          ae(s.values[w], r.keyPath, b)))
                                    : ((x = Kt(O, s.values[w])),
                                      (P = c.fire.call(E, x, b, O, v)) &&
                                        ((k = s.values[w]),
          ...
          function br(e, n, t) {
            try {
              ...
              for (
                var r = [], o = 0, i = 0;
                o < n.keys.length && i < e.length;
                ++o
              )
                M(n.keys[o], e[i]) === 0 &&
                  (r.push(t ? Se(n.values[o]) : n.values[o]), ++i);
            ...
            create: function (e) {
              ...
              return C(C({}, e), {
                transaction: function (r, o, i) {
                  if (I.subscr && o !== "readonly")
                    throw new S.ReadOnly(
                  ...
                  var o = e.table(r),
                                ...
                                i.indexes.forEach(function (_) {
                                  ...
                                  (h || m).forEach(function (R, ne) {
                                    var q = h && j(h[ne]),
                                      ne = m && j(m[ne]);
                                    M(q, ne) !== 0 &&
                                      (q != null && B(q), ne != null && B(ne));
                                  });
                                })))
                            : k
                              ? ((O = { from: k.lower, to: k.upper }),
                                x.add(O),
                                w.add(O))
                              : (w.add(t),
                                x.add(t),
                    ...
                    s = function (d) {
                      ...
                      return [
                        d,
                        new re(
                          (d = v.lower) !== null && d !== void 0
                            ? d
                            : e.MIN_KEY,
                          (v = v.upper) !== null && v !== void 0
                            ? v
                            : e.MAX_KEY,
                        ),
                      ];
          ...
          function xr(e, n, t) {
            ...
            return t.numFailures === r
              ...
              : ((n = C({}, n)),
                K(n.keys) &&
                  (n.keys = n.keys.filter(function (o, i) {
                    return !(i in t.failures);
                  })),
                "values" in n &&
                  K(n.values) &&
                  (n.values = n.values.filter(function (o, i) {
                    return !(i in t.failures);
                  })),
                n);
          }
          function Tt(e, n) {
            return (
              (t = e),
              ((r = n).lower === void 0 ||
                (r.lowerOpen ? 0 < M(t, r.lower) : 0 <= M(t, r.lower))) &&
                ((e = e),
                (n = n).upper === void 0 ||
                  (n.upperOpen ? M(e, n.upper) < 0 : M(e, n.upper) <= 0))
            );
            var t, r;
          }
              ...
              y = y.reduce(function (l, d) {
                ...
                switch (d.type) {
                  case "add":
                    ...
                    break;
                  case "put":
                    var P = new re().addKeys(
                        d.values.map(function (_) {
                          return c(_);
                        }),
                      ),
                      v = l
                                ...
                                if (u._explicit && f && u.mutatedParts)
                                  for (
                                    ...
                                    for (
                                      ...
                                      Et((k = b[g]).obsSet, u.mutatedParts) &&
                                        (Ke(P, k),
                                  ...
                                  for (
                                    var w = 0,
                                      x = Object.values(l.queries.query);
                                    w < x.length;
                                    w++
                                  )
                                    for (
                ...
                table: function (t) {
                  ...
                  return C(C({}, r), {
                    ...
                    query: function (i) {
                      ...
                      var a =
                          ((c = I.trans) === null || c === void 0
                            ? void 0
                            : c.db._options.cache) === "immutable",
                        s = I,
                        u = s.requery,
                        f = s.signal,
                        c = (function (d, v, h, m) {
                          ...
                          var b =
                            v[(m.query ? m.query.index.name : null) || ""];
                            ...
                            case "query":
                              var w = b.find(function (x) {
                                return (
                                  ...
                                  Or(x.req.query.range, m.query.range)
                                );
                              });
                              return w
                                ? [w, !0, g, b]
                                : [
                                    b.find(function (x) {
                                      return (
                                        ...
                                        po(x.req.query.range, m.query.range)
                                      );
                                    }),
                                    !1,
                                    g,
          ...
          var be =
            ((X.prototype.version = function (e) {
              if (isNaN(e) || e < 0.1)
            ...
            (X.prototype._whenReady = function (e) {
              var n = this;
              return this.idbdb &&
                (this._state.openComplete || I.letThrough || this._vip)
                ? e()
                : new A(function (t, r) {
                    if (n._state.openComplete)
                      return r(new S.DatabaseClosed(n._state.dbOpenError));
            ...
            (X.prototype.use = function (e) {
              var n = e.stack,
                ...
                o = e.name;
              return (
                o && this.unuse({ stack: n, name: o }),
                (e = this._middlewares[n] || (this._middlewares[n] = [])),
                e.push({ stack: n, create: t, level: r ?? 10, name: o }),
                e.sort(function (i, a) {
            ...
            (X.prototype._close = function () {
              ...
              e.isBeingOpened ||
                ((e.dbReadyPromise = new A(function (t) {
                  e.dbReadyResolve = t;
                })),
            ...
            (X.prototype.close = function (t) {
              var n = (t === void 0 ? { disableAutoOpen: !0 } : t)
                ...
                t = this._state;
              n
                ? (t.isBeingOpened && t.cancelOpen(new S.DatabaseClosed()),
                  this._close(),
                  (t.autoOpen = !1),
                  (t.dbOpenError = new S.DatabaseClosed()))
                : (this._close(),
                ...
                function a() {
                  ...
                  (u.onsuccess = Q(function () {
                    ...
                    (f = n._deps),
                      ...
                      (p = f.indexedDB),
                      (f = f.IDBKeyRange),
                      kt(p) || c === Sn || xt(p, f).delete(c).catch(V),
                      o();
                  })),
                    (u.onerror = he(i)),
            ...
            (X.prototype._transaction = function (e, n, t) {
              ...
              try {
                if (
                  ((a = n.map(function (c) {
                    if (
                      ((c = c instanceof r.Table ? c.name : c),
                      typeof c != "string")
                    )
                      throw new TypeError(
                ...
                return A.resolve().then(function () {
                  ...
                  return (
                    ...
                    (v = A.follow(function () {
                      ...
                      (m = d.call(h, h)) &&
                        (g
                          ? ((b = Pe.bind(null, null)), m.then(b, b))
                          : typeof m.next == "function" &&
                            typeof m.throw == "function" &&
                            (m = St(m)));
                    }, v)),
                    (m && typeof m.then == "function"
                      ? A.resolve(m).then(function (b) {
                          return h.active
                            ? b
                            : H(
                                new S.PrematureCommit(
            ...
            (X.prototype.table = function (e) {
              if (!Y(this._allTables, e))
                throw new S.InvalidTable("Table ".concat(e, " does not exist"));
          ...
          function X(e, n) {
                  ...
                  return function (y, l) {
                    X.vip(function () {
                      var d,
                        v = t._state;
                      v.openComplete
                        ? (v.dbOpenError || A.resolve().then(y), l && s(y))
                        : v.onReadyBeingFired
                          ? (v.onReadyBeingFired.push(y), l && s(y))
                          : (s(y),
                            (d = t),
                            l ||
                              s(function h() {
            ...
            var p = new Proxy(this, {
              get: function (s, y, l) {
                ...
                return d instanceof ir
                  ? $n(d, p)
                  : y === "tables"
                    ? d.map(function (v) {
                        return $n(v, p);
                      })
                    : y === "_createTransaction"
                      ? function () {
                        ...
                        function (g) {
                          (t = !0),
                            ...
                            u ||
                              ...
                              ((f = {}),
                              (function (b) {
                                for (var w in b) if (Y(b, w)) return;
                                return 1;
                              })((c = v)) ||
                                s ||
                                (Ce(hn, l), (s = !0)),
          ...
          Ue(
            ...
            C(C({}, _n), {
                ...
                try {
                  return (
                    ...
                    (kt(t)
                      ...
                      : xt(t, n).toCollection().primaryKeys()
                    ).then(e)
                  );
                } catch {
              ...
              waitFor: function (e, n) {
                return (
                  (n = A.resolve(
                    typeof e == "function" ? Me.ignoreTransaction(e) : e,
                  ).timeout(n || 6e4)),
                  I.trans ? I.trans.waitFor(n) : n
                );
              },
              Promise: A,
              debug: {
...
if (Ft.semVer !== Hn.semVer)
  throw new Error(
    `Two different versions of Dexie loaded in the same app: ${Ft.semVer} and ${Hn.semVer}`,
  );
const {
  liveQuery: Ko,
  mergeRanges: Fo,
...
function Do(D, W, z) {
  ...
  var F = mn.useRef({ hasResult: !1, result: ee, error: null }),
  ...
  var K = L[1],
    N = mn.useMemo(function () {
      ...
      if (
        !F.current.hasResult &&
        typeof window < "u" &&
        (typeof $.hasValue != "function" || $.hasValue())
      )
        if (typeof $.getValue == "function")
          (F.current.result = $.getValue()), (F.current.hasResult = !0);
        else {
  ...
  if (
    (mn.useDebugValue(F.current.result),
    mn.useEffect(function () {
      var $ = N.subscribe(
        function (se) {
          var Y = F.current;
          (Y.error !== null || Y.result !== se) &&
            ((Y.error = null), (Y.result = se), (Y.hasResult = !0), K());
        },
        function (se) {
          var Y = F.current;
...
function Kr(D) {
  D.version(1).stores({ conversations: "id, accountUserId, authUserId" });
}
  ...
  gn = {
    ...
    setCurrentAccountV2: async (D) => {
      ...
      if (W && W.authUserId !== z.authUserId)
        try {
          await pe()
            .db.conversations.where("accountUserId")
            .notEqual(_e(z?.accountUserId))
            .delete(),
            we({ currentAccountData: z }),
            ie.addAction("fannypack.web.swap_user");
        } catch (C) {
          ie.addError(
            `FannyPack: Failed to delete conversations for new user: ${C}`,
          );
        }
      we({ currentAccountData: z });
    },
    setCurrentAccount: (D) => {
      if (!D.accountUserId || !D.authUserId) {
        pe()
          ...
          .catch((C) => {
            ie.addError(
              `FannyPack: Invalid user. Failed to clear conversations: ${C}`,
            );
          }),
          we({ currentAccountData: void 0 });
        return;
...
function Ro(D, W, z = 0) {
  const C = D.toLowerCase(),
    ...
    F = W.sort((K, N) =>
      K.updateTime === N.updateTime
        ? N.id.localeCompare(K.id)
        : (N.updateTime ?? 0) - (K.updateTime ?? 0),
    ).filter((K) => ee.includes(K.id)),
    L = [];
  for (const K of F) {
    if (L.length >= z) break;
    const N = K.messages
      .toReversed()
      .find(($) => $.text.toLowerCase().includes(C));
    (N || K.title.toLowerCase().includes(C)) &&
      L.push({
        conversationId: K.id,
        nodeId: N?.id,
        title: K.title,
      ...
      To(
        () =>
          z
            ? gn
                .getDatabase()
                .conversations.where({ accountUserId: z.accountUserId })
                .toArray()
                .catch(
                  (L) => (
                    ie.addError(
                      `FannyPack: Failed to fetch conversations: ${L}`,
                    ),
                    []
                  ),
                )
...
//# sourceMappingURL=nbz4aahqzuixvvgr.js.map
