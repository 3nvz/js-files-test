...
import { u as $ } from "./abdc4q71tykmepri.js";
import {
  b8 as S,
  aZ as V,
  e$ as G,
...
import { V as se, u as te } from "./esv8bq6wmes9vj4c.js";
import { T as ae } from "./baqe411ijw4zke1t.js";
...
function ie({ conversationId: s, initialVoiceName: m }) {
  ...
  const F = () => {
      v(!0),
        R.voiceAdvancedDisclosureAccepted.click(),
        x(!0),
        setTimeout(async () => {
          b(!1);
        }, ae);
    ...
    j = e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className: "shrink-0",
          children: e.jsx(G, { className: "me-4 h-8 w-8" }),
        }),
        e.jsxs("div", {
    ...
    A = e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className: "shrink-0",
          children: e.jsx(K, { className: "me-4 h-8 w-8" }),
        }),
        e.jsxs("div", {
          className: "text-start",
          children: [
    ...
    I = e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className: "shrink-0",
          children: e.jsx(ne, { className: "me-4 h-8 w-8" }),
        }),
        e.jsxs("div", {
          className: "text-start",
          children: [
    ...
    k = e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className: "shrink-0",
          children: e.jsx(oe, { className: "me-4 h-8 w-8" }),
        }),
        e.jsxs("div", {
          className: "text-start",
          children: [
    ...
    M = e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className: "shrink-0",
          children: e.jsx(Q, { className: "me-4 h-8 w-8" }),
        }),
        e.jsxs("div", {
          className: "text-start",
          children: [
        ...
        children: e.jsxs("div", {
          ...
          children: [
            ...
            e.jsx("div", {
              ...
              children: E.map((d, O) => e.jsx("div", { children: d }, O)),
            }),
            e.jsxs("p", {
            ...
            e.jsx(z, {
              className:
                "bg-token-text-primary rounded-full px-20 py-3 font-semibold",
              onClick: F,
              children: e.jsx(C, { id: "ppi93b", defaultMessage: "Continue" }),
            }),
          ],
        }),
      }),
...
function Me({ clientThreadId: s }) {
  const m = w((a) => a.showVoicePicker),
    t = w((a) => a.showNuxFullPage),
    i = J(),
    n = U(s) ?? s,
    { isUnauthenticated: c } = q(),
    { startVoiceMode: r } = te(),
    { prospectiveModelId: l } = ee(s),
    { setValue: u } = $(B.VoiceName),
    x = ce(),
    h = H();
  return (
    o.useEffect(() => {
          ...
          try {
            sessionStorage.removeItem("selectedVoiceName"),
              await r({
                ...
                voice_mode: "advanced",
                clientThreadId: X(),
                gizmo_id: D.getGizmoId(W(n)),
                requested_default_model: l ?? void 0,
              });
          } catch (p) {
            Y.addError(`Failed to start voice mode after voice picker: ${p}`, {
              protocol: h,
            });
          }
        };
...
export { Me as VoiceModals };
//# sourceMappingURL=i4lct9tt8qg58lvp.js.map
