...
import { r as pa, j as ze, a5 as _o, M as eh } from "./lip667d8t42poxum.js";
import { c as th, b as rh, i as nh } from "./jwvxkjptpstk4ej7.js";
function ma(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.isText && i.text != s.text) {
      for (let a = 0; i.text[a] == s.text[a]; a++) t++;
      return t;
    }
    if (i.content.size || s.content.size) {
      let a = ma(i.content, s.content, t + 1);
      if (a != null) return a;
    }
    t += i.nodeSize;
  }
...
function ga(n, e, t, r) {
  for (let i = n.childCount, s = e.childCount; ; ) {
    ...
    if (a.isText && a.text != l.text) {
      let h = 0,
        d = Math.min(a.text.length, l.text.length);
      for (
        ;
        h < d && a.text[a.text.length - h - 1] == l.text[l.text.length - h - 1];
    ...
    if (a.content.size || l.content.size) {
      let h = ga(a.content, l.content, t - 1, r - 1);
      if (h) return h;
    }
    (t -= o), (r -= o);
  }
...
class z {
  ...
  nodesBetween(e, t, r, i = 0, s) {
    for (let a = 0, l = 0; l < t; a++) {
      let o = this.content[a],
        h = l + o.nodeSize;
      if (h > e && r(o, i + l, s || null, a) !== !1 && o.content.size) {
        let d = l + 1;
        o.nodesBetween(
          Math.max(0, e - d),
          Math.min(o.content.size, t - d),
          r,
          i + d,
        );
      }
  ...
  textBetween(e, t, r, i) {
    ...
    return (
      this.nodesBetween(
        ...
        (l, o) => {
          let h = l.isText
            ? l.text.slice(Math.max(e, o) - o, t - o)
            : l.isLeaf
              ? i
                ? typeof i == "function"
                  ? i(l)
  ...
  findIndex(e, t = -1) {
    if (e == 0) return Yr(0, e);
    if (e == this.size) return Yr(this.content.length, e);
    if (e > this.size || e < 0)
      throw new RangeError(`Position ${e} outside of fragment (${this})`);
    for (let r = 0, i = 0; ; r++) {
      let s = this.child(r),
        a = i + s.nodeSize;
      if (a >= e) return a == e || t > 0 ? Yr(r + 1, a) : Yr(r, i);
      i = a;
    }
  }
  toString() {
...
z.empty = new z([], 0);
const G0 = { index: 0, offset: 0 };
function Yr(n, e) {
  return (G0.index = n), (G0.offset = e), G0;
}
function d0(n, e) {
  if (n === e) return !0;
  ...
  if (t) {
    ...
    for (let r = 0; r < n.length; r++) if (!d0(n[r], e[r])) return !1;
  } else {
    for (let r in n) if (!(r in e) || !d0(n[r], e[r])) return !1;
...
class j {
  ...
  eq(e) {
    return this == e || (this.type == e.type && d0(this.attrs, e.attrs));
  }
  toJSON() {
  ...
  static setFrom(e) {
    if (!e || (Array.isArray(e) && e.length == 0)) return j.none;
...
class B {
  ...
  insertAt(e, t) {
    let r = va(this.content, e + this.openStart, t);
    return r && new B(r, this.openStart, this.openEnd);
  }
  removeBetween(e, t) {
    return new B(
      ya(this.content, e + this.openStart, t + this.openStart),
      this.openStart,
      this.openEnd,
    );
  }
  ...
  static fromJSON(e, t) {
    ...
    return new B(z.fromJSON(e, t.content), r, i);
  }
...
function ya(n, e, t) {
  ...
  return n.replaceChild(r, s.copy(ya(s.content, e - i - 1, t - i - 1)));
}
function va(n, e, t, r) {
  let { index: i, offset: s } = n.findIndex(e),
    a = n.maybeChild(i);
  if (s == e || a.isText) return n.cut(0, e).append(t).append(n.cut(e));
  let l = va(a.content, e - s - 1, t);
  return l && n.replaceChild(i, a.copy(l));
}
function ih(n, e, t) {
  if (t.openStart > n.depth)
    throw new f0("Inserted content deeper than insertion position");
  if (n.depth - t.openStart != e.depth - t.openEnd)
    throw new f0("Inconsistent open depths");
  return ba(n, e, t, 0);
}
function ba(n, e, t, r) {
  let i = n.index(r),
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: a, end: l } = sh(t, n);
      return Gt(s, wa(n, a, l, e, r));
    }
  else return Gt(s, p0(n, e, r));
}
function xa(n, e) {
  if (!e.type.compatibleContent(n.type))
    throw new f0("Cannot join " + e.type.name + " onto " + n.type.name);
}
function bn(n, e, t) {
  let r = n.node(t);
  return xa(r, e.node(t)), r;
}
function Wt(n, e) {
  let t = e.length - 1;
...
function Mr(n, e, t, r) {
  ...
  n &&
    ((s = n.index(t)),
    n.depth > t ? s++ : n.textOffset && (Wt(n.nodeAfter, r), s++));
  for (let l = s; l < a; l++) Wt(i.child(l), r);
  e && e.depth == t && e.textOffset && Wt(e.nodeBefore, r);
}
function Gt(n, e) {
  return n.type.checkContent(e), n.copy(e);
}
function wa(n, e, t, r, i) {
  let s = n.depth > i && bn(n, e, i + 1),
    a = r.depth > i && bn(t, r, i + 1),
    l = [];
  return (
    Mr(null, n, i, l),
    s && a && e.index(i) == t.index(i)
      ? (xa(s, a), Wt(Gt(s, wa(n, e, t, r, i + 1)), l))
      : (s && Wt(Gt(s, p0(n, e, i + 1)), l),
        Mr(e, t, i, l),
        a && Wt(Gt(a, p0(t, r, i + 1)), l)),
    Mr(r, null, i, l),
    new z(l)
  );
}
function p0(n, e, t) {
  ...
  if ((Mr(null, n, t, r), n.depth > t)) {
    let i = bn(n, e, t + 1);
    Wt(Gt(i, p0(n, e, t + 1)), r);
  }
  return Mr(e, null, t, r), new z(r);
}
function sh(n, e) {
  let t = e.depth - n.openStart,
    i = e.node(t).copy(n.content);
  for (let s = t - 1; s >= 0; s--) i = e.node(s).copy(z.from(i));
  return {
...
class zr {
  ...
  marks() {
    ...
    for (var a = 0; a < s.length; a++)
      s[a].type.spec.inclusive === !1 &&
        (!i || !s[a].isInSet(i.marks)) &&
        (s = s[a--].removeFromSet(s));
    return s;
  }
  marksAcross(e) {
  ...
  static resolve(e, t) {
    ...
    let r = [],
      ...
      s = t;
    for (let a = e; ; ) {
      let { index: l, offset: o } = a.content.findIndex(s),
        h = s - o;
      if ((r.push(a, l, i + o), !h || ((a = a.child(l)), a.isText))) break;
      (s = h - 1), (i += o + 1);
    }
    return new zr(t, r, s);
  }
  static resolveCached(e, t) {
    ...
    else Di.set(e, (r = new ah()));
    let i = (r.elts[r.i] = zr.resolve(e, t));
    return (r.i = (r.i + 1) % lh), i;
  }
}
class ah {
  constructor() {
...
class Qe {
  ...
  hasMarkup(e, t, r) {
    return (
      this.type == e &&
      d0(this.attrs, t || e.defaultAttrs || hh) &&
  ...
  copy(e = null) {
    return e == this.content
      ? this
      : new Qe(this.type, this.attrs, e, this.marks);
  }
  mark(e) {
    return e == this.marks
      ? this
      : new Qe(this.type, this.attrs, this.content, e);
  }
  ...
  slice(e, t = this.content.size, r = !1) {
    ...
    let i = this.resolve(e),
      ...
      l = i.start(a),
      h = i.node(a).content.cut(i.pos - l, s.pos - l);
    return new B(h, i.depth - a, s.depth - a);
  }
  replace(e, t, r) {
    return ih(this.resolve(e), this.resolve(t), r);
  }
  nodeAt(e) {
    for (let t = this; ; ) {
  ...
  resolve(e) {
    return zr.resolveCached(this, e);
  }
  resolveNoCache(e) {
    return zr.resolve(this, e);
  }
  rangeHasMark(e, t, r) {
    let i = !1;
    return (
  ...
  canReplace(e, t, r = z.empty, i = 0, s = r.childCount) {
    let a = this.contentMatchAt(e).matchFragment(r, i, s),
      l = a && a.matchFragment(this.content, t);
    if (!l || !l.validEnd) return !1;
    for (let o = i; o < s; o++)
      if (!this.type.allowsMarks(r.child(o).marks)) return !1;
    return !0;
  }
...
let uh = class xn extends Qe {
  ...
  toString() {
    return this.type.spec.toDebugString
      ...
      : ka(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
class Ut {
  ...
  static parse(e, t) {
    let r = new ch(e, t);
    if (r.next == null) return Ut.empty;
    let i = Sa(r);
  ...
  fillBefore(e, t = !1, r = 0) {
    let i = [this];
    function s(a, l) {
      let o = a.matchFragment(e, r);
      if (o && (!t || o.validEnd))
        return z.from(l.map((h) => h.createAndFill()));
      for (let h = 0; h < a.next.length; h++) {
        let { type: d, next: f } = a.next[h];
        if (!(d.isText || d.hasRequiredAttrs()) && i.indexOf(f) == -1) {
          i.push(f);
          let g = s(f, l.concat(d));
          if (g) return g;
        }
      }
      return null;
...
function yh(n) {
  ...
  function s(a, l) {
    if (a.type == "choice")
      return a.exprs.reduce((o, h) => o.concat(s(h, l)), []);
    if (a.type == "seq")
      for (let o = 0; ; o++) {
        let h = s(a.exprs[o], l);
        if (o == a.exprs.length - 1) return h;
        i(h, (l = t()));
      }
    else if (a.type == "star") {
      let o = t();
      return r(l, o), i(s(a.expr, o), o), [r(o)];
    } else if (a.type == "plus") {
      let o = t();
      return i(s(a.expr, l), o), i(s(a.expr, o), o), [r(o)];
    } else {
      if (a.type == "opt") return [r(l)].concat(s(a.expr, l));
      if (a.type == "range") {
        let o = l;
        ...
        if (a.max == -1) i(s(a.expr, o), o);
        else
          for (let h = a.min; h < a.max; h++) {
            let d = t();
            r(o, d), i(s(a.expr, o), d), (o = d);
          }
        return [r(o)];
      } else {
...
function vh(n) {
  ...
  function t(r) {
    let i = [];
    r.forEach((a) => {
      n[a].forEach(({ term: l, to: o }) => {
        if (!l) return;
        let h;
        for (let d = 0; d < i.length; d++) i[d][0] == l && (h = i[d][1]);
        Ei(n, o).forEach((d) => {
          h || i.push([l, (h = [])]), h.indexOf(d) == -1 && h.push(d);
        });
      });
    });
    ...
    for (let a = 0; a < i.length; a++) {
      let l = i[a][1].sort(Ma);
      s.next.push({ type: i[a][0], next: e[l.join(",")] || t(l) });
    }
    return s;
  }
}
...
function Na(n, e) {
  let t = Object.create(null);
  if (e) for (let r in e) t[r] = new wh(n, r, e[r]);
  return t;
}
let Bi = class za {
  constructor(e, t, r) {
    (this.name = e),
      ...
      (this.defaultAttrs = Ta(this.attrs)),
  ...
  create(e = null, t, r) {
    ...
    return new Qe(this, this.computeAttrs(e), z.from(t), j.setFrom(r));
  }
  createChecked(e = null, t, r) {
    return (
      (t = z.from(t)),
      this.checkContent(t),
      new Qe(this, this.computeAttrs(e), t, j.setFrom(r))
    );
  }
  createAndFill(e = null, t, r) {
    ...
    let i = this.contentMatch.matchFragment(t),
      s = i && i.fillBefore(z.empty, !0);
    return s ? new Qe(this, e, t.append(s), j.setFrom(r)) : null;
  }
  validContent(e) {
  ...
  checkAttrs(e) {
    Aa(this.attrs, e, "node", this.name);
  }
  allowsMarkType(e) {
  ...
  static compile(e, t) {
    ...
    e.forEach((s, a) => (r[s] = new za(s, t, a)));
...
class wh {
  constructor(e, t, r) {
    (this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default")),
      ...
      (this.validate =
        typeof r.validate == "string" ? xh(e, t, r.validate) : r.validate);
  }
  get isRequired() {
...
class C0 {
  constructor(e, t, r, i) {
    (this.name = e),
      ...
      (this.schema = r),
      (this.spec = i),
      (this.attrs = Na(e, i.attrs)),
      (this.excluded = null);
    let s = Ta(this.attrs);
    this.instance = s ? new j(this, s) : null;
  }
  create(e = null) {
    return !e && this.instance ? this.instance : new j(this, Ca(this.attrs, e));
  }
  static compile(e, t) {
    let r = Object.create(null),
      i = 0;
    return e.forEach((s, a) => (r[s] = new C0(s, i++, t, a))), r;
  }
  removeFromSet(e) {
  ...
  checkAttrs(e) {
    Aa(this.attrs, e, "mark", this.name);
  }
  excludes(e) {
...
class kf {
  constructor(e) {
    ...
    (t.nodes = zi.from(e.nodes)),
      (t.marks = zi.from(e.marks || {})),
      (this.nodes = Bi.compile(this.spec.nodes, this)),
      (this.marks = C0.compile(this.spec.marks, this));
    let r = Object.create(null);
    for (let i in this.nodes) {
      ...
      let s = this.nodes[i],
        ...
        l = s.spec.marks;
      if (
        ((s.contentMatch = r[a] || (r[a] = Ut.parse(a, this.nodes))),
    ...
    for (let i in this.marks) {
      let s = this.marks[i],
        a = s.spec.excludes;
      s.excluded = a == null ? [s] : a == "" ? [] : Ri(this, a.split(" "));
    }
  ...
  text(e, t) {
    ...
    return new uh(r, r.defaultAttrs, e, j.setFrom(t));
  }
  mark(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    if (s) t.push(s);
      ...
      for (let l in n.marks) {
        let o = n.marks[l];
        (i == "_" ||
          (o.spec.group && o.spec.group.split(" ").indexOf(i) > -1)) &&
          t.push((a = o));
      }
...
class Dr {
  ...
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      s &&
        s.forEach((a) => {
          r((a = Pi(a))), a.mark || a.ignore || a.clearMark || (a.mark = i);
        });
    }
    for (let i in e.nodes) {
      ...
      s &&
        s.forEach((a) => {
          r((a = Pi(a))), a.node || a.ignore || a.mark || (a.node = i);
        });
    }
    return t;
  }
  static fromSchema(e) {
    return (
      e.cached.domParser || (e.cached.domParser = new Dr(e, Dr.schemaRules(e)))
    );
  }
}
const Da = {
  ...
  Mh = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  Oa = { ol: !0, ul: !0 },
  m0 = 1,
  g0 = 2,
  a0 = 4;
...
class jr {
  constructor(e, t, r, i, s, a, l) {
    (this.type = e),
      ...
      (this.stashMarks = []),
      (this.match = a || (l & a0 ? null : e.contentMatch));
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type) return [];
  ...
  finish(e) {
    ...
    return (
      !e && this.match && (t = t.append(this.match.fillBefore(z.empty, !0))),
  ...
  applyPending(e) {
    for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
      let i = r[t];
      (this.type ? this.type.allowsMarkType(i.type) : Ah(i.type, e)) &&
...
class Fi {
  constructor(e, t, r) {
    ...
    let i = t.topNode,
      s,
      a = Ii(null, t.preserveWhitespace, 0) | (r ? a0 : 0);
    i
      ? (s = new jr(
          i.type,
          i.attrs,
      ...
      : r
        ? (s = new jr(null, null, j.none, j.none, !0, null, a))
        : (s = new jr(e.schema.topNodeType, null, j.none, j.none, !0, null, a)),
      (this.nodes = [s]),
  ...
  withStyleRules(e, t) {
    ...
    let [s, a] = i,
      l = this.top;
    for (let o = 0; o < a.length; o++) this.removePendingMark(a[o], l);
    for (let o = 0; o < s.length; o++) this.addPendingMark(s[o]);
    t();
    for (let o = 0; o < s.length; o++) this.removePendingMark(s[o], l);
    for (let o = 0; o < a.length; o++) this.addPendingMark(a[o]);
  }
  addTextNode(e) {
    let t = e.nodeValue,
      r = this.top;
    if (r.options & g0 || r.inlineContext(e) || /[^ \t\r\n\u000c]/.test(t)) {
      if (r.options & m0)
        r.options & g0
          ? (t = t.replace(
              /\r\n?/g,
...
`,
  ...
  addElement(e, t) {
    let r = e.nodeName.toLowerCase(),
      i;
    Oa.hasOwnProperty(r) && this.parser.normalizeLists && Th(e);
    let s =
      (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
      (i = this.parser.matchTag(e, this, t));
    if (s ? s.ignore : Mh.hasOwnProperty(r))
...
`),
  ...
  readStyles(e) {
    ...
    if (e.length)
      for (let i = 0; i < this.parser.matchedStyles.length; i++) {
        ...
        if (a)
          for (let l = void 0; ; ) {
            let o = this.parser.matchStyle(s, a, this, l);
            if (!o) break;
  ...
  addElementByRule(e, t, r) {
    ...
    if (s && s.isLeaf) this.findInside(e);
      ...
      this.findInside(e),
        t.getContent(e, this.parser.schema).forEach((o) => this.insertNode(o));
    else {
      let o = e;
      typeof t.contentElement == "string"
        ? (o = e.querySelector(t.contentElement))
        : typeof t.contentElement == "function"
          ? (o = t.contentElement(e))
          : t.contentElement && (o = t.contentElement),
  ...
  findPlace(e) {
    ...
    for (let i = this.open; i >= 0; i--) {
      let s = this.nodes[i],
        a = s.findWrapping(e);
      if (
        (a && (!t || t.length > a.length) && ((t = a), (r = s), !a.length)) ||
        s.solid
      )
        break;
    }
  ...
  enterInner(e, t = null, r = !1, i) {
    ...
    let a = Ii(e, i, s.options);
    s.options & a0 && s.content.length == 0 && (a |= a0),
      this.nodes.push(new jr(e, t, s.activeMarks, s.pendingMarks, r, null, a)),
      this.open++;
  }
  closeExtra(e = !1) {
            ...
            let d =
              o > 0 || (o == 0 && i)
                ...
                : r && o >= s
                  ? r.node(o - s).type
                  : null;
            if (!d || (d.name != h && d.groups.indexOf(h) == -1)) return !1;
            o--;
          }
        }
        return !0;
  ...
  addPendingMark(e) {
    let t = Nh(e, this.top.pendingMarks);
...
function Ah(n, e) {
  ...
  for (let r in t) {
    ...
    let s = [],
      a = (l) => {
        s.push(l);
        for (let o = 0; o < l.edgeCount; o++) {
          let { type: h, next: d } = l.edge(o);
          if (h == e || (s.indexOf(d) < 0 && a(d))) return !0;
        }
      };
...
class pr {
  ...
  serializeFragment(e, t = {}, r) {
    r || (r = J0(t).createDocumentFragment());
    let i = r,
      s = [];
    return (
      e.forEach((a) => {
        if (s.length || a.marks.length) {
          let l = 0,
            o = 0;
          for (; l < s.length && o < a.marks.length; ) {
            let h = a.marks[o];
          ...
          for (; o < a.marks.length; ) {
            let h = a.marks[o++],
              d = this.serializeMark(h, a.isInline, t);
            d &&
              (s.push([h, i]),
              i.appendChild(d.dom),
  ...
  serializeMark(e, t, r = {}) {
    ...
    return i && l0(J0(r), i(e, t), null, e.attrs);
  }
...
function zh(n) {
  let e = Li.get(n);
  return e === void 0 && Li.set(n, (e = Dh(n))), e;
}
function Dh(n) {
  let e = null;
  function t(r) {
...
function l0(n, e, t, r) {
  ...
  let l,
    o = t ? n.createElementNS(t, i) : n.createElement(i),
    h = e[1],
    d = 1;
  if (h && typeof h == "object" && h.nodeType == null && !Array.isArray(h)) {
    ...
    for (let f in h)
      if (h[f] != null) {
        let g = f.indexOf(" ");
        g > 0
          ? o.setAttributeNS(f.slice(0, g), f.slice(g + 1), h[f])
          : o.setAttribute(f, h[f]);
      }
  }
  for (let f = d; f < e.length; f++) {
    ...
    if (g === 0) {
      ...
      let { dom: y, contentDOM: v } = l0(n, g, t, r);
      if ((o.appendChild(y), v)) {
        if (l) throw new RangeError("Multiple content holes");
        l = v;
      }
    }
  }
  return { dom: o, contentDOM: l };
}
const Ea = 65535,
  Ba = Math.pow(2, 16);
function Oh(n, e) {
...
class wn {
  ...
  get deletedBefore() {
    return (this.delInfo & (Ra | o0)) > 0;
  }
  get deletedAfter() {
    return (this.delInfo & (Ia | o0)) > 0;
  }
  get deletedAcross() {
    return (this.delInfo & o0) > 0;
  }
}
class De {
  constructor(e, t = !1) {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      let o = this.ranges[l] - (this.inverted ? i : 0);
      if (o > e) break;
      let h = this.ranges[l + s],
        d = this.ranges[l + a],
        f = o + h;
      if (e <= f) {
        let g = h ? (e == o ? -1 : e == f ? 1 : t) : t,
          y = o + i + (g < 0 ? 0 : d);
        if (r) return y;
        let v = e == (t < 0 ? o : f) ? null : Oh(l / 3, e - o),
          k = e == o ? Ia : e == f ? Ra : o0;
        return (t < 0 ? e != o : e != f) && (k |= Fa), new wn(y, k, v);
      }
      i += d - h;
    }
    return r ? e + i : new wn(e + i, 0, null);
  }
  touches(e, t) {
    let r = 0,
      i = Vi(t),
      ...
      a = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
      let o = this.ranges[l] - (this.inverted ? r : 0);
      if (o > e) break;
      let h = this.ranges[l + s],
        d = o + h;
  ...
  forEach(e) {
    ...
    for (let i = 0, s = 0; i < this.ranges.length; i += 3) {
      let a = this.ranges[i],
        l = a - (this.inverted ? s : 0),
        o = a + (this.inverted ? 0 : s),
        h = this.ranges[i + t],
        d = this.ranges[i + r];
      e(l, l + h, o, o + d), (s += d - h);
    }
...
class Tr {
  ...
  slice(e = 0, t = this.maps.length) {
    return new Tr(this.maps, this.mirror, e, t);
  }
  copy() {
    return new Tr(
      this.maps.slice(),
    ...
    for (let s = this.from; s < this.to; s++) {
      ...
      if (l.recover != null) {
        ...
        if (o != null && o > s && o < this.to) {
          (s = o), (e = this.maps[o].recover(l.recover));
          continue;
        }
      }
      (i |= l.delInfo), (e = l.pos);
    }
    return r ? e : new wn(e, i, null);
  }
}
const $0 = Object.create(null);
class ye {
  getMap() {
    return De.empty;
  }
  ...
  static jsonID(e, t) {
    if (e in $0) throw new RangeError("Duplicate use of step JSON ID " + e);
    return ($0[e] = t), (t.prototype.jsonID = e), t;
  }
}
class oe {
  constructor(e, t) {
  ...
  static fromReplace(e, t, r, i) {
    try {
      return oe.ok(e.replace(t, r, i));
    } catch (s) {
      if (s instanceof f0) return oe.fail(s.message);
      throw s;
    }
  }
}
function Gn(n, e, t) {
  ...
  for (let i = 0; i < n.childCount; i++) {
    let s = n.child(i);
    s.content.size && (s = s.copy(Gn(s.content, e, s))),
...
class je extends ye {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      r = new B(
        Gn(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e),
        t.openStart,
        t.openEnd,
      );
  ...
  merge(e) {
    return e instanceof je &&
      ...
      this.from <= e.to &&
      this.to >= e.from
      ? new je(Math.min(this.from, e.from), Math.max(this.to, e.to), this.mark)
      : null;
  }
  toJSON() {
    return {
    ...
    if (t) {
      ...
      if (r.length == t.marks.length) {
        for (let i = 0; i < t.marks.length; i++)
          if (!t.marks[i].isInSet(r)) return new Tt(this.pos, t.marks[i]);
...
class me extends ye {
  ...
  map(e) {
    ...
    return t.deletedAcross && r.deletedAcross
      ? null
      : new me(t.pos, Math.max(t.pos, r.pos), this.slice);
  }
  merge(e) {
    if (!(e instanceof me) || e.structure || this.structure) return null;
    if (
  ...
  static fromJSON(e, t) {
    ...
    return new me(t.from, t.to, B.fromJSON(e, t.slice), !!t.structure);
  }
}
ye.jsonID("replace", me);
class Ee extends ye {
  constructor(e, t, r, i, s, a, l = !1) {
    super(),
      (this.from = e),
      (this.to = t),
      (this.gapFrom = r),
  ...
  apply(e) {
    if (
      this.structure &&
      (kn(e, this.from, this.gapFrom) || kn(e, this.gapTo, this.to))
    )
      return oe.fail("Structure gap-replace would overwrite content");
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return oe.fail("Gap is not a flat range");
    let r = this.slice.insertAt(this.insert, t.content);
    return r
      ? oe.fromReplace(e, this.from, this.to, r)
  ...
  map(e) {
    ...
    return (t.deletedAcross && r.deletedAcross) || i < t.pos || s > r.pos
      ? null
      : new Ee(t.pos, r.pos, i, s, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
...
function Bh(n, e, t, r) {
  let i = [],
    ...
    a,
    l;
  n.doc.nodesBetween(e, t, (o, h, d) => {
    if (!o.isInline) return;
    let f = o.marks;
    if (!r.isInSet(f) && d.type.allowsMarkType(r.type)) {
      let g = Math.max(h, e),
        y = Math.min(h + o.nodeSize, t),
        v = r.addToSet(f);
      for (let k = 0; k < f.length; k++)
        f[k].isInSet(v) ||
          (a && a.to == g && a.mark.eq(f[k])
            ? (a.to = y)
            : i.push((a = new je(g, y, f[k]))));
      l && l.to == g ? (l.to = y) : s.push((l = new Mt(g, y, r)));
    }
  }),
    i.forEach((o) => n.step(o)),
    s.forEach((o) => n.step(o));
}
function Rh(n, e, t, r) {
  let i = [],
    s = 0;
  n.doc.nodesBetween(e, t, (a, l) => {
    ...
    if (r instanceof C0) {
      let h = a.marks,
        d;
      for (; (d = r.isInSet(h)); )
        (o || (o = [])).push(d), (h = d.removeFromSet(h));
    } else r ? r.isInSet(a.marks) && (o = [r]) : (o = a.marks);
    if (o && o.length) {
      let h = Math.min(l + a.nodeSize, t);
      for (let d = 0; d < o.length; d++) {
        let f = o[d],
          g;
        for (let y = 0; y < i.length; y++) {
          let v = i[y];
          v.step == s - 1 && f.eq(i[y].style) && (g = v);
        }
        g
          ? ((g.to = h), (g.step = s))
          : i.push({ style: f, from: Math.max(l, e), to: h, step: s });
      }
    }
  }),
    i.forEach((a) => n.step(new je(a.from, a.to, a.style)));
}
function Pa(n, e, t, r = t.contentMatch, i = !0) {
  ...
  for (let o = 0; o < s.childCount; o++) {
    let h = s.child(o),
      d = l + h.nodeSize,
      f = r.matchType(h.type);
    if (!f) a.push(new me(l, d, B.empty));
    else {
      r = f;
      for (let g = 0; g < h.marks.length; g++)
        t.allowsMarkType(h.marks[g].type) || n.step(new je(l, d, h.marks[g]));
      if (i && h.isText && t.whitespace != "pre") {
        ...
        for (; (g = y.exec(h.text)); )
          v ||
            (v = new B(
              z.from(t.schema.text(" ", t.allowedMarks(h.marks))),
              0,
              0,
            )),
            a.push(new me(l + g.index, l + g.index + g[0].length, v));
      }
    }
    l = d;
  }
  if (!r.validEnd) {
    let o = r.fillBefore(z.empty, !0);
    n.replace(l, l, new B(o, 0, 0));
  }
  for (let o = a.length - 1; o >= 0; o--) n.step(a[o]);
}
function Ih(n, e, t) {
  return (
...
function Jn(n) {
  ...
  for (let r = n.depth; ; --r) {
    let i = n.$from.node(r),
      s = n.$from.index(r),
      a = n.$to.indexAfter(r);
    if (r < n.depth && i.canReplace(s, a, t)) return r;
    if (r == 0 || i.type.spec.isolating || !Ih(i, s, a)) break;
  }
  return null;
}
function Fh(n, e, t) {
  let { $from: r, $to: i, depth: s } = e,
    ...
    d = z.empty,
    f = 0;
  for (let v = s, k = !1; v > t; v--)
    k || r.index(v) > 0
      ? ((k = !0), (d = z.from(r.node(v).copy(d))), f++)
      : o--;
  let g = z.empty,
    y = 0;
  for (let v = s, k = !1; v > t; v--)
    k || i.after(v + 1) < i.end(v)
      ? ((k = !0), (g = z.from(i.node(v).copy(g))), y++)
      : h++;
  n.step(new Ee(o, h, a, l, new B(d.append(g), f, y), d.size - f, !0));
}
function Ph(n, e, t = null, r = n) {
  let i = qh(n, e),
    s = i && Lh(r, e);
  return s ? i.map(Hi).concat({ type: e, attrs: t }).concat(s.map(Hi)) : null;
}
function Hi(n) {
...
function Lh(n, e) {
  let { parent: t, startIndex: r, endIndex: i } = n,
    s = t.child(r),
    a = e.contentMatch.findWrapping(s.type);
  if (!a) return null;
  let o = (a.length ? a[a.length - 1] : e).contentMatch;
  for (let h = r; o && h < i; h++) o = o.matchType(t.child(h).type);
  return !o || !o.validEnd ? null : a;
}
function Vh(n, e, t) {
  let r = z.empty;
  ...
  let i = e.start,
    s = e.end;
  n.step(new Ee(i, s, i, s, new B(r, 0, 0), t.length, !0));
}
function Hh(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (a, l) => {
    if (
      a.isTextblock &&
      !a.hasMarkup(r, i) &&
      Jh(n.doc, n.mapping.slice(s).map(l), r)
    ) {
      let o = null;
      ...
      o === !1 && Gh(n, a, l, s),
        Pa(n, n.mapping.slice(s).map(l, 1), r, void 0, o === null);
      let h = n.mapping.slice(s),
        d = h.map(l, 1),
        f = h.map(l + a.nodeSize, 1);
      return (
        n.step(
          new Ee(
            d,
            ...
            d + 1,
            f - 1,
            new B(z.from(r.create(i, null, a.marks)), 0, 0),
            1,
            !0,
          ),
        ),
  ...
  e.forEach((i, s) => {
    if (i.isText) {
      let a,
        l = /\r?\n|\r/g;
      for (; (a = l.exec(i.text)); ) {
        let o = n.mapping.slice(r).map(t + 1 + s + a.index);
        n.replaceWith(o, o + 1, e.type.schema.linebreakReplacement.create());
      }
    }
  });
}
function Gh(n, e, t, r) {
  e.forEach((i, s) => {
    if (i.type == i.type.schema.linebreakReplacement) {
      let a = n.mapping.slice(r).map(t + 1 + s);
      n.replaceWith(
        a,
        a + 1,
        e.type.schema.text(`
...
function $h(n, e, t, r, i) {
  ...
  if (s.isLeaf) return n.replaceWith(e, e + s.nodeSize, a);
...
function h0(n, e, t = 1, r) {
  ...
  if (
    ...
    return !1;
  for (let h = i.depth - 1, d = t - 2; h > s; h--, d--) {
    let f = i.node(h),
      g = i.index(h);
    if (f.type.spec.isolating) return !1;
    let y = f.content.cutByIndex(g, f.childCount),
      v = r && r[d + 1];
    v && (y = y.replaceChild(0, v.type.create(v.attrs)));
    let k = (r && r[d]) || f;
    if (!f.canReplace(g + 1, f.childCount) || !k.type.validContent(y))
      return !1;
  }
  let l = i.indexAfter(s),
    o = r && r[0];
  return i.node(s).canReplaceWith(l, l, o ? o.type : i.node(s + 1).type);
}
function Uh(n, e, t = 1, r) {
  let i = n.doc.resolve(e),
    s = z.empty,
    a = z.empty;
  for (let l = i.depth, o = i.depth - t, h = t - 1; l > o; l--, h--) {
    s = z.from(i.node(l).copy(s));
    let d = r && r[h];
    a = z.from(d ? d.type.create(d.attrs, a) : i.node(l).copy(a));
  }
  n.step(new me(e, e, new B(s.append(a), t, t), !0));
}
function qa(n, e) {
  let t = n.resolve(e),
    r = t.index();
...
function Yh(n, e, t) {
  let r = new me(e - t, e + t, B.empty, !0);
  n.step(r);
}
function jh(n, e, t) {
  let r = n.resolve(e);
  ...
  for (let s = 1; s <= (t.openStart == 0 && t.size ? 2 : 1); s++)
    for (let a = r.depth; a >= 0; a--) {
      let l =
        ...
        h = r.node(a),
        d = !1;
      if (s == 1) d = h.canReplace(o, o, i);
      else {
        let f = h.contentMatchAt(o).findWrapping(i.firstChild.type);
        d = f && h.canReplaceWith(o, o, f[0]);
      }
      if (d) return l == 0 ? r.pos : l < 0 ? r.before(a + 1) : r.after(a + 1);
    }
  return null;
}
function $n(n, e, t = e, r = B.empty) {
  if (e == t && !r.size) return null;
  let i = n.resolve(e),
    s = n.resolve(t);
  return La(i, s, r) ? new me(e, t, r) : new Zh(i, s, r).fit();
}
function La(n, e, t) {
  return (
    !t.openStart &&
...
class Zh {
  ...
  fit() {
    ...
    let s = this.placed,
      a = r.depth,
      l = i.depth;
    for (; a && l && s.childCount == 1; ) (s = s.firstChild.content), a--, l--;
    let o = new B(s, a, l);
    return e > -1
      ? new Ee(r.pos, e, this.$to.pos, this.$to.end(), o, t)
      : o.size || r.pos != this.$to.pos
        ? new me(r.pos, i.pos, o)
        : null;
  }
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let i,
          s = null;
        r
          ? ((s = U0(this.unplaced.content, r - 1).firstChild), (i = s.content))
          : (i = this.unplaced.content);
        let a = i.firstChild;
        for (let l = this.depth; l >= 0; l--) {
          let { type: o, match: h } = this.frontier[l],
            d,
            f = null;
          if (
            t == 1 &&
            (a
              ? h.matchType(a.type) || (f = h.fillBefore(z.from(a), !1))
              : s && o.compatibleContent(s.type))
          )
            return { sliceDepth: r, frontierDepth: l, parent: s, inject: f };
          if (t == 2 && a && (d = h.findWrapping(a.type)))
  ...
  dropNode() {
    ...
    if (i.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new B(br(e, t - 1, 1), t - 1, s ? t - 1 : r);
    } else this.unplaced = new B(br(e, t, 1), t, r);
  }
  placeNodes({
    sliceDepth: e,
    frontierDepth: t,
    ...
    if (s) for (let k = 0; k < s.length; k++) this.openFrontierNode(s[k]);
    let a = this.unplaced,
      l = r ? r.content : a.content,
      o = a.openStart - e,
      h = 0,
      d = [],
      { match: f, type: g } = this.frontier[t];
    if (i) {
      for (let k = 0; k < i.childCount; k++) d.push(i.child(k));
      f = f.matchFragment(i);
    }
    let y = l.size + e - (a.content.size - a.openEnd);
    for (; h < l.childCount; ) {
      let k = l.child(h),
        M = f.matchType(k.type);
      if (!M) break;
      h++,
        (h > 1 || o == 0 || k.content.size) &&
          ((f = M),
          d.push(
            Va(
              k.mark(g.allowedMarks(k.marks)),
              h == 1 ? o : 0,
              h == l.childCount ? y : -1,
            ),
          ));
    }
    let v = h == l.childCount;
    v || (y = -1),
      (this.placed = xr(this.placed, t, z.from(d))),
    ...
    this.unplaced = v
      ? e == 0
        ? B.empty
        : new B(br(a.content, e - 1, 1), e - 1, y < 0 ? a.openEnd : e - 1)
      : new B(br(a.content, e, h), a.openStart, a.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !e.type.isTextblock ||
      !K0(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      ...
      if (a) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: o, type: h } = this.frontier[l],
            d = K0(e, l, h, o, !0);
  ...
  openFrontierNode(e, t = null, r) {
    ...
    (i.match = i.match.matchType(e)),
      (this.placed = xr(this.placed, this.depth, z.from(e.create(t, r)))),
...
function br(n, e, t) {
  return e == 0
    ...
    : n.replaceChild(0, n.firstChild.copy(br(n.firstChild.content, e - 1, t)));
}
function xr(n, e, t) {
  return e == 0
    ? n.append(t)
    : n.replaceChild(
        n.childCount - 1,
        n.lastChild.copy(xr(n.lastChild.content, e - 1, t)),
      );
}
function U0(n, e) {
...
function Va(n, e, t) {
  ...
  return (
    e > 1 &&
      (r = r.replaceChild(
        0,
        Va(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0),
      )),
    e > 0 &&
      ((r = n.type.contentMatch.fillBefore(r).append(r)),
      t <= 0 &&
        (r = r.append(
          n.type.contentMatch.matchFragment(r).fillBefore(z.empty, !0),
        ))),
    n.copy(r)
  );
}
function K0(n, e, t, r, i) {
  ...
  if (a == s.childCount && !t.compatibleContent(s.type)) return null;
  let l = r.fillBefore(s.content, !0, a);
  return l && !Qh(t, s.content, a) ? l : null;
}
function Qh(n, e, t) {
...
function eu(n, e, t, r) {
  ...
  let i = n.doc.resolve(e),
    s = n.doc.resolve(t);
  if (La(i, s, r)) return n.step(new me(e, t, r));
  let a = Wa(i, n.doc.resolve(t));
  a[a.length - 1] == 0 && a.pop();
  let l = -(i.depth + 1);
  a.unshift(l);
  for (let g = i.depth, y = i.pos - 1; g > 0; g--, y--) {
    let v = i.node(g).type.spec;
  ...
  for (let g = r.content, y = 0; ; y++) {
    let v = g.firstChild;
    if ((h.push(v), y == r.openStart)) break;
    g = v.content;
  }
  for (let g = d - 1; g >= 0; g--) {
    let y = h[g],
      v = _h(y.type);
    if (v && !y.sameMarkup(i.node(Math.abs(l) - 1))) d = g;
    else if (v || !y.type.isTextblock) break;
  }
  for (let g = r.openStart; g >= 0; g--) {
    let y = (g + d + 1) % (r.openStart + 1),
      v = h[y];
    if (v)
      for (let k = 0; k < a.length; k++) {
        let M = a[(k + o) % a.length],
          T = !0;
        M < 0 && ((T = !1), (M = -M));
        let R = i.node(M - 1),
          L = i.index(M - 1);
        if (R.canReplaceWith(L, L, v.type, v.marks))
          return n.replace(
            i.before(M),
            T ? s.after(M) : t,
            new B(Ha(r.content, 0, r.openStart, y), y, r.openEnd),
          );
      }
  }
  ...
  for (
    let g = a.length - 1;
    g >= 0 && (n.replace(e, t, r), !(n.steps.length > f));
    g--
  ) {
    let y = a[g];
...
function Ha(n, e, t, r, i) {
  if (e < t) {
    let s = n.firstChild;
    n = n.replaceChild(0, s.copy(Ha(s.content, e + 1, t, r, s)));
  }
  if (e > r) {
    let s = i.contentMatchAt(0),
      a = s.fillBefore(n).append(n);
...
function tu(n, e, t, r) {
  if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
    let i = jh(n.doc, e, r.type);
    i != null && (e = t = i);
  }
  n.replaceRange(e, t, new B(z.from(r), 0, 0));
}
function ru(n, e, t) {
  ...
  for (let a = 0; a < s.length; a++) {
    let l = s[a],
      o = a == s.length - 1;
    if ((o && l == 0) || r.node(l).type.contentMatch.validEnd)
      return n.delete(r.start(l), i.end(l));
    if (
      l > 0 &&
      (o || r.node(l - 1).canReplace(r.index(l - 1), i.indexAfter(l - 1)))
    )
...
class nu {
  ...
  step(e) {
    ...
    if (t.failed) throw new ur(t.failed);
    return this;
  }
  maybeStep(e) {
  ...
  replace(e, t = e, r = B.empty) {
    let i = $n(this.doc, e, t, r);
    return i && this.step(i), this;
  }
  replaceWith(e, t, r) {
    return this.replace(e, t, new B(z.from(r), 0, 0));
  }
  delete(e, t) {
...
const Y0 = Object.create(null);
class K {
  constructor(e, t, r) {
    (this.$anchor = e),
      (this.$head = t),
      (this.ranges = r || [new iu(e.min(t), e.max(t))]);
  }
  get anchor() {
  ...
  replace(e, t = B.empty) {
    ...
    for (let l = 0; l < a.length; l++) {
      let { $from: o, $to: h } = a[l],
        d = e.mapping.slice(s);
      e.replaceRange(d.map(o.pos), d.map(h.pos), l ? B.empty : t),
        l == 0 && Ji(e, s, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  replaceWith(e, t) {
    ...
    for (let s = 0; s < i.length; s++) {
      ...
      s
        ? e.deleteRange(h, d)
        : (e.replaceRangeWith(h, d, t), Ji(e, r, t.isInline ? -1 : 1));
    }
  }
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent
      ? new X(e)
      : ir(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i) return i;
    for (let s = e.depth - 1; s >= 0; s--) {
      let a =
        t < 0
          ? ir(e.node(0), e.node(s), e.before(s + 1), e.index(s), t, r)
          : ir(e.node(0), e.node(s), e.after(s + 1), e.index(s) + 1, t, r);
      if (a) return a;
    }
    return null;
  }
  ...
  static atStart(e) {
    return ir(e, e, 0, 0, 1) || new Be(e);
  }
  static atEnd(e) {
    return ir(e, e, e.content.size, e.childCount, -1) || new Be(e);
  }
  static fromJSON(e, t) {
    if (!t || !t.type)
  ...
  static jsonID(e, t) {
    ...
    return (Y0[e] = t), (t.prototype.jsonID = e), t;
  }
  getBookmark() {
...
class X extends K {
  ...
  getBookmark() {
    return new A0(this.anchor, this.head);
  }
  toJSON() {
  ...
  static between(e, t, r) {
    ...
    if (((!r || i) && (r = i >= 0 ? 1 : -1), !t.parent.inlineContent)) {
      let s = K.findFrom(t, r, !0) || K.findFrom(t, -r, !0);
      if (s) t = s.$head;
      else return K.near(t, r);
    }
    return (
      e.parent.inlineContent ||
        (i == 0
          ? (e = t)
          : ((e = (K.findFrom(e, -r, !0) || K.findFrom(e, r, !0)).$anchor),
            e.pos < t.pos != i < 0 && (e = t))),
      new X(e, t)
    );
  }
...
class A0 {
  ...
  map(e) {
    return new A0(e.map(this.anchor), e.map(this.head));
  }
  resolve(e) {
...
class W extends K {
  ...
  map(e, t) {
    let { deleted: r, pos: i } = t.mapResult(this.anchor),
      s = e.resolve(i);
    return r ? K.near(s) : new W(s);
  }
  content() {
    return new B(z.from(this.node), 0, 0);
  }
  eq(e) {
...
class Un {
  ...
  map(e) {
    ...
    return t ? new A0(r, r) : new Un(r);
  }
  resolve(e) {
    let t = e.resolve(this.anchor),
      r = t.nodeAfter;
    return r && W.isSelectable(r) ? new W(t) : K.near(t);
  }
}
class Be extends K {
  constructor(e) {
...
function ir(n, e, t, r, i, s = !1) {
  if (e.inlineContent) return X.create(n, t);
  for (let a = r - (i > 0 ? 0 : 1); i > 0 ? a < e.childCount : a >= 0; a += i) {
    ...
    if (l.isAtom) {
      ...
      let o = ir(n, l, t + i, i < 0 ? l.childCount : 0, i, s);
      if (o) return o;
    }
    t += l.nodeSize * i;
  }
...
function Ji(n, e, t) {
  ...
  if (r < e) return;
  let i = n.steps[r];
  if (!(i instanceof me || i instanceof Ee)) return;
  let s = n.mapping.maps[r],
    a;
  s.forEach((l, o, h, d) => {
    a == null && (a = d);
  }),
    n.setSelection(K.near(n.doc.resolve(a), t));
}
const $i = 1,
  Ui = 2,
  Ki = 4;
  ...
  replaceSelectionWith(e, t = !0) {
    ...
    return (
      t &&
        (e = e.mark(
          this.storedMarks ||
            (r.empty ? r.$from.marks() : r.$from.marksAcross(r.$to) || j.none),
        )),
...
class wr {
  constructor(e, t, r) {
    (this.name = e), (this.init = Yi(t.init, r)), (this.apply = Yi(t.apply, r));
  }
}
const lu = [
  new wr("doc", {
  ...
  new wr("selection", {
    init(n, e) {
      return n.selection || K.atStart(e.doc);
    },
    apply(n) {
      return n.selection;
    },
      ...
      t &&
        t.forEach((r) => {
          ...
          this.plugins.push(r),
            ...
            r.spec.state && this.fields.push(new wr(r.key, r.spec.state, r));
        });
  }
}
class kr {
      ...
      for (let a = 0; a < this.config.plugins.length; a++) {
        ...
        if (l.spec.appendTransaction) {
          let o = i ? i[a].n : 0,
            ...
            d =
              o < t.length &&
              l.spec.appendTransaction.call(l, o ? t.slice(o) : t, h, r);
          if (d && r.filterTransaction(d, a)) {
            if ((d.setMeta("appendedTransaction", e), !i)) {
              i = [];
              for (let f = 0; f < this.config.plugins.length; f++)
                i.push(
                  f < a ? { state: r, n: t.length } : { state: this, n: 0 },
                );
            }
  ...
  static create(e) {
    let t = new j0(e.doc ? e.doc.type.schema : e.schema, e.plugins),
      r = new kr(t);
  ...
  reconfigure(e) {
    let t = new j0(this.schema, e.plugins),
      r = t.fields,
      i = new kr(t);
  ...
  static fromJSON(e, t, r) {
    ...
    let i = new j0(e.schema, e.plugins),
      s = new kr(i);
    return (
      i.fields.forEach((a) => {
        if (a.name == "doc") s.doc = Qe.fromJSON(e.schema, t.doc);
        else if (a.name == "selection")
          s.selection = K.fromJSON(s.doc, t.selection);
          ...
          if (r)
            for (let l in r) {
              ...
              if (
                ...
                s[a.name] = h.fromJSON.call(o, e, t[l], s);
                return;
              }
            }
          s[a.name] = a.init(e, s);
...
class Kn {
  constructor(e) {
    (this.spec = e),
      (this.props = {}),
      e.props && Ga(e.props, this, this.props),
      (this.key = e.key ? e.key.key : Ja("plugin"));
  }
  getState(e) {
    return e[this.key];
  }
...
function Ja(n) {
  return n in X0 ? n + "$" + ++X0[n] : ((X0[n] = 0), n + "$");
}
class ou {
  constructor(e = "key") {
    this.key = Ja(e);
...
const $a = new ou("contentReference"),
  Sf = (n) => {
    const e = Po(n).map(({ newContentReference: t }) => t);
    return new Kn({
      key: $a,
      state: {
        init: (t, { doc: r }) => ({ displayedContentReferences: e }),
        apply: (t, r) => r,
      },
      props: {},
    });
...
const Yn = (n, e, t) => {
  ...
  let s = i.nodeBefore;
  if (!s.type.spec.isolating && Qa(n, i, e)) return !0;
  if (r.parent.content.size == 0 && (cr(s, "end") || W.isSelectable(s))) {
    let a = $n(n.doc, r.before(), r.after(), B.empty);
    if (a && a.slice.size < a.to - a.from) {
      if (e) {
        let l = n.tr.step(a);
        l.setSelection(
          cr(s, "end")
            ? K.findFrom(l.doc.resolve(l.mapping.map(i.pos, -1)), -1)
            : W.create(l.doc, i.pos - s.nodeSize),
        ),
          e(l.scrollIntoView());
      }
      return !0;
...
const uu = (n, e, t) => {
  ...
  return !a || !W.isSelectable(a)
    ? !1
    : (e &&
        e(
          n.tr
            .setSelection(W.create(n.doc, s.pos - a.nodeSize))
            .scrollIntoView(),
        ),
      !0);
};
...
const du = (n, e, t) => {
    ...
    if (r.parent.content.size == 0 && (cr(s, "start") || W.isSelectable(s))) {
      let a = $n(n.doc, r.before(), r.after(), B.empty);
      if (a && a.slice.size < a.to - a.from) {
        if (e) {
          let l = n.tr.step(a);
          l.setSelection(
            cr(s, "start")
              ...
              : W.create(l.doc, l.mapping.map(i.pos)),
          ),
            e(l.scrollIntoView());
        }
        return !0;
  ...
  fu = (n, e, t) => {
    ...
    return !a || !W.isSelectable(a)
      ? !1
      : (e && e(n.tr.setSelection(W.create(n.doc, s.pos)).scrollIntoView()),
        !0);
  };
function Ya(n) {
  if (!n.parent.type.spec.isolating)
...
const mu = (n, e) => {
    ...
    let i = t.node(-1),
      s = t.indexAfter(-1),
      a = jn(i.contentMatchAt(s));
    if (!a || !i.canReplaceWith(s, s, a)) return !1;
    if (e) {
      let l = t.after(),
        o = n.tr.replaceWith(l, l, a.createAndFill());
      o.setSelection(K.near(o.doc.resolve(l), 1)), e(o.scrollIntoView());
    }
    return !0;
  },
  ja = (n, e) => {
    ...
    if (e) {
      let a = (!r.parentOffset && i.index() < i.parent.childCount ? r : i).pos,
        l = n.tr.insert(a, s.createAndFill());
      l.setSelection(X.create(l.doc, a + 1)), e(l.scrollIntoView());
    }
    return !0;
  },
  Xa = (n, e) => {
    ...
    if (t.depth > 1 && t.after() != t.end(-1)) {
      let s = t.before();
      if (h0(n.doc, s)) return e && e(n.tr.split(s).scrollIntoView()), !0;
    }
    let r = t.blockRange(),
      i = r && Jn(r);
...
function gu(n) {
  return (e, t) => {
    ...
    if (e.selection instanceof W && e.selection.node.isBlock)
      return !r.parentOffset || !h0(e.doc, r.pos)
        ? !1
    ...
    if (t) {
      let s = i.parentOffset == i.parent.content.size,
        a = e.tr;
      (e.selection instanceof X || e.selection instanceof Be) &&
        a.deleteSelection();
      let l =
          r.depth == 0 ? null : jn(r.node(-1).contentMatchAt(r.indexAfter(-1))),
        o = s && l ? [{ type: l }] : void 0,
        h = h0(a.doc, a.mapping.map(r.pos), 1, o);
      if (
        (!o &&
          !h &&
          h0(a.doc, a.mapping.map(r.pos), 1, l ? [{ type: l }] : void 0) &&
          (l && (o = [{ type: l }]), (h = !0)),
        h &&
          (a.split(a.mapping.map(r.pos), 1, o),
          !s && !r.parentOffset && r.parent.type != l))
      ) {
        let d = a.mapping.map(r.before()),
          f = a.doc.resolve(d);
        l &&
...
const Za = gu(),
  yu = (n, e) => (e && e(n.tr.setSelection(new Be(n.doc))), !0);
function vu(n, e, t) {
  let r = e.nodeBefore,
    i = e.nodeAfter,
    s = e.index();
  return !r || !i || !r.type.compatibleContent(i.type)
    ...
    : !r.content.size && e.parent.canReplace(s - 1, s)
      ...
      : !e.parent.canReplace(s, s + 1) || !(i.isTextblock || qa(n.doc, e.pos))
        ? !1
        : (t &&
            t(
              n.tr
...
function Qa(n, e, t) {
  ...
  if (vu(n, e, t)) return !0;
  let l = e.parent.canReplace(e.index(), e.index() + 1);
  if (
    l &&
    (s = (a = r.contentMatchAt(r.childCount)).findWrapping(i.type)) &&
    a.matchType(s[0] || i.type).validEnd
  ) {
    if (t) {
      let f = e.pos + i.nodeSize,
        g = z.empty;
      for (let k = s.length - 1; k >= 0; k--) g = z.from(s[k].create(null, g));
      g = z.from(r.copy(g));
      let y = n.tr.step(
          new Ee(e.pos - 1, f, e.pos, f, new B(g, 1, 0), s.length, !0),
        ),
        v = f + 2 * s.length;
      qa(y.doc, v) && y.join(v), t(y.scrollIntoView());
    }
    return !0;
  }
  let o = K.findFrom(e, 1),
    h = o && o.$from.blockRange(o.$to),
    d = h && Jn(h);
  if (d != null && d >= e.depth)
    return t && t(n.tr.lift(h, d).scrollIntoView()), !0;
  if (l && cr(i, "start", !0) && cr(r, "end")) {
    let f = r,
      g = [];
    for (; g.push(f), !f.isTextblock; ) f = f.lastChild;
    let y = i,
      v = 1;
    for (; !y.isTextblock; y = y.firstChild) v++;
    if (f.canReplace(f.childCount, f.childCount, y.content)) {
      if (t) {
        let k = z.empty;
        for (let T = g.length - 1; T >= 0; T--) k = z.from(g[T].copy(k));
        let M = n.tr.step(
          new Ee(
            e.pos - g.length,
            e.pos + i.nodeSize,
...
function _a(n) {
  return function (e, t) {
    ...
    return i.node(s).isTextblock
      ? (t &&
          t(e.tr.setSelection(X.create(e.doc, n < 0 ? i.start(s) : i.end(s)))),
        !0)
      : !1;
  };
}
...
function Mf(n, e = null) {
  return function (t, r) {
    let { $from: i, $to: s } = t.selection,
      a = i.blockRange(s),
      l = a && Ph(a, n, e);
    return l ? (r && r(t.tr.wrap(a, l).scrollIntoView()), !0) : !1;
  };
}
function Tf(n, e = null) {
  return function (t, r) {
    ...
    for (let s = 0; s < t.selection.ranges.length && !i; s++) {
      ...
      t.doc.nodesBetween(a, l, (o, h) => {
        if (i) return !1;
        if (!(!o.isTextblock || o.hasMarkup(n, e)))
          if (o.type == n) i = !0;
          else {
            let d = t.doc.resolve(h),
              f = d.index();
...
function wu(n, e, t) {
  for (let r = 0; r < e.length; r++) {
    let { $from: i, $to: s } = e[r],
      a = i.depth == 0 ? n.inlineContent && n.type.allowsMarkType(t) : !1;
    if (
      (n.nodesBetween(i.pos, s.pos, (l) => {
        if (a) return !1;
...
function Cf(n, e = null) {
  return function (t, r) {
    let { empty: i, $cursor: s, ranges: a } = t.selection;
    if ((i && !s) || !wu(t.doc, a, n)) return !1;
    if (r)
      if (s)
        ...
        for (let h = 0; h < a.length; h++) {
          let { $from: d, $to: f } = a[h];
          if (l) o.removeMark(d.pos, f.pos, n);
          else {
            let g = d.pos,
              y = f.pos,
              v = d.nodeAfter,
              k = f.nodeBefore,
              M = v && v.isText ? /^\s*/.exec(v.text)[0].length : 0,
              T = k && k.isText ? /\s*$/.exec(k.text)[0].length : 0;
            g + M < y && ((g += M), (y -= T)), o.addMark(g, y, n.create(e));
          }
        }
        r(o.scrollIntoView());
      }
...
`) &&
      (e = e.slice(0, -1)),
    { content: e, metadata: { custom_symbol_offsets: r } }
  );
}
function Nf(n) {
  return Su(n.state.doc);
}
const tl = N0(ja, Xa, Za);
async function zf(n, e, t = !1) {
  if (t) {
    Tu(n, e);
    return;
  }
  const { schema: r } = n.state,
    i = e.split(`
`);
  if (
    (n.dispatch(n.state.tr.deleteSelection()),
    n.dispatch(n.state.tr.insertText(i[0])),
    i.length > 1)
  ) {
    tl(n.state, n.dispatch);
    const s = i.slice(1),
      a = z.fromArray(
        s.map((o) =>
          r.nodes.paragraph.create(null, o === "" ? null : r.text(o)),
        ),
      ),
      l = new B(a, 0, 0);
    n.dispatch(n.state.tr.replaceSelection(l)), Yn(n.state, n.dispatch, n);
  }
}
const Mu = /oaicite:(\d+)/g;
...
`);
  ...
  s.parent.isTextblock ||
    (i.insert(s.pos, t.nodes.paragraph.create()), n.dispatch(i), n.focus());
  const { selection: a } = n.state,
    ...
    d = z.fromArray(h);
  let f = d;
  l.parent.type.validContent(d) || (f = t.nodes.paragraph.create(null, d));
  const g = new B(z.from(f), 0, 0);
  if ((n.dispatch(n.state.tr.replaceSelection(g)), r.length > 1)) {
    tl(n.state, n.dispatch);
    const v = r.slice(1).map((T) => {
        const R = Xi(T, t, n);
        return t.nodes.paragraph.create(null, R);
      }),
      k = z.fromArray(v),
      M = new B(k, 0, 0);
    n.dispatch(n.state.tr.replaceSelection(M)), Yn(n.state, n.dispatch, n);
  }
}
function Xi(n, e, t) {
  const r = [];
  let i = 0,
    s;
  if (!!!$a.get(t.state)) return [e.text(n)];
  for (; (s = Mu.exec(n)) !== null; ) {
    if (s.index > i) {
      const h = n.slice(i, s.index);
      r.push(e.text(h));
    }
    const l = s[1],
      o = Cu(l, e);
    r.push(o), (i = s.index + s[0].length);
  }
  if (i < n.length) {
    const l = n.slice(i);
    r.push(e.text(l));
...
function Cu(n, e) {
  const t = Go({ value: "oaicite:" + n }, e);
  if (t == null)
    throw new Error("Failed to create text node for content reference");
  const r = { index: n, displayLayout: "inline" },
    i = z.fromArray([t]);
  return e.nodes.contentReference.create(r, i);
}
const Df = (n) => qo(n).checkGate("223382091"),
  fe = function (n) {
...
const at = function (n, e, t) {
    let r = Sn || (Sn = document.createRange());
  ...
  Kt = function (n, e, t, r) {
    return t && (Zi(n, e, t, r, -1) || Zi(n, e, t, r, 1));
  },
  Nu = /^(img|br|input|textarea|hr)$/i;
...
function zu(n, e) {
  for (;;) {
    ...
    } else if (n.parentNode && !qr(n)) (e = fe(n)), (n = n.parentNode);
    else return null;
  }
}
function Du(n, e) {
  for (;;) {
    ...
    } else if (n.parentNode && !qr(n)) (e = fe(n) + 1), (n = n.parentNode);
    else return null;
  }
}
function Ou(n, e, t) {
...
const z0 = function (n) {
  return (
    n.focusNode && Kt(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset)
  );
};
function Lt(n, e) {
...
const _e = typeof navigator < "u" ? navigator : null,
  ...
  Mn = /Edge\/(\d+)/.exec(Rt),
  rl = /MSIE \d/.exec(Rt),
  Tn = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Rt),
  Ce = !!(rl || Tn || Mn),
  Nt = rl ? document.documentMode : Tn ? +Tn[1] : Mn ? +Mn[1] : 0,
  Ue = !Ce && /gecko\/(\d+)/i.test(Rt);
Ue && +(/Firefox\/(\d+)/.exec(Rt) || [0, 0])[1];
const Cn = !Ce && /Chrome\/(\d+)/.exec(Rt),
  ge = !!Cn,
  nl = Cn ? +Cn[1] : 0,
  xe = !Ce && !!_e && /Apple Computer/.test(_e.vendor),
  dr = xe && (/Mobile\/\w+/.test(Rt) || (!!_e && _e.maxTouchPoints > 2)),
  Fe = dr || (_e ? /Mac/.test(_e.platform) : !1),
  Ru = _e ? /Win/.test(_e.platform) : !1,
  $e = /Android \d/.test(Rt),
  Lr = !!Qi && "webkitFontSmoothing" in Qi.documentElement.style,
  Iu = Lr
...
function _i(n, e, t) {
  ...
  for (let a = t || n.dom; a; a = Er(a)) {
    ...
    let l = a,
      ...
      f = 0;
    if (
      (e.top < h.top + it(r, "top")
        ? (f = -(h.top - e.top + it(i, "top")))
        : e.bottom > h.bottom - it(r, "bottom") &&
          (f =
            e.bottom - e.top > h.bottom - h.top
              ? e.top + it(i, "top") - h.top
              : e.bottom - h.bottom + it(i, "bottom")),
      e.left < h.left + it(r, "left")
        ? (d = -(h.left - e.left + it(i, "left")))
        : e.right > h.right - it(r, "right") &&
          (d = e.right - h.right + it(i, "right")),
      d || f)
    )
      if (o) s.defaultView.scrollBy(d, f);
      else {
        let g = l.scrollLeft,
          y = l.scrollTop;
        f && (l.scrollTop += f), d && (l.scrollLeft += d);
        let v = l.scrollLeft - g,
          k = l.scrollTop - y;
        e = {
          left: e.left - v,
          top: e.top - k,
    ...
    if (o || /^(fixed|sticky)$/.test(getComputedStyle(a).position)) break;
  }
}
function qu(n) {
  let e = n.dom.getBoundingClientRect(),
    ...
    i;
  for (
    let s = (e.left + e.right) / 2, a = t + 1;
    a < Math.min(innerHeight, e.bottom);
    a += 5
  ) {
    let l = n.root.elementFromPoint(s, a);
  ...
  return { refDOM: r, refTop: i, stack: il(n.dom) };
}
function il(n) {
  let e = [],
    t = n.ownerDocument;
...
function al(n, e) {
  ...
  for (let d = n.firstChild, f = 0; d; d = d.nextSibling, f++) {
    let g;
    if (d.nodeType == 1) g = d.getClientRects();
    else if (d.nodeType == 3) g = at(d).getClientRects();
    else continue;
    for (let y = 0; y < g.length; y++) {
      let v = g[y];
      if (v.top <= a && v.bottom >= l) {
        (a = Math.max(v.bottom, a)), (l = Math.min(v.top, l));
        let k =
          v.left > e.left
            ? v.left - e.left
            : v.right < e.left
        ...
        if (k < r) {
          (t = d),
            ...
            (i =
              k && t.nodeType == 3
                ? { left: v.right < e.left ? v.right : v.left, top: e.top }
                : e),
            d.nodeType == 1 &&
              k &&
              (s = f + (e.left >= (v.left + v.right) / 2 ? 1 : 0));
          continue;
        }
      } else
        v.top > e.top &&
      ...
      !t &&
        ((e.left >= v.right && e.top >= v.top) ||
          (e.left >= v.left && e.top >= v.bottom)) &&
        (s = f + 1);
    }
  }
  return (
...
function Ju(n, e, t, r) {
  ...
  for (let s = e, a = !1; s != n.dom; ) {
    ...
    if (
      ...
      let o = l.dom.getBoundingClientRect();
      if (
        (l.node.isBlock &&
          l.parent &&
...
function $u(n, e) {
  ...
  if (!a || !n.dom.contains(a.nodeType != 1 ? a.parentNode : a)) {
    ...
    if (!Xn(e, h) || ((a = ll(n.dom, e, h)), !a)) return null;
  }
  if (xe) for (let h = a; r && h; h = Er(h)) h.draggable && (r = void 0);
  if (((a = Wu(a, e)), r)) {
    if (
      Ue &&
      r.nodeType == 1 &&
    ...
    Lr &&
      i &&
      r.nodeType == 1 &&
      (h = r.childNodes[i - 1]).nodeType == 1 &&
      h.contentEditable == "false" &&
      h.getBoundingClientRect().top >= e.top &&
      i--,
      r == n.dom &&
  ...
  return { pos: l, inside: o ? o.posAtStart - o.border : -1 };
}
function es(n) {
...
function wt(n, e) {
  ...
  return Array.prototype.find.call(t, es) || n.getBoundingClientRect();
}
const Uu = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function ol(n, e, t) {
  let { node: r, offset: i, atom: s } = n.docView.domFromPos(e, t < 0 ? -1 : 1),
    a = Lr || Ue;
  if (r.nodeType == 3)
    if (a && (Uu.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let o = wt(at(r, i, i), t);
      if (Ue && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let h = wt(at(r, i - 1, i - 1), -1);
        if (h.top == o.top) {
          let d = wt(at(r, i, i + 1), -1);
          if (d.top != o.top) return vr(d, d.left < h.left);
        }
      }
      return o;
    } else {
        ...
        t < 0 && !i
          ...
          : t >= 0 && i == r.nodeValue.length
            ...
            : t < 0
              ? o--
              : h++,
        vr(wt(at(r, o, h), d), d < 0)
      );
    }
  if (!n.state.doc.resolve(e - (s || 0)).parent.inlineContent) {
    if (s == null && i && (t < 0 || i == Ye(r))) {
      let o = r.childNodes[i - 1];
      if (o.nodeType == 1) return Q0(o.getBoundingClientRect(), !1);
    }
    if (s == null && i < Ye(r)) {
      let o = r.childNodes[i];
      if (o.nodeType == 1) return Q0(o.getBoundingClientRect(), !0);
    }
    return Q0(r.getBoundingClientRect(), t >= 0);
  }
  if (s == null && i && (t < 0 || i == Ye(r))) {
    let o = r.childNodes[i - 1],
      h =
        o.nodeType == 3
          ? at(o, Ye(o) - (a ? 0 : 1))
          : o.nodeType == 1 && (o.nodeName != "BR" || !o.nextSibling)
            ? o
            : null;
    if (h) return vr(wt(h, 1), !1);
  }
  if (s == null && i < Ye(r)) {
    let o = r.childNodes[i];
    for (; o.pmViewDesc && o.pmViewDesc.ignoreForCoords; ) o = o.nextSibling;
    let h = o
      ? o.nodeType == 3
        ? at(o, 0, a ? 0 : 1)
        : o.nodeType == 1
          ...
          : null
      : null;
    if (h) return vr(wt(h, -1), !0);
  }
  return vr(wt(r.nodeType == 3 ? at(r) : r, -t), t >= 0);
}
function vr(n, e) {
...
function Ku(n, e, t) {
  ...
  return hl(n, e, () => {
    ...
    for (let l = s.firstChild; l; l = l.nextSibling) {
      let o;
      if (l.nodeType == 1) o = l.getClientRects();
      else if (l.nodeType == 3)
        o = at(l, 0, l.nodeValue.length).getClientRects();
      else continue;
      for (let h = 0; h < o.length; h++) {
        ...
        if (
          d.bottom > d.top + 1 &&
          (t == "up"
            ? a.top - d.top > (d.bottom - a.top) * 2
            : d.bottom - a.bottom > (a.bottom - d.top) * 2)
        )
          return !1;
      }
    }
...
function ju(n, e, t) {
  ...
  let i = r.parentOffset,
    ...
    l = n.domSelection();
  return !Yu.test(r.parent.textContent) || !l.modify
    ? t == "left" || t == "backward"
      ? s
      : a
    : hl(n, e, () => {
        ...
        let y = r.depth ? n.docView.domAfterPos(r.before()) : n.dom,
          { focusNode: v, focusOffset: k } = n.domSelectionRange(),
          M =
            (v && !y.contains(v.nodeType == 1 ? v : v.parentNode)) ||
            (o == v && h == k);
        try {
          l.collapse(d, f),
            o && (o != d || h != f) && l.extend && l.extend(o, h);
        } catch {}
        return g != null && (l.caretBidiLevel = g), M;
      });
}
let ts = null,
  rs = null,
...
function Xu(n, e, t) {
  return ts == e && rs == t
    ...
    : ((ts = e),
      (rs = t),
      (ns = t == "up" || t == "down" ? Ku(n, e, t) : ju(n, e, t)));
}
const Le = 0,
  is = 1,
  Vt = 2,
...
class Vr {
  ...
  domFromPos(e, t) {
    ...
    for (
      let s;
      r && !(s = this.children[r - 1]).size && s instanceof ul && s.side >= 0;
      r--
    );
    if (t <= 0) {
      let s,
      ...
      return s && t && a && !s.border && !s.domAtom
        ? s.domFromPos(s.size, t)
        : { node: this.contentDOM, offset: s ? fe(s.dom) + 1 : 0 };
    } else {
      let s,
        a = !0;
      for (
    ...
    for (let a = r, l = 0; ; l++) {
      ...
      if (i == -1 && e <= h) {
        ...
        if (
          ...
          o.node &&
          o.contentDOM &&
          this.contentDOM.contains(o.contentDOM)
        )
          return o.parseRange(e, t, d);
        e = a;
        for (let f = l; f > 0; f--) {
          let g = this.children[f - 1];
          if (
            g.size &&
  ...
  setSelection(e, t, r, i = !1) {
    ...
    for (let g = 0, y = 0; g < this.children.length; g++) {
      let v = this.children[g],
        k = y + v.size;
      if (s > y && a < k)
        return v.setSelection(e - y - v.border, t - y - v.border, r, i);
      y = k;
    }
    let l = this.domFromPos(e, e ? -1 : 1),
      o = t == e ? l : this.domFromPos(t, t ? -1 : 1),
      h = r.getSelection(),
      d = !1;
    if ((Ue || xe) && e == t) {
...
`
          ...
          for (let v = g, k; v; v = v.parentNode) {
            if ((k = v.nextSibling)) {
              k.nodeName == "BR" &&
                (l = o = { node: k.parentNode, offset: fe(k) + 1 });
              break;
            }
            let M = v.pmViewDesc;
    ...
    if (
      ...
      h.focusNode &&
      h.focusNode != o.node &&
      h.focusNode.nodeType == 1
    ) {
      let g = h.focusNode.childNodes[h.focusOffset];
      g && g.contentEditable == "false" && (i = !0);
    }
    if (
      !(i || (d && xe)) &&
      Kt(l.node, l.offset, h.anchorNode, h.anchorOffset) &&
      Kt(o.node, o.offset, h.focusNode, h.focusOffset)
    )
      return;
    let f = !1;
    if ((h.extend || e == t) && !d) {
      ...
      try {
        e != t && h.extend(o.node, o.offset), (f = !0);
      } catch {}
    }
    if (!f) {
      if (e > t) {
...
class Yt extends Vr {
  ...
  static create(e, t, r, i) {
    ...
    return (
      (!a || !a.dom) &&
        (a = pr.renderSpec(document, t.type.spec.toDOM(t, r), null, t.attrs)),
      new Yt(e, t, a.dom, a.contentDOM || a.dom)
    );
  }
  parseRule() {
  ...
  slice(e, t, r) {
    let i = Yt.create(this.parent, this.mark, !0, r),
      s = this.children,
      a = this.size;
    t < a && (s = zn(s, t, a, r)), e > 0 && (s = zn(s, 0, e, r));
    for (let l = 0; l < s.length; l++) s[l].parent = i;
    return (i.children = s), i;
  }
}
class zt extends Vr {
  constructor(e, t, r, i, s, a, l, o, h) {
    super(e, [], s, a),
      (this.node = t),
      (this.outerDeco = r),
      (this.innerDeco = i),
  ...
  static create(e, t, r, i, s, a) {
    ...
    return (
      (d = pl(d, r, t)),
      h
        ? (o = new Qu(e, t, r, i, d, f || null, g, h, s, a + 1))
        : t.isText
          ? new D0(e, t, r, i, d, g, s)
          : new zt(e, t, r, i, d, f || null, g, s, a + 1)
    );
  }
  parseRule() {
  ...
  updateChildren(e, t) {
    let r = this.node.inlineContent,
      ...
      a = s && s.pos > -1 ? s : null,
      l = s && s.pos < 0,
      o = new e1(this, a && a.node, e);
    n1(
      this.node,
      this.innerDeco,
      (h, d, f) => {
        h.spec.marks
          ? o.syncToMarks(h.spec.marks, r, e)
          : h.type.side >= 0 &&
            !f &&
            o.syncToMarks(
              d == this.node.childCount ? j.none : this.node.child(d).marks,
              r,
              e,
            ),
          o.placeWidget(h, e, i);
      ...
      (h, d, f, g) => {
        o.syncToMarks(h.marks, r, e);
        let y;
        o.findNodeMatch(h, d, f, g) ||
          (l &&
            e.state.selection.from > i &&
            e.state.selection.to < i + h.nodeSize &&
            (y = o.findIndexWithChild(s.node)) > -1 &&
            o.updateNodeAt(h, d, f, y, e)) ||
          o.updateNextNode(h, d, f, e, g, i) ||
          o.addNode(h, d, f, e, i),
          (i += h.nodeSize);
      },
    ),
      ...
      o.destroyRest(),
      (o.changed || this.dirty == Vt) &&
        (a && this.protectLocalComposition(e, a),
        dl(this.contentDOM, this.children, e),
        dr && i1(this.dom));
  }
  localCompositionInfo(e, t) {
    let { from: r, to: i } = e.state.selection;
    if (
      !(e.state.selection instanceof X) ||
      r < t ||
    ...
    if (this.node.inlineContent) {
      let a = s.nodeValue,
        l = s1(this.node.content, a, r - t, i - t);
  ...
  protectLocalComposition(e, { node: t, pos: r, text: i }) {
    ...
    let a = new Zu(this, s, t, i);
    e.input.compositionNodes.push(a),
      (this.children = zn(this.children, r, r + i.length, e, a));
  }
  update(e, t, r, i) {
    return this.dirty == et || !e.sameMarkup(this.node)
      ? !1
  ...
  updateOuterDeco(e) {
    if (Nn(e, this.outerDeco)) return;
    let t = this.nodeDOM.nodeType != 1,
      r = this.dom;
    (this.dom = fl(
      this.dom,
      this.nodeDOM,
      An(this.outerDeco, this.node, t),
      An(e, this.node, t),
    )),
...
class D0 extends zt {
  ...
  slice(e, t, r) {
    ...
    return new D0(this.parent, i, this.outerDeco, this.innerDeco, s, s, r);
  }
  markDirty(e, t) {
    super.markDirty(e, t),
...
class Qu extends zt {
  constructor(e, t, r, i, s, a, l, o, h, d) {
    super(e, t, r, i, s, a, l, h, d), (this.spec = o);
  }
  update(e, t, r, i) {
...
function dl(n, e, t) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (a instanceof Yt) {
      let o = r ? r.previousSibling : n.lastChild;
      dl(a.contentDOM, a.children, t), (r = o ? o.nextSibling : n.firstChild);
    }
  }
  for (; r; ) (r = as(r)), (i = !0);
...
function An(n, e, t) {
  ...
  for (let s = 0; s < n.length; s++) {
    ...
    if (a) {
      a.nodeName && i.push((r = new Cr(a.nodeName)));
      for (let l in a) {
        let o = a[l];
        o != null &&
          (t &&
            i.length == 1 &&
            i.push((r = new Cr(e.isInline ? "span" : "div"))),
          l == "class"
  ...
  for (let s = 0; s < r.length; s++) {
    ...
    if (s) {
      ...
      (l &&
        ...
        i != n &&
        (o = i.parentNode) &&
        o.nodeName.toLowerCase() == a.nodeName) ||
        ((o = document.createElement(a.nodeName)),
        (o.pmIsDeco = !0),
        o.appendChild(i),
        (l = Ht[0])),
        (i = o);
...
function pl(n, e, t) {
  return fl(n, n, Ht, An(e, t, n.nodeType != 1));
}
function Nn(n, e) {
  if (n.length != e.length) return !1;
...
class e1 {
  constructor(e, t, r) {
    (this.lock = t),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = t1(e.node.content, e));
  }
  destroyBetween(e, t) {
    if (e != t) {
  ...
  syncToMarks(e, t, r) {
    ...
    for (; s < e.length; ) {
      ...
      for (
        let o = this.index;
        o < Math.min(this.index + 3, this.top.children.length);
        o++
      ) {
        let h = this.top.children[o];
      ...
      if (l > -1)
        ...
        let o = Yt.create(this.top, e[s], t, r);
  ...
  findNodeMatch(e, t, r, i) {
    ...
    if (
      ...
      for (
        let l = this.index, o = Math.min(this.top.children.length, l + 5);
        l < o;
        l++
      ) {
        let h = this.top.children[l];
        if (h.matchesNode(e, t, r) && !this.preMatch.matched.has(h)) {
          s = l;
          break;
        }
      }
  ...
  updateNodeAt(e, t, r, i, s) {
    ...
    return (
      a.dirty == et && a.dom == a.contentDOM && (a.dirty = Vt),
      a.update(e, t, r, s)
  ...
  updateNextNode(e, t, r, i, s, a) {
    for (let l = this.index; l < this.top.children.length; l++) {
      let o = this.top.children[l];
      if (o instanceof zt) {
        let h = this.preMatch.matched.get(o);
        ...
        if (!g && (f = this.recreateWrapper(o, e, t, r, i, a)))
          return (
            (this.top.children[this.index] = f),
            f.contentDOM &&
              ((f.dirty = Vt), f.updateChildren(i, a + 1), (f.dirty = Le)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  recreateWrapper(e, t, r, i, s, a) {
    if (
      ...
      return null;
    let l = zt.create(this.top, t, r, i, s, a);
    if (l.contentDOM) {
      (l.children = e.children), (e.children = []);
      for (let o of l.children) o.parent = l;
    }
    return e.destroy(), l;
  }
  addNode(e, t, r, i, s) {
    let a = zt.create(this.top, e, t, r, i, s);
    a.contentDOM && a.updateChildren(i, s + 1),
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      t = this.top;
    for (; e instanceof Yt; ) (t = e), (e = t.children[t.children.length - 1]);
    (!e ||
      !(e instanceof D0) ||
      /\n$/.test(e.node.text) ||
...
function t1(n, e) {
  ...
  e: for (; i > 0; ) {
    ...
    for (;;)
      if (r) {
        let h = t.children[r - 1];
        if (h instanceof Yt) (t = h), (r = h.children.length);
        else {
          (l = h), r--;
          break;
        }
    ...
    let o = l.node;
    if (o) {
      if (o != n.child(i - 1)) break;
      --i, s.set(l, i), a.push(l);
    }
  }
...
function n1(n, e, t, r) {
  ...
  if (i.length == 0) {
    for (let h = 0; h < n.childCount; h++) {
      let d = n.child(h);
      r(d, i, e.forChild(s, d), h), (s += d.nodeSize);
    }
    return;
  }
  let a = 0,
  ...
  for (let h = 0; ; ) {
    ...
    if (d)
      if (f) {
        f.sort(r1);
        for (let M = 0; M < f.length; M++) t(f[M], h, !!o);
      } else t(d, h, !!o);
    let g, y;
    if (o) (y = -1), (g = o), (o = null);
    else if (h < n.childCount) (y = h), (g = n.child(h++));
    else break;
    for (let M = 0; M < l.length; M++) l[M].to <= s && l.splice(M--, 1);
    for (; a < i.length && i[a].from <= s && i[a].to > s; ) l.push(i[a++]);
    let v = s + g.nodeSize;
    if (g.isText) {
      let M = v;
      a < i.length && i[a].from < M && (M = i[a].from);
      for (let T = 0; T < l.length; T++) l[T].to < M && (M = l[T].to);
      M < v && ((o = g.cut(M - s)), (g = g.cut(0, M - s)), (v = M), (y = -1));
    } else for (; a < i.length && i[a].to < v; ) a++;
    let k = g.isInline && !g.isLeaf ? l.filter((M) => !M.inline) : l.slice();
    r(g, k, e.forChild(s, g), y), (s = v);
  }
}
function i1(n) {
...
function s1(n, e, t, r) {
  for (let i = 0, s = 0; i < n.childCount && s <= r; ) {
    ...
    if (s >= t) {
      if (s >= r && o.slice(r - e.length - l, r - l) == e) return r - e.length;
      let h = l < r ? o.lastIndexOf(e, r - l - 1) : -1;
      if (h >= 0 && h + e.length + l >= t) return l + h;
      if (
        t == r &&
        o.length >= r + e.length - l &&
        o.slice(r - l, r - l + e.length) == e
      )
        return r;
    }
  }
...
function zn(n, e, t, r, i) {
  ...
  for (let a = 0, l = 0; a < n.length; a++) {
    ...
    h >= t || d <= e
      ? s.push(o)
      : (h < e && s.push(o.slice(0, e - h, r)),
        i && (s.push(i), (i = void 0)),
        d > t && s.push(o.slice(t - h, o.size, r)));
  }
  return s;
}
function Zn(n, e = null) {
  ...
  if (z0(t)) {
    ...
    if (
      ...
      W.isSelectable(d) &&
      i.parent &&
      !(d.isInline && Ou(t.focusNode, t.focusOffset, i.dom))
    ) {
      let f = i.posBefore;
      h = new W(a == f ? l : r.resolve(f));
    }
  } else {
...
function ml(n) {
  return n.editable
    ? n.hasFocus()
    : yl(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function ht(n, e = !1) {
  ...
  if ((gl(n, t), !!ml(n))) {
    if (!e && n.input.mouseDown && n.input.mouseDown.allowDefault && ge) {
      ...
      if (
        r.anchorNode &&
        i.anchorNode &&
        Kt(r.anchorNode, r.anchorOffset, i.anchorNode, i.anchorOffset)
      ) {
    ...
    if ((n.domObserver.disconnectSelection(), n.cursorWrapper)) l1(n);
    else {
      ...
      ls &&
        !(t instanceof X) &&
        (t.$from.parent.inlineContent || (s = hs(n, t.from)),
        !t.empty && !t.$from.parent.inlineContent && (a = hs(n, t.to))),
...
function _0(n) {
  return (
    ...
    xe && n.draggable && ((n.draggable = !1), (n.wasDraggable = !0)),
    n
  );
}
function us(n) {
  ...
  e.addEventListener(
    ...
    (n.input.hideSelectionGuard = () => {
      (t.anchorNode != r || t.anchorOffset != i) &&
        (e.removeEventListener("selectionchange", n.input.hideSelectionGuard),
        setTimeout(() => {
          (!ml(n) || n.state.selection.visible) &&
            n.dom.classList.remove("ProseMirror-hideselection");
        }, 20));
    }),
  );
...
function gl(n, e) {
  if (e instanceof W) {
    ...
    t != n.lastSelectedViewDesc &&
      (cs(n), t && t.selectNode(), (n.lastSelectedViewDesc = t));
  } else cs(n);
}
function cs(n) {
...
function fs(n, e, t) {
  ...
  if (r instanceof X)
    if (t.indexOf("s") > -1) {
      ...
      let a = n.state.doc.resolve(i.pos + s.nodeSize * (e < 0 ? -1 : 1));
      return kt(n, new X(r.$anchor, a));
    } else if (r.empty) {
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        let i = Dn(n.state, e);
        return i && i instanceof W ? kt(n, i) : !1;
        ...
        return s.isAtom || ((a = n.docView.descAt(l)) && !a.contentDOM)
          ? W.isSelectable(s)
            ? kt(n, new W(e < 0 ? n.state.doc.resolve(i.pos - s.nodeSize) : i))
            : Lr
              ? kt(n, new X(n.state.doc.resolve(e < 0 ? l : l + s.nodeSize)))
              : !1
          : !1;
      }
    } else return !1;
    ...
    if (r instanceof W && r.node.isInline)
      return kt(n, new X(e > 0 ? r.$to : r.$from));
    {
      let i = Dn(n.state, e);
      return i ? kt(n, i) : !1;
    }
...
function h1(n) {
  ...
  let i,
    ...
    a = !1;
  for (
    Ue && t.nodeType == 1 && r < y0(t) && Ar(t.childNodes[r], -1) && (a = !0);
    ;
  ...
  for (;;)
    if (r < i) {
      ...
      if (vl(t)) break;
      {
        let l = t.nextSibling;
        for (; l && Ar(l, 1); )
          (s = l.parentNode), (a = fe(l) + 1), (l = l.nextSibling);
        if (l) (t = l), (r = 0), (i = y0(t));
        else {
          if (((t = t.parentNode), t == n.dom)) break;
          r = i = 0;
...
function d1(n, e) {
  for (; n && !e && !qr(n); ) (e = fe(n)), (n = n.parentNode);
  for (; n && e; ) {
...
function On(n, e, t) {
  if (e.nodeType != 3) {
    ...
    (a = c1(e, t))
      ? ((e = a), (t = 0))
      : (s = d1(e, t)) && ((e = s), (t = s.nodeValue.length));
  }
...
function ps(n, e) {
  ...
  if (!(ge || Ru) && t.parent.inlineContent) {
...
function ms(n, e, t) {
  ...
  if (!i.parent.inlineContent || n.endOfTextblock(e < 0 ? "up" : "down")) {
    let a = Dn(n.state, e);
    if (a && a instanceof W) return kt(n, a);
  }
  if (!i.parent.inlineContent) {
    let a = e < 0 ? i : s,
      l = r instanceof Be ? K.near(a, e) : K.findFrom(a, e);
    return l ? kt(n, l) : !1;
  }
  return !1;
}
function gs(n, e) {
  ...
  if (s && !s.isText) {
    ...
    return (
      e < 0
        ? a.delete(t.pos - s.nodeSize, t.pos)
        : a.delete(t.pos, t.pos + s.nodeSize),
      n.dispatch(a),
      !0
    );
  }
...
function f1(n) {
  if (!xe || n.state.selection.$head.parentOffset > 0) return !1;
...
function m1(n, e) {
  let t = e.keyCode,
    r = p1(e);
  if (t == 8 || (Fe && t == 72 && r == "c")) return gs(n, -1) || rr(n, -1);
  if ((t == 46 && !e.shiftKey) || (Fe && t == 68 && r == "c"))
    return gs(n, 1) || rr(n, 1);
  if (t == 13 || t == 27) return !0;
  if (t == 37 || (Fe && t == 66 && r == "c")) {
    let i = t == 37 ? (ps(n, n.state.selection.from) == "ltr" ? -1 : 1) : -1;
    return fs(n, i, r) || rr(n, i);
  } else if (t == 39 || (Fe && t == 70 && r == "c")) {
    let i = t == 39 ? (ps(n, n.state.selection.from) == "ltr" ? 1 : -1) : 1;
    return fs(n, i, r) || rr(n, i);
  } else {
    if (t == 38 || (Fe && t == 80 && r == "c"))
      return ms(n, -1, r) || rr(n, -1);
    if (t == 40 || (Fe && t == 78 && r == "c"))
      return f1(n) || ms(n, 1, r) || rr(n, 1);
...
function bl(n, e) {
  ...
  let a = n.someProp("clipboardSerializer") || pr.fromSchema(n.state.schema),
    l = Tl(),
    o = l.createElement("div");
  o.appendChild(a.serializeFragment(r, { document: l }));
  let h = o.firstChild,
    d,
    f = 0;
  for (; h && h.nodeType == 1 && (d = Ml[h.nodeName.toLowerCase()]); ) {
    for (let y = d.length - 1; y >= 0; y--) {
      let v = l.createElement(d[y]);
...
`,
        ...
        : B.empty;
    let f = n.someProp("clipboardTextParser", (g) => g(e, i, r, n));
    if (f) l = f;
    else {
      let g = i.marks(),
        { schema: y } = n.state,
      ...
      (a = document.createElement("div")),
        e.split(/(?:\r\n?|\n)+/).forEach((k) => {
          ...
          k && M.appendChild(v.serializeNode(y.text(k, g)));
        });
    }
  } else
  ...
  if (
    ...
    l = x1(vs(l, +d[1], +d[2]), d[4]);
  else if (((l = B.maxOpen(y1(l.content, i), !0)), l.openStart || l.openEnd)) {
    let f = 0,
      g = 0;
    for (
      let y = l.content.firstChild;
      f < l.openStart && !y.type.spec.isolating;
      f++, y = y.firstChild
    );
    for (
...
function y1(n, e) {
  ...
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (
      (n.forEach((l) => {
        if (!a) return;
        let o = i.findWrapping(l.type),
          h;
        if (!o) return (a = null);
        if ((h = a.length && s.length && kl(o, s, l, a[a.length - 1], 0)))
          a[a.length - 1] = h;
        else {
          a.length && (a[a.length - 1] = Sl(a[a.length - 1], s.length));
          let d = wl(l, o);
          a.push(d), (i = i.matchType(d.type)), (s = o);
        }
      }),
      a)
    )
...
function wl(n, e, t = 0) {
  for (let r = e.length - 1; r >= t; r--) n = e[r].create(null, z.from(n));
  return n;
}
function kl(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let s = kl(n, e, t, r.lastChild, i + 1);
    ...
    if (
      ...
      return r.copy(r.content.append(z.from(wl(t, n, i + 1))));
  }
}
function Sl(n, e) {
  if (e == 0) return n;
  let t = n.content.replaceChild(n.childCount - 1, Sl(n.lastChild, e - 1)),
    r = n.contentMatchAt(n.childCount).fillBefore(z.empty, !0);
      ...
      (l =
        e < 0
          ? a
              ...
              .fillBefore(l, s <= i)
              .append(l)
          : l.append(a.contentMatchAt(a.childCount).fillBefore(z.empty, !0))),
...
function vs(n, e, t) {
  return (
    e < n.openStart &&
      (n = new B(
        En(n.content, -1, e, n.openStart, 0, n.openEnd),
        e,
        n.openEnd,
      )),
    t < n.openEnd &&
      (n = new B(En(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)),
    n
  );
}
const Ml = {
...
function v1(n) {
  ...
  let t = Tl().createElement("div"),
    r = /<([a-z][^>\s]+)/i.exec(n),
    i;
  if (
    ((i = r && Ml[r[1].toLowerCase()]) &&
      (n =
        i.map((s) => "<" + s + ">").join("") +
        n +
        i
...
function x1(n, e) {
  ...
  for (let l = r.length - 2; l >= 0; l -= 2) {
    let o = t.nodes[r[l]];
    if (!o || o.hasRequiredAttrs()) break;
    (i = z.from(o.create(r[l + 1], i))), s++, a++;
  }
  return new B(i, s, a);
}
const we = {},
  ke = {},
  w1 = { touchstart: !0, touchmove: !0 };
class k1 {
  constructor() {
    (this.shiftKey = !1),
      (this.mouseDown = null),
  ...
  for (let e in we) {
    ...
    n.dom.addEventListener(
      ...
      (n.input.eventHandlers[e] = (r) => {
        T1(n, r) && !_n(n, r) && (n.editable || !(r.type in ke)) && t(n, r);
      }),
      w1[e] ? { passive: !0 } : void 0,
    );
  }
  xe && n.dom.addEventListener("input", () => null), Bn(n);
}
function Ct(n, e) {
  ...
  n.someProp("handleDOMEvents", (e) => {
    for (let t in e)
      n.input.eventHandlers[t] ||
        n.dom.addEventListener(t, (n.input.eventHandlers[t] = (r) => _n(n, r)));
  });
}
function _n(n, e) {
...
ke.keydown = (n, e) => {
  ...
  if (
    ...
    if (
      ...
      dr && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey)
    ) {
      let r = Date.now();
      (n.input.lastIOSEnter = r),
        (n.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          n.input.lastIOSEnter == r &&
            (n.someProp("handleKeyDown", (i) => i(n, Lt(13, "Enter"))),
            (n.input.lastIOSEnter = 0));
        }, 200));
    } else
      n.someProp("handleKeyDown", (r) => r(n, t)) || m1(n, t)
        ? t.preventDefault()
        : Ct(n, "key");
};
ke.keyup = (n, e) => {
...
ke.keypress = (n, e) => {
  let t = e;
  if (Al(n, t) || !t.charCode || (t.ctrlKey && !t.altKey) || (Fe && t.metaKey))
    return;
...
function ei(n, e, t, r, i) {
  ...
  for (let a = s.depth + 1; a > 0; a--)
    if (
      n.someProp(e, (l) =>
        a > s.depth
          ? l(n, t, s.nodeAfter, s.before(a), i, !0)
          : l(n, t, s.node(a), s.before(a), i, !1),
      )
    )
      return !0;
  return !1;
...
function N1(n, e) {
  ...
  let t = n.state.doc.resolve(e),
    r = t.nodeAfter;
  return r && r.isAtom && W.isSelectable(r) ? (lr(n, new W(t)), !0) : !1;
}
function z1(n, e) {
  if (e == -1) return !1;
  let t = n.state.selection,
  ...
  return i != null ? (lr(n, W.create(n.state.doc, i)), !0) : !1;
}
function D1(n, e, t, r, i) {
  return (
    ei(n, "handleClickOn", e, t, r) ||
...
function O1(n, e, t, r) {
  return (
    ei(n, "handleDoubleClickOn", e, t, r) ||
    n.someProp("handleDoubleClick", (i) => i(n, e, r))
  );
}
function E1(n, e, t, r) {
  return (
    ei(n, "handleTripleClickOn", e, t, r) ||
...
function B1(n, e, t) {
  ...
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (lr(n, X.create(r, 0, r.content.size)), !0) : !1;
  let i = r.resolve(e);
  for (let s = i.depth + 1; s > 0; s--) {
    let a = s > i.depth ? i.nodeAfter : i.node(s),
      l = i.before(s);
    if (a.inlineContent) lr(n, X.create(r, l + 1, l + 1 + a.content.size));
    else if (W.isSelectable(a)) lr(n, W.create(r, l));
    else continue;
    return !0;
  }
}
...
we.mousedown = (n, e) => {
  ...
  let a = n.posAtCoords(O0(t));
  a &&
    (s == "singleClick"
      ? (n.input.mouseDown && n.input.mouseDown.done(),
        (n.input.mouseDown = new R1(n, a, t, !!r)))
      : (s == "doubleClick" ? O1 : E1)(n, a.pos, a.inside, t)
        ? t.preventDefault()
        : Ct(n, "pointer"));
};
class R1 {
  constructor(e, t, r, i) {
    ...
    this.view.root.removeEventListener("mouseup", this.up),
      ...
      this.mightDrag &&
        ...
        this.view.domObserver.start()),
      this.delayedSelectionSync && setTimeout(() => ht(this.view)),
      (this.view.input.mouseDown = null);
  }
  up(e) {
    if ((this.done(), !this.view.dom.contains(e.target))) return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(O0(e))),
      ...
      this.allowDefault || !t
        ...
        : D1(this.view, t.pos, t.inside, e, this.selectNode)
          ...
          : e.button == 0 &&
            ...
            ? (lr(this.view, K.near(this.view.state.doc.resolve(t.pos))),
              e.preventDefault())
            : Ct(this.view, "pointer");
  }
  move(e) {
...
we.touchstart = (n) => {
  (n.input.lastTouch = Date.now()), ti(n), Ct(n, "pointer");
};
we.touchmove = (n) => {
  (n.input.lastTouch = Date.now()), Ct(n, "pointer");
};
we.contextmenu = (n) => ti(n);
function Al(n, e) {
  return n.composing
    ? !0
    : xe && Math.abs(e.timeStamp - n.input.compositionEndedAt) < 500
...
function Nl(n, e) {
  clearTimeout(n.input.composingTimeout),
    e > -1 && (n.input.composingTimeout = setTimeout(() => v0(n), e));
}
function zl(n) {
  for (
    n.composing &&
    ((n.input.composing = !1), (n.input.compositionEndedAt = P1()));
...
function F1(n) {
  ...
  let t = zu(e.focusNode, e.focusOffset),
    r = Du(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc,
    ...
    if (n.input.compositionNode == r) {
      let a = t.pmViewDesc;
      if (!(!a || !a.isText(t.nodeValue))) return r;
    }
  }
  return t || r;
}
...
function v0(n, e = !1) {
  if (!($e && n.domObserver.flushingSoon >= 0)) {
    if (
      (n.domObserver.forceFlush(), zl(n), e || (n.docView && n.docView.dirty))
    ) {
      let t = Zn(n);
      return (
...
const Br = (Ce && Nt < 15) || (dr && Iu < 604);
we.copy = ke.cut = (n, e) => {
  let t = e,
    r = n.state.selection,
    i = t.type == "cut";
  if (r.empty) return;
  let s = Br ? null : t.clipboardData,
    a = r.content(),
    { dom: l, text: o } = bl(n, a);
  s
    ? (t.preventDefault(),
...
function V1(n, e) {
  ...
  setTimeout(() => {
    n.focus(),
      ...
      t ? Rr(n, r.value, null, i, e) : Rr(n, r.textContent, r.innerHTML, i, e);
  }, 50);
}
function Rr(n, e, t, r, i) {
  let s = xl(n, e, t, r, n.state.selection.$from);
  if (n.someProp("handlePaste", (o) => o(n, i, s || B.empty))) return !0;
  if (!s) return !1;
  let a = L1(s),
    l = a
...
ke.paste = (n, e) => {
  let t = e;
  if (n.composing && !$e) return;
  let r = Br ? null : t.clipboardData,
    i = n.input.shiftKey && n.input.lastKeyCode != 45;
  r && Rr(n, Dl(r), r.getData("text/html"), i, t)
    ? t.preventDefault()
    : V1(n, t);
};
class Ol {
...
const El = Fe ? "altKey" : "ctrlKey";
we.dragstart = (n, e) => {
  let t = e,
    r = n.input.mouseDown;
  if ((r && r.done(), !t.dataTransfer)) return;
  let i = n.state.selection,
    s = i.empty ? null : n.posAtCoords(O0(t)),
    a;
  if (!(s && s.pos >= i.from && s.pos <= (i instanceof W ? i.to - 1 : i.to))) {
    if (r && r.mightDrag) a = W.create(n.state.doc, r.mightDrag.pos);
    else if (t.target && t.target.nodeType == 1) {
      let f = n.docView.nearestDesc(t.target, !0);
      f &&
        f.node.type.spec.draggable &&
        f != n.docView &&
        (a = W.create(n.state.doc, f.posBefore));
    }
  }
  let l = (a || n.state.selection).content(),
    { dom: o, text: h, slice: d } = bl(n, l);
  (!t.dataTransfer.files.length || !ge || nl > 120) &&
    t.dataTransfer.clearData(),
    t.dataTransfer.setData(Br ? "Text" : "text/html", o.innerHTML),
    (t.dataTransfer.effectAllowed = "copyMove"),
    Br || t.dataTransfer.setData("text/plain", h),
    (n.dragging = new Ol(d, !t[El], a));
};
we.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
ke.drop = (n, e) => {
  ...
  let i = n.posAtCoords(O0(t));
  if (!i) return;
  let s = n.state.doc.resolve(i.pos),
    a = r && r.slice;
  a
    ? n.someProp("transformPasted", (v) => {
        a = v(a, n);
      })
    : (a = xl(
        n,
        Dl(t.dataTransfer),
        Br ? null : t.dataTransfer.getData("text/html"),
        !1,
        s,
      ));
  let l = !!(r && !t[El]);
  if (n.someProp("handleDrop", (v) => v(n, t, a || B.empty, l))) {
    t.preventDefault();
    return;
  }
  if (!a) return;
  t.preventDefault();
  let o = a ? Xh(n.state.doc, s.pos, a) : s.pos;
  o == null && (o = s.pos);
  let h = n.state.tr;
  if (l) {
    let { node: v } = r;
    v ? v.replace(h) : h.deleteSelection();
  }
  let d = h.mapping.map(o),
    f = a.openStart == 0 && a.openEnd == 0 && a.content.childCount == 1,
    g = h.doc;
  if (
    (f
      ? h.replaceRangeWith(d, d, a.content.firstChild)
      : h.replaceRange(d, d, a),
    h.doc.eq(g))
  )
    return;
  ...
  if (
    f &&
    W.isSelectable(a.content.firstChild) &&
    y.nodeAfter &&
    y.nodeAfter.sameMarkup(a.content.firstChild)
  )
    h.setSelection(new W(y));
  else {
    let v = h.mapping.map(o);
    h.mapping.maps[h.mapping.maps.length - 1].forEach((k, M, T, R) => (v = R)),
      h.setSelection(Qn(n, y, h.doc.resolve(v)));
  }
...
we.beforeinput = (n, e) => {
  if (ge && $e && e.inputType == "deleteContentBackward") {
    ...
    setTimeout(() => {
      if (
        ...
        (n.dom.blur(),
        n.focus(),
        n.someProp("handleKeyDown", (s) => s(n, Lt(8, "Backspace"))))
      )
        return;
...
class b0 {
  ...
  map(e, t, r, i) {
    let { pos: s, deleted: a } = e.mapResult(
      t.from + i,
      this.side < 0 ? -1 : 1,
    );
    return a ? null : new Pe(s - r, s - r, this);
  }
  valid() {
    return !0;
  }
...
class Dt {
  ...
  map(e, t, r, i) {
    ...
    return s >= a ? null : new Pe(s, a, this);
  }
  valid(e, t) {
    return t.from < t.to;
  }
  eq(e) {
    return (
      this == e ||
      (e instanceof Dt && Ir(this.attrs, e.attrs) && Ir(this.spec, e.spec))
    );
  }
  static is(e) {
    return e.type instanceof Dt;
  }
  destroy() {}
}
class ri {
  ...
  map(e, t, r, i) {
    ...
    return a.deleted || a.pos <= s.pos
      ? null
      : new Pe(s.pos - r, a.pos - r, this);
  }
  valid(e, t) {
  ...
  eq(e) {
    return (
      this == e ||
      (e instanceof ri && Ir(this.attrs, e.attrs) && Ir(this.spec, e.spec))
    );
  }
  destroy() {}
}
class Pe {
  ...
  static widget(e, t, r) {
    return new Pe(e, e, new b0(t, r));
  }
  static inline(e, t, r, i) {
    return new Pe(e, t, new Dt(r, i));
  }
  static node(e, t, r, i) {
    return new Pe(e, t, new ri(r, i));
  }
  get spec() {
    return this.type.spec;
  }
  get inline() {
    return this.type instanceof Dt;
  }
  get widget() {
    return this.type instanceof b0;
  }
}
const sr = [],
  Jt = {};
class ue {
  ...
  static create(e, t) {
    return t.length ? x0(t, e, 0, Jt) : pe;
  }
  find(e, t, r) {
    let i = [];
  ...
  findInner(e, t, r, i, s) {
    ...
    for (let a = 0; a < this.children.length; a += 3)
      if (this.children[a] < t && this.children[a + 1] > e) {
        ...
        this.children[a + 2].findInner(e - l, t - l, r, i + l, s);
      }
  }
  map(e, t, r) {
    return this == pe || e.maps.length == 0
      ? this
      : this.mapInner(e, t, 0, 0, r || Jt);
  }
  mapInner(e, t, r, i, s) {
    let a;
    for (let l = 0; l < this.local.length; l++) {
      let o = this.local[l].map(e, r, i);
      o && o.type.valid(t, o)
        ? (a || (a = [])).push(o)
        : s.onRemove && s.onRemove(this.local[l].spec);
    }
    return this.children.length
      ? H1(this.children, a || [], e, t, r, i, s)
      : a
        ? new ue(a.sort($t), sr)
        : pe;
  }
  ...
  addInner(e, t, r) {
    ...
    e.forEach((l, o) => {
      let h = o + r,
        d;
      if ((d = Rl(t, l, h))) {
        for (i || (i = this.children.slice()); s < i.length && i[s] < o; )
          s += 3;
        i[s] == o
          ? (i[s + 2] = i[s + 2].addInner(l, d, h + 1))
          : i.splice(s, 0, o, o + l.nodeSize, x0(d, l, h + 1, Jt)),
          (s += 3);
      }
    });
    let a = Bl(s ? Il(t) : t, -r);
    ...
    return new ue(
      a.length ? this.local.concat(a).sort($t) : this.local,
      i || this.children,
    );
  }
  remove(e) {
  ...
  removeInner(e, t) {
    ...
    for (let s = 0; s < r.length; s += 3) {
      ...
      let h = r[s + 2].removeInner(a, l + 1);
      h != pe ? (r[s + 2] = h) : (r.splice(s, 3), (s -= 3));
    }
    if (i.length) {
  ...
  forChild(e, t) {
    ...
    for (let l = 0; l < this.local.length; l++) {
      let o = this.local[l];
      if (o.from < a && o.to > s && o.type instanceof Dt) {
        let h = Math.max(s, o.from) - s,
          d = Math.min(a, o.to) - s;
        h < d && (i || (i = [])).push(o.copy(h, d));
      }
    }
    if (i) {
      let l = new ue(i.sort($t), sr);
  ...
  localsInner(e) {
    if (this == pe) return sr;
    if (e.inlineContent || !this.local.some(Dt.is)) return this.local;
    let t = [];
    for (let r = 0; r < this.local.length; r++)
      this.local[r].type instanceof Dt || t.push(this.local[r]);
    return t;
  }
}
ue.empty = new ue([], []);
...
class St {
  ...
  forChild(e, t) {
    ...
    for (let i = 0; i < this.members.length; i++) {
      ...
      s != pe && (s instanceof St ? (r = r.concat(s.members)) : r.push(s));
    }
    return St.from(r);
  }
  eq(e) {
  ...
  static from(e) {
    switch (e.length) {
      ...
      default:
        return new St(
          e.every((t) => t instanceof ue)
            ? e
            : e.reduce((t, r) => t.concat(r instanceof ue ? r : r.members), []),
        );
    }
  }
}
function H1(n, e, t, r, i, s, a) {
  let l = n.slice();
  for (let h = 0, d = s; h < t.maps.length; h++) {
    let f = 0;
    t.maps[h].forEach((g, y, v, k) => {
      let M = k - v - (y - g);
      for (let T = 0; T < l.length; T += 3) {
        let R = l[T + 1];
        if (R < 0 || g > R + d - f) continue;
        let L = l[T] + d - f;
        y >= L
          ? (l[T + 1] = g <= L ? -2 : -1)
          : g >= d && M && ((l[T] += M), (l[T + 1] += M));
  ...
  for (let h = 0; h < l.length; h += 3)
    if (l[h + 1] < 0) {
      ...
      let g = t.map(n[h + 1] + s, -1),
        y = g - i,
        { index: v, offset: k } = r.content.findIndex(f),
        M = r.maybeChild(v);
      if (M && k == f && k + M.nodeSize == y) {
        let T = l[h + 2].mapInner(t, M, d + 1, n[h] + s + 1, a);
        T != pe
          ? ((l[h] = f), (l[h + 1] = y), (l[h + 2] = T))
          : ((l[h + 1] = -2), (o = !0));
      } else o = !0;
    }
  if (o) {
    let h = W1(l, n, e, t, i, s, a),
      d = x0(h, r, 0, a);
    e = d.local;
    for (let f = 0; f < l.length; f += 3)
      l[f + 1] < 0 && (l.splice(f, 3), (f -= 3));
    for (let f = 0, g = 0; f < d.children.length; f += 3) {
      let y = d.children[f];
      for (; g < l.length && l[g] < y; ) g += 3;
      l.splice(g, 0, d.children[f], d.children[f + 1], d.children[f + 2]);
    }
  }
  return new ue(e.sort($t), l);
}
function Bl(n, e) {
...
function W1(n, e, t, r, i, s, a) {
  function l(o, h) {
    for (let d = 0; d < o.local.length; d++) {
      let f = o.local[d].map(r, i, h);
      f ? t.push(f) : a.onRemove && a.onRemove(o.local[d].spec);
    }
    for (let d = 0; d < o.children.length; d += 3)
      l(o.children[d + 2], o.children[d] + h + 1);
  }
  for (let o = 0; o < n.length; o += 3)
    n[o + 1] == -1 && l(n[o + 2], e[o] + s + 1);
  return t;
}
function Rl(n, e, t) {
...
function x0(n, e, t, r) {
  ...
  e.forEach((l, o) => {
    ...
    if (h) {
      s = !0;
      let d = x0(h, l, t + o + 1, r);
      d != pe && i.push(o, o + l.nodeSize, d);
    }
  });
  let a = Bl(s ? Il(n) : n, -t).sort($t);
  for (let l = 0; l < a.length; l++)
    a[l].type.valid(e, a[l]) ||
      (r.onRemove && r.onRemove(a[l].spec), a.splice(l--, 1));
  return a.length || i.length ? new ue(a, i) : pe;
}
function $t(n, e) {
      ...
      for (let i = t + 1; i < e.length; i++) {
        ...
        if (s.from == r.from) {
          s.to != r.to &&
            ...
            xs(e, i + 1, s.copy(r.to, s.to)));
          continue;
        } else {
          s.from < r.to &&
            (e == n && (e = n.slice()),
            (e[t] = r.copy(r.from, s.from)),
            xs(e, i, r.copy(s.from, r.to)));
          break;
        }
      }
  }
...
function en(n) {
  ...
  return (
    ...
    n.cursorWrapper && e.push(ue.create(n.state.doc, [n.cursorWrapper.deco])),
    St.from(e)
  );
}
const G1 = {
...
class U1 {
  ...
  start() {
    this.observer &&
      (this.observer.takeRecords(), this.observer.observe(this.view.dom, G1)),
      this.onCharData &&
  ...
  onSelectionChange() {
    if (ds(this.view)) {
      if (this.suppressingSelectionUpdates) return ht(this.view);
      if (Ce && Nt <= 11 && !this.view.state.selection.empty) {
        let e = this.view.domSelectionRange();
        if (
          e.focusNode &&
          Kt(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
        )
  ...
  ignoreSelectionChange(e) {
    ...
    let t = new Set(),
      r;
    for (let s = e.focusNode; s; s = Er(s)) t.add(s);
    for (let s = e.anchorNode; s; s = Er(s))
      if (t.has(s)) {
        r = s;
        break;
      }
  ...
  flush() {
    ...
    if (e.editable)
      for (let d = 0; d < t.length; d++) {
        let f = this.registerMutation(t[d], o);
        f &&
          ((s = s < 0 ? f.from : Math.min(f.from, s)),
          (a = a < 0 ? f.to : Math.max(f.to, a)),
          f.typeOver && (l = !0));
      }
    if (Ue && o.length) {
      ...
      if (d.length == 2) {
        let [f, g] = d;
        f.parentNode && f.parentNode.parentNode == g.parentNode
          ? g.remove()
          : f.remove();
      } else {
        ...
        for (let g of d) {
          let y = g.parentNode;
          y && y.nodeName == "LI" && (!f || j1(e, f) != y) && g.remove();
        }
      }
    }
    let h = null;
    ...
    z0(r) &&
    (h = Zn(e)) &&
    h.eq(K.near(e.state.doc.resolve(0), 1))
      ? ((e.input.lastFocus = 0),
        ht(e),
        this.currentSelection.set(r),
        e.scrollToSelection())
      : (s > -1 || i) &&
        (s > -1 && (e.docView.markDirty(s, a), K1(e)),
        this.handleDOMChange(s, a, l, o),
        e.docView && e.docView.dirty
          ? e.updateState(e.state)
          : this.currentSelection.eq(r) || ht(e),
        this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      let i = e.previousSibling,
        s = e.nextSibling;
      if (Ce && Nt <= 11 && e.addedNodes.length)
        for (let d = 0; d < e.addedNodes.length; d++) {
      ...
      let a = i && i.parentNode == e.target ? fe(i) + 1 : 0,
        l = r.localPosFromDOM(e.target, a, -1),
        o = s && s.parentNode == e.target ? fe(s) : e.target.childNodes.length,
        h = r.localPosFromDOM(e.target, o, 1);
      return { from: l, to: h };
    } else
...
function K1(n) {
  if (
    ...
    if (((n.requiresGeckoHackNode = Ue), ks)) return;
    console.warn(
...
function Ss(n, e) {
  let t = e.startContainer,
    ...
    i = e.endContainer,
    s = e.endOffset,
    a = n.domAtPos(n.state.selection.anchor);
  return (
    Kt(a.node, a.offset, i, s) && ([t, r, i, s] = [i, s, t, r]),
...
function X1(n, e, t) {
  let {
    ...
    o = n.domSelectionRange(),
    h,
    d = o.anchorNode;
  if (
    (d &&
      n.dom.contains(d.nodeType == 1 ? d : d.parentNode) &&
      ((h = [{ node: d, offset: o.anchorOffset }]),
      z0(o) || h.push({ node: o.focusNode, offset: o.focusOffset })),
    ge && n.input.lastKeyCode === 8)
  )
    for (let M = s; M > i; M--) {
      let T = r.childNodes[M - 1],
        R = T.pmViewDesc;
      if (T.nodeName == "BR" && !R) {
        s = M;
        break;
  ...
  let f = n.state.doc,
    g = n.someProp("domParser") || Dr.fromSchema(n.state.schema),
    y = f.resolve(a),
    v = null,
    k = g.parse(r, {
      topNode: y.parent,
  ...
  if (h && h[0].pos != null) {
    let M = h[0].pos,
      T = h[1] && h[1].pos;
    T == null && (T = M), (v = { anchor: M + a, head: T + a });
  }
  return { doc: k, sel: v, from: a, to: l };
}
function Z1(n) {
  let e = n.pmViewDesc;
  ...
  if (n.nodeName == "BR" && n.parentNode) {
    if (xe && /^(ul|ol)$/i.test(n.parentNode.nodeName)) {
      ...
      (xe && /^(tr|table)$/i.test(n.parentNode.nodeName))
    )
      return { ignore: !0 };
...
function _1(n, e, t, r, i) {
  ...
  if (((n.input.compositionPendingChanges = 0), e < 0)) {
    let I =
        n.input.lastSelectionTime > Date.now() - 50
          ...
          : null,
      de = Zn(n, I);
    if (de && !n.state.selection.eq(de)) {
      if (
        ge &&
        $e &&
        n.input.lastKeyCode === 13 &&
        Date.now() - 100 < n.input.lastKeyCodeTime &&
        n.someProp("handleKeyDown", (se) => se(n, Lt(13, "Enter")))
      )
        return;
      let le = n.state.tr.setSelection(de);
      I == "pointer"
        ? le.setMeta("pointer", !0)
        : I == "key" && le.scrollIntoView(),
        s && le.setMeta("composition", s),
        n.dispatch(le);
    }
    return;
  }
  ...
  let v = rc(f.content, h.doc.content, h.from, g, y);
  if (
    ((dr && n.input.lastIOSEnter > Date.now() - 225) || $e) &&
    i.some((I) => I.nodeType == 1 && !Q1.test(I.nodeName)) &&
    (!v || v.endA >= v.endB) &&
    n.someProp("handleKeyDown", (I) => I(n, Lt(13, "Enter")))
  ) {
    n.input.lastIOSEnter = 0;
  ...
  if (!v)
    if (
      ...
      o instanceof X &&
      !o.empty &&
      o.$head.sameParent(o.$anchor) &&
      !n.composing &&
      !(h.sel && h.sel.anchor != h.sel.head)
    )
      v = { start: o.from, endA: o.to, endB: o.to };
    else {
      if (h.sel) {
        let I = Ms(n, n.state.doc, h.sel);
        if (I && !I.eq(n.state.selection)) {
          let de = n.state.tr.setSelection(I);
          s && de.setMeta("composition", s), n.dispatch(de);
        }
      }
      return;
    }
  n.input.domChangeCount++,
    n.state.selection.from < n.state.selection.to &&
      v.start == v.endB &&
      n.state.selection instanceof X &&
      (v.start > n.state.selection.from &&
      v.start <= n.state.selection.from + 2 &&
      n.state.selection.from >= h.from
        ? (v.start = n.state.selection.from)
        : v.endA < n.state.selection.to &&
          v.endA >= n.state.selection.to - 2 &&
          n.state.selection.to <= h.to &&
          ((v.endB += n.state.selection.to - v.endA),
          (v.endA = n.state.selection.to))),
    Ce &&
      Nt <= 11 &&
      v.endB == v.start + 1 &&
  ...
  let k = h.doc.resolveNoCache(v.start - h.from),
    M = h.doc.resolveNoCache(v.endB - h.from),
    T = d.resolve(v.start),
    R = k.sameParent(M) && k.parent.inlineContent && T.end() >= v.endA,
    L;
  if (
    ((dr &&
      n.input.lastIOSEnter > Date.now() - 225 &&
      (!R || i.some((I) => I.nodeName == "DIV" || I.nodeName == "P"))) ||
      (!R &&
        k.pos < h.doc.content.size &&
        !k.sameParent(M) &&
        (L = K.findFrom(h.doc.resolve(k.pos + 1), 1, !0)) &&
        L.head == M.pos)) &&
    n.someProp("handleKeyDown", (I) => I(n, Lt(13, "Enter")))
  ) {
    n.input.lastIOSEnter = 0;
  ...
  if (
    n.state.selection.anchor > v.start &&
    tc(d, v.start, v.endA, k, M) &&
    n.someProp("handleKeyDown", (I) => I(n, Lt(8, "Backspace")))
  ) {
    $e && ge && n.domObserver.suppressSelectionUpdates();
    return;
  }
  ge && $e && v.endB == v.start && (n.input.lastAndroidDelete = Date.now()),
    $e &&
      !R &&
      k.start() != M.start() &&
      M.parentOffset == 0 &&
  ...
  if (R) {
    if (k.pos == M.pos)
      Ce &&
        Nt <= 11 &&
        k.parentOffset == 0 &&
        (n.domObserver.suppressSelectionUpdates(), setTimeout(() => ht(n), 20)),
        (G = n.state.tr.delete($, H)),
        (U = d.resolve(v.start).marksAcross(d.resolve(v.endA)));
    else if (
      v.endA == v.endB &&
      (Z = ec(
        k.parent.content.cut(k.parentOffset, M.parentOffset),
        T.parent.content.cut(T.parentOffset, v.endA - T.start()),
      ))
    )
      (G = n.state.tr),
        Z.type == "add" ? G.addMark($, H, Z.mark) : G.removeMark($, H, Z.mark);
    else if (
      k.parent.child(k.index()).isText &&
      k.index() == M.index() - (M.textOffset ? 0 : 1)
    ) {
      let I = k.parent.textBetween(k.parentOffset, M.parentOffset);
      if (n.someProp("handleTextInput", (de) => de(n, $, H, I))) return;
      G = n.state.tr.insertText(I, $, H);
    }
  }
  if (
    (G ||
      (G = n.state.tr.replace(
        $,
        H,
        h.doc.slice(v.start - h.from, v.endB - h.from),
      )),
    h.sel)
  ) {
    let I = Ms(n, G.doc, h.sel);
    I &&
      !(
        (ge &&
          $e &&
          n.composing &&
          I.empty &&
          (v.start != v.endB || n.input.lastAndroidDelete < Date.now() - 100) &&
          (I.head == $ || I.head == G.mapping.map(H) - 1)) ||
        (Ce && I.empty && I.head == $)
      ) &&
      G.setSelection(I);
  }
  U && G.ensureMarks(U),
    ...
    n.dispatch(G.scrollIntoView());
}
function Ms(n, e, t) {
  return Math.max(t.anchor, t.head) > e.content.size
    ? null
    : Qn(n, e.resolve(t.anchor), e.resolve(t.head));
}
function ec(n, e) {
  ...
  if (i.length == 1 && s.length == 0)
    (l = i[0]), (a = "add"), (o = (d) => d.mark(l.addToSet(d.marks)));
  else if (i.length == 0 && s.length == 1)
    (l = s[0]), (a = "remove"), (o = (d) => d.mark(l.removeFromSet(d.marks)));
  else return null;
  let h = [];
  for (let d = 0; d < e.childCount; d++) h.push(o(e.child(d)));
  if (z.from(h).eq(n)) return { mark: l, type: a };
}
function tc(n, e, t, r, i) {
  if (t - e <= i.pos - r.pos || tn(r, !0, !1) < i.pos) return !1;
  let s = n.resolve(e);
  if (!r.parent.isTextblock) {
    let l = s.nodeAfter;
  ...
  if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock)
    return !1;
  let a = n.resolve(tn(s, !0, !0));
  return !a.parent.isTextblock || a.pos > t || tn(a, !0, !1) < t
    ? !1
...
function rc(n, e, t, r, i) {
  ...
  if (i == "end") {
    let o = Math.max(0, s - Math.min(a, l));
    r -= a + o - s;
  }
  if (a < s && n.size < e.size) {
    let o = r <= s && r >= a ? s - r : 0;
    (s -= o),
      s && s < e.size && Ts(e.textBetween(s - 1, s + 1)) && (s += o ? 1 : -1),
      (l = s + (l - a)),
      (a = s);
  } else if (l < s) {
    let o = r <= s && r >= l ? s - r : 0;
    (s -= o),
      s && s < n.size && Ts(n.textBetween(s - 1, s + 1)) && (s += o ? 1 : -1),
      (a = s + (a - l)),
      (l = s);
  }
  return { start: s, endA: a, endB: l };
}
function Ts(n) {
...
class Of {
  constructor(e, t) {
    (this._root = null),
      ...
      (this.editable = Ns(this)),
      As(this),
      (this.nodeViews = zs(this)),
      (this.docView = ss(this.state.doc, Cs(this), en(this), this.dom, this)),
      (this.domObserver = new U1(this, (r, i, s, a) => _1(this, r, i, s, a))),
  ...
  update(e) {
    e.handleDOMEvents != this._props.handleDOMEvents && Bn(this);
    let t = this._props;
    (this._props = e),
      e.plugins && (e.plugins.forEach(Ds), (this.directPlugins = e.plugins)),
  ...
  updateStateInner(e, t) {
    ...
    let i = this.state,
      s = !1,
      a = !1;
    e.storedMarks && this.composing && (zl(this), (a = !0)), (this.state = e);
    ...
    if (
      ...
      let y = zs(this);
      ic(y, this.nodeViews) && ((this.nodeViews = y), (s = !0));
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && Bn(this),
      (this.editable = Ns(this)),
      As(this);
    let o = en(this),
      h = Cs(this),
      d =
        i.plugins != e.plugins && !i.doc.eq(e.doc)
          ...
          : e.scrollToSelection > i.scrollToSelection
            ? "to selection"
            : "preserve",
      f = s || !this.docView.matchesNode(e.doc, h, o);
    (f || !e.selection.eq(i.selection)) && (a = !0);
    let g =
      d == "preserve" && a && this.dom.style.overflowAnchor == null && qu(this);
    if (a) {
      ...
      let y =
        ...
        !i.selection.empty &&
        !e.selection.empty &&
        nc(i.selection, e.selection);
      if (f) {
        let v = ge
          ? (this.trackWrites = this.domSelectionRange().focusNode)
          : null;
        this.composing && (this.input.compositionNode = F1(this)),
          (s || !this.docView.update(e.doc, h, o, this)) &&
            (this.docView.updateOuterDeco(h),
            this.docView.destroy(),
            (this.docView = ss(e.doc, h, o, this.dom, this))),
          v && !this.trackWrites && (y = !0);
      }
      y ||
      !(
        ...
        ? ht(this, y)
        : (gl(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start();
    }
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Ol(
      e.slice,
      e.move,
      i < 0 ? void 0 : W.create(this.state.doc, i),
    );
  }
  someProp(e, t) {
  ...
  domSelectionRange() {
    ...
    return (
      (xe &&
        ...
        Eu(this.dom.ownerDocument) == this.dom &&
        Y1(this, e)) ||
      e
    );
  }
...
function As(n) {
  if (n.markCursor) {
    ...
    (e.className = "ProseMirror-separator"),
      ...
      (n.cursorWrapper = {
        dom: e,
        deco: Pe.widget(n.state.selection.head, e, {
          raw: !0,
          marks: n.markCursor,
        }),
      });
...
function ac(n) {
  ...
  for (let l = 0; l < e.length - 1; l++) {
    let o = e[l];
    if (/^(cmd|meta|m)$/i.test(o)) a = !0;
    else if (/^a(lt)?$/i.test(o)) r = !0;
    else if (/^(c|ctrl|control)$/i.test(o)) i = !0;
    else if (/^s(hift)?$/i.test(o)) s = !0;
    else if (/^mod$/i.test(o)) sc ? (a = !0) : (i = !0);
    else throw new Error("Unrecognized modifier name: " + o);
  }
  return (
    r && (t = "Alt-" + t),
    i && (t = "Ctrl-" + t),
...
function Ef(n) {
  return new Kn({ props: { handleKeyDown: Fl(n) } });
}
function Fl(n) {
  let e = lc(n);
  return function (t, r) {
...
class ie extends K {
  ...
  map(e, t) {
    let r = e.resolve(t.map(this.head));
    return ie.valid(r) ? new ie(r) : K.near(r);
  }
  content() {
    return B.empty;
  }
  ...
  static valid(e) {
    let t = e.parent;
    if (t.isTextblock || !oc(e) || !hc(e)) return !1;
...
class ii {
  ...
  resolve(e) {
    ...
    return ie.valid(t) ? new ie(t) : K.near(t);
  }
}
function oc(n) {
...
function Bf() {
  return new Kn({
    props: {
      ...
      handleClick: cc,
      handleKeyDown: uc,
      handleDOMEvents: { beforeinput: dc },
    },
  });
}
const uc = Fl({
...
function Xr(n, e) {
  ...
  return function (r, i, s) {
    ...
    if (a instanceof X) {
      ...
      (o = !1), (l = r.doc.resolve(e > 0 ? l.after() : l.before()));
    }
    let h = ie.findGapCursorFrom(l, e, o);
    return h ? (i && i(r.tr.setSelection(new ie(h))), !0) : !1;
  };
}
function cc(n, e, t) {
  if (!n || !n.editable) return !1;
  let r = n.state.doc.resolve(e);
  if (!ie.valid(r)) return !1;
  let i = n.posAtCoords({ left: t.clientX, top: t.clientY });
  return i && i.inside > -1 && W.isSelectable(n.state.doc.nodeAt(i.inside))
    ? !1
    : (n.dispatch(n.state.tr.setSelection(new ie(r))), !0);
}
function dc(n, e) {
  if (
    e.inputType != "insertCompositionText" ||
    !(n.state.selection instanceof ie)
  )
    return !1;
  ...
  let s = n.state.tr.replace(t.pos, t.pos, new B(i, 0, 0));
  return s.setSelection(X.near(s.doc.resolve(t.pos + 1))), n.dispatch(s), !1;
}
function fc(n) {
  if (!(n.selection instanceof ie)) return null;
  let e = document.createElement("div");
  return (
    (e.className = "ProseMirror-gapcursor"),
    ue.create(n.doc, [Pe.widget(n.selection.head, e, { key: "gapcursor" })])
  );
}
class Ne {
  constructor(e, t, r) {
  ...
  static range(e, t) {
    return t
      ? !e || !e.loc || !t.loc || e.loc.lexer !== t.loc.lexer
        ? null
        : new Ne(e.loc.lexer, e.loc.start, t.loc.end)
      : e && e.loc;
  }
}
class Ve {
  ...
  range(e, t) {
    return new Ve(t, Ne.range(this, e));
  }
}
class N {
  constructor(e, t) {
    ...
    if (a && a.start <= a.end) {
      ...
      (i = a.start),
        ...
        i === l.length
          ? (r += " at end of input: ")
          : (r += " at position " + (i + 1) + ": ");
      var o = l.slice(i, s).replace(/[^]/g, "$&̲"),
        h;
      i > 15 ? (h = "…" + l.slice(i - 15, i)) : (h = l.slice(0, i));
      var d;
      s + 15 < l.length ? (d = l.slice(s, s + 15) + "…") : (d = l.slice(s)),
        (r += h + o + d);
    }
    var f = new Error(r);
    return (
      (f.name = "ParseError"),
      (f.__proto__ = N.prototype),
      (f.position = i),
      i != null && s != null && (f.length = s - i),
      (f.rawMessage = e),
      f
    );
  }
...
var pc = function (e, t) {
  ...
  gc = /([A-Z])/g,
  yc = function (e) {
    return e.replace(gc, "-$1").toLowerCase();
  },
  vc = { "&": "&amp;", ">": "&gt;", "<": "&lt;", '"': "&quot;", "'": "&#x27;" },
  bc = /[&><"']/g;
function xc(n) {
  return String(n).replace(bc, (e) => vc[e]);
}
var Pl = function n(e) {
...
class si {
  constructor(e) {
    (this.displayMode = void 0),
      ...
      (e = e || {});
    for (var t in u0)
      if (u0.hasOwnProperty(t)) {
        var r = u0[t];
        this[t] =
          e[t] !== void 0 ? (r.processor ? r.processor(e[t]) : e[t]) : Mc(r);
      }
  }
...
class bt {
  ...
  sup() {
    return Ke[Tc[this.id]];
  }
  sub() {
    return Ke[Cc[this.id]];
  }
  fracNum() {
    return Ke[Ac[this.id]];
  }
  fracDen() {
    return Ke[Nc[this.id]];
  }
  cramp() {
    return Ke[zc[this.id]];
  }
  text() {
    return Ke[Dc[this.id]];
  }
  isTight() {
    return this.size >= 2;
  }
...
var ai = 0,
  ...
  Tc = [Fr, qe, Fr, qe, fr, be, fr, be],
  Cc = [qe, qe, qe, qe, be, be, be, be],
  Ac = [or, ut, Fr, qe, fr, be, fr, be],
  Nc = [ut, ut, qe, qe, be, be, be, be],
  zc = [w0, w0, ut, ut, qe, qe, be, be],
  Dc = [ai, w0, or, ut, or, ut, or, ut],
  q = { DISPLAY: Ke[ai], TEXT: Ke[or], SCRIPT: Ke[Fr], SCRIPTSCRIPT: Ke[fr] },
  Rn = [
    {
      name: "latin",
      blocks: [
...
function Oc(n) {
  for (var e = 0; e < Rn.length; e++)
    for (var t = Rn[e], r = 0; r < t.blocks.length; r++) {
      var i = t.blocks[r];
      if (n >= i[0] && n <= i[1]) return t.name;
    }
  return null;
}
var c0 = [];
Rn.forEach((n) => n.blocks.forEach((e) => c0.push(...e)));
function ql(n) {
  for (var e = 0; e < c0.length; e += 2)
    if (n >= c0[e] && n <= c0[e + 1]) return !0;
  return !1;
}
var nr = 80,
  Ec = function (e, t) {
...
function li(n, e, t) {
  if (!Xe[e]) throw new Error("Font metrics not found for font: " + e + ".");
  var r = n.charCodeAt(0),
    i = Xe[e][r];
  if (
    (!i && n[0] in Es && ((r = Es[n[0]].charCodeAt(0)), (i = Xe[e][r])),
    !i && t === "text" && ql(r) && (i = Xe[e][77]),
    i)
  )
...
function Gc(n) {
  var e;
  if ((n >= 5 ? (e = 0) : n >= 3 ? (e = 1) : (e = 2), !nn[e])) {
    var t = (nn[e] = { cssEmPerMu: Zr.quad[e] / 18 });
    for (var r in Zr) Zr.hasOwnProperty(r) && (t[r] = Zr[r][e]);
  }
  return nn[e];
}
var Jc = [
  ...
  Bs = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
  Rs = function (e, t) {
...
class ot {
  constructor(e) {
    (this.style = void 0),
      ...
      (this.sizeMultiplier = Bs[this.size - 1]),
  ...
  havingStyle(e) {
    return this.style === e
      ? this
      : this.extend({ style: e, size: Rs(this.textSize, e) });
  }
  havingCrampedStyle() {
  ...
  havingSize(e) {
    return this.size === e && this.textSize === e
      ...
      : this.extend({
          ...
          size: e,
          textSize: e,
          sizeMultiplier: Bs[e - 1],
        });
  }
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = Rs(ot.BASESIZE, e);
    return this.size === t && this.textSize === ot.BASESIZE && this.style === e
      ? this
  ...
  baseSizingClasses() {
    return this.size !== ot.BASESIZE
      ? ["sizing", "reset-size" + this.size, "size" + ot.BASESIZE]
      : [];
  }
  fontMetrics() {
    return (
      this._fontMetrics || (this._fontMetrics = Gc(this.size)),
      this._fontMetrics
    );
  }
  getColor() {
...
var In = {
  ...
  Ll = function (e) {
    return (
      typeof e != "string" && (e = e.unit), e in In || e in $c || e === "ex"
    );
  },
  re = function (e, t) {
    var r;
    if (e.unit in In)
      r = In[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
    else if (e.unit === "mu") r = t.fontMetrics().cssEmPerMu;
    else {
      var i;
      if (
        (t.style.isTight() ? (i = t.havingStyle(t.style.text())) : (i = t),
        e.unit === "ex")
      )
  ...
  Wl = function (e) {
    var t = "<" + e;
    this.classes.length && (t += ' class="' + F.escape(Ot(this.classes)) + '"');
    var r = "";
    for (var i in this.style)
      this.style.hasOwnProperty(i) &&
        (r += F.hyphenate(i) + ":" + this.style[i] + ";");
    r && (t += ' style="' + F.escape(r) + '"');
    for (var s in this.attributes)
      if (this.attributes.hasOwnProperty(s)) {
        if (Uc.test(s)) throw new N("Invalid attribute name '" + s + "'");
        t += " " + s + '="' + F.escape(this.attributes[s]) + '"';
      }
    t += ">";
...
class Wr {
  ...
  toNode() {
    return Hl.call(this, "span");
  }
  toMarkup() {
    return Wl.call(this, "span");
  }
}
class oi {
  constructor(e, t, r, i) {
  ...
  toNode() {
    return Hl.call(this, "a");
  }
  toMarkup() {
    return Wl.call(this, "a");
  }
}
class Kc {
  constructor(e, t, r) {
  ...
  toMarkup() {
    var e =
        ...
        F.escape(this.src) +
        '"' +
        (' alt="' + F.escape(this.alt) + '"'),
      t = "";
    for (var r in this.style)
      this.style.hasOwnProperty(r) &&
        (t += F.hyphenate(r) + ":" + this.style[r] + ";");
    return t && (e += ' style="' + F.escape(t) + '"'), (e += "'/>"), e;
  }
}
var Yc = { î: "ı̂", ï: "ı̈", í: "ı́", ì: "ı̀" };
class He {
  constructor(e, t, r, i, s, a, l, o) {
    (this.text = void 0),
      (this.height = void 0),
      (this.depth = void 0),
      (this.italic = void 0),
      ...
      (this.style = o || {}),
      (this.maxFontSize = 0);
    var h = Oc(this.text.charCodeAt(0));
    h && this.classes.push(h + "_fallback"),
      /[îïíì]/.test(this.text) && (this.text = Yc[this.text]);
  }
  hasClass(e) {
    return F.contains(this.classes, e);
  }
  toNode() {
    ...
    this.italic > 0 &&
      ...
      (t.style.marginRight = D(this.italic))),
  ...
  toNode() {
    ...
    return (
      this.alternate
        ...
        : t.setAttribute("d", Os[this.pathName]),
      t
    );
  }
  toMarkup() {
    return this.alternate
      ...
      : '<path d="' + F.escape(Os[this.pathName]) + '"/>';
  }
}
class Fn {
  constructor(e) {
...
var Xc = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  Zc = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
  _ = { math: {}, text: {} };
function u(n, e, t, r, i, s) {
  (_[n][i] = { font: e, group: t, replace: r }), s && r && (_[n][r] = _[n][i]);
}
var c = "math",
  C = "text",
  p = "main",
...
u(c, p, x, "⋈", "\\bowtie", !0);
u(c, p, x, "⌣", "\\smile", !0);
u(c, p, x, "⊑", "\\sqsubseteq", !0);
u(c, p, x, "⊒", "\\sqsupseteq", !0);
u(c, p, x, "≐", "\\doteq", !0);
u(c, p, x, "⌢", "\\frown", !0);
u(c, p, x, "∋", "\\ni", !0);
u(c, p, x, "∝", "\\propto", !0);
...
u(c, p, w, "‡", "\\ddag");
u(C, p, w, "‡", "\\ddag");
u(C, p, w, "‡", "\\textdaggerdbl");
u(c, p, Se, "⎱", "\\rmoustache", !0);
u(c, p, Re, "⎰", "\\lmoustache", !0);
u(c, p, Se, "⟯", "\\rgroup", !0);
u(c, p, Re, "⟮", "\\lgroup", !0);
u(c, p, E, "∓", "\\mp", !0);
u(c, p, E, "⊖", "\\ominus", !0);
...
u(c, p, E, "⨿", "\\amalg");
u(c, p, E, "&", "\\And");
u(c, p, x, "⟵", "\\longleftarrow", !0);
u(c, p, x, "⇐", "\\Leftarrow", !0);
u(c, p, x, "⟸", "\\Longleftarrow", !0);
u(c, p, x, "⟶", "\\longrightarrow", !0);
u(c, p, x, "⇒", "\\Rightarrow", !0);
u(c, p, x, "⟹", "\\Longrightarrow", !0);
u(c, p, x, "↔", "\\leftrightarrow", !0);
u(c, p, x, "⟷", "\\longleftrightarrow", !0);
u(c, p, x, "⇔", "\\Leftrightarrow", !0);
u(c, p, x, "⟺", "\\Longleftrightarrow", !0);
u(c, p, x, "↦", "\\mapsto", !0);
u(c, p, x, "⟼", "\\longmapsto", !0);
u(c, p, x, "↗", "\\nearrow", !0);
u(c, p, x, "↩", "\\hookleftarrow", !0);
u(c, p, x, "↪", "\\hookrightarrow", !0);
u(c, p, x, "↘", "\\searrow", !0);
u(c, p, x, "↼", "\\leftharpoonup", !0);
u(c, p, x, "⇀", "\\rightharpoonup", !0);
u(c, p, x, "↙", "\\swarrow", !0);
u(c, p, x, "↽", "\\leftharpoondown", !0);
u(c, p, x, "⇁", "\\rightharpoondown", !0);
u(c, p, x, "↖", "\\nwarrow", !0);
u(c, p, x, "⇌", "\\rightleftharpoons", !0);
u(c, b, x, "≮", "\\nless", !0);
u(c, b, x, "", "\\@nleqslant");
u(c, b, x, "", "\\@nleqq");
u(c, b, x, "⪇", "\\lneq", !0);
...
u(c, b, x, "⋬", "\\ntrianglelefteq", !0);
u(c, b, x, "⊊", "\\subsetneq", !0);
u(c, b, x, "", "\\@varsubsetneq");
u(c, b, x, "⫋", "\\subsetneqq", !0);
u(c, b, x, "", "\\@varsubsetneqq");
u(c, b, x, "≯", "\\ngtr", !0);
u(c, b, x, "", "\\@ngeqslant");
u(c, b, x, "", "\\@ngeqq");
u(c, b, x, "⪈", "\\gneq", !0);
...
u(c, b, x, "⋡", "\\nsucceq", !0);
u(c, b, x, "⋩", "\\succnsim", !0);
u(c, b, x, "⪺", "\\succnapprox", !0);
u(c, b, x, "≆", "\\ncong", !0);
u(c, b, x, "", "\\@nshortparallel");
u(c, b, x, "∦", "\\nparallel", !0);
u(c, b, x, "⊯", "\\nVDash", !0);
u(c, b, x, "⋫", "\\ntriangleright");
u(c, b, x, "⋭", "\\ntrianglerighteq", !0);
u(c, b, x, "", "\\@nsupseteqq");
u(c, b, x, "⊋", "\\supsetneq", !0);
u(c, b, x, "", "\\@varsupsetneq");
u(c, b, x, "⫌", "\\supsetneqq", !0);
u(c, b, x, "", "\\@varsupsetneqq");
u(c, b, x, "⊮", "\\nVdash", !0);
u(c, b, x, "⪵", "\\precneqq", !0);
u(c, b, x, "⪶", "\\succneqq", !0);
u(c, b, x, "", "\\@nsubseteqq");
...
u(c, b, w, "®", "\\circledR");
u(C, b, w, "®", "\\circledR");
u(c, b, w, "∡", "\\measuredangle", !0);
u(c, b, w, "∄", "\\nexists");
u(c, b, w, "℧", "\\mho");
u(c, b, w, "Ⅎ", "\\Finv", !0);
u(c, b, w, "⅁", "\\Game", !0);
u(c, b, w, "‵", "\\backprime");
u(c, b, w, "▲", "\\blacktriangle");
u(c, b, w, "▼", "\\blacktriangledown");
u(c, b, w, "■", "\\blacksquare");
u(c, b, w, "⧫", "\\blacklozenge");
u(c, b, w, "★", "\\bigstar");
u(c, b, w, "∢", "\\sphericalangle", !0);
u(c, b, w, "∁", "\\complement", !0);
u(c, b, w, "ð", "\\eth", !0);
u(C, p, w, "ð", "ð");
u(c, b, w, "╱", "\\diagup");
u(c, b, w, "╲", "\\diagdown");
...
u(c, b, x, "≦", "\\leqq", !0);
u(c, b, x, "⩽", "\\leqslant", !0);
u(c, b, x, "⪕", "\\eqslantless", !0);
u(c, b, x, "≲", "\\lesssim", !0);
u(c, b, x, "⪅", "\\lessapprox", !0);
u(c, b, x, "≊", "\\approxeq", !0);
u(c, b, E, "⋖", "\\lessdot");
u(c, b, x, "⋘", "\\lll", !0);
u(c, b, x, "≶", "\\lessgtr", !0);
u(c, b, x, "⋚", "\\lesseqgtr", !0);
u(c, b, x, "⪋", "\\lesseqqgtr", !0);
u(c, b, x, "≑", "\\doteqdot");
u(c, b, x, "≓", "\\risingdotseq", !0);
u(c, b, x, "≒", "\\fallingdotseq", !0);
u(c, b, x, "∽", "\\backsim", !0);
u(c, b, x, "⋍", "\\backsimeq", !0);
u(c, b, x, "⫅", "\\subseteqq", !0);
u(c, b, x, "⋐", "\\Subset", !0);
u(c, b, x, "⊏", "\\sqsubset", !0);
u(c, b, x, "≼", "\\preccurlyeq", !0);
u(c, b, x, "⋞", "\\curlyeqprec", !0);
u(c, b, x, "≾", "\\precsim", !0);
u(c, b, x, "⪷", "\\precapprox", !0);
u(c, b, x, "⊲", "\\vartriangleleft");
u(c, b, x, "⊴", "\\trianglelefteq");
u(c, b, x, "⊨", "\\vDash", !0);
u(c, b, x, "⊪", "\\Vvdash", !0);
u(c, b, x, "⌣", "\\smallsmile");
u(c, b, x, "⌢", "\\smallfrown");
...
u(c, b, x, "⋑", "\\Supset", !0);
u(c, b, x, "⊐", "\\sqsupset", !0);
u(c, b, x, "≽", "\\succcurlyeq", !0);
u(c, b, x, "⋟", "\\curlyeqsucc", !0);
u(c, b, x, "≿", "\\succsim", !0);
u(c, b, x, "⪸", "\\succapprox", !0);
u(c, b, x, "⊳", "\\vartriangleright");
u(c, b, x, "⊵", "\\trianglerighteq");
u(c, b, x, "⊩", "\\Vdash", !0);
u(c, b, x, "∣", "\\shortmid");
u(c, b, x, "∥", "\\shortparallel");
u(c, b, x, "≬", "\\between", !0);
u(c, b, x, "⋔", "\\pitchfork", !0);
u(c, b, x, "∝", "\\varpropto");
u(c, b, x, "◀", "\\blacktriangleleft");
u(c, b, x, "∴", "\\therefore", !0);
u(c, b, x, "∍", "\\backepsilon");
u(c, b, x, "▶", "\\blacktriangleright");
u(c, b, x, "∵", "\\because", !0);
u(c, b, x, "⋘", "\\llless");
u(c, b, x, "⋙", "\\gggtr");
u(c, b, E, "⊲", "\\lhd");
...
u(c, b, x, "≑", "\\Doteq", !0);
u(c, b, E, "∔", "\\dotplus", !0);
u(c, b, E, "∖", "\\smallsetminus");
u(c, b, E, "⋒", "\\Cap", !0);
u(c, b, E, "⋓", "\\Cup", !0);
u(c, b, E, "⩞", "\\doublebarwedge", !0);
u(c, b, E, "⊟", "\\boxminus", !0);
u(c, b, E, "⊞", "\\boxplus", !0);
u(c, b, E, "⋇", "\\divideontimes", !0);
u(c, b, E, "⋉", "\\ltimes", !0);
u(c, b, E, "⋊", "\\rtimes", !0);
u(c, b, E, "⋋", "\\leftthreetimes", !0);
u(c, b, E, "⋌", "\\rightthreetimes", !0);
u(c, b, E, "⋏", "\\curlywedge", !0);
u(c, b, E, "⋎", "\\curlyvee", !0);
u(c, b, E, "⊝", "\\circleddash", !0);
u(c, b, E, "⊛", "\\circledast", !0);
u(c, b, E, "⋅", "\\centerdot");
u(c, b, E, "⊺", "\\intercal", !0);
u(c, b, E, "⋒", "\\doublecap");
u(c, b, E, "⋓", "\\doublecup");
u(c, b, E, "⊠", "\\boxtimes", !0);
u(c, b, x, "⇢", "\\dashrightarrow", !0);
u(c, b, x, "⇠", "\\dashleftarrow", !0);
u(c, b, x, "⇇", "\\leftleftarrows", !0);
u(c, b, x, "⇆", "\\leftrightarrows", !0);
u(c, b, x, "⇚", "\\Lleftarrow", !0);
u(c, b, x, "↞", "\\twoheadleftarrow", !0);
u(c, b, x, "↢", "\\leftarrowtail", !0);
u(c, b, x, "↫", "\\looparrowleft", !0);
u(c, b, x, "⇋", "\\leftrightharpoons", !0);
u(c, b, x, "↶", "\\curvearrowleft", !0);
u(c, b, x, "↺", "\\circlearrowleft", !0);
u(c, b, x, "↰", "\\Lsh", !0);
u(c, b, x, "⇈", "\\upuparrows", !0);
u(c, b, x, "↿", "\\upharpoonleft", !0);
u(c, b, x, "⇃", "\\downharpoonleft", !0);
u(c, p, x, "⊶", "\\origof", !0);
u(c, p, x, "⊷", "\\imageof", !0);
u(c, b, x, "⊸", "\\multimap", !0);
u(c, b, x, "↭", "\\leftrightsquigarrow", !0);
u(c, b, x, "⇉", "\\rightrightarrows", !0);
u(c, b, x, "⇄", "\\rightleftarrows", !0);
u(c, b, x, "↠", "\\twoheadrightarrow", !0);
u(c, b, x, "↣", "\\rightarrowtail", !0);
u(c, b, x, "↬", "\\looparrowright", !0);
u(c, b, x, "↷", "\\curvearrowright", !0);
u(c, b, x, "↻", "\\circlearrowright", !0);
u(c, b, x, "↱", "\\Rsh", !0);
u(c, b, x, "⇊", "\\downdownarrows", !0);
u(c, b, x, "↾", "\\upharpoonright", !0);
u(c, b, x, "⇂", "\\downharpoonright", !0);
u(c, b, x, "⇝", "\\rightsquigarrow", !0);
u(c, b, x, "⇝", "\\leadsto");
u(c, b, x, "⇛", "\\Rrightarrow", !0);
u(c, b, x, "↾", "\\restriction");
u(c, p, w, "‘", "`");
u(c, p, w, "$", "\\$");
u(C, p, w, "$", "\\$");
...
u(c, p, P, "ψ", "\\psi", !0);
u(c, p, P, "ω", "\\omega", !0);
u(c, p, P, "ε", "\\varepsilon", !0);
u(c, p, P, "ϑ", "\\vartheta", !0);
u(c, p, P, "ϖ", "\\varpi", !0);
u(c, p, P, "ϱ", "\\varrho", !0);
u(c, p, P, "ς", "\\varsigma", !0);
u(c, p, P, "φ", "\\varphi", !0);
u(c, p, E, "∗", "*", !0);
u(c, p, E, "+", "+");
u(c, p, E, "−", "-", !0);
...
u(c, p, w, "∂", "\\partial", !0);
u(c, p, E, "⊘", "\\oslash", !0);
u(c, b, E, "⊚", "\\circledcirc", !0);
u(c, b, E, "⊡", "\\boxdot", !0);
u(c, p, E, "△", "\\bigtriangleup");
u(c, p, E, "▽", "\\bigtriangledown");
u(c, p, E, "†", "\\dagger");
u(c, p, E, "⋄", "\\diamond");
u(c, p, E, "⋆", "\\star");
u(c, p, E, "◃", "\\triangleleft");
u(c, p, E, "▹", "\\triangleright");
u(c, p, Re, "{", "\\{");
u(C, p, w, "{", "\\{");
u(C, p, w, "{", "\\textbraceleft");
u(c, p, Se, "}", "\\}");
u(C, p, w, "}", "\\}");
u(C, p, w, "}", "\\textbraceright");
u(c, p, Re, "{", "\\lbrace");
u(c, p, Se, "}", "\\rbrace");
u(c, p, Re, "[", "\\lbrack", !0);
u(C, p, w, "[", "\\lbrack", !0);
...
u(c, p, w, "∥", "\\Vert");
u(C, p, w, "∥", "\\textbardbl");
u(C, p, w, "~", "\\textasciitilde");
u(C, p, w, "\\", "\\textbackslash");
u(C, p, w, "^", "\\textasciicircum");
u(c, p, x, "↑", "\\uparrow", !0);
u(c, p, x, "⇑", "\\Uparrow", !0);
u(c, p, x, "↓", "\\downarrow", !0);
u(c, p, x, "⇓", "\\Downarrow", !0);
u(c, p, x, "↕", "\\updownarrow", !0);
u(c, p, x, "⇕", "\\Updownarrow", !0);
u(c, p, he, "∐", "\\coprod");
u(c, p, he, "⋁", "\\bigvee");
u(c, p, he, "⋀", "\\bigwedge");
...
u(c, p, he, "⨆", "\\bigsqcup");
u(c, p, he, "∫", "\\smallint");
u(C, p, mr, "…", "\\textellipsis");
u(c, p, mr, "…", "\\mathellipsis");
u(C, p, mr, "…", "\\ldots", !0);
u(c, p, mr, "…", "\\ldots", !0);
u(c, p, mr, "⋯", "\\@cdots", !0);
u(c, p, mr, "⋱", "\\ddots", !0);
...
u(C, p, w, "—", "\\textemdash");
u(C, p, w, "‘", "`", !0);
u(C, p, w, "‘", "\\textquoteleft");
u(C, p, w, "’", "'", !0);
u(C, p, w, "’", "\\textquoteright");
u(C, p, w, "“", "``", !0);
u(C, p, w, "“", "\\textquotedblleft");
u(C, p, w, "”", "''", !0);
u(C, p, w, "”", "\\textquotedblright");
u(c, p, w, "°", "\\degree", !0);
u(C, p, w, "°", "\\degree");
u(C, p, w, "°", "\\textdegree", !0);
u(c, p, w, "£", "\\pounds");
u(c, p, w, "£", "\\mathsterling", !0);
u(C, p, w, "£", "\\pounds");
u(C, p, w, "£", "\\textsterling", !0);
u(c, b, w, "✠", "\\maltese");
u(C, b, w, "✠", "\\maltese");
var Fs = '0123456789/@."';
for (var sn = 0; sn < Fs.length; sn++) {
  var Ps = Fs.charAt(sn);
  u(c, p, w, Ps, Ps);
}
var qs = '0123456789!@*()-=+";:?/.,';
for (var an = 0; an < qs.length; an++) {
  var Ls = qs.charAt(an);
  u(C, p, w, Ls, Ls);
}
var k0 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
for (var ln = 0; ln < k0.length; ln++) {
  var Qr = k0.charAt(ln);
  u(c, p, P, Qr, Qr), u(C, p, w, Qr, Qr);
}
u(c, b, w, "C", "ℂ");
u(C, b, w, "C", "ℂ");
u(c, b, w, "H", "ℍ");
...
u(C, p, P, "h", "ℎ");
var V = "";
for (var ve = 0; ve < k0.length; ve++) {
  var ne = k0.charAt(ve);
  (V = String.fromCharCode(55349, 56320 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56372 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56424 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56580 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56684 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56736 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56788 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56840 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    (V = String.fromCharCode(55349, 56944 + ve)),
    u(c, p, P, ne, V),
    u(C, p, w, ne, V),
    ve < 26 &&
      ((V = String.fromCharCode(55349, 56632 + ve)),
      u(c, p, P, ne, V),
      u(C, p, w, ne, V),
      (V = String.fromCharCode(55349, 56476 + ve)),
      u(c, p, P, ne, V),
      u(C, p, w, ne, V));
}
V = "𝕜";
...
for (var Pt = 0; Pt < 10; Pt++) {
  var xt = Pt.toString();
  (V = String.fromCharCode(55349, 57294 + Pt)),
    u(c, p, P, xt, V),
    u(C, p, w, xt, V),
    (V = String.fromCharCode(55349, 57314 + Pt)),
    u(c, p, P, xt, V),
    u(C, p, w, xt, V),
    (V = String.fromCharCode(55349, 57324 + Pt)),
    u(c, p, P, xt, V),
    u(C, p, w, xt, V),
    (V = String.fromCharCode(55349, 57334 + Pt)),
    u(c, p, P, xt, V),
    u(C, p, w, xt, V);
}
var Pn = "ÐÞþ";
for (var on = 0; on < Pn.length; on++) {
  var _r = Pn.charAt(on);
  u(c, p, P, _r, _r), u(C, p, w, _r, _r);
}
var e0 = [
  ...
  Qc = function (e, t) {
    ...
    if (119808 <= s && s < 120484) {
      ...
      return [e0[l][2], e0[l][a]];
    } else if (120782 <= s && s <= 120831) {
      var o = Math.floor((s - 120782) / 10);
      return [Vs[o][2], Vs[o][a]];
    } else {
      if (s === 120485 || s === 120486) return [e0[0][2], e0[0][a]];
  ...
  B0 = function (e, t, r) {
    return (
      _[r][e] && _[r][e].replace && (e = _[r][e].replace),
      { value: e, metrics: li(e, t, r) }
    );
  },
  Je = function (e, t, r, i, s) {
    ...
    if (l) {
      var h = l.italic;
      (r === "text" || (i && i.font === "mathit")) && (h = 0),
        (o = new He(e, l.height, l.depth, h, l.skew, l.width, s));
    } else
      typeof console < "u" &&
        console.warn(
  ...
  _c = function (e, t, r, i) {
    return (
      i === void 0 && (i = []),
      r.font === "boldsymbol" && B0(e, "Main-Bold", t).metrics
        ? Je(e, "Main-Bold", t, r, i.concat(["mathbf"]))
        : e === "\\" || _[t][e].font === "main"
          ? Je(e, "Main-Regular", t, r, i)
          : Je(e, "AMS-Regular", t, r, i.concat(["amsrm"]))
    );
  },
  ed = function (e, t, r, i, s) {
    return s !== "textord" && B0(e, "Math-BoldItalic", t).metrics
  ...
  td = function (e, t, r) {
    var i = e.mode,
      s = e.text,
      a = ["mord"],
      l = i === "math" || (i === "text" && t.font),
      o = l ? t.font : t.fontFamily,
      h = "",
      d = "";
    if ((s.charCodeAt(0) === 55349 && ([h, d] = Qc(s, i)), h.length > 0))
      return Je(s, h, i, t, a.concat(d));
    if (o) {
      var f, g;
      if (o === "boldsymbol") {
        var y = ed(s, i, t, a, r);
        (f = y.fontName), (g = [y.fontClass]);
      } else
        l
          ? ((f = Ul[o].fontName), (g = [o]))
          : ((f = t0(o, t.fontWeight, t.fontShape)),
            (g = [o, t.fontWeight, t.fontShape]));
      if (B0(s, f, i).metrics) return Je(s, f, i, t, a.concat(g));
      if (Gl.hasOwnProperty(s) && f.slice(0, 10) === "Typewriter") {
        for (var v = [], k = 0; k < s.length; k++)
          v.push(Je(s[k], f, i, t, a.concat(g)));
        return $l(v);
      }
    }
    if (r === "mathord")
      return Je(s, "Math-Italic", i, t, a.concat(["mathnormal"]));
    if (r === "textord") {
      var M = _[i][s] && _[i][s].font;
      if (M === "ams") {
        var T = t0("amsrm", t.fontWeight, t.fontShape);
        return Je(s, T, i, t, a.concat("amsrm", t.fontWeight, t.fontShape));
      } else if (M === "main" || !M) {
        var R = t0("textrm", t.fontWeight, t.fontShape);
        return Je(s, R, i, t, a.concat(t.fontWeight, t.fontShape));
      } else {
        var L = t0(M, t.fontWeight, t.fontShape);
        return Je(s, L, i, t, a.concat(L, t.fontWeight, t.fontShape));
      }
    } else throw new Error("unexpected type: " + r + " in makeOrd");
  },
  rd = (n, e) => {
    if (
      Ot(n.classes) !== Ot(e.classes) ||
      n.skew !== e.skew ||
      n.maxFontSize !== e.maxFontSize
    )
      return !1;
    ...
    for (var r in n.style)
      if (n.style.hasOwnProperty(r) && n.style[r] !== e.style[r]) return !1;
    for (var i in e.style)
      if (e.style.hasOwnProperty(i) && n.style[i] !== e.style[i]) return !1;
    return !0;
  },
  nd = (n) => {
  ...
  hi = function (e) {
    for (var t = 0, r = 0, i = 0, s = 0; s < e.children.length; s++) {
      ...
      a.height > t && (t = a.height),
        a.depth > r && (r = a.depth),
        a.maxFontSize > i && (i = a.maxFontSize);
    }
    (e.height = t), (e.depth = r), (e.maxFontSize = i);
  },
  Te = function (e, t, r, i) {
    var s = new Wr(e, t, r, i);
    return hi(s), s;
  },
  Jl = (n, e, t, r) => new Wr(n, e, t, r),
  id = function (e, t, r) {
    var i = Te([e], [], t);
    return (
      (i.height = Math.max(
      ...
      (i.style.borderBottomWidth = D(i.height)),
      (i.maxFontSize = 1),
      i
    );
  },
  sd = function (e, t, r, i) {
    var s = new oi(e, t, r, i);
    return hi(s), s;
  },
  $l = function (e) {
    var t = new Hr(e);
  ...
  ad = function (e, t) {
    return e instanceof Hr ? Te([], [e], t) : e;
  },
  ld = function (e) {
    if (e.positionType === "individualShift") {
      for (
        var t = e.children,
          r = [t[0]],
          i = -t[0].shift - t[0].elem.depth,
          s = i,
          a = 1;
        a < t.length;
        a++
      ) {
        var l = -t[a].shift - s - t[a].elem.depth,
          o = l - (t[a - 1].elem.height + t[a - 1].elem.depth);
        (s = s + l), r.push({ type: "kern", size: o }), r.push(t[a]);
      }
    ...
    if (e.positionType === "top") {
      ...
      h = d;
    } else if (e.positionType === "bottom") h = -e.positionData;
    else {
      var y = e.children[0];
      if (y.type !== "elem")
        throw new Error('First child must have type "elem".');
      if (e.positionType === "shift") h = -y.elem.depth - e.positionData;
      else if (e.positionType === "firstBaseline") h = -y.elem.depth;
      else throw new Error("Invalid positionType " + e.positionType + ".");
    }
    return { children: e.children, depth: h };
  },
  od = function (e, t) {
    for (
      var { children: r, depth: i } = ld(e), s = 0, a = 0;
      a < r.length;
      a++
    ) {
      var l = r[a];
    ...
    var h = Te(["pstrut"], []);
    h.style.height = D(s);
    for (var d = [], f = i, g = i, y = i, v = 0; v < r.length; v++) {
      var k = r[v];
      if (k.type === "kern") y += k.size;
        ...
        var M = k.elem,
          ...
          R = k.wrapperStyle || {},
          L = Te(T, [h, M], void 0, R);
        (L.style.top = D(-s - y - M.depth)),
          k.marginLeft && (L.style.marginLeft = k.marginLeft),
          k.marginRight && (L.style.marginRight = k.marginRight),
          d.push(L),
          (y += M.height + M.depth);
      }
      (f = Math.min(f, y)), (g = Math.max(g, y));
    }
    var $ = Te(["vlist"], d);
    $.style.height = D(g);
    var H;
    if (f < 0) {
      var G = Te([], []),
        U = Te(["vlist"], [G]);
      U.style.height = D(-f);
      var Z = Te(["vlist-s"], [new He("​")]);
      H = [Te(["vlist-r"], [$, Z]), Te(["vlist-r"], [U])];
    } else H = [Te(["vlist-r"], [$])];
    var I = Te(["vlist-t"], H);
    return (
      H.length === 2 && I.classes.push("vlist-t2"),
      (I.height = g),
      (I.depth = -f),
      I
    );
  ...
  ud = function (e, t) {
    var [r, i, s] = Kl[e],
      ...
      o = Jl(["overlay"], [l], t);
    return (o.height = s), (o.style.height = D(s)), (o.style.width = D(i)), o;
  },
  S = {
    fontMap: Ul,
    makeSymbol: Je,
  ...
  st = { number: 5, unit: "mu" },
  cd = {
    mord: { mop: te, mbin: qt, mrel: st, minner: te },
    mop: { mord: te, mop: te, mrel: st, minner: te },
    mbin: { mord: qt, mop: qt, mopen: qt, minner: qt },
    mrel: { mord: st, mop: st, mopen: st, minner: st },
    mopen: {},
    mclose: { mop: te, mbin: qt, mrel: st, minner: te },
    mpunct: {
      mord: te,
      mop: te,
      mrel: st,
...
function jt(n) {
  var { type: e, htmlBuilder: t, mathmlBuilder: r } = n;
  O({
    type: e,
    names: [],
    props: { numArgs: 0 },
...
var T0 = function (e) {
  ...
  ft = S.makeSpan,
  fd = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
  pd = ["rightmost", "mrel", "mclose", "mpunct"],
  md = {
    display: q.DISPLAY,
    text: q.TEXT,
    script: q.SCRIPT,
  ...
  ce = function (e, t, r, i) {
    ...
    if ((S.tryCombineChars(s), !r)) return s;
    var h = t;
    if (e.length === 1) {
      var d = e[0];
      d.type === "sizing"
        ? (h = t.havingSize(d.size))
        : d.type === "styling" && (h = t.havingStyle(md[d.style]));
    }
    var f = ft([i[0] || "leftmost"], [], t),
      g = ft([i[1] || "rightmost"], [], t),
      y = r === "root";
    return (
      Hs(
        s,
        (v, k) => {
          var M = k.classes[0],
            T = v.classes[0];
          M === "mbin" && F.contains(pd, T)
            ? (k.classes[0] = "mord")
            : T === "mbin" && F.contains(fd, M) && (v.classes[0] = "mord");
        },
        { node: f },
        g,
        y,
      ...
      Hs(
        ...
        (v, k) => {
          var M = qn(k),
            T = qn(v),
            R = M && T ? (v.hasClass("mtight") ? dd[M][T] : cd[M][T]) : null;
          if (R) return S.makeGlue(R, h);
        },
        { node: f },
        g,
        y,
  ...
  Hs = function n(e, t, r, i, s) {
    ...
    for (var a = 0; a < e.length; a++) {
      ...
      if (h) {
        var d = t(l, r.node);
        d && (r.insertAfter ? r.insertAfter(d) : (e.unshift(d), a++));
      }
      h
        ? (r.node = l)
        : s && l.hasClass("newline") && (r.node = ft(["leftmost"])),
        (r.insertAfter = ((f) => (g) => {
          e.splice(f + 1, 0, g), a++;
        })(a));
    }
  ...
  jl = function (e) {
    return e instanceof Hr ||
      e instanceof oi ||
      (e instanceof Wr && e.hasClass("enclosing"))
      ? e
      : null;
  },
  yd = function n(e, t) {
    ...
    if (r) {
      var i = r.children;
      if (i.length) {
        if (t === "right") return n(i[i.length - 1], "right");
        if (t === "left") return n(i[0], "left");
      }
    }
    return e;
  },
  qn = function (e, t) {
    return e ? (t && (e = yd(e, t)), gd[e.classes[0]] || null) : null;
  },
  Pr = function (e, t) {
  ...
  Y = function (e, t, r) {
    ...
    if (S0[e.type]) {
      var i = S0[e.type](e, t);
      if (r && t.size !== r.size) {
        i = ft(t.sizingClasses(r), [i], t);
        var s = t.sizeMultiplier / r.sizeMultiplier;
        (i.height *= s), (i.depth *= s);
      }
      return i;
    } else throw new N("Got group of unknown type: '" + e.type + "'");
  };
function r0(n, e) {
  var t = ft(["base"], n, e),
    r = ft(["strut"]);
  return (
    (r.style.height = D(t.height + t.depth)),
    t.depth && (r.style.verticalAlign = D(-t.depth)),
...
function Ln(n, e) {
  ...
  for (var s = [], a = [], l = 0; l < r.length; l++)
    if (
      (a.push(r[l]),
      r[l].hasClass("mbin") ||
        r[l].hasClass("mrel") ||
        r[l].hasClass("allowbreak"))
    ) {
      for (
        var o = !1;
        l < r.length - 1 &&
        r[l + 1].hasClass("mspace") &&
        !r[l + 1].hasClass("newline");

      )
        l++, a.push(r[l]), r[l].hasClass("nobreak") && (o = !0);
      o || (s.push(r0(a, e)), (a = []));
    } else
      r[l].hasClass("newline") &&
        (a.pop(), a.length > 0 && (s.push(r0(a, e)), (a = [])), s.push(r[l]));
  a.length > 0 && s.push(r0(a, e));
  var h;
  t
    ? ((h = r0(ce(t, e, !0))), (h.classes = ["tag"]), s.push(h))
    : i && s.push(i);
  var d = ft(["katex-html"], s);
  if ((d.setAttribute("aria-hidden", "true"), h)) {
    var f = h.children[0];
    (f.style.height = D(d.height + d.depth)),
      d.depth && (f.style.verticalAlign = D(-d.depth));
  }
  return d;
}
function Xl(n) {
...
class Oe {
  ...
  toNode() {
    ...
    this.classes.length > 0 && (e.className = Ot(this.classes));
    for (var r = 0; r < this.children.length; r++)
      if (
        this.children[r] instanceof Ze &&
        this.children[r + 1] instanceof Ze
      ) {
        for (
  ...
  toMarkup() {
    ...
    for (var t in this.attributes)
      Object.prototype.hasOwnProperty.call(this.attributes, t) &&
        ...
        (e += '"'));
    this.classes.length > 0 &&
      (e += ' class ="' + F.escape(Ot(this.classes)) + '"'),
      (e += ">");
    for (var r = 0; r < this.children.length; r++)
      e += this.children[r].toMarkup();
...
var A = { MathNode: Oe, TextNode: Ze, SpaceNode: vd, newDocumentFragment: Xl },
  We = function (e, t, r) {
    return (
      _[t][e] &&
        _[t][e].replace &&
  ...
  ci = function (e, t) {
    ...
    var s = e.text;
    if (F.contains(["\\imath", "\\jmath"], s)) return null;
    _[i][s] && _[i][s].replace && (s = _[i][s].replace);
    var a = S.fontMap[r].fontName;
    return li(s, a, i) ? S.fontMap[r].variant : null;
  };
function hn(n) {
  if (!n) return !1;
  if (n.type === "mi" && n.children.length === 1) {
    var e = n.children[0];
    return e instanceof Ze && e.text === ".";
  } else if (
    n.type === "mo" &&
    n.children.length === 1 &&
    n.getAttribute("separator") === "true" &&
    n.getAttribute("lspace") === "0em" &&
    n.getAttribute("rspace") === "0em"
  ) {
    var t = n.children[0];
    return t instanceof Ze && t.text === ",";
  } else return !1;
}
var Ae = function (e, t, r) {
    ...
    for (var s = [], a, l = 0; l < e.length; l++) {
      var o = Q(e[l], t);
      if (o instanceof Oe && a instanceof Oe) {
        if (
          o.type === "mtext" &&
          a.type === "mtext" &&
          ...
          continue;
        } else if (o.type === "mn" && a.type === "mn") {
          a.children.push(...o.children);
          continue;
        } else if (hn(o) && a.type === "mn") {
          a.children.push(...o.children);
          continue;
        } else if (o.type === "mn" && hn(a))
          (o.children = [...a.children, ...o.children]), s.pop();
        else if (
          ...
          h instanceof Oe &&
            h.type === "mn" &&
            ((h.children = [...a.children, ...h.children]), s.pop());
          ...
          if (
            ...
            f instanceof Ze &&
              f.text.length > 0 &&
              ((f.text = f.text.slice(0, 1) + "̸" + f.text.slice(1)), s.pop());
          }
        }
      }
      s.push(o), (a = o);
...
function Ws(n, e, t, r, i) {
  ...
  s.length === 1 &&
  s[0] instanceof Oe &&
  F.contains(["mrow", "mtable"], s[0].type)
    ? (a = s[0])
    : (a = new A.MathNode("mrow", s));
  var l = new A.MathNode("annotation", [new A.TextNode(e)]);
  l.setAttribute("encoding", "application/x-tex");
  var o = new A.MathNode("semantics", [a, l]),
    h = new A.MathNode("math", [o]);
  h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"),
    r && h.setAttribute("display", "block");
  var d = i ? "katex" : "katex-mathml";
  return S.makeSpan([d], [h]);
}
var Zl = function (e) {
    return new ot({
  ...
  bd = function (e, t, r) {
    var i = Zl(r),
      s;
    if (r.output === "mathml") return Ws(e, t, i, r.displayMode, !0);
    if (r.output === "html") {
      var a = Ln(e, i);
      s = S.makeSpan(["katex"], [a]);
    } else {
      var l = Ws(e, t, i, r.displayMode, !1),
        o = Ln(e, i);
      s = S.makeSpan(["katex"], [l, o]);
    }
    return Ql(s, r);
  },
  xd = function (e, t, r) {
  ...
  kd = function (e) {
    var t = new A.MathNode("mo", [new A.TextNode(wd[e.replace(/^\\/, "")])]);
  ...
  Td = function (e, t) {
    function r() {
      var l = 4e5,
        o = e.label.slice(1);
      if (F.contains(["widehat", "widecheck", "widetilde", "utilde"], o)) {
        var h = e,
          d = Md(h.base),
          f,
          g,
          y;
        if (d > 5)
          o === "widehat" || o === "widecheck"
            ? ((f = 420), (l = 2364), (y = 0.42), (g = o + "4"))
            : ((f = 312), (l = 2340), (y = 0.34), (g = "tilde4"));
        else {
          var v = [1, 1, 2, 2, 3, 3][d];
          o === "widehat" || o === "widecheck"
            ? ((l = [0, 1062, 2364, 2364, 2364][v]),
              (f = [0, 239, 300, 360, 420][v]),
              (y = [0, 0.24, 0.3, 0.3, 0.36, 0.42][v]),
              (g = o + v))
            : ((l = [0, 600, 1033, 2339, 2340][v]),
              (f = [0, 260, 286, 306, 312][v]),
        ...
        return { span: S.makeSvgSpan([], [M], t), minWidth: 0, height: y };
      } else {
        var T = [],
          R = Sd[o],
          [L, $, H] = R,
        ...
        for (var le = 0; le < U; le++) {
          var se = new Et(L[le]),
            Ft = new dt([se], {
              ...
              height: D(G),
              viewBox: "0 0 " + l + " " + H,
              preserveAspectRatio: I[le] + " slice",
            }),
            Me = S.makeSvgSpan([Z[le]], [Ft], t);
          if (U === 1) return { span: Me, minWidth: $, height: G };
          (Me.style.height = D(G)), T.push(Me);
        }
        return { span: S.makeSpan(["stretchy"], T, t), minWidth: $, height: G };
      }
    }
    var { span: i, minWidth: s, height: a } = r();
    return (
      (i.height = a),
      (i.style.height = D(a)),
      s > 0 && (i.style.minWidth = D(s)),
      i
    );
  },
  Cd = function (e, t, r, i, s) {
    var a,
      l = e.height + e.depth + r + i;
    if (/fbox|color|angl/.test(t)) {
      if (((a = S.makeSpan(["stretchy", t], [], s)), t === "fbox")) {
      ...
      var d = new dt(h, { width: "100%", height: D(l) });
      a = S.makeSvgSpan([], [d], s);
    }
    return (a.height = l), (a.style.height = D(l)), a;
  },
  pt = { encloseSpan: Cd, mathMLnode: kd, svgSpan: Td };
function J(n, e) {
  if (!n || n.type !== e)
    throw new Error(
      "Expected node of type " +
        e +
        ", but got " +
        (n ? "node of type " + n.type : String(n)),
    );
  return n;
}
function di(n) {
...
function R0(n) {
  return n && (n.type === "atom" || Zc.hasOwnProperty(n.type)) ? n : null;
}
var fi = (n, e) => {
    var t, r, i;
    n && n.type === "supsub"
      ? ((r = J(n.base, "accent")),
        ...
        (i = jc(Y(n, e))),
        (n.base = r))
      : ((r = J(n, "accent")), (t = r.base));
    var s = Y(t, e.havingCrampedStyle()),
      a = r.isShifty && F.isCharacterBox(t),
      l = 0;
    if (a) {
      var o = F.getBaseElem(t),
        h = Y(o, e.havingCrampedStyle());
      l = Is(h).skew;
    }
    var d = r.label === "\\c",
      f = d ? s.height + s.depth : Math.min(s.height, e.fontMetrics().xHeight),
      g;
    if (r.isStretchy)
      (g = pt.svgSpan(r, e)),
        (g = S.makeVList(
      ...
      k && (g.classes.push("accent-full"), (f = s.height));
      var M = l;
      k || (M -= v / 2),
        (g.style.left = D(M)),
    ...
    var T = S.makeSpan(["mord", "accent"], [g], e);
    return i
      ? ((i.children[0] = T),
        (i.height = Math.max(T.height, i.height)),
        (i.classes[0] = "mord"),
        i)
      : T;
  },
  _l = (n, e) => {
    var t = n.isStretchy
        ? pt.mathMLnode(n.label)
        : new A.MathNode("mo", [We(n.label, n.mode)]),
      r = new A.MathNode("mover", [Q(n.base, e), t]);
...
O({
  ...
  handler: (n, e) => {
    var t = T0(e[0]),
      r = !Ad.test(n.funcName),
      i =
        !r ||
        n.funcName === "\\widehat" ||
        n.funcName === "\\widetilde" ||
        n.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: n.parser.mode,
      label: n.funcName,
...
O({
  ...
  handler: (n, e) => {
    ...
    return (
      r === "math" &&
        (n.parser.settings.reportNonstrict(
          "mathVsTextAccents",
          "LaTeX's accent " + n.funcName + " works only in text mode",
        ),
        (r = "text")),
      {
        type: "accent",
...
O({
  ...
  props: { numArgs: 1 },
  handler: (n, e) => {
    var { parser: t, funcName: r } = n,
      i = e[0];
    return { type: "accentUnder", mode: t.mode, label: r, base: i };
  },
  htmlBuilder: (n, e) => {
    var t = Y(n.base, e),
      r = pt.svgSpan(n, e),
      i = n.label === "\\utilde" ? 0.12 : 0,
      s = S.makeVList(
        {
          positionType: "top",
  ...
  mathmlBuilder: (n, e) => {
    var t = pt.mathMLnode(n.label),
      r = new A.MathNode("munder", [Q(n.base, e), t]);
    return r.setAttribute("accentunder", "true"), r;
  },
});
var n0 = (n) => {
  var e = new A.MathNode("mpadded", n ? [n] : []);
  return (
...
O({
  ...
  handler(n, e, t) {
    var { parser: r, funcName: i } = n;
    return { type: "xArrow", mode: r.mode, label: i, body: e[0], below: t[0] };
  },
  htmlBuilder(n, e) {
    var t = e.style,
      r = e.havingStyle(t.sup()),
      i = S.wrapFragment(Y(n.body, r, e), e),
      s = n.label.slice(0, 2) === "\\x" ? "x" : "cd";
    i.classes.push(s + "-arrow-pad");
    var a;
    n.below &&
      ((r = e.havingStyle(t.sub())),
      (a = S.wrapFragment(Y(n.below, r, e), e)),
      a.classes.push(s + "-arrow-pad"));
    var l = pt.svgSpan(n, e),
      o = -e.fontMetrics().axisHeight + 0.5 * l.height,
      h = -e.fontMetrics().axisHeight - 0.5 * l.height - 0.111;
    (i.depth > 0.25 || n.label === "\\xleftequilibrium") && (h -= i.depth);
    var d;
    if (a) {
      var f = -e.fontMetrics().axisHeight + a.height + 0.5 * l.height + 0.111;
      d = S.makeVList(
        {
  ...
  mathmlBuilder(n, e) {
    ...
    if (n.body) {
      var i = n0(Q(n.body, e));
      if (n.below) {
        var s = n0(Q(n.below, e));
        r = new A.MathNode("munderover", [t, s, i]);
      } else r = new A.MathNode("mover", [t, i]);
    } else if (n.below) {
      var a = n0(Q(n.below, e));
      r = new A.MathNode("munder", [t, a]);
    } else (r = n0()), (r = new A.MathNode("mover", [t, r]));
    return r;
  },
});
var Nd = S.makeSpan;
        ...
        : (n.isCharacterBox
          ...
          n.mclass === "mbin"
            ...
            : n.mclass === "mpunct"
              ...
              : n.mclass === "mopen" || n.mclass === "mclose"
...
O({
  ...
  handler(n, e) {
    ...
    return {
      ...
      mclass: "m" + r.slice(5),
      body: ae(i),
      isCharacterBox: F.isCharacterBox(i),
    };
  },
  htmlBuilder: eo,
  mathmlBuilder: to,
...
O({
  ...
  handler(n, e) {
    ...
    return {
      ...
      mclass: I0(e[0]),
      body: ae(e[1]),
      isCharacterBox: F.isCharacterBox(e[1]),
    };
  },
});
O({
  ...
  handler(n, e) {
    ...
    return {
      ...
      mclass: a,
      body: [o],
      isCharacterBox: F.isCharacterBox(o),
    };
  },
  htmlBuilder: eo,
  mathmlBuilder: to,
...
O({
  ...
  handler(n, e) {
    var { parser: t } = n;
    return { type: "pmb", mode: t.mode, mclass: I0(e[0]), body: ae(e[0]) };
  },
  htmlBuilder(n, e) {
    var t = ce(n.body, e, !0),
      r = S.makeSpan([n.mclass], t, e);
...
var zd = {
  ...
  Gs = () => ({ type: "styling", body: [], mode: "math", style: "display" }),
  Js = (n) => n.type === "textord" && n.text === "@",
  Dd = (n, e) => (n.type === "mathord" || n.type === "atom") && n.text === e;
function Od(n, e, t) {
  var r = zd[n];
  switch (r) {
    case "\\\\cdrightarrow":
    ...
    case "\\uparrow":
    case "\\downarrow": {
      var i = t.callFunction("\\\\cdleft", [e[0]], []),
        s = { type: "atom", text: r, mode: "math", family: "rel" },
        a = t.callFunction("\\Big", [s], []),
        l = t.callFunction("\\\\cdright", [e[1]], []),
        o = { type: "ordgroup", mode: "math", body: [i, a, l] };
...
function Ed(n) {
  ...
  for (
    n.gullet.beginGroup(),
      n.gullet.macros.set("\\cr", "\\\\\\relax"),
      n.gullet.beginGroup();
    ;

  ) {
    e.push(n.parseExpression(!1, "\\\\")),
      n.gullet.endGroup(),
      n.gullet.beginGroup();
    var t = n.fetch().text;
    if (t === "&" || t === "\\\\") n.consume();
      ...
      break;
    } else throw new N("Expected \\\\ or \\cr or \\end", n.nextToken);
  }
  for (var r = [], i = [r], s = 0; s < e.length; s++) {
    for (var a = e[s], l = Gs(), o = 0; o < a.length; o++)
      if (!Js(a[o])) l.body.push(a[o]);
      else {
        r.push(l), (o += 1);
        var h = di(a[o]).text,
          d = new Array(2);
        if (
          ...
          if ("<>AV".indexOf(h) > -1)
            for (var f = 0; f < 2; f++) {
              for (var g = !0, y = o + 1; y < a.length; y++) {
                if (Dd(a[y], h)) {
                  (g = !1), (o = y);
                  break;
                }
          ...
          else throw new N('Expected one of "<>AV=|." after @', a[o]);
        var v = Od(h, d, n),
          k = { type: "styling", body: [v], mode: "math", style: "display" };
        r.push(k), (l = Gs());
      }
...
O({
  ...
  htmlBuilder(n, e) {
    var t = e.havingStyle(e.style.sup()),
      r = S.wrapFragment(Y(n.label, t, e), e);
    return (
      r.classes.push("cd-label-" + n.side),
      (r.style.bottom = D(0.8 - r.depth)),
      (r.height = 0),
      (r.depth = 0),
      r
    );
  ...
  mathmlBuilder(n, e) {
    var t = new A.MathNode("mrow", [Q(n.label, e)]);
    return (
      (t = new A.MathNode("mpadded", [t])),
      t.setAttribute("width", "0"),
      n.side === "left" && t.setAttribute("lspace", "-1width"),
...
O({
  ...
  htmlBuilder(n, e) {
    var t = S.wrapFragment(Y(n.fragment, e), e);
    return t.classes.push("cd-vert-arrow"), t;
  },
  mathmlBuilder(n, e) {
    return new A.MathNode("mrow", [Q(n.fragment, e)]);
  },
});
O({
  type: "textord",
  ...
  handler(n, e) {
    for (
      var { parser: t } = n, r = J(e[0], "ordgroup"), i = r.body, s = "", a = 0;
      a < i.length;
      a++
    ) {
      var l = J(i[a], "textord");
    ...
    var o = parseInt(s),
      h;
    if (isNaN(o)) throw new N("\\@char has non-numeric argument " + s);
    if (o < 0 || o >= 1114111)
    ...
    return (
      o <= 65535
        ...
        : ((o -= 65536),
          (h = String.fromCharCode((o >> 10) + 55296, (o & 1023) + 56320))),
      { type: "textord", mode: t.mode, text: h }
    );
  },
});
var ro = (n, e) => {
    var t = ce(n.body, e.withColor(n.color), !1);
    return S.makeFragment(t);
  },
  no = (n, e) => {
    var t = Ae(n.body, e.withColor(n.color)),
      r = new A.MathNode("mstyle", t);
...
O({
  ...
  handler(n, e) {
    var { parser: t } = n,
      ...
      i = e[1];
    return { type: "color", mode: t.mode, color: r, body: ae(i) };
  },
  htmlBuilder: ro,
  mathmlBuilder: no,
});
  ...
  htmlBuilder(n, e) {
    ...
    return (
      n.newLine &&
        ...
        n.size && (t.style.marginTop = D(re(n.size, e)))),
      t
    );
  },
  mathmlBuilder(n, e) {
    ...
    return (
      n.newLine &&
        ...
        n.size && t.setAttribute("height", D(re(n.size, e)))),
      t
    );
  },
});
...
O({
  ...
  handler(n) {
    var { parser: e, funcName: t } = n;
    e.consumeSpaces();
    var r = e.fetch();
    if (Vn[r.text])
      return (
        (t === "\\global" || t === "\\\\globallong") && (r.text = Vn[r.text]),
        J(e.parseFunction(), "internal")
      );
    throw new N("Invalid token after macro prefix", r);
  },
});
O({
  type: "internal",
  ...
  handler(n) {
    var { parser: e, funcName: t } = n,
      ...
      i = r.text;
    if (/^(?:[\\{}$&#^_]|EOF)$/.test(i))
      throw new N("Expected a control sequence", r);
    for (var s = 0, a, l = [[]]; e.gullet.future().text !== "{"; )
      if (((r = e.gullet.popToken()), r.text === "#")) {
        if (e.gullet.future().text === "{") {
          (a = e.gullet.future()), l[s].push("{");
          break;
        }
        if (((r = e.gullet.popToken()), !/^[1-9]$/.test(r.text)))
          throw new N('Invalid argument number "' + r.text + '"');
        if (parseInt(r.text) !== s + 1)
          throw new N('Argument number "' + r.text + '" out of order');
        s++, l.push([]);
      } else {
        if (r.text === "EOF") throw new N("Expected a macro definition");
        l[s].push(r.text);
      }
    var { tokens: o } = e.gullet.consumeArg();
    return (
      a && o.unshift(a),
      (t === "\\edef" || t === "\\xdef") &&
        ((o = e.gullet.expandTokens(o)), o.reverse()),
      e.gullet.macros.set(
        i,
        { tokens: o, numArgs: s, delimiters: l },
        t === Vn[t],
      ),
...
O({
  ...
  handler(n) {
    var { parser: e, funcName: t } = n,
      r = io(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var i = Bd(e);
    return (
      so(e, r, i, t === "\\\\globallet"), { type: "internal", mode: e.mode }
    );
  },
});
O({
...
var Sr = function (e, t, r) {
    var i = _.math[e] && _.math[e].replace,
      s = li(i || e, t, r);
    if (!s)
  ...
  pi = function (e, t, r, i) {
    var s = r.havingBaseStyle(t),
      a = S.makeSpan(i.concat(s.sizingClasses(r)), [e], r),
      l = s.sizeMultiplier / r.sizeMultiplier;
    return (
      (a.height *= l), (a.depth *= l), (a.maxFontSize = s.sizeMultiplier), a
    );
  },
  ao = function (e, t, r) {
    var i = t.havingBaseStyle(r),
      s =
        (1 - t.sizeMultiplier / i.sizeMultiplier) * t.fontMetrics().axisHeight;
    e.classes.push("delimcenter"),
      (e.style.top = D(s)),
      (e.height -= s),
      (e.depth += s);
  },
  Rd = function (e, t, r, i, s, a) {
    var l = S.makeSymbol(e, "Main-Regular", s, i),
      o = pi(l, t, i, a);
    return r && ao(o, i, t), o;
  },
  Id = function (e, t, r, i) {
    return S.makeSymbol(e, "Size" + t + "-Regular", r, i);
  },
  lo = function (e, t, r, i, s, a) {
    var l = Id(e, t, s, i),
      o = pi(S.makeSpan(["delimsizing", "size" + t], [l], i), q.TEXT, i, a);
    return r && ao(o, i, q.TEXT), o;
  },
  un = function (e, t, r) {
    var i;
  ...
  cn = function (e, t, r) {
    var i = Xe["Size4-Regular"][e.charCodeAt(0)]
        ? Xe["Size4-Regular"][e.charCodeAt(0)][4]
        : Xe["Size1-Regular"][e.charCodeAt(0)][4],
      s = new Et("inner", Vc(e, Math.round(1e3 * t))),
      a = new dt([s], {
        width: D(i),
        height: D(t),
        style: "width:" + D(i),
  ...
  Hn = 0.008,
  i0 = { type: "kern", size: -1 * Hn },
  Fd = ["|", "\\lvert", "\\rvert", "\\vert"],
  Pd = ["\\|", "\\lVert", "\\rVert", "\\Vert"],
  oo = function (e, t, r, i, s, a) {
    var l,
      o,
      h,
      d,
      ...
      : e === "\\Uparrow"
        ...
        : e === "\\downarrow"
          ...
          : e === "\\Downarrow"
            ? (l = h = "‖")
            : e === "\\updownarrow"
              ? ((l = "\\uparrow"), (h = "⏐"), (d = "\\downarrow"))
              : e === "\\Updownarrow"
                ? ((l = "\\Uparrow"), (h = "‖"), (d = "\\Downarrow"))
                : F.contains(Fd, e)
                  ? ((h = "∣"), (f = "vert"), (g = 333))
                  : F.contains(Pd, e)
                    ? ((h = "∥"), (f = "doublevert"), (g = 556))
                    : e === "[" || e === "\\lbrack"
                      ? ((l = "⎡"),
                        (h = "⎢"),
                        (d = "⎣"),
    ...
    if (o !== null) {
      var G = Sr(o, y, s);
      ($ = G.height + G.depth), (H = 2);
    }
    var U = k + L + $,
      Z = Math.max(0, Math.ceil((t - U) / (H * T))),
      I = U + Z * H * T,
      de = i.fontMetrics().axisHeight;
    r && (de *= i.sizeMultiplier);
    var le = I / 2 - de,
      se = [];
    if (f.length > 0) {
      var Ft = I - k - L,
        Me = Math.round(I * 1e3),
        Ge = Hc(f, Math.round(Ft * 1e3)),
        gt = new Et(f, Ge),
        Xt = (g / 1e3).toFixed(3) + "em",
        Zt = (Me / 1e3).toFixed(3) + "em",
        L0 = new dt([gt], {
          width: Xt,
          height: Zt,
          viewBox: "0 0 " + g + " " + Me,
        }),
        yt = S.makeSvgSpan([], [L0], i);
      (yt.height = Me / 1e3),
        (yt.style.width = Xt),
        (yt.style.height = Zt),
        se.push({ type: "elem", elem: yt });
    } else {
      if ((se.push(un(d, y, s)), se.push(i0), o === null)) {
        var vt = I - k - L + 2 * Hn;
        se.push(cn(h, vt, i));
      } else {
        var Ie = (I - k - L - $) / 2 + 2 * Hn;
      ...
      se.push(i0), se.push(un(l, y, s));
    }
    var yr = i.havingBaseStyle(q.TEXT),
      V0 = S.makeVList(
        { positionType: "bottom", positionData: le, children: se },
        yr,
      );
    return pi(S.makeSpan(["delimsizing", "mult"], [V0], yr), q.TEXT, i, a);
  },
  dn = 80,
  fn = 0.08,
  pn = function (e, t, r, i, s) {
    var a = Lc(e, i, r),
      l = new Et(e, a),
      o = new dt([l], {
        width: "400em",
    ...
    return S.makeSvgSpan(["hide-tail"], [o], s);
  },
  qd = function (e, t) {
    var r = t.havingBaseSizing(),
      i = fo("\\surd", e * r.sizeMultiplier, co, r),
      s = r.sizeMultiplier,
    ...
    return (
      i.type === "small"
        ...
        : i.type === "large"
          ? ((d = (1e3 + dn) * Nr[i.size]),
            (h = (Nr[i.size] + a) / s),
            (o = (Nr[i.size] + a + fn) / s),
            (l = pn("sqrtSize" + i.size, o, d, a, t)),
            (l.style.minWidth = "1.02em"),
            (f = 1 / s))
          : ((o = e + a + fn),
            (h = e + a),
            (d = Math.floor(1e3 * e + a) + dn),
            (l = pn("sqrtTall", o, d, a, t)),
      ...
      (l.style.height = D(o)),
      {
        span: l,
        advanceWidth: f,
        ruleWidth: (t.fontMetrics().sqrtRuleThickness + a) * s,
      }
    );
  },
  ho = [
  ...
  uo = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"],
  Nr = [0, 1.2, 1.8, 2.4, 3],
  Vd = function (e, t, r, i, s) {
    if (
      (e === "<" || e === "\\lt" || e === "⟨"
        ? (e = "\\langle")
        : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"),
      F.contains(ho, e) || F.contains(uo, e))
    )
      return lo(e, t, !1, r, i, s);
    if (F.contains(Ld, e)) return oo(e, Nr[t], !1, r, i, s);
  ...
  fo = function (e, t, r, i) {
    for (
      var s = Math.min(2, 3 - i.style.size), a = s;
      a < r.length && r[a].type !== "stack";
      a++
    ) {
      var l = Sr(e, Gd(r[a]), "math"),
        o = l.height + l.depth;
      if (r[a].type === "small") {
        var h = i.havingBaseStyle(r[a].style);
        o *= h.sizeMultiplier;
      }
      if (o > t) return r[a];
    }
  ...
  po = function (e, t, r, i, s, a) {
    e === "<" || e === "\\lt" || e === "⟨"
      ? (e = "\\langle")
      : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
    var l;
    F.contains(uo, e) ? (l = Hd) : F.contains(ho, e) ? (l = co) : (l = Wd);
    var o = fo(e, t, l, i);
    return o.type === "small"
      ? Rd(e, o.style, r, i, s, a)
      : o.type === "large"
        ? lo(e, o.size, r, i, s, a)
        : oo(e, t, r, i, s, a);
  },
  Jd = function (e, t, r, i, s, a) {
    var l = i.fontMetrics().axisHeight * i.sizeMultiplier,
      o = 901,
      h = 5 / i.fontMetrics().ptPerEm,
      d = Math.max(t - l, r + l),
      f = Math.max((d / 500) * o, 2 * d - h);
    return po(e, f, !0, i, s, a);
  },
  ct = {
    sqrtImage: qd,
    sizedDelim: Vd,
...
function F0(n, e) {
  var t = R0(n);
  if (t && F.contains($d, t.text)) return t;
  throw t
    ? new N("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", n)
    : new N("Invalid delimiter type '" + n.type + "'", n);
}
O({
  type: "delimsizing",
  names: [
  ...
  handler: (n, e) => {
    ...
    return {
      type: "delimsizing",
      mode: n.parser.mode,
      size: $s[n.funcName].size,
      mclass: $s[n.funcName].mclass,
      delim: t.text,
    };
  },
  htmlBuilder: (n, e) =>
    n.delim === "."
      ? S.makeSpan([n.mclass])
      : ct.sizedDelim(n.delim, n.size, e, n.mode, [n.mclass]),
  mathmlBuilder: (n) => {
    var e = [];
    n.delim !== "." && e.push(We(n.delim, n.mode));
    var t = new A.MathNode("mo", e);
    n.mclass === "mopen" || n.mclass === "mclose"
      ? t.setAttribute("fence", "true")
      : t.setAttribute("fence", "false"),
      t.setAttribute("stretchy", "true");
    var r = D(ct.sizeToMaxHeight[n.size]);
...
O({
  ...
  handler: (n, e) => {
    ...
    var s = J(r.parseFunction(), "leftright-right");
    return {
      type: "leftright",
      mode: r.mode,
      body: i,
  ...
  htmlBuilder: (n, e) => {
    Us(n);
    for (
      var t = ce(n.body, e, !0, ["mopen", "mclose"]),
        r = 0,
        i = 0,
        s = !1,
        a = 0;
      ...
      t[a].isMiddle
        ? (s = !0)
        : ((r = Math.max(t[a].height, r)), (i = Math.max(t[a].depth, i)));
    (r *= e.sizeMultiplier), (i *= e.sizeMultiplier);
    var l;
    if (
      (n.left === "."
        ? (l = Pr(e, ["mopen"]))
        : (l = ct.leftRightDelim(n.left, r, i, e, n.mode, ["mopen"])),
      t.unshift(l),
      s)
    )
      for (var o = 1; o < t.length; o++) {
        var h = t[o],
          d = h.isMiddle;
        d && (t[o] = ct.leftRightDelim(d.delim, r, i, d.options, n.mode, []));
      }
    var f;
    if (n.right === ".") f = Pr(e, ["mclose"]);
    else {
      var g = n.rightColor ? e.withColor(n.rightColor) : e;
      f = ct.leftRightDelim(n.right, r, i, g, n.mode, ["mclose"]);
    }
    return t.push(f), S.makeSpan(["minner"], t, e);
  },
  mathmlBuilder: (n, e) => {
    Us(n);
    var t = Ae(n.body, e);
    if (n.left !== ".") {
      var r = new A.MathNode("mo", [We(n.left, n.mode)]);
      r.setAttribute("fence", "true"), t.unshift(r);
    }
    if (n.right !== ".") {
      var i = new A.MathNode("mo", [We(n.right, n.mode)]);
      i.setAttribute("fence", "true"),
        n.rightColor && i.setAttribute("mathcolor", n.rightColor),
        t.push(i);
    }
    return ui(t);
  },
...
O({
  ...
  handler: (n, e) => {
    ...
    if (!n.parser.leftrightDepth)
      throw new N("\\middle without preceding \\left", t);
    return { type: "middle", mode: n.parser.mode, delim: t.text };
  },
  htmlBuilder: (n, e) => {
    var t;
    if (n.delim === ".") t = Pr(e, []);
    else {
      t = ct.sizedDelim(n.delim, 1, e, n.mode, []);
      var r = { delim: n.delim, options: e };
      t.isMiddle = r;
    }
    return t;
  },
...
var mi = (n, e) => {
    var t = S.wrapFragment(Y(n.body, e), e),
      r = n.label.slice(1),
      i = e.sizeMultiplier,
      s,
      a = 0,
      l = F.isCharacterBox(n.body);
    if (r === "sout")
      (s = S.makeSpan(["stretchy", "sout"])),
        (s.height = e.fontMetrics().defaultRuleThickness / i),
        (a = -0.5 * e.fontMetrics().xHeight);
    else if (r === "phase") {
      var o = re({ number: 0.6, unit: "pt" }, e),
        h = re({ number: 0.35, unit: "ex" }, e),
        d = e.havingBaseSizing();
      i = i / d.sizeMultiplier;
      var f = t.height + t.depth + o + h;
      t.style.paddingLeft = D(f / 2 + o);
      var g = Math.floor(1e3 * f * i),
        y = Pc(g),
        v = new dt([new Et("phase", y)], {
          width: "400em",
          height: D(g / 1e3),
          viewBox: "0 0 400000 " + g,
          preserveAspectRatio: "xMinYMin slice",
        });
      (s = S.makeSvgSpan(["hide-tail"], [v], e)),
        (s.style.height = D(f)),
        (a = t.depth + o + h);
    } else {
      /cancel/.test(r)
      ...
      var k = 0,
        ...
        T = 0;
      /box/.test(r)
        ? ((T = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)),
          (k = e.fontMetrics().fboxsep + (r === "colorbox" ? 0 : T)),
          (M = k))
        : r === "angl"
          ? ((T = Math.max(
          ...
          : ((k = l ? 0.2 : 0), (M = k)),
        (s = pt.encloseSpan(t, r, k, M, e)),
        /fbox|boxed|fcolorbox/.test(r)
          ? ((s.style.borderStyle = "solid"), (s.style.borderWidth = D(T)))
          : r === "angl" &&
            T !== 0.049 &&
            ((s.style.borderTopWidth = D(T)),
            (s.style.borderRightWidth = D(T))),
        (a = t.depth + M),
        n.backgroundColor &&
          ((s.style.backgroundColor = n.backgroundColor),
          n.borderColor && (s.style.borderColor = n.borderColor));
    }
    var R;
    if (n.backgroundColor)
      ...
      var L = /cancel|phase/.test(r) ? ["svg-align"] : [];
      R = S.makeVList(
        {
          positionType: "individualShift",
          children: [
            { type: "elem", elem: t, shift: 0 },
            { type: "elem", elem: s, shift: a, wrapperClasses: L },
          ],
        },
        e,
      );
    ...
    return (
      ...
      /cancel/.test(r) && !l
        ? S.makeSpan(["mord", "cancel-lap"], [R], e)
        : S.makeSpan(["mord"], [R], e)
    );
  },
  gi = (n, e) => {
    ...
    switch (n.label) {
      ...
      case "\\colorbox":
        if (
          ...
          r.setAttribute(
            "style",
            "border: " + i + "em solid " + String(n.borderColor),
          );
        }
        break;
      case "\\xcancel":
    ...
    return (
      n.backgroundColor && r.setAttribute("mathbackground", n.backgroundColor),
      r
    );
  };
O({
...
O({
  ...
  handler(n, e) {
    var { parser: t, funcName: r } = n,
      i = e[0];
    return { type: "enclose", mode: t.mode, label: r, body: i };
  },
  htmlBuilder: mi,
  mathmlBuilder: gi,
});
...
function Ks(n) {
  ...
  var t = n.fetch().text;
  for (
    t === "\\relax" && (n.consume(), n.consumeSpaces(), (t = n.fetch().text));
    t === "\\hline" || t === "\\hdashline";
...
var P0 = (n) => {
  ...
  if (!e.displayMode)
    throw new N("{" + n.envName + "} can be used only in display mode.");
};
function yi(n) {
...
function It(n, e, t) {
  ...
  if (
    (n.gullet.beginGroup(), h || n.gullet.macros.set("\\cr", "\\\\\\relax"), !a)
  ) {
    var y = n.gullet.expandMacroAsText("\\arraystretch");
    if (y == null) a = 1;
    else if (((a = parseFloat(y)), !a || a < 0))
      throw new N("Invalid \\arraystretch: " + y);
  }
  n.gullet.beginGroup();
  var v = [],
    k = [v],
  ...
  function $() {
    R &&
      (n.gullet.macros.get("\\df@tag")
        ? (R.push(n.subparse([new Ve("\\df@tag")])),
          n.gullet.macros.set("\\df@tag", void 0, !0))
        : R.push(!!o && n.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (L(), T.push(Ks(n)); ; ) {
    var H = n.parseExpression(!1, h ? "\\end" : "\\\\");
    n.gullet.endGroup(),
      n.gullet.beginGroup(),
      (H = { type: "ordgroup", mode: n.mode, body: H }),
      t && (H = { type: "styling", mode: n.mode, style: t, body: [H] }),
      v.push(H);
    var G = n.fetch().text;
    if (G === "&") {
      if (f && v.length === f) {
        if (h || l) throw new N("Too many tab characters: &", n.nextToken);
      ...
      $(),
        v.length === 1 &&
          ...
          (k.length > 1 || !d) &&
          k.pop(),
        T.length < k.length + 1 && T.push([]);
      break;
    } else if (G === "\\\\") {
      n.consume();
      var U = void 0;
      n.gullet.future().text !== " " && (U = n.parseSizeGroup(!0)),
        M.push(U ? U.value : null),
        $(),
        T.push(Ks(n)),
        (v = []),
        k.push(v),
        L();
    } else throw new N("Expected & or \\\\ or \\cr or \\end", n.nextToken);
  }
  return (
    n.gullet.endGroup(),
    n.gullet.endGroup(),
...
var rt = function (e, t) {
    ...
    var v =
      ...
      L = 0;
    function $(Ur) {
      for (var Kr = 0; Kr < Ur.length; ++Kr)
        Kr > 0 && (L += 0.25), h.push({ pos: L, isDashed: Ur[Kr] });
    }
    for ($(a[0]), r = 0; r < e.body.length; ++r) {
      var H = e.body[r],
        G = T,
        U = R;
      l < H.length && (l = H.length);
      ...
      var de = e.rowGaps[r],
        le = 0;
      de &&
        ((le = re(de, t)), le > 0 && ((le += R), U < le && (U = le), (le = 0))),
        e.addJot && (U += k),
        (Z.height = G),
        (Z.depth = U),
        (L += G),
    ...
    var se = L / 2 + t.fontMetrics().axisHeight,
      Ft = e.cols || [],
      Me = [],
      Ge,
      gt,
    ...
    if (e.tags && e.tags.some((Ur) => Ur))
      for (r = 0; r < s; ++r) {
        var Zt = o[r],
          ...
          vt = void 0;
        yt === !0
          ? (vt = S.makeSpan(["eqn-num"], [], t))
          : yt === !1
            ? (vt = S.makeSpan([], [], t))
            : (vt = S.makeSpan([], ce(yt, t, !0), t)),
          (vt.depth = Zt.depth),
          (vt.height = Zt.height),
          Xt.push({ type: "elem", elem: vt, shift: L0 });
      }
    for (i = 0, gt = 0; i < l || gt < Ft.length; ++i, ++gt) {
      for (var Ie = Ft[gt] || {}, yr = !0; Ie.type === "separator"; ) {
        if (
          (yr ||
            ((Ge = S.makeSpan(["arraycolsep"], [])),
            (Ge.style.width = D(t.fontMetrics().doubleRuleSep)),
            Me.push(Ge)),
          Ie.separator === "|" || Ie.separator === ":")
        ) {
          var V0 = Ie.separator === "|" ? "solid" : "dashed",
            Qt = S.makeSpan(["vertical-separator"], [], t);
          (Qt.style.height = D(L)),
            (Qt.style.borderRightWidth = D(d)),
            (Qt.style.borderRightStyle = V0),
            (Qt.style.margin = "0 " + D(-d / 2));
          var Ti = L - se;
          Ti && (Qt.style.verticalAlign = D(-Ti)), Me.push(Qt);
        } else throw new N("Invalid separator type: " + Ie.separator);
        gt++, (Ie = Ft[gt] || {}), (yr = !1);
      }
      if (!(i >= l)) {
        var _t = void 0;
        (i > 0 || e.hskipBeforeAndAfter) &&
          ((_t = F.deflt(Ie.pregap, g)),
          _t !== 0 &&
            ((Ge = S.makeSpan(["arraycolsep"], [])),
            (Ge.style.width = D(_t)),
            Me.push(Ge)));
        ...
        for (r = 0; r < s; ++r) {
          ...
          if ($r) {
            ...
            ($r.depth = Jr.depth),
              ($r.height = Jr.height),
              er.push({ type: "elem", elem: $r, shift: Ro });
          }
        }
        (er = S.makeVList(
          { positionType: "individualShift", children: er },
          t,
        )),
          (er = S.makeSpan(["col-align-" + (Ie.align || "c")], [er])),
          Me.push(er),
          (i < l - 1 || e.hskipBeforeAndAfter) &&
            ((_t = F.deflt(Ie.postgap, g)),
            _t !== 0 &&
              ((Ge = S.makeSpan(["arraycolsep"], [])),
              (Ge.style.width = D(_t)),
              Me.push(Ge)));
    ...
    if (((o = S.makeSpan(["mtable"], Me)), h.length > 0)) {
      for (
        var Io = S.makeLineSpan("hline", t, d),
          Fo = S.makeLineSpan("hdashline", t, d),
          H0 = [{ type: "elem", elem: o, shift: 0 }];
        h.length > 0;
        ...
        var Ci = h.pop(),
          Ai = Ci.pos - se;
        Ci.isDashed
          ? H0.push({ type: "elem", elem: Fo, shift: Ai })
          : H0.push({ type: "elem", elem: Io, shift: Ai });
      }
      o = S.makeVList({ positionType: "individualShift", children: H0 }, t);
    }
    if (Xt.length === 0) return S.makeSpan(["mord"], [o], t);
    var W0 = S.makeVList({ positionType: "individualShift", children: Xt }, t);
    return (W0 = S.makeSpan(["tag"], [W0], t)), S.makeFragment([o, W0]);
  },
  Ud = { c: "center ", l: "left ", r: "right " },
  nt = function (e, t) {
    for (
      var r = [],
        i = new A.MathNode("mtd", [], ["mtr-glue"]),
        s = new A.MathNode("mtd", [], ["mml-eqn-num"]),
        a = 0;
      a < e.body.length;
      a++
    ) {
      for (var l = e.body[a], o = [], h = 0; h < l.length; h++)
        o.push(new A.MathNode("mtd", [Q(l[h], t)]));
      e.tags &&
        e.tags[a] &&
        (o.unshift(i), o.push(i), e.leqno ? o.unshift(s) : o.push(s)),
        r.push(new A.MathNode("mtr", o));
    }
    var d = new A.MathNode("mtable", r),
      f =
        e.arraystretch === 0.5
          ? 0.1
          : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
    d.setAttribute("rowspacing", D(f));
    var g = "",
      y = "";
    if (e.cols && e.cols.length > 0) {
      var v = e.cols,
        ...
        T = 0,
        R = v.length;
      v[0].type === "separator" && ((g += "top "), (T = 1)),
        v[v.length - 1].type === "separator" && ((g += "bottom "), (R -= 1));
      for (var L = T; L < R; L++)
        v[L].type === "align"
          ? ((y += Ud[v[L].align]), M && (k += "none "), (M = !0))
          : v[L].type === "separator" &&
            M &&
            ((k += v[L].separator === "|" ? "solid " : "dashed "), (M = !1));
      d.setAttribute("columnalign", y.trim()),
        /[sd]/.test(k) && d.setAttribute("columnlines", k.trim());
    }
    if (e.colSeparationType === "align") {
      for (var $ = e.cols || [], H = "", G = 1; G < $.length; G++)
        H += G % 2 ? "0em " : "1em ";
      d.setAttribute("columnspacing", H.trim());
    } else
    ...
    for (var I = 1; I < Z.length - 1; I++)
      U += Z[I].length === 0 ? "none " : Z[I][0] ? "dashed " : "solid ";
    return (
      /[sd]/.test(U) && d.setAttribute("rowlines", U.trim()),
      g !== "" &&
        ((d = new A.MathNode("menclose", [d])),
        d.setAttribute("notation", g.trim())),
      e.arraystretch &&
        e.arraystretch < 1 &&
        ((d = new A.MathNode("mstyle", [d])),
        d.setAttribute("scriptlevel", "1")),
      d
    );
  },
  yo = function (e, t) {
    e.envName.indexOf("ed") === -1 && P0(e);
    var r = [],
    ...
    a.body.forEach(function (T) {
      ...
      if (y) o < T.length && (o = T.length);
      else {
        var H = T.length / 2;
        if (l < H)
          throw new N(
            "Too many math in a row: " + ("expected " + l + ", but got " + H),
            T[0],
          );
      }
    });
    for (var v = 0; v < o; ++v) {
      var k = "r",
        M = 0;
      v % 2 === 1 ? (k = "l") : v > 0 && y && (M = 1),
        (r[v] = { type: "align", align: k, pregap: M, postgap: 0 });
    }
    return (a.colSeparationType = y ? "align" : "alignat"), a;
  };
tt({
  type: "array",
  names: ["array", "darray"],
  ...
  handler(n, e) {
    var t = R0(e[0]),
      ...
      i = r.map(function (a) {
        var l = di(a),
          o = l.text;
        if ("lcr".indexOf(o) !== -1) return { type: "align", align: o };
        if (o === "|") return { type: "separator", separator: "|" };
        if (o === ":") return { type: "separator", separator: ":" };
        throw new N("Unknown column alignment: " + o, a);
      }),
      s = { cols: i, hskipBeforeAndAfter: !0, maxNumCols: i.length };
    return It(n.parser, s, vi(n.envName));
  },
  htmlBuilder: rt,
  mathmlBuilder: nt,
});
tt({
  ...
  handler(n) {
    ...
    var s = It(n.parser, r, vi(n.envName)),
      a = Math.max(0, ...s.body.map((l) => l.length));
    return (
      (s.cols = new Array(a).fill({ type: "align", align: t })),
      e
        ? {
            type: "leftright",
            mode: n.mode,
...
tt({
  ...
  handler(n, e) {
    ...
    if (i.length > 1) throw new N("{subarray} can contain only one column");
    var s = { cols: i, hskipBeforeAndAfter: !1, arraystretch: 0.5 };
    if (
      ((s = It(n.parser, s, "script")),
...
tt({
  ...
  props: { numArgs: 0 },
  handler(n) {
    F.contains(["gather", "gather*"], n.envName) && P0(n);
    var e = {
      cols: [{ type: "align", align: "c" }],
      addJot: !0,
      colSeparationType: "gather",
      autoTag: yi(n.envName),
      emptySingleRow: !0,
      leqno: n.parser.settings.leqno,
    };
    return It(n.parser, e, "display");
  },
  htmlBuilder: rt,
  mathmlBuilder: nt,
});
...
O({
  ...
  handler(n, e) {
    throw new N(n.funcName + " valid only within array environment");
  },
});
var Ys = mo;
O({
  ...
  handler(n, e) {
    var { parser: t, funcName: r } = n,
      i = e[0];
    if (i.type !== "ordgroup") throw new N("Invalid environment name", i);
    for (var s = "", a = 0; a < i.body.length; ++a)
      s += J(i.body[a], "textord").text;
    if (r === "\\begin") {
      if (!Ys.hasOwnProperty(s)) throw new N("No such environment: " + s, i);
      var l = Ys[s],
        { args: o, optArgs: h } = t.parseArguments("\\begin{" + s + "}", l),
        d = { mode: t.mode, envName: s, parser: t },
        f = l.handler(d, o, h);
      t.expect("\\end", !1);
      var g = t.nextToken,
        y = J(t.parseFunction(), "environment");
      if (y.name !== s)
        throw new N(
    ...
    return { type: "environment", mode: t.mode, name: s, nameGroup: i };
  },
});
var vo = (n, e) => {
    var t = n.font,
...
O({
  ...
  handler: (n, e) => {
    ...
    return (
      s in js && (s = js[s]),
      { type: "font", mode: t.mode, font: s.slice(1), body: i }
    );
  },
  htmlBuilder: vo,
  mathmlBuilder: bo,
...
O({
  ...
  props: { numArgs: 0, allowedInText: !0 },
  handler: (n, e) => {
    var { parser: t, funcName: r, breakOnTokenText: i } = n,
      { mode: s } = t,
      a = t.parseExpression(!0, i),
      l = "math" + r.slice(1);
    return {
      type: "font",
      mode: s,
...
var xo = (n, e) => {
    ...
    return (
      n === "display"
        ...
        : n === "text" && t.size === q.DISPLAY.size
          ? (t = q.TEXT)
          : n === "script"
            ? (t = q.SCRIPT)
            : n === "scriptscript" && (t = q.SCRIPTSCRIPT),
      t
    );
  },
  bi = (n, e) => {
    var t = xo(n.size, e.style),
      r = t.fracNum(),
      i = t.fracDen(),
      s;
    s = e.havingStyle(r);
    ...
    if (n.continued) {
      var l = 8.5 / e.fontMetrics().ptPerEm,
        o = 3.5 / e.fontMetrics().ptPerEm;
      (a.height = a.height < l ? l : a.height),
        (a.depth = a.depth < o ? o : a.depth);
    }
    s = e.havingStyle(i);
    var h = Y(n.denom, s, e),
      d,
    ...
    n.hasBarLine
      ? (n.barSize
          ? ((f = re(n.barSize, e)), (d = S.makeLineSpan("frac-line", e, f)))
          : (d = S.makeLineSpan("frac-line", e)),
        (f = d.height),
        (g = d.height))
      : ((d = null), (f = 0), (g = e.fontMetrics().defaultRuleThickness));
    var y, v, k;
    t.size === q.DISPLAY.size || n.size === "display"
      ? ((y = e.fontMetrics().num1),
        f > 0 ? (v = 3 * g) : (v = 7 * g),
        (k = e.fontMetrics().denom1))
      : (f > 0
          ? ((y = e.fontMetrics().num2), (v = g))
          : ((y = e.fontMetrics().num3), (v = 3 * g)),
        (k = e.fontMetrics().denom2));
    var M;
    if (d) {
      var R = e.fontMetrics().axisHeight;
      y - a.depth - (R + 0.5 * f) < v &&
        (y += v - (y - a.depth - (R + 0.5 * f))),
        R - 0.5 * f - (h.height - k) < v &&
          (k += v - (R - 0.5 * f - (h.height - k)));
      var L = -(R - 0.5 * f);
      M = S.makeVList(
        {
          positionType: "individualShift",
          children: [
            ...
            { type: "elem", elem: a, shift: -y },
          ],
        },
        e,
      );
    } else {
      var T = y - a.depth - (h.height - k);
      T < v && ((y += 0.5 * (v - T)), (k += 0.5 * (v - T))),
        (M = S.makeVList(
          {
            positionType: "individualShift",
            children: [
    ...
    (s = e.havingStyle(t)),
      (M.height *= s.sizeMultiplier / e.sizeMultiplier),
      (M.depth *= s.sizeMultiplier / e.sizeMultiplier);
    var $;
    t.size === q.DISPLAY.size
      ? ($ = e.fontMetrics().delim1)
      : t.size === q.SCRIPTSCRIPT.size
        ? ($ = e.havingStyle(q.SCRIPT).fontMetrics().delim2)
        : ($ = e.fontMetrics().delim2);
    var H, G;
    return (
      n.leftDelim == null
        ? (H = Pr(e, ["mopen"]))
        : (H = ct.customSizedDelim(
            n.leftDelim,
            $,
            !0,
            e.havingStyle(t),
      ...
      S.makeSpan(
        ...
        [H, S.makeSpan(["mfrac"], [M]), G],
        e,
      )
    );
  },
  xi = (n, e) => {
    var t = new A.MathNode("mfrac", [Q(n.numer, e), Q(n.denom, e)]);
    if (!n.hasBarLine) t.setAttribute("linethickness", "0px");
    else if (n.barSize) {
      var r = re(n.barSize, e);
      t.setAttribute("linethickness", D(r));
    }
    var i = xo(n.size, e.style);
    if (i.size !== e.style.size) {
      t = new A.MathNode("mstyle", [t]);
      var s = i.size === q.DISPLAY.size ? "true" : "false";
      t.setAttribute("displaystyle", s), t.setAttribute("scriptlevel", "0");
    }
    if (n.leftDelim != null || n.rightDelim != null) {
      var a = [];
      if (n.leftDelim != null) {
        var l = new A.MathNode("mo", [
          new A.TextNode(n.leftDelim.replace("\\", "")),
        ]);
        l.setAttribute("fence", "true"), a.push(l);
      }
      if ((a.push(t), n.rightDelim != null)) {
        var o = new A.MathNode("mo", [
          new A.TextNode(n.rightDelim.replace("\\", "")),
        ]);
...
O({
  ...
  handler(n) {
    var { parser: e, funcName: t, token: r } = n,
      i;
    switch (t) {
      case "\\over":
        i = "\\frac";
...
var Xs = ["display", "text", "script", "scriptscript"],
  Zs = function (e) {
    var t = null;
...
O({
  ...
  handler(n, e) {
    var { parser: t } = n,
      ...
      i = e[5],
      s = T0(e[0]),
      a = s.type === "atom" && s.family === "open" ? Zs(s.text) : null,
      l = T0(e[1]),
      o = l.type === "atom" && l.family === "close" ? Zs(l.text) : null,
      h = J(e[2], "size"),
      d,
      f = null;
    ...
    if (y.type === "ordgroup") {
      if (y.body.length > 0) {
        var v = J(y.body[0], "textord");
        g = Xs[Number(v.text)];
      }
    } else (y = J(y, "textord")), (g = Xs[Number(y.text)]);
    return {
      type: "genfrac",
      mode: t.mode,
      numer: r,
...
O({
  ...
  handler(n, e) {
    var { parser: t, funcName: r, token: i } = n;
    return {
      type: "infix",
      mode: t.mode,
...
var wo = (n, e) => {
    ...
    n.type === "supsub"
      ? ((r = n.sup
          ? Y(n.sup, e.havingStyle(t.sup()), e)
          : Y(n.sub, e.havingStyle(t.sub()), e)),
        (i = J(n.base, "horizBrace")))
      : (i = J(n, "horizBrace"));
    var s = Y(i.base, e.havingBaseStyle(q.DISPLAY)),
      a = pt.svgSpan(i, e),
      l;
    if (
      (i.isOver
        ...
        : ((l = S.makeVList(
            {
              positionType: "bottom",
              positionData: s.depth + 0.1 + a.height,
              children: [
                { type: "elem", elem: a },
                { type: "kern", size: 0.1 },
                { type: "elem", elem: s },
      ...
      var o = S.makeSpan(["mord", i.isOver ? "mover" : "munder"], [l], e);
      i.isOver
        ? (l = S.makeVList(
            {
              positionType: "firstBaseline",
    ...
    return S.makeSpan(["mord", i.isOver ? "mover" : "munder"], [l], e);
  },
  Kd = (n, e) => {
    var t = pt.mathMLnode(n.label);
    return new A.MathNode(n.isOver ? "mover" : "munder", [Q(n.base, e), t]);
  };
O({
  type: "horizBrace",
...
O({
  ...
  handler: (n, e) => {
    var { parser: t } = n,
      r = e[1],
      i = J(e[0], "url").url;
    return t.settings.isTrusted({ command: "\\href", url: i })
      ? { type: "href", mode: t.mode, href: i, body: ae(r) }
      : t.formatUnsupportedCmd("\\href");
  },
  htmlBuilder: (n, e) => {
    var t = ce(n.body, e, !1);
    return S.makeAnchor(n.href, [], t, e);
  },
  mathmlBuilder: (n, e) => {
    var t = Bt(n.body, e);
    return (
      t instanceof Oe || (t = new Oe("mrow", [t])),
...
O({
  ...
  handler: (n, e) => {
    ...
    for (var i = [], s = 0; s < r.length; s++) {
      var a = r[s];
      a === "~" && (a = "\\textasciitilde"),
        i.push({ type: "textord", mode: "text", text: a });
    }
    var l = { type: "text", mode: t.mode, font: "\\texttt", body: i };
    return { type: "href", mode: t.mode, href: r, body: ae(l) };
  },
});
O({
  type: "hbox",
  ...
  mathmlBuilder(n, e) {
    return new A.MathNode("mrow", Ae(n.body, e));
  },
});
O({
  type: "html",
  ...
  handler: (n, e) => {
    ...
    switch (r) {
      case "\\htmlClass":
        (o.class = s), (l = { command: "\\htmlClass", class: s });
        break;
      case "\\htmlId":
        (o.id = s), (l = { command: "\\htmlId", id: s });
        break;
      case "\\htmlStyle":
        (o.style = s), (l = { command: "\\htmlStyle", style: s });
        break;
      case "\\htmlData": {
        ...
        l = { command: "\\htmlData", attributes: o };
        break;
      }
      default:
    ...
    return t.settings.isTrusted(l)
      ? { type: "html", mode: t.mode, attributes: o, body: ae(a) }
  ...
  htmlBuilder: (n, e) => {
    ...
    var i = S.makeSpan(r, t, e);
    for (var s in n.attributes)
      s !== "class" &&
        n.attributes.hasOwnProperty(s) &&
        i.setAttribute(s, n.attributes[s]);
    return i;
  },
  mathmlBuilder: (n, e) => Bt(n.body, e),
});
O({
  type: "htmlmathml",
  names: ["\\html@mathml"],
  ...
  mathmlBuilder: (n, e) => Bt(n.mathml, e),
});
var mn = function (e) {
...
O({
  ...
  handler: (n, e, t) => {
    ...
    if (t[0])
      for (
        var o = J(t[0], "raw").string, h = o.split(","), d = 0;
        d < h.length;
        d++
      ) {
        var f = h[d].split("=");
        if (f.length === 2) {
          ...
          switch (f[0].trim()) {
            ...
            case "totalheight":
              ...
              break;
            default:
              throw new N("Invalid key: '" + f[0] + "' in \\includegraphics.");
          }
        }
      }
    var y = J(e[0], "url").url;
  ...
  htmlBuilder: (n, e) => {
    var t = re(n.height, e),
      r = 0;
    n.totalheight.number > 0 && (r = re(n.totalheight, e) - t);
    var i = 0;
    n.width.number > 0 && (i = re(n.width, e));
    var s = { height: D(t + r) };
    i > 0 && (s.width = D(i)), r > 0 && (s.verticalAlign = D(-r));
    var a = new Kc(n.src, n.alt, s);
    return (a.height = t), (a.depth = r), a;
  },
  mathmlBuilder: (n, e) => {
    ...
    var r = re(n.height, e),
      i = 0;
    if (
      (n.totalheight.number > 0 &&
        ((i = re(n.totalheight, e) - r), t.setAttribute("valign", D(-i))),
      t.setAttribute("height", D(r + i)),
      n.width.number > 0)
    ) {
      var s = re(n.width, e);
      t.setAttribute("width", D(s));
    }
...
O({
  ...
  handler(n, e) {
    ...
    return { type: "kern", mode: t.mode, dimension: i.value };
  },
  htmlBuilder(n, e) {
    return S.makeGlue(n.dimension, e);
  },
  mathmlBuilder(n, e) {
    var t = re(n.dimension, e);
...
O({
  ...
  handler: (n, e) => {
    var { parser: t, funcName: r } = n,
      i = e[0];
    return { type: "lap", mode: t.mode, alignment: r.slice(5), body: i };
  },
  htmlBuilder: (n, e) => {
    var t;
    n.alignment === "clap"
      ? ((t = S.makeSpan([], [Y(n.body, e)])),
        (t = S.makeSpan(["inner"], [t], e)))
      : (t = S.makeSpan(["inner"], [Y(n.body, e)]));
    var r = S.makeSpan(["fix"], []),
      i = S.makeSpan([n.alignment], [t, r], e),
      s = S.makeSpan(["strut"]);
    return (
      (s.style.height = D(i.height + i.depth)),
      i.depth && (s.style.verticalAlign = D(-i.depth)),
      i.children.unshift(s),
      (i = S.makeSpan(["thinbox"], [i], e)),
      S.makeSpan(["mord", "vbox"], [i], e)
    );
  },
  mathmlBuilder: (n, e) => {
    var t = new A.MathNode("mpadded", [Q(n.body, e)]);
    if (n.alignment !== "rlap") {
...
O({
  ...
  props: { numArgs: 0, allowedInText: !0, allowedInMath: !1 },
  handler(n, e) {
    throw new N("Mismatched " + n.funcName);
  },
});
var Qs = (n, e) => {
  switch (e.style.size) {
...
var ko = (n, e, t, r, i, s, a) => {
    n = S.makeSpan([], [n]);
    var l = t && F.isCharacterBox(t),
      o,
      h;
    if (e) {
      var d = Y(e, r.havingStyle(i.sup()), r);
      h = {
        elem: d,
        kern: Math.max(
    ...
    if (t) {
      var f = Y(t, r.havingStyle(i.sub()), r);
      o = {
        elem: f,
        kern: Math.max(
      ...
      g = S.makeVList(
        {
          ...
          children: [
            ...
            { type: "elem", elem: o.elem, marginLeft: D(-s) },
            { type: "kern", size: o.kern },
            { type: "elem", elem: n },
            { type: "kern", size: h.kern },
            { type: "elem", elem: h.elem, marginLeft: D(s) },
            { type: "kern", size: r.fontMetrics().bigOpSpacing5 },
          ],
        },
        r,
    ...
    if (o && s !== 0 && !l) {
      ...
      (T.style.marginRight = D(s)), M.unshift(T);
    }
    return S.makeSpan(["mop", "op-limits"], M, r);
  },
  So = ["\\smallint"],
  gr = (n, e) => {
    var t,
      ...
      s;
    n.type === "supsub"
      ? ((t = n.sup), (r = n.sub), (s = J(n.base, "op")), (i = !0))
      : (s = J(n, "op"));
    var a = e.style,
      l = !1;
    a.size === q.DISPLAY.size &&
      s.symbol &&
      !F.contains(So, s.name) &&
      (l = !0);
    var o;
    if (s.symbol) {
      ...
      if (
        ((s.name === "\\oiint" || s.name === "\\oiiint") &&
          ((d = s.name.slice(1)),
          (s.name = d === "oiint" ? "\\iint" : "\\iiint")),
        (o = S.makeSymbol(s.name, h, "math", e, [
          "mop",
          "op-symbol",
          l ? "large-op" : "small-op",
        ])),
        ...
        var f = o.italic,
          g = S.staticSvg(d + "Size" + (l ? "2" : "1"), e);
        (o = S.makeVList(
          {
            positionType: "individualShift",
            children: [
              { type: "elem", elem: o, shift: 0 },
              { type: "elem", elem: g, shift: l ? 0.08 : 0 },
            ],
          },
          e,
        )),
      ...
      var y = ce(s.body, e, !0);
      y.length === 1 && y[0] instanceof He
        ? ((o = y[0]), (o.classes[0] = "mop"))
        : (o = S.makeSpan(["mop"], y, e));
    } else {
      for (var v = [], k = 1; k < s.name.length; k++)
        v.push(S.mathsym(s.name[k], s.mode, e));
      o = S.makeSpan(["mop"], v, e);
    }
    var M = 0,
      T = 0;
    return (
      (o instanceof He || s.name === "\\oiint" || s.name === "\\oiiint") &&
        !s.suppressBaseShift &&
        ((M = (o.height - o.depth) / 2 - e.fontMetrics().axisHeight),
        (T = o.italic)),
      i
        ? ko(o, t, r, e, a, T, M)
        : (M && ((o.style.position = "relative"), (o.style.top = D(M))), o)
    );
  },
  Gr = (n, e) => {
    var t;
    if (n.symbol)
      (t = new Oe("mo", [We(n.name, n.mode)])),
        F.contains(So, n.name) && t.setAttribute("largeop", "false");
    else if (n.body) t = new Oe("mo", Ae(n.body, e));
    else {
      t = new Oe("mi", [new Ze(n.name.slice(1))]);
      var r = new Oe("mo", [We("⁡", "text")]);
      n.parentIsSupSub ? (t = new Oe("mrow", [t, r])) : (t = Xl([t, r]));
    }
    return t;
  },
  Yd = {
...
var Mo = (n, e) => {
    var t,
      ...
      s;
    n.type === "supsub"
      ? ((t = n.sup), (r = n.sub), (s = J(n.base, "operatorname")), (i = !0))
      : (s = J(n, "operatorname"));
    var a;
    if (s.body.length > 0) {
      for (
        var l = s.body.map((f) => {
            ...
            return typeof g == "string"
              ? { type: "textord", mode: f.mode, text: g }
              : f;
          }),
          o = ce(l, e.withFont("mathrm"), !0),
          h = 0;
        h < o.length;
        h++
      ) {
      ...
      a = S.makeSpan(["mop"], o, e);
    } else a = S.makeSpan(["mop"], [], e);
    return i ? ko(a, t, r, e, e.style, 0, 0) : a;
  },
  Xd = (n, e) => {
    for (
      var t = Ae(n.body, e.withFont("mathrm")), r = !0, i = 0;
      i < t.length;
      i++
    ) {
      var s = t[i];
      if (!(s instanceof A.SpaceNode))
        if (s instanceof A.MathNode)
          switch (s.type) {
            case "mi":
            case "mn":
            case "ms":
            ...
            case "mo": {
              var a = s.children[0];
              s.children.length === 1 && a instanceof A.TextNode
                ? (a.text = a.text
                    .replace(/\u2212/, "-")
                    .replace(/\u2217/, "*"))
                : (r = !1);
    ...
    var o = new A.MathNode("mi", t);
    o.setAttribute("mathvariant", "normal");
    var h = new A.MathNode("mo", [We("⁡", "text")]);
    return n.parentIsSupSub
      ? new A.MathNode("mrow", [o, h])
      : A.newDocumentFragment([o, h]);
  };
O({
  type: "operatorname",
...
jt({
  ...
  htmlBuilder(n, e) {
    return n.semisimple
      ? S.makeFragment(ce(n.body, e, !1))
      : S.makeSpan(["mord"], ce(n.body, e, !0), e);
  },
  mathmlBuilder(n, e) {
    return Bt(n.body, e, !0);
  },
});
O({
  type: "overline",
  ...
  htmlBuilder(n, e) {
    var t = Y(n.body, e.havingCrampedStyle()),
  ...
  mathmlBuilder(n, e) {
    ...
    t.setAttribute("stretchy", "true");
    var r = new A.MathNode("mover", [Q(n.body, e), t]);
    return r.setAttribute("accent", "true"), r;
  },
});
O({
  ...
  handler: (n, e) => {
    var { parser: t } = n,
      r = e[0];
    return { type: "phantom", mode: t.mode, body: ae(r) };
  },
  htmlBuilder: (n, e) => {
    var t = ce(n.body, e.withPhantom(), !1);
    return S.makeFragment(t);
  },
  mathmlBuilder: (n, e) => {
    var t = Ae(n.body, e);
...
O({
  ...
  htmlBuilder: (n, e) => {
    var t = S.makeSpan([], [Y(n.body, e.withPhantom())]);
  ...
  mathmlBuilder: (n, e) => {
    var t = Ae(ae(n.body), e),
      r = new A.MathNode("mphantom", t),
      i = new A.MathNode("mpadded", [r]);
...
O({
  ...
  htmlBuilder: (n, e) => {
    var t = S.makeSpan(["inner"], [Y(n.body, e.withPhantom())]),
      r = S.makeSpan(["fix"], []);
...
O({
  ...
  handler(n, e) {
    var { parser: t } = n,
      r = J(e[0], "size").value,
      i = e[1];
    return { type: "raisebox", mode: t.mode, dy: r, body: i };
  },
  htmlBuilder(n, e) {
    var t = Y(n.body, e),
      r = re(n.dy, e);
...
O({
  ...
  htmlBuilder(n, e) {
    var t = S.makeSpan(["mord", "rule"], [], e),
      r = re(n.width, e),
      i = re(n.height, e),
      s = n.shift ? re(n.shift, e) : 0;
    return (
      (t.style.borderRightWidth = D(r)),
      (t.style.borderTopWidth = D(i)),
      (t.style.bottom = D(s)),
      (t.width = r),
      (t.height = i + s),
      (t.depth = -s),
      (t.maxFontSize = i * 1.125 * e.sizeMultiplier),
      t
    );
  },
  mathmlBuilder(n, e) {
    var t = re(n.width, e),
      r = re(n.height, e),
      i = n.shift ? re(n.shift, e) : 0,
      s = (e.color && e.getColor()) || "black",
      a = new A.MathNode("mspace");
    a.setAttribute("mathbackground", s),
      a.setAttribute("width", D(t)),
      a.setAttribute("height", D(r));
    var l = new A.MathNode("mpadded", [a]);
    return (
      i >= 0
        ? l.setAttribute("height", D(i))
        : (l.setAttribute("height", D(i)), l.setAttribute("depth", D(-i))),
      l.setAttribute("voffset", D(i)),
      l
    );
  },
});
function To(n, e, t) {
  for (
    var r = ce(n, e, !1), i = e.sizeMultiplier / t.sizeMultiplier, s = 0;
    s < r.length;
    s++
  ) {
    var a = r[s].classes.indexOf("sizing");
    a < 0
      ? Array.prototype.push.apply(r[s].classes, e.sizingClasses(t))
      : r[s].classes[a + 1] === "reset-size" + e.size &&
        (r[s].classes[a + 1] = "reset-size" + t.size),
      (r[s].height *= i),
      (r[s].depth *= i);
  }
  return S.makeFragment(r);
...
O({
  ...
  props: { numArgs: 0, allowedInText: !0 },
  handler: (n, e) => {
    var { breakOnTokenText: t, funcName: r, parser: i } = n,
      s = i.parseExpression(!1, t);
    return { type: "sizing", mode: i.mode, size: _s.indexOf(r) + 1, body: s };
  },
  htmlBuilder: Zd,
  mathmlBuilder: (n, e) => {
    var t = e.havingSize(n.size),
      r = Ae(n.body, t),
      i = new A.MathNode("mstyle", r);
    return i.setAttribute("mathsize", D(t.sizeMultiplier)), i;
  },
});
O({
  type: "smash",
  ...
  handler: (n, e, t) => {
    var { parser: r } = n,
      i = !1,
      s = !1,
      a = t[0] && J(t[0], "ordgroup");
    if (a)
      for (var l = "", o = 0; o < a.body.length; ++o) {
        var h = a.body[o];
        if (((l = h.text), l === "t")) i = !0;
        else if (l === "b") s = !0;
        else {
  ...
  htmlBuilder: (n, e) => {
    var t = S.makeSpan([], [Y(n.body, e)]);
    if (!n.smashHeight && !n.smashDepth) return t;
    ...
    if (n.smashDepth && ((t.depth = 0), t.children))
      for (var i = 0; i < t.children.length; i++) t.children[i].depth = 0;
    var s = S.makeVList(
  ...
  mathmlBuilder: (n, e) => {
    var t = new A.MathNode("mpadded", [Q(n.body, e)]);
    return (
      n.smashHeight && t.setAttribute("height", "0px"),
      n.smashDepth && t.setAttribute("depth", "0px"),
      t
    );
  },
});
O({
  ...
  handler(n, e, t) {
    var { parser: r } = n,
      i = t[0],
      s = e[0];
    return { type: "sqrt", mode: r.mode, body: s, index: i };
  },
  htmlBuilder(n, e) {
    var t = Y(n.body, e.havingCrampedStyle());
    ...
    var a = i + s / 4,
      l = t.height + t.depth + a + i,
      { span: o, ruleWidth: h, advanceWidth: d } = ct.sqrtImage(l, e),
      f = o.height - h;
    f > t.height + t.depth + a && (a = (a + f - t.height - t.depth) / 2);
    var g = o.height - t.height - a - h;
    t.style.paddingLeft = D(d);
    var y = S.makeVList(
      {
        positionType: "firstBaseline",
        children: [
    ...
    if (n.index) {
      var v = e.havingStyle(q.SCRIPTSCRIPT),
        k = Y(n.index, v, e),
        M = 0.6 * (y.height - y.depth),
        T = S.makeVList(
          {
            positionType: "shift",
            positionData: -M,
        ...
        R = S.makeSpan(["root"], [T]);
      return S.makeSpan(["mord", "sqrt"], [R, y], e);
    } else return S.makeSpan(["mord", "sqrt"], [y], e);
  },
  mathmlBuilder(n, e) {
    var { body: t, index: r } = n;
    return r
      ? new A.MathNode("mroot", [Q(t, e), Q(r, e)])
      : new A.MathNode("msqrt", [Q(t, e)]);
  },
});
var ea = {
  display: q.DISPLAY,
...
O({
  ...
  handler(n, e) {
    var { breakOnTokenText: t, funcName: r, parser: i } = n,
      s = i.parseExpression(!0, t),
      a = r.slice(1, r.length - 5);
    return { type: "styling", mode: i.mode, style: a, body: s };
  },
  htmlBuilder(n, e) {
    var t = ea[n.style],
      r = e.havingStyle(t).withFont("");
    return To(n.body, r, e);
  },
  mathmlBuilder(n, e) {
    var t = ea[n.style],
      r = e.havingStyle(t),
      i = Ae(n.body, r),
      s = new A.MathNode("mstyle", i),
      a = {
        display: ["0", "true"],
        text: ["0", "false"],
        script: ["1", "false"],
      ...
      l = a[n.style];
    return (
      s.setAttribute("scriptlevel", l[0]),
      s.setAttribute("displaystyle", l[1]),
      s
    );
  },
});
var Qd = function (e, t) {
  ...
  if (r)
    if (r.type === "op") {
      ...
      var s =
        r.alwaysHandleSupSub && (t.style.size === q.DISPLAY.size || r.limits);
      return s ? Mo : null;
    } else {
      if (r.type === "accent") return F.isCharacterBox(r.base) ? fi : null;
      if (r.type === "horizBrace") {
        var a = !e.sub;
        return a === r.isOver ? wo : null;
      } else return null;
    }
  else return null;
};
  ...
  htmlBuilder(n, e) {
    ...
    if (o) {
      var L =
        ...
        n.base.type === "op" &&
        n.base.name &&
        (n.base.name === "\\oiint" || n.base.name === "\\oiiint");
      (a instanceof He || L) && (R = D(-a.italic));
    }
    var $;
    if (l && o) {
      (d = Math.max(d, k, l.depth + 0.25 * h.xHeight)),
        (f = Math.max(f, h.sub2));
      var H = h.defaultRuleThickness,
        G = 4 * H;
      if (d - l.depth - (o.height - f) < G) {
        f = G - (d - l.depth) + o.height;
        var U = 0.8 * h.xHeight - (d - l.depth);
        U > 0 && ((d += U), (f -= U));
      }
      var Z = [
        { type: "elem", elem: o, shift: f, marginRight: T, marginLeft: R },
        { type: "elem", elem: l, shift: -d, marginRight: T },
      ];
      $ = S.makeVList({ positionType: "individualShift", children: Z }, e);
    } else if (o) {
      f = Math.max(f, h.sub1, o.height - 0.8 * h.xHeight);
      var I = [{ type: "elem", elem: o, marginLeft: R, marginRight: T }];
      $ = S.makeVList(
        { positionType: "shift", positionData: f, children: I },
        e,
      );
    } else if (l)
      (d = Math.max(d, k, l.depth + 0.25 * h.xHeight)),
        ($ = S.makeVList(
          {
            positionType: "shift",
            positionData: -d,
            children: [{ type: "elem", elem: l, marginRight: T }],
          },
          e,
        ));
    else throw new Error("supsub must have either sup or sub.");
    var de = qn(a, "right") || "mord";
    return S.makeSpan([de], [a, S.makeSpan(["msupsub"], [$])], e);
  },
  mathmlBuilder(n, e) {
    var t = !1,
      r,
      i;
    n.base &&
      n.base.type === "horizBrace" &&
      ((i = !!n.sup), i === n.base.isOver && ((t = !0), (r = n.base.isOver))),
      n.base &&
        (n.base.type === "op" || n.base.type === "operatorname") &&
        (n.base.parentIsSupSub = !0);
    var s = [Q(n.base, e)];
    n.sub && s.push(Q(n.sub, e)), n.sup && s.push(Q(n.sup, e));
    var a;
    if (t) a = r ? "mover" : "munder";
    else if (n.sub)
      if (n.sup) {
        var h = n.base;
        (h && h.type === "op" && h.limits && e.style === q.DISPLAY) ||
        (h &&
          h.type === "operatorname" &&
          h.alwaysHandleSupSub &&
          (e.style === q.DISPLAY || h.limits))
          ? (a = "munderover")
          : (a = "msubsup");
      } else {
        var o = n.base;
        (o &&
          o.type === "op" &&
          o.limits &&
          (e.style === q.DISPLAY || o.alwaysHandleSupSub)) ||
        (o &&
          o.type === "operatorname" &&
          o.alwaysHandleSupSub &&
          (o.limits || e.style === q.DISPLAY))
          ? (a = "munder")
          : (a = "msub");
      }
    else {
      ...
      (l &&
        l.type === "op" &&
        l.limits &&
        (e.style === q.DISPLAY || l.alwaysHandleSupSub)) ||
      (l &&
        l.type === "operatorname" &&
        l.alwaysHandleSupSub &&
        (l.limits || e.style === q.DISPLAY))
        ? (a = "mover")
        : (a = "msup");
    }
    return new A.MathNode(a, s);
  },
});
jt({
  type: "atom",
  htmlBuilder(n, e) {
    return S.mathsym(n.text, n.mode, e, ["m" + n.family]);
  },
  mathmlBuilder(n, e) {
    var t = new A.MathNode("mo", [We(n.text, n.mode)]);
    if (n.family === "bin") {
      var r = ci(n, e);
      ...
      n.family === "punct"
        ...
        : (n.family === "open" || n.family === "close") &&
          t.setAttribute("stretchy", "false");
    return t;
  },
});
var Co = { mi: "italic", mn: "normal", mtext: "normal" };
jt({
  type: "mathord",
  htmlBuilder(n, e) {
    return S.makeOrd(n, e, "mathord");
  },
  mathmlBuilder(n, e) {
    var t = new A.MathNode("mi", [We(n.text, n.mode, e)]),
      r = ci(n, e) || "italic";
    return r !== Co[t.type] && t.setAttribute("mathvariant", r), t;
  },
});
jt({
  type: "textord",
  htmlBuilder(n, e) {
    return S.makeOrd(n, e, "textord");
  },
  mathmlBuilder(n, e) {
    var t = We(n.text, n.mode, e),
      r = ci(n, e) || "normal",
      i;
    return (
      n.mode === "text"
        ? (i = new A.MathNode("mtext", [t]))
        : /[0-9]/.test(n.text)
          ? (i = new A.MathNode("mn", [t]))
          : n.text === "\\prime"
            ? (i = new A.MathNode("mo", [t]))
            : (i = new A.MathNode("mi", [t])),
      r !== Co[i.type] && i.setAttribute("mathvariant", r),
      i
    );
  },
});
...
jt({
  type: "spacing",
  htmlBuilder(n, e) {
    if (yn.hasOwnProperty(n.text)) {
      var t = yn[n.text].className || "";
      if (n.mode === "text") {
        var r = S.makeOrd(n, e, "textord");
        return r.classes.push(t), r;
      } else
        return S.makeSpan(["mspace", t], [S.mathsym(n.text, n.mode, e)], e);
    } else {
      if (gn.hasOwnProperty(n.text))
        return S.makeSpan(["mspace", gn[n.text]], [], e);
      throw new N('Unknown type of space "' + n.text + '"');
    }
  },
  mathmlBuilder(n, e) {
    var t;
    if (yn.hasOwnProperty(n.text))
      ...
      if (gn.hasOwnProperty(n.text)) return new A.MathNode("mspace");
      throw new N('Unknown type of space "' + n.text + '"');
    }
    return t;
  },
...
jt({
  ...
  mathmlBuilder(n, e) {
    var t = new A.MathNode("mtable", [
      new A.MathNode("mtr", [
        ta(),
        new A.MathNode("mtd", [Bt(n.body, e)]),
        ta(),
        new A.MathNode("mtd", [Bt(n.tag, e)]),
      ]),
    ]);
...
var ra = {
  ...
  na = { "\\textbf": "textbf", "\\textmd": "textmd" },
  _d = { "\\textit": "textit", "\\textup": "textup" },
  ia = (n, e) => {
    var t = n.font;
    if (t) {
      if (ra[t]) return e.withTextFontFamily(ra[t]);
      if (na[t]) return e.withTextFontWeight(na[t]);
      if (t === "\\emph")
        return e.fontShape === "textit"
          ? e.withTextFontShape("textup")
          : e.withTextFontShape("textit");
    } else return e;
    return e.withTextFontShape(_d[t]);
  };
O({
  type: "text",
  names: [
  ...
  handler(n, e) {
    var { parser: t, funcName: r } = n,
      i = e[0];
    return { type: "text", mode: t.mode, body: ae(i), font: r };
  },
  htmlBuilder(n, e) {
    var t = ia(n, e),
      r = ce(n.body, t, !0);
...
O({
  ...
  mathmlBuilder(n, e) {
    var t = new A.MathNode("mo", [new A.TextNode("‾")]);
    t.setAttribute("stretchy", "true");
    var r = new A.MathNode("munder", [Q(n.body, e), t]);
    return r.setAttribute("accentunder", "true"), r;
  },
});
O({
  ...
  mathmlBuilder(n, e) {
    return new A.MathNode("mpadded", [Q(n.body, e)], ["vcenter"]);
  },
});
O({
  type: "verb",
  ...
  htmlBuilder(n, e) {
    for (
      var t = sa(n), r = [], i = e.havingStyle(e.style.text()), s = 0;
      s < t.length;
      s++
    ) {
      var a = t[s];
      a === "~" && (a = "\\textasciitilde"),
        r.push(
          S.makeSymbol(a, "Typewriter-Regular", n.mode, i, ["mord", "texttt"]),
        );
    }
    return S.makeSpan(
  ...
  mathmlBuilder(n, e) {
    var t = new A.TextNode(sa(n)),
      r = new A.MathNode("mtext", [t]);
    return r.setAttribute("mathvariant", "monospace"), r;
  },
});
var sa = (n) => n.body.replace(/ /g, n.star ? "␣" : " "),
  At = Yl,
  Ao = `[ \r
	]`,
  ef = "\\\\[a-zA-Z@]+",
...
class aa {
  constructor(e, t) {
    (this.input = void 0),
      ...
      (this.input = e),
      (this.settings = t),
      (this.tokenRegex = new RegExp(af, "g")),
      (this.catcodes = { "%": 14, "~": 13 });
  }
  setCatcode(e, t) {
    this.catcodes[e] = t;
  ...
  lex() {
    ...
    if (t === e.length) return new Ve("EOF", new Ne(this, t, t));
    var r = this.tokenRegex.exec(e);
    if (r === null || r.index !== t)
      throw new N(
        "Unexpected character: '" + e[t] + "'",
        new Ve(e[t], new Ne(this, t, t + 1)),
      );
    var i = r[6] || r[3] || (r[2] ? "\\ " : " ");
...
`,
    ...
    return new Ve(i, new Ne(this, t, this.tokenRegex.lastIndex));
  }
}
class lf {
  constructor(e, t) {
...
m("\\noexpand", function (n) {
  var e = n.popToken();
  return (
    n.isExpandable(e.text) && ((e.noexpand = !0), (e.treatAsRelax = !0)),
    { tokens: [e], numArgs: 0 }
  );
});
m("\\expandafter", function (n) {
  var e = n.popToken();
  return n.expandOnce(!0), { tokens: [e], numArgs: 0 };
});
...
m("\\char", function (n) {
  var e = n.popToken(),
    t,
    r = "";
  if (e.text === "'") (t = 8), (e = n.popToken());
  else if (e.text === '"') (t = 16), (e = n.popToken());
  else if (e.text === "`")
    if (((e = n.popToken()), e.text[0] === "\\")) r = e.text.charCodeAt(1);
    else {
      if (e.text === "EOF") throw new N("\\char` missing argument");
      r = e.text.charCodeAt(0);
    }
  else t = 10;
  if (t) {
    if (((r = la[e.text]), r == null || r >= t))
      throw new N("Invalid base-" + t + " digit " + e.text);
    for (var i; (i = la[n.future().text]) != null && i < t; )
      (r *= t), (r += i), n.popToken();
  }
  return "\\@char{" + r + "}";
});
var wi = (n, e, t, r) => {
  ...
  if (((i = n.consumeArg().tokens), i.length === 1 && i[0].text === "[")) {
    for (
      var o = "", h = n.expandNextToken();
      h.text !== "]" && h.text !== "EOF";

    )
      (o += h.text), (h = n.expandNextToken());
    if (!o.match(/^\s*[0-9]+\s*$/))
      throw new N("Invalid number of arguments: " + o);
    (l = parseInt(o)), (i = n.consumeArg().tokens);
  }
  return (a && r) || n.macros.set(s, { tokens: i, numArgs: l }), "";
};
m("\\newcommand", (n) => wi(n, !1, !0, !1));
m("\\renewcommand", (n) => wi(n, !0, !1, !1));
m("\\providecommand", (n) => wi(n, !0, !0, !0));
m("\\message", (n) => {
...
m("\\show", (n) => {
  var e = n.popToken(),
    t = e.text;
  return console.log(e, n.macros.get(t), At[t], _.math[t], _.text[t]), "";
});
m("\\bgroup", "{");
m("\\egroup", "}");
m("~", "\\nobreakspace");
...
m("\\dots", function (n) {
  var e = "\\dotso",
    t = n.expandAfterFuture().text;
  return (
    t in oa
      ? (e = oa[t])
      : (t.slice(0, 4) === "\\not" ||
          (t in _.math && F.contains(["bin", "rel"], _.math[t].group))) &&
        (e = "\\dotsb"),
    e
  );
});
...
m("\\dotso", function (n) {
  var e = n.future().text;
  return e in ki ? "\\ldots\\," : "\\ldots";
});
m("\\dotsc", function (n) {
  var e = n.future().text;
  return e in ki && e !== "," ? "\\ldots\\," : "\\ldots";
});
m("\\cdots", function (n) {
  var e = n.future().text;
  return e in ki ? "\\@cdots\\," : "\\@cdots";
});
m("\\dotsb", "\\cdots");
m("\\dotsm", "\\cdots");
m("\\dotsi", "\\!\\cdots");
...
m("\\tag@literal", (n) => {
  if (n.macros.get("\\df@tag")) throw new N("Multiple \\tag");
...
var No = D(Xe["Main-Regular"][84][1] - 0.7 * Xe["Main-Regular"][65][1]);
m(
  "\\LaTeX",
  "\\textrm{\\html@mathml{" +
    ("L\\kern-.36em\\raisebox{" + No + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{LaTeX}}",
);
m(
  "\\KaTeX",
  "\\textrm{\\html@mathml{" +
    ("K\\kern-.17em\\raisebox{" + No + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{KaTeX}}",
);
...
var zo = (n) => (e) => {
  ...
  e.macros.beginGroup();
  var o = (f) => (g) => {
    n && (g.macros.set("|", a), i.length && g.macros.set("\\|", l));
    var y = f;
    if (!f && i.length) {
      var v = g.future();
      v.text === "|" && (g.popToken(), (y = !0));
    }
    return { tokens: y ? i : r, numArgs: 0 };
  };
  e.macros.set("|", o(!1)), i.length && e.macros.set("\\|", o(!0));
  var h = e.consumeArg().tokens,
    d = e.expandTokens([...s, ...h, ...t]);
...
class hf {
  constructor(e, t, r) {
    (this.settings = void 0),
      ...
      this.feed(e),
      (this.macros = new lf(of, t.macros)),
      (this.mode = r),
      (this.stack = []);
  }
  feed(e) {
    this.lexer = new aa(e, this.settings);
  }
  switchMode(e) {
    this.mode = e;
  }
  ...
  scanArgument(e) {
    ...
    return (
      this.pushToken(new Ve("EOF", r.loc)), this.pushTokens(i), t.range(r, "")
    );
  }
  consumeSpaces() {
    for (;;) {
  ...
  consumeArg(e) {
    ...
    var i = this.future(),
      ...
      l = 0;
    do {
      if (((s = this.popToken()), t.push(s), s.text === "{")) ++a;
      else if (s.text === "}") {
        if ((--a, a === -1)) throw new N("Extra }", s);
      } else if (s.text === "EOF")
        throw new N(
  ...
  consumeArgs(e, t) {
    if (t) {
      ...
      for (var r = t[0], i = 0; i < r.length; i++) {
        var s = this.popToken();
        if (r[i] !== s.text)
          throw new N("Use of the macro doesn't match its definition", s);
      }
    }
    for (var a = [], l = 0; l < e; l++)
      a.push(this.consumeArg(t && t[l + 1]).tokens);
    return a;
  }
  countExpansion(e) {
    if (
  ...
  expandOnce(e) {
    var t = this.popToken(),
      r = t.text,
      i = t.noexpand ? null : this._getExpansion(r);
    ...
    if (i.numArgs) {
      ...
      for (var l = s.length - 1; l >= 0; --l) {
        ...
        if (o.text === "#") {
          if (l === 0)
            throw new N("Incomplete placeholder at end of macro body", o);
          if (((o = s[--l]), o.text === "#")) s.splice(l + 1, 1);
          else if (/^[1-9]$/.test(o.text)) s.splice(l, 2, ...a[+o.text - 1]);
          else throw new N("Not a valid argument number", o);
        }
      }
    }
  ...
  _getExpansion(e) {
    ...
    if (typeof i == "string") {
      var s = 0;
      if (i.indexOf("#") !== -1)
        for (var a = i.replace(/##/g, ""); a.indexOf("#" + (s + 1)) !== -1; )
          ++s;
      for (
        var l = new aa(i, this.settings), o = [], h = l.lex();
        h.text !== "EOF";

      )
        o.push(h), (h = l.lex());
      o.reverse();
      var d = { tokens: o, numArgs: s };
      return d;
    }
    return i;
  }
  isDefined(e) {
    return (
      this.macros.has(e) ||
      At.hasOwnProperty(e) ||
      _.math.hasOwnProperty(e) ||
      _.text.hasOwnProperty(e) ||
      Do.hasOwnProperty(e)
    );
  }
  isExpandable(e) {
    ...
    return t != null
      ...
      : At.hasOwnProperty(e) && !At[e].primitive;
  }
}
var ha = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
  s0 = Object.freeze({
    "₊": "+",
    "₋": "-",
    "₌": "=",
...
class q0 {
  constructor(e, t) {
    (this.mode = void 0),
      ...
      (this.mode = "math"),
      (this.gullet = new hf(e, t, this.mode)),
      (this.settings = t),
  ...
  parseExpression(e, t) {
    for (var r = []; ; ) {
      ...
      var i = this.fetch();
      if (
        q0.endOfExpression.indexOf(i.text) !== -1 ||
        (t && i.text === t) ||
        (e && At[i.text] && At[i.text].infix)
      )
        break;
  ...
  handleInfixNodes(e) {
    for (var t = -1, r, i = 0; i < e.length; i++)
      if (e[i].type === "infix") {
        if (t !== -1)
          throw new N("only one infix operator per group", e[i].token);
    ...
    if (t !== -1 && r) {
      ...
      return (
        r === "\\\\abovefrac"
          ? (h = this.callFunction(r, [s, e[t], a], []))
          : (h = this.callFunction(r, [s, a], [])),
        [h]
      );
    } else return e;
  }
  ...
  formatUnsupportedCmd(e) {
    ...
    var i = { type: "text", mode: this.mode, body: t },
      s = {
        type: "color",
        mode: this.mode,
  ...
  parseAtom(e) {
    ...
    for (var r, i; ; ) {
      ...
      if (s.text === "\\limits" || s.text === "\\nolimits") {
        if (t && t.type === "op") {
          var a = s.text === "\\limits";
          (t.limits = a), (t.alwaysHandleSupSub = !0);
        } else if (t && t.type === "operatorname")
          t.alwaysHandleSupSub && (t.limits = s.text === "\\limits");
        else throw new N("Limit controls must follow a math operator", s);
        this.consume();
      } else if (s.text === "^") {
        if (r) throw new N("Double superscript", s);
        r = this.handleSupSubscript("superscript");
      } else if (s.text === "_") {
        if (i) throw new N("Double subscript", s);
        ...
        var h = ha.test(s.text),
          d = [];
        for (d.push(new Ve(s0[s.text])), this.consume(); ; ) {
          var f = this.fetch().text;
          if (!s0[f] || ha.test(f) !== h) break;
          d.unshift(new Ve(s0[f])), this.consume();
        }
        var g = this.subparse(d);
        h
          ? (i = { type: "ordgroup", mode: "math", body: g })
          : (r = { type: "ordgroup", mode: "math", body: g });
      } else break;
    }
    return r || i
      ? { type: "supsub", mode: this.mode, base: t, sup: r, sub: i }
      : t;
  }
  parseFunction(e, t) {
    var r = this.fetch(),
    ...
    if ((this.consume(), t && t !== "atom" && !s.allowedInArgument))
      throw new N(
        "Got function '" + i + "' with no arguments" + (t ? " as " + t : ""),
        r,
      );
    if (this.mode === "text" && !s.allowedInText)
      throw new N("Can't use function '" + i + "' in text mode", r);
    if (this.mode === "math" && s.allowedInMath === !1)
      throw new N("Can't use function '" + i + "' in math mode", r);
    var { args: a, optArgs: l } = this.parseArguments(i, s);
    return this.callFunction(i, a, l, r, e);
  }
  callFunction(e, t, r, i, s) {
    var a = { funcName: e, parser: this, token: i, breakOnTokenText: s },
      l = At[e];
    if (l && l.handler) return l.handler(a, t, r);
  ...
  parseArguments(e, t) {
    ...
    for (var i = [], s = [], a = 0; a < r; a++) {
      var l = t.argTypes && t.argTypes[a],
        o = a < t.numOptionalArgs;
      ((t.primitive && l == null) ||
        (t.type === "sqrt" && a === 1 && s[0] == null)) &&
        (l = "primitive");
      var h = this.parseGroupOfType("argument to '" + e + "'", l, o);
      if (o) s.push(h);
      else if (h != null) i.push(h);
  ...
  parseGroupOfType(e, t, r) {
    switch (t) {
      ...
      case "primitive": {
        ...
        if (a == null) throw new N("Expected group as " + e, this.fetch());
        return a;
      }
      case "original":
      case null:
  ...
  parseRegexGroup(e, t) {
    for (
      var r = this.fetch(), i = r, s = "", a;
      (a = this.fetch()).text !== "EOF" && e.test(s + a.text);

    )
      (i = a), (s += i.text), this.consume();
    if (s === "") throw new N("Invalid " + t + ": '" + r.text + "'", r);
    return r.range(i, s);
  }
  parseColorGroup(e) {
  ...
  parseSizeGroup(e) {
    ...
    if (!Ll(s)) throw new N("Invalid unit: '" + s.unit + "'", t);
  ...
  parseArgumentGroup(e, t) {
    ...
    var a = { type: "ordgroup", mode: this.mode, loc: r.loc, body: s };
  ...
  parseGroup(e, t) {
    ...
    if (i === "{" || i === "\\begingroup") {
      ...
      var l = this.parseExpression(!1, a),
        o = this.fetch();
      this.expect(a),
      ...
      s == null && i[0] === "\\" && !Do.hasOwnProperty(i))
    ) {
  ...
  parseSymbol() {
    ...
    if (/^\\verb[^a-zA-Z]/.test(t)) {
      ...
      return (
        (r = r.slice(1, -1)), { type: "verb", mode: "text", body: r, star: i }
      );
    }
    ua.hasOwnProperty(t[0]) &&
      !_[this.mode][t[0]] &&
    ...
    if (_[this.mode][t]) {
      ...
      var l = _[this.mode][t].group,
        o = Ne.range(e),
        h;
      if (Xc.hasOwnProperty(l)) {
        var d = l;
        h = { type: "atom", mode: this.mode, family: d, loc: o, text: t };
      } else h = { type: l, mode: this.mode, loc: o, text: t };
      a = h;
      ...
      this.settings.strict &&
        ...
        (a = { type: "textord", mode: "text", loc: Ne.range(e), text: t });
    else return null;
    if ((this.consume(), s))
      for (var f = 0; f < s[0].length; f++) {
        var g = s[0][f];
        if (!vn[g]) throw new N("Unknown accent ' " + g + "'", e);
        var y = vn[g][this.mode] || vn[g].text;
        if (!y)
          throw new N(
...
var uf = function (e, t) {
  ...
  Eo = function (e, t, r) {
    ...
    var i = S.makeSpan(["katex-error"], [new He(t)]);
    return (
  ...
  Rf = {
    ...
    SETTINGS_SCHEMA: u0,
    __parse: cf,
    __renderToDomTree: Mi,
    __renderToHTMLTree: df,
    __setFontMetrics: Wc,
    __defineSymbol: u,
    __defineFunction: O,
    __defineMacro: m,
...
const ca = "contextList";
function If() {
  return (n) => {
    Uo(n, (e) => {
      if (!Qo(e) || e.name !== ca) return;
...
function mf(n) {
  if (typeof n != "object" || n == null || !("props" in n) || n.props == null)
    return;
  const e = n.props;
  if (e.node?.tagName === Ho) return parseInt(e.index);
}
const da = fa.div`gap-6 border-b pb-4 my-4 context-list border-token-border-default`;
function Ff({ children: n }) {
  const e = pa.useContext(Ko),
    t = Array.isArray(n) ? n : Vo([n]);
  if (t.length === 0 || e?.analyticsMetadata.turnIndex === void 0) return null;
  const [r, ...i] = t,
    s = mf(r);
  if (s != null && e != null) {
    const a = e?.contentReferences?.[s],
      l = a?.type === "image_v2",
      o = a?.type === "optimistic_image_citation";
    if (l || o)
      return ze.jsxs(da, {
        className: "flex w-full",
        children: [
          ze.jsx("div", { className: "grow leading-normal", children: i }),
          ze.jsxs("div", {
            ...
            children: [
              ...
              o && ze.jsx(yf, { optimisticRef: a }),
            ],
          }),
        ],
      });
  }
  return ze.jsx(da, { className: "leading-normal", children: t });
}
const Bo = fa.button`not-prose flex w-full h-fit	items-center justify-center overflow-hidden rounded-lg max-h-48`;
function gf({ imageRef: n, analyticsMetadata: e }) {
  const t = n.images[0],
    r = t.thumbnail_size.width / t.thumbnail_size.height,
    i = th(t, { width: 200, height: Math.max(Math.round(200 / r), 112) }),
    { isSuccess: s } = rh(i),
    a = Yo.useStore(),
    l = pa.useRef(!1),
    o = { ...Wo(e), type: "context_list_image_thumbnail", image_url: i };
  return (
    l.current ||
      ((l.current = !0),
      Ni.logEventWithStatsig(
    ...
    ze.jsx(Bo, {
      onClick: () => {
        a.setCurrentImage({ image: t, source: jo.Turn, analyticsMetadata: e }),
          Ni.logEventWithStatsig(
      ...
      children: ze.jsx(_o.img, {
        src: i,
        className: "w-full object-cover",
        alt: t.title,
        initial: { opacity: 0 },
        animate: s ? { opacity: 1 } : {},
        whileHover: { scale: 1.1, transition: nh },
      }),
    })
  );
}
function yf({ optimisticRef: n }) {
  return ze.jsx(Bo, {
    children:
      n.status === "done"
        ? ze.jsx(Xo, {
        ...
        : ze.jsx("div", {
            className:
              "bg-token-main-surface-tertiary h-24 w-full animate-pulse",
          }),
  });
}
export {
...
//# sourceMappingURL=gkp5860wafdf24mv.js.map
