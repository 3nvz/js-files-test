const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/mgs6y88d6jgbxxbo.js",
      "assets/hgyrt6j47bbfyjrt.js",
      "assets/lip667d8t42poxum.js",
      "assets/root-nsehtib5.css",
      "assets/lldlc1iohuff645g.js",
      "assets/m2ge2j4nru1zawef.js",
      "assets/okkj3my0355ooax9.js",
      "assets/e6avexgvsnyzdql7.js",
      "assets/lt33kyg33yr7b6zd.js",
      "assets/bmbgs6hwth8vxxct.js",
    ]),
) => i.map((i) => d[i]);
import { _ as F } from "./hgyrt6j47bbfyjrt.js";
import {
  au as De,
  _,
  P as Ar,
...
function j(n) {
  return (
    Object.prototype.toString.call(n).slice(8, -1).toLowerCase() === "object"
  );
}
    ...
    function n(e) {
      ...
      (this.settings = e),
        ...
        (this.onEventMethodCall =
          (t = e.onEventMethodCall) !== null && t !== void 0
            ? t
            : function () {}),
        (this.onFinishedEvent =
          (r = e.onFinishedEvent) !== null && r !== void 0
            ? r
            : function () {});
    }
    return n;
  ...
  zr = (function () {
    ...
    return (
      ...
      (n.prototype.page = function (e, t, r, i, o) {
        ...
        return (
          e !== null &&
            ((a.category = e),
            (a.properties =
              (u = a.properties) !== null && u !== void 0 ? u : {}),
      ...
      (n.prototype.alias = function (e, t, r, i) {
        ...
        return (
          t !== null && (o.previousId = t),
          e === void 0
            ? this.normalize(_(_({}, o), this.baseEvent()))
            : this.normalize(_(_({}, this.baseEvent()), o))
        );
      }),
      ...
      (n.prototype.context = function (e) {
        ...
        return (
          i.forEach(function (a) {
            a !== "context" &&
              (r.includes(a) ? $e(u, a, e[a]) : $e(o, a, e[a]));
          }),
          [o, u]
        );
      }),
      (n.prototype.normalize = function (e) {
        var t,
          r,
          i = Object.keys(
            (t = e.integrations) !== null && t !== void 0 ? t : {},
          ).reduce(function (d, v) {
            var h, p;
            return _(
              _({}, d),
              ((h = {}),
              (h[v] = !!(
                !((p = e.integrations) === null || p === void 0) && p[v]
              )),
              h),
            );
          }, {});
        ...
        var o = _(
            _({}, i),
            (r = e.options) === null || r === void 0 ? void 0 : r.integrations,
          ),
  ...
  it = (function () {
    function n(e) {
      ...
      (this.callbacks = {}),
        (this.warned = !1),
        (this.maxListeners =
          (t = e?.maxListeners) !== null && t !== void 0 ? t : 10);
    }
    return (
      (n.prototype.warnIfPossibleMemoryLeak = function (e) {
        this.warned ||
          (this.maxListeners &&
      ...
      (n.prototype.off = function (e, t) {
        var r,
          i = (r = this.callbacks[e]) !== null && r !== void 0 ? r : [],
    ...
    return (
      (e.prototype.push = function () {
        ...
        var o = r.map(function (u) {
          ...
          return a > t.maxAttempts || t.includes(u)
            ? !1
            : (t.queue.push(u), !0);
        });
        return (
          (this.queue = this.queue.sort(function (u, a) {
      ...
      (e.prototype.pushWithBackoff = function (t, r) {
        var i = this;
        if ((r === void 0 && (r = 0), r == 0 && this.getAttempts(t) === 0))
...
var Gr = (function () {
      ...
      (n.prototype.flush = function () {
        if (this.logs.length > 1) {
          var e = this._logs.reduce(function (t, r) {
            ...
            var c =
              (u =
                (o = r.time) === null || o === void 0
                  ? void 0
                  : o.toISOString()) !== null && u !== void 0
                ? u
                : "";
            return (
              t[c] && (c = "".concat(c, "-").concat(Math.random())),
              _(_({}, t), ((i = {}), (i[c] = a), i))
            );
          }, {});
  ...
  Zt = (function () {
    ...
    return (
      (n.prototype.increment = function (e, t, r) {
        t === void 0 && (t = 1),
          this.metrics.push({
            metric: e,
            value: t,
  ...
  ie = (function () {
    function n(e) {
      ...
      (this.retry = (t = e.retry) !== null && t !== void 0 ? t : !0),
        (this.type =
          (r = e.type) !== null && r !== void 0 ? r : "plugin Error"),
    ...
    return (
      ...
      (n.prototype.updateEvent = function (e, t) {
        ...
        if (e.split(".")[0] === "integrations") {
          var i = e.split(".")[1];
          if (
            ((r = this.event.integrations) === null || r === void 0
              ? void 0
              : r[i]) === !1
          )
            return this.event;
...
function ye(n, e) {
  ...
  var i = Xr(function () {
    ...
    .catch(function (o) {
      ...
      return o instanceof ie
        ? (n.log("warn", o.type, {
            plugin: e.name,
            error: o,
          }),
          o)
        : (n.log("error", "plugin Error", {
            plugin: e.name,
            error: o,
          }),
...
var Yr = (function (n) {
    ...
    return (
      (e.prototype.register = function (t, r, i) {
        return R(this, void 0, void 0, function () {
          var o,
            u,
            a = this;
            ...
            switch (c.label) {
              case 0:
                return (
                  ...
                  r.type === "destination" && r.name !== "Segment.io"
                    ? (r.load(t, i).catch(o), [3, 4])
                    : [3, 1]
                );
              case 1:
        ...
        return R(this, void 0, void 0, function () {
          ...
          return q(this, function (u) {
            switch (u.label) {
              ...
              case 2:
                return (
                  (this.plugins = this.plugins.filter(function (a) {
        ...
        return R(this, void 0, void 0, function () {
          ...
          return q(this, function (i) {
            return (
              ...
              [
                2,
                this.deliver(t).catch(function (o) {
                  var u = r.enqueuRetry(o, t);
                  return u
                    ? r.subscribeToDelivery(t)
                    : (t.setFailedDelivery({
                        reason: o,
                      }),
                      t);
      ...
      (e.prototype.availableExtensions = function (t) {
        var r = this.plugins.filter(function (v) {
            ...
            var g = void 0;
            return (
              (h = v.alternativeNames) === null ||
                h === void 0 ||
                h.forEach(function (S) {
                  t[S] !== void 0 && (g = t[S]);
                }),
              (w = (p = t[v.name]) !== null && p !== void 0 ? p : g) !== null &&
              w !== void 0
                ? w
                : (v.name === "Segment.io" ? !0 : t.All) !== !1
            );
          }),
          i = $r(r, "type"),
          o = i.before,
              ...
              case 0:
                ...
                t.attempts > 1 && this.emit("delivery_retry", t),
                  (o = this.availableExtensions(
                    (r = t.event.integrations) !== null && r !== void 0
                      ? r
                      : {},
                  )),
                  (u = o.before),
              ...
              case 8:
                return (
                  (p = this.availableExtensions(
                    (i = t.event.integrations) !== null && i !== void 0
                      ? i
                      : {},
                  )),
                  (w = p.destinations),
  ...
  return R(this, void 0, void 0, function () {
    ...
    return q(this, function (u) {
      switch (u.label) {
        ...
        case 4:
          return r?.callback
            ? [4, Kr(o, r.callback, en(i, r.timeout))]
            : [3, 6];
        case 5:
          (o = u.sent()), (u.label = 6);
        case 6:
...
function He(n, e, t, r, i) {
  var o,
    ...
    s = [n, e, t, r, i],
    l = s.filter(oe);
  l[0] !== void 0 && l[1] !== void 0 && ((a = l[0]), (c = l[1])),
    l.length === 1 && ((a = null), (c = l[0]));
  var f = s.find(de),
...
var Xe = function (n) {
  return function () {
    for (var e, t, r, i = [], o = 0; o < arguments.length; o++)
      i[o] = arguments[o];
    for (
      var u = {}, a = ["callback", "options", "traits", "id"], c = 0, s = i;
      c < s.length;
      c++
    ) {
      var l = s[c],
    ...
    return [
      (e = u.id) !== null && e !== void 0 ? e : n.id(),
      (t = u.traits) !== null && t !== void 0 ? t : {},
      (r = u.options) !== null && r !== void 0 ? r : {},
      u.callback,
    ];
  };
};
...
var an = (function () {
    function n(e) {
      var t = this,
        ...
        a;
      if (
        ((this.host = (r = e?.host) !== null && r !== void 0 ? r : tr),
        (this.sampleRate =
          (i = e?.sampleRate) !== null && i !== void 0 ? i : 1),
        (this.flushTimer =
          (o = e?.flushTimer) !== null && o !== void 0 ? o : 30 * 1e3),
        (this.maxQueueSize =
          (u = e?.maxQueueSize) !== null && u !== void 0 ? u : 20),
        (this.protocol =
          (a = e?.protocol) !== null && a !== void 0 ? a : "https"),
        (this.queue = []),
        this.sampleRate > 0)
      ) {
        var c = !1,
...
function sn(n) {
  ...
  for (var e in n) if (!un.includes(e)) return !1;
  return !0;
}
var cn = function (n, e) {
...
var se = function (n, e) {
    ...
    var t = n.context,
      r;
    n.type === "page" &&
      ((r = n.properties && vn(n.properties, Object.keys(e))),
      (n.properties = y(
        y(y({}, e), n.properties),
        n.name
          ? {
...
function lt(n) {
  for (
    var e = n.constructor.prototype, t = 0, r = Object.getOwnPropertyNames(e);
    t < r.length;
    t++
  ) {
    var i = r[t];
    ...
    if (!(typeof document > "u")) {
      (u = _e({}, e, u)),
        typeof u.expires == "number" &&
          (u.expires = new Date(Date.now() + u.expires * 864e5)),
...
var wn = 365,
    ...
    return (
      ...
      (n.prototype.set = function (e, t) {
        typeof t == "string"
          ? B.set(e, t, this.opts())
          : t === null
            ? B.remove(e, this.opts())
            : B.set(e, JSON.stringify(t), this.opts());
      }),
  ...
  Sn = (function () {
    function n() {}
    return (
      (n.prototype.localStorageWarning = function (e, t) {
        console.warn(
          "Unable to access ".concat(e, ", localStorage may be ").concat(t),
        );
      }),
      (n.prototype.get = function (e) {
        var t;
...
function vr(n) {
  return (
    n &&
    n.stores &&
    Array.isArray(n.stores) &&
    n.stores.every(function (e) {
...
var Le = function (n, e, t, r) {
    console.warn(
      ""
        .concat(n.constructor.name, ": Can't ")
        .concat(e, ' key "')
        .concat(t, '" | Err: ')
        .concat(r),
    );
    ...
    function n(e, t) {
      ...
      (this.options = {}),
        ...
        (this.anonymousId = function (s) {
          ...
          if (s === void 0) {
            var d =
              (l = r.identityStore.getAndSync(r.anonKey)) !== null &&
              l !== void 0
                ? l
                : (f = r.legacySIO()) === null || f === void 0
                  ? void 0
                  : f[0];
            if (d) return d;
          }
          return s === null
            ? (r.identityStore.set(r.anonKey, null),
              r.identityStore.getAndSync(r.anonKey))
            : (r.identityStore.set(r.anonKey, s ?? at()),
              r.identityStore.getAndSync(r.anonKey));
        }),
        (this.traits = function (s) {
          ...
          if (!r.options.disable)
            return (
              ...
              (l = r.traitsStore.get(r.traitsKey)) !== null && l !== void 0
                ? l
                : {}
            );
        }),
        ...
        (this.idKey =
          (o = (i = e.cookie) === null || i === void 0 ? void 0 : i.key) !==
            null && o !== void 0
            ? o
            : J.cookie.key),
        (this.traitsKey =
          (a =
            (u = e.localStorage) === null || u === void 0 ? void 0 : u.key) !==
            null && a !== void 0
            ? a
            : J.localStorage.key),
      ...
      c &&
        typeof c == "object" &&
        (c.id && this.id(c.id), c.traits && this.traits(c.traits)),
        lt(this);
    }
    return (
      (n.prototype.legacySIO = function () {
...
var Pn = function (n) {
    ...
    return m(void 0, void 0, void 0, function () {
      ...
      return b(this, function (o) {
        switch (o.label) {
          ...
          case 1:
            return t < r.length
              ? ((i = r[t]), [4, Te(n, i).catch(console.error)])
              : [3, 4];
          case 2:
            o.sent(), (o.label = 3);
          case 3:
  ...
  Dn = (function () {
    ...
    return (
      Object.defineProperty(n.prototype, "calls", {
        get: function () {
      ...
      (n.prototype.add = function () {
        ...
        t.forEach(function (i) {
          ...
          o.includes(i.method) &&
            !gr(i.args) &&
            (i.args = A(A([], i.args, !0), [ar()], !1)),
            e.calls[i.method]
              ? e.calls[i.method].push(i)
              : (e.calls[i.method] = [i]);
        });
      }),
      ...
      (n.prototype._createChainableMethod = function (e) {
        ...
        return function () {
          for (var r, i = [], o = 0; o < arguments.length; o++)
            i[o] = arguments[o];
          return t.instance
            ? ((r = t.instance)[e].apply(r, i), t)
            : (t._preInitBuffer.add(new tt(e, i)), t);
        };
      }),
      n
    );
...
var pt = (function (n) {
    ...
    function e(t, r, i, o, u) {
      ...
      (a.settings = new Tn(t)),
        (a.queue =
          i ?? jn("".concat(t.writeKey, ":event-queue"), r?.retryQueue, f));
      var d = r?.storage;
      return (
        (a._universalStorage = a.createStore(f, d, l)),
        (a._user =
          o ??
          new dt(
            y(
        ...
        (a.integrations =
          (s = r?.integrations) !== null && s !== void 0 ? s : {}),
        (a.options = r ?? {}),
        lt(a),
        a
      );
    ...
    return (
      (e.prototype.createStore = function (t, r, i) {
        return t
          ? new K([new ft()])
          : r && vr(r)
            ? new K(et(hr(r.stores, i)))
            : new K(
                et([
                  C.LocalStorage,
                  {
        ...
        return m(this, void 0, void 0, function () {
          ...
          return b(this, function (d) {
            return (
              ...
              [
                2,
                this._dispatch(l, s).then(function (v) {
                  return (
                    f.emit("track", u, v.event.properties, v.event.options), v
                  );
                }),
              ]
            );
        ...
        return m(this, void 0, void 0, function () {
          ...
          return b(this, function (v) {
            return (
              ...
              [
                2,
                this._dispatch(f, l).then(function (h) {
                  return (
                    d.emit("page", u, a, h.event.properties, h.event.options), h
                  );
                }),
              ]
            );
      ...
      (e.prototype.identify = function () {
        ...
        return m(this, void 0, void 0, function () {
          ...
          return b(this, function (d) {
            return (
              (i = ce(t)),
              (o = Xe(this._user).apply(void 0, t)),
              (u = o[0]),
              (a = o[1]),
              (c = o[2]),
              (s = o[3]),
              this._user.identify(u, a),
              (l = this.eventFactory.identify(
                this._user.id(),
                this._user.traits(),
                c,
                this.integrations,
      ...
      (e.prototype.group = function () {
        ...
        return this._dispatch(v, l).then(function (h) {
          return (
            t.emit("group", h.event.groupId, h.event.traits, h.event.options), h
          );
        });
      }),
          ...
          return b(this, function (v) {
            return (
              ...
              [
                ...
                this._dispatch(f, l).then(function (h) {
                  return (
                    d.emit("screen", u, a, h.event.properties, h.event.options),
                    h
                  );
                }),
              ]
      ...
      (e.prototype._dispatch = function (t, r) {
        return m(this, void 0, void 0, function () {
          ...
          return b(this, function (o) {
            return (
              (i = new N(t)),
              ge() && !this.options.retryQueue
                ? [2, i]
                : [
                    2,
                    tn(i, this.queue, this, {
                      callback: r,
                      debug: this._debug,
                      ...
                      return b(this, function (c) {
                        switch (c.label) {
                          case 0:
                            return [
                              4,
                              F(() => Promise.resolve().then(() => ci), void 0),
                            ];
                          case 1:
                            return (
                              (o = c.sent().sourceMiddlewarePlugin),
                              (u = {}),
      ...
      (e.prototype.addDestinationMiddleware = function (t) {
        for (var r = [], i = 1; i < arguments.length; i++)
          r[i - 1] = arguments[i];
        return (
          this.queue.plugins.filter(sr).forEach(function (o) {
            (t === "*" || o.name.toLowerCase() === t.toLowerCase()) &&
              o.addMiddleware.apply(o, r);
          }),
          ...
          m(this, void 0, void 0, function () {
            return b(this, function (r) {
              return [
                2,
                Promise.all(
                  this.queue.plugins.map(function (i) {
      ...
      Object.defineProperty(e.prototype, "Integrations", {
        get: function () {
          console.warn(U);
          var t = this.queue.plugins
            .filter(function (r) {
              return r.type === "destination";
            })
            .reduce(function (r, i) {
              var o = "".concat(
                  i.name.toLowerCase().replace(".", "").split(" ").join("-"),
                  "Integration",
                ),
                u = window[o];
              if (!u) return r;
...
var Rn =
  ...
  qn = function () {
    var n,
      e = Array.prototype.slice.call(document.querySelectorAll("script"));
    return (
      e.forEach(function (t) {
        var r,
          i = (r = t.getAttribute("src")) !== null && r !== void 0 ? r : "",
          o = Rn.exec(i);
        o && o[1] && (n = o[1]);
      }),
      n
  ...
  Nn = function () {
    var n,
      e = Me ?? ((n = ht()) === null || n === void 0 ? void 0 : n._cdn);
    return e;
  },
  Ln = function (n) {
    var e = ht();
      ...
      return (
        ...
        e
          ? n
            ? [
                2,
                e.getHighEntropyValues(n).catch(function () {
                  return e.toJSON();
                }),
              ]
            : [2, e.toJSON()]
        ...
        (this.enrich = function (t) {
          ...
          s &&
            ...
            Wn(
              a,
              o,
              (i = e.instance.options.disableClientPersistence) !== null &&
                i !== void 0
                ? i
                : !1,
            );
...
function Ue(n, e) {
  ...
  return new Promise(function (i, o) {
    ...
    v
      ? (u = v.parentElement) === null || u === void 0 || u.insertBefore(a, v)
...
function Xn() {
  ...
  function t(i, o) {
    return function () {
      ...
      return (
        e.default(u, "address." + i) ||
        e.default(u, i) ||
        (o ? e.default(u, "address." + o) : null) ||
        (o ? e.default(u, o) : null) ||
        e.default(a, "address." + i) ||
        e.default(a, i) ||
        (o ? e.default(a, "address." + o) : null) ||
        (o ? e.default(a, o) : null)
      );
    };
  }
...
function _r() {
  ...
  return (
    ...
    (Se.is = function (e, t) {
      return typeof e != "string" || (t && /^\d{4}-\d{2}-\d{2}/.test(e) === !1)
        ? !1
        : n.test(e);
    }),
    Se
...
function ae() {
  ...
  function a(l, f) {
    (f = f || {}),
      ...
      "timestamp" in l
        ? (l.timestamp = i.default(l.timestamp))
  ...
  (c.proxy = function (l) {
    ...
    return (
      d &&
      (typeof d == "function" && (d = d.call(this) || {}),
      f.length === 0
        ? this.opts.clone
          ? s(d)
          : d
        : ((d = o.default(d, f.join("."))), this.opts.clone ? s(d) : d))
    );
  }),
    (c.field = function (l) {
      var f = this.obj[l];
    ...
    (c.options = function (l) {
      ...
      if (this.enabled(l)) {
        var v = this.integrations(),
          h = v[l] || o.default(v, l);
        return (
          typeof h != "object" && (h = o.default(this.options(), l)),
          typeof h == "object" ? h : {}
        );
      }
    }),
    ...
    (c.enabled = function (l) {
      ...
      var d = f && r.default(l),
        v = this.integrations();
      if (
        (v.providers && v.providers.hasOwnProperty(l) && (d = v.providers[l]),
        v.hasOwnProperty(l))
      ) {
        var h = v[l];
    ...
    (c.traits = function (l) {
      ...
      for (var v in l)
        if (Object.prototype.hasOwnProperty.call(l, v)) {
          var h =
            this[v] == null ? this.proxy("options.traits." + v) : this[v]();
          if (h == null) continue;
          (f[l[v]] = h), delete f[v];
        }
      return f;
...
function wr() {
  ...
  return (
    ...
    (c.avatar = function () {
      ...
      return (
        t.default(s, "avatar") ||
        t.default(s, "photoUrl") ||
        t.default(s, "avatarUrl")
      );
    }),
    (c.position = function () {
      var s = this.traits();
...
function mt() {
  ...
  (a.action = function () {
    ...
    (a.revenue = function () {
      ...
      return (
        !s && l && l.match(f) && (s = this.proxy("properties.total")), c(s)
      );
    }),
    (a.cents = function () {
      var s = this.revenue();
  ...
  function c(s) {
    if (s) {
      ...
      if (
        typeof s == "string" &&
        ((s = s.replace(/\$/g, "")), (s = parseFloat(s)), !isNaN(s))
      )
        return s;
    }
  }
...
function ke(n, e) {
  ...
  return (
    n.type === "track" && (t = new te.Track(n, e)),
...
function Ae(n, e) {
  var t = e.methodName,
    ...
    u = o === void 0 ? !1 : o;
  n.stats.increment(
    "analytics_js.integration.invoke".concat(u ? ".error" : ""),
    1,
    ["method:".concat(t), "integration_name:".concat(r), "type:".concat(i)],
  );
}
var li = (function () {
  function n(e, t) {
  ...
  return (
    ...
    (n.prototype.unload = function (e, t) {
      var r, i;
      return (i = (r = this.action).unload) === null || i === void 0
        ? void 0
        : i.call(r, e, t);
    }),
    n
      ...
      e.forEach(function (r) {
        ...
        if (t[r] === void 0)
          throw new Error(
            "Plugin: "
              .concat(
                (i = t.name) !== null && i !== void 0 ? i : "unknown",
    ...
    return b(this, function (c) {
      switch (c.label) {
        ...
        case 7:
          c.sent(), (c.label = 8);
        case 8:
          return typeof window[n.libraryName] == "function"
      ...
      switch (v.label) {
        case 0:
          return (
            ...
            (l =
              (a =
                (u = n.middlewareSettings) === null || u === void 0
                  ? void 0
                  : u.routingRules) !== null && a !== void 0
                ? a
                : []),
            (f = ((c = n.remotePlugins) !== null && c !== void 0 ? c : []).map(
              function (h) {
                ...
                (p = s(w)) === null || p === void 0
                  ...
                  : p.catch(function (S) {
                      ...
                      I.log("error", "Error sending batch", S),
                        h <=
                          ((E = e?.maxRetries) !== null && E !== void 0
                            ? E
                            : 10) &&
                          (S.name === "RateLimitError" && (c = S.retryTimeout),
                          i.push.apply(i, w),
                          i.map(function (O) {
                            if ("_metadata" in O) {
                              var P = O;
...
function Si(n) {
  function e(t, r) {
    return Fe(t, {
      ...
      if (i.status === 429) {
        var u =
            (o = i.headers) === null || o === void 0
              ? void 0
              : o.get("x-ratelimit-reset"),
...
function Ei(n, e, t, r, i) {
  ...
  var p = (o = t?.maybeBundledConfigIds) !== null && o !== void 0 ? o : {},
    w = [];
  return (
    c.sort().forEach(function (g) {
      var S;
      ((S = p[g]) !== null && S !== void 0 ? S : []).forEach(function (E) {
        w.push(E);
      });
    }),
    t?.addBundledMetadata !== !1 &&
      (e._metadata = y(y({}, e._metadata), {
        bundled: c.sort(),
        unbundled: s.sort(),
        bundledIds: w,
...
function Pi(n, e) {
  ...
  return (
    (e.previousId =
      (i =
        (r = (t = e.previousId) !== null && t !== void 0 ? t : e.from) !==
          null && r !== void 0
          ? r
          : u.id()) !== null && i !== void 0
        ? i
...
function Or(n, e, t) {
  ...
  var u = (r = e?.apiKey) !== null && r !== void 0 ? r : "",
    a = n.options.disableClientPersistence
      ? new ot(n.queue.queue.maxAttempts, [])
      : new ct(n.queue.queue.maxAttempts, "".concat(u, ":dest-Segment.io")),
    c = new Set(),
    s = !1,
        ...
        return ge()
          ...
          : (c.add(g),
            ...
            [
              2,
              h
                .dispatch("".concat(d, "/").concat(S), Ei(n, E, e, t, g))
                .then(function () {
                  return g;
                })
                .catch(function (O) {
                  if (
                    (g.log("error", "Error sending event", O),
...
var Je,
  ...
  Ai = st(),
  Qt =
    (Je = ($t = Ai).__SEGMENT_INSPECTOR__) !== null && Je !== void 0
      ? Je
...
function Mi(n, e) {
  var t = e ?? yt();
  return Fe("".concat(t, "/v1/projects/").concat(n, "/settings"))
    .then(function (r) {
      return r.ok
        ? r.json()
...
function ki(n) {
  ...
  return (
    ...
    ((r =
      (t =
        (e = n.middlewareSettings) === null || e === void 0
          ? void 0
          : e.routingRules) === null || t === void 0
        ? void 0
      ...
      return b(this, function (x) {
        switch (x.label) {
          case 0:
            return (
              ...
              (f = i?.filter(function (M) {
                return (
                  typeof M == "function" && typeof M.pluginName == "string"
                );
              })),
              ki(e)
                ? [
                    4,
                    F(() => import("./lro4l4xv2rzlaxz6.js"), []).then(
                      function (M) {
                        return M.tsubMiddleware(
                          e.middlewareSettings.routingRules,
                        );
                      },
                    ),
                  ]
            ...
            return (
              ...
              Ci(e) || o.length > 0
                ? [
                    4,
                    F(
                      () => import("./m2ge2j4nru1zawef.js"),
                      __vite__mapDeps([5, 6, 1, 2, 3]),
                    ).then(function (M) {
          ...
          case 7:
            x.sent(), (x.label = 8);
          case 8:
            return !((a = r.plan) === null || a === void 0) && a.track
              ? [
                  4,
                  F(
                    () => import("./lt33kyg33yr7b6zd.js"),
                    __vite__mapDeps([8, 6, 1, 2, 3]),
                  ).then(function (M) {
                    var G;
                    return M.schemaFilter(
                      (G = r.plan) === null || G === void 0 ? void 0 : G.track,
                      e,
                    );
                  }),
                ]
          ...
          case 11:
            return (
              ...
              [
                4,
                hi(e, t.integrations, S, r, d, f).catch(function () {
                  return [];
                }),
              ]
            );
          case 12:
            return (
              ...
              w && I.push(w),
              (O =
                (((c = r.integrations) === null || c === void 0
                  ? void 0
                  : c.All) === !1 &&
                  !r.integrations["Segment.io"]) ||
                (r.integrations && r.integrations["Segment.io"] === !1)),
              O
                ? [3, 14]
                : ((k = (P = I).push),
          ...
          case 16:
            return (
              x.sent(),
              Object.entries(
                (s = e.enabledMiddleware) !== null && s !== void 0 ? s : {},
              ).some(function (M) {
                var G = M[1];
                return G;
              })
      ...
      return b(this, function (D) {
        switch (D.label) {
          case 0:
            return e.disable === !0
              ? [2, [new Pt(), N.system()]]
              : (e.globalAnalyticsKey && In(e.globalAnalyticsKey),
                n.cdnURL && Ln(n.cdnURL),
                e.initialPageview && t.add(new tt("page", [])),
                (r = n.cdnSettings) !== null && r !== void 0
                  ? ((h = r), [3, 3])
                  : [3, 1]);
          case 1:
          ...
          case 5:
            return (
              (w =
                (o =
                  (i = v.integrations["Segment.io"]) === null || i === void 0
                    ? void 0
                    : i.retryQueue) !== null && o !== void 0
                  ? o
                  : !0),
              (e = y(
                {
              ...
              (E =
                (a = n.classicIntegrations) !== null && a !== void 0 ? a : []),
              (I =
                (c = e.integrations) === null || c === void 0
                  ? void 0
                  : c["Segment.io"]),
              rr.initRemoteMetrics(
                y(y({}, v.metrics), {
                  host:
                    (s = I?.apiHost) !== null && s !== void 0
                      ? s
                      : (l = v.metrics) === null || l === void 0
                        ? void 0
                        : l.host,
                  protocol: I?.protocol,
                }),
          ...
          case 6:
            return (
              (O = D.sent()),
              (P =
                (f = window.location.search) !== null && f !== void 0 ? f : ""),
              (k =
                (d = window.location.hash) !== null && d !== void 0 ? d : ""),
              (V = P.length ? P : k.replace(/(?=#).*(?=\?)/, "")),
              V.includes("ajs_")
                ? [4, g.queryString(V).catch(console.error)]
                : [3, 8]
            );
          case 7:
            D.sent(), (D.label = 8);
          case 8:
            return (
              (g.initialized = !0), g.emit("initialize", n, e), [4, Fi(g, t)]
            );
          case 9:
            return D.sent(), [2, [g, O]];
        }
...
//# sourceMappingURL=bnsebkfktmtf4dlq.js.map
