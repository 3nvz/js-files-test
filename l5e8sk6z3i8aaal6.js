...
import {
  ...
  i as na,
  d as ra,
} from "./glin8sqjw0f6znku.js";
import { D as oa, a as la, H as aa, Z as li } from "./jy1u8exw8iz2slve.js";
import { L as ha } from "./gy64pge8qevmvg7e.js";
import { S as ca } from "./fgib8os5mzfls06e.js";
const xr = ({ origin: n, url: t }) =>
    p.jsxs("div", {
      "aria-label": t,
  ...
  fa = ({ request: n, isDenied: t = !1, onClick: e }) => {
    const [{ width: i }, s] = ml();
    return p.jsxs("button", {
      ...
      children: [
        p.jsx("div", {
          ...
          children: p.jsx("div", {
            className:
              "absolute top-0 hidden h-8 -translate-y-1/2 bg-gray-100 group-hover:block",
            style: { width: i },
          }),
        }),
        p.jsx("div", {
          className:
            "bg-token-main-surface-primary text-token-text-secondary sticky start-0 z-10 flex h-8 shrink-0 items-center px-2 group-hover:bg-gray-100",
          children: t
            ? p.jsx(xl, { className: "icon-md text-red-500" })
            : p.jsx(yl, { className: "icon-md text-green-500" }),
        }),
        p.jsx(xr, { ...n }),
      ],
    });
  },
  ua = ({ title: n, requests: t }) => {
    const e = me(),
      [i, s] = w.useState(() => new Set()),
      r = () => {
        for (const { requestId: c, approve: h, deny: f } of t)
          i.has(c) ? f() : h();
      },
      o = () => {
        ...
        children: [
          ...
          p.jsx(Is, {
            ...
            children: p.jsx(Qt, {
              ...
              openNewTab: !0,
              onClick: () =>
                dl.logButtonClick(gl.LEARN_MODE_ABOUT_NETWORK_REQUESTS),
              as: "a",
              color: "ghost",
              size: "small",
        ...
        children: [
          p.jsx("span", {
            ...
            children: p.jsx(rt, {
              ...
              values: { title: `"${n}"`, numRequests: t.length },
            }),
          }),
          p.jsx("div", {
            ...
            children:
              t.length > 1
                ? p.jsx("ul", {
                    className:
                      "border-token-border-default relative flex max-h-48 flex-col overflow-x-auto overflow-y-auto rounded-lg border",
                    children: t.map((c) => {
                      const { requestId: h } = c;
                      return p.jsx(
                        "li",
                ...
                : p.jsx("div", {
                    className:
                      "no-scrollbar bg-token-main-surface-secondary overflow-x-auto rounded-lg p-2",
                    children: p.jsx(xr, { ...t[0] }),
                  }),
          }),
        ],
      }),
      primaryButton: p.jsx(Js.Button, {
        disabled: a === 0,
        title:
          t.length > 1
            ? e.formatMessage(
                { id: "xpKkWv", defaultMessage: "Allow selected ({count})" },
                { count: a },
              )
            : e.formatMessage({ id: "ZeMrpd", defaultMessage: "Allow" }),
        color: "primary",
        onClick: r,
      }),
      secondaryButton: p.jsx(Js.Button, {
  ...
  da = ({ instrument: n }) => {
    switch (n.type) {
      case "hist":
        return Ot.hist(Tt.WEB_SANDBOX, n.label, n.tags, n.value);
      case "count":
        return Ot.count(Tt.WEB_SANDBOX, n.label, n.tags, n.count);
      case "error":
        return Be.addError(n.error);
    }
  },
  yr = ({
    size: n = 60,
    ...
    const [l, a] = w.useState(0),
      c = e.findIndex((d) => d.id === i),
      h = w.useRef(null),
      f = e[c];
    w.useEffect(() => {
      if (!f || s) return;
      ...
      let x = null,
        y = null;
      const b = 5 / f.estimatedTime,
        S = (v) => {
          y == null && (y = v);
          const k = v - y;
          if (k !== 0) {
            const A = m - g,
              O = g + A * (1 - Math.exp(-b * k));
            a(Math.min(O, m - 1e-4));
          }
          x = window.setTimeout(() => {
    ...
    return p.jsx(or, {
      ...
      thickness: t,
      backgroundStrokeClassName: R(
        o == null && "stroke-[rgba(0,0,0,0.1)] dark:stroke-[rgba(0,0,0,0.32)]",
        o === "dark" && "stroke-[rgba(0,0,0,0.32)]",
        o === "light" && "stroke-[rgba(0,0,0,0.1)] ",
      ),
      percentage: s ? 100 : l,
      onTransitionEnd: u,
      ...
      p.jsx(qe, {
        children:
          ...
          p.jsxs(Z.div, {
            ...
            animate: { opacity: 1 },
            className:
              "bg-token-main-surface-primary absolute end-2 bottom-2 flex items-center gap-2 rounded-full px-3 py-1.5 shadow-lg",
            children: [
              e
                ? p.jsx(or, {
                    percentage: 30,
                    ...
                    backgroundStrokeClassName:
                      "dark:stroke-[rgba(255,255,255,0.4)] stroke-[rgba(0,0,0,0.1)]",
                    sizeOverride: 12,
                  })
                : t &&
                  p.jsx(yr, {
              ...
              p.jsxs("span", {
                className:
                  "text-token-text-secondary flex items-baseline text-sm",
                children: [
                  p.jsx(rt, { id: "zfcWbe", defaultMessage: "Updating" }),
                  p.jsx(Oi, { gap: 1.5, padding: 2, size: 2 }),
                ],
              }),
            ],
          }),
...
function ga(n) {
  ...
  return (
    n.on("message", (s) => {
      t ? (t({ value: s, done: i }), (t = null)) : e.push(s),
        s.type === I.RUN_COMPLETE && (i = !0);
    }),
    {
      ...
      next() {
        if (e.length > 0) {
          const s = e.shift();
          return Promise.resolve({ value: s, done: i });
        }
        return i
          ? Promise.resolve({ value: void 0, done: i })
          : new Promise((s) => {
              t = s;
            });
      },
...
const ma = "web-sandbox.oaiusercontent.com",
  Gi = `https://${ma}`,
  { origin: xa } = new URL(Gi),
  ya = [
    xa,
...
function Zs() {
  ...
  return { resolve: n, promise: t };
}
const br = () => {
    const [n, t] = w.useState(Zs);
    return [n, w.useCallback(() => t(Zs()), [])];
  },
  wr = () =>
    bl(
      ur.getItem(dr.CODE_EXECUTION_DOMAIN_ALLOW_LIST),
      (t) => wl(t, { origin: Ei, expiresAt: vl }),
      [],
    ).filter(({ expiresAt: t }) => t >= Date.now()),
  Qs = (n, t) => {
    const { origin: e } = new URL(n);
    let i = [...ya];
    const s = wr().map(({ origin: r }) => r);
  ...
  ba = ({
    ...
    const s = fr(),
      ...
      a = w.useRef(null),
      [c, h] = w.useState([]),
      f = w.useCallback((y) => l.current?.postMessage(y), []),
      u = w.useCallback((y) => a.current?.postMessage(y), []);
    w.useEffect(
      () => () => {
        u({ type: Ge.DISCONNECT, sessionId: n });
      },
      [n],
    );
    const d = w.useCallback(
        ({ url: y, requestId: b }) => {
          try {
            ...
            Ot.count(Tt.WEB_SANDBOX, "network_access_requested");
            const { origin: S } = new URL(y),
              v = (A) => {
                Ot.count(
                  Tt.WEB_SANDBOX,
                  `network_access_request.${A ? "allow" : "deny"}`,
                ),
                  u({ type: Ge.FETCH_RESPONSE, isApproved: A, requestId: b }),
                  h((O) =>
                    O.filter((T) => !i && !Qs(T.url, !e) && T.requestId !== b),
                  );
              },
              k = () => {
                ur.setItem(dr.CODE_EXECUTION_DOMAIN_ALLOW_LIST, [
                  ...wr(),
                  {
                    origin: S,
            ...
            Be.addError(S),
              u({ type: Ge.FETCH_RESPONSE, isApproved: !1, requestId: b });
          }
        },
        [e, u, s, t, r, i],
      ),
      ...
      x = w.useCallback(
        async (y, b) => {
          if (y.type === Ce.SW_NOT_SUPPORTED)
            Ot.count(Tt.WEB_SANDBOX, "sw_not_supported"), g.resolve?.();
          else {
            (l.current = b[0]),
              (a.current = b[1]),
              (a.current.onmessage = (S) => {
                S.data.type === "ready" ? g.resolve?.() : d(S.data);
              });
            try {
              const { token: S } = await pr.safeGet(
                "/public/code_execution_challenge",
                {
                  authOption: Wl.Anonymous,
                  parameters: { query: { relay_client_id: y.clientId } },
                },
              );
              f({
                type: Ql.SW_RECONNECT_RESPONSE,
    ...
    return {
      relayRef: o,
      relayInitPromise: g,
      resetRelayInitPromise: m,
      handleMessageFromRelay: x,
      pendingFetchRequests: c,
    };
  },
  wa = "https://persistent.oaistatic.com/canvas/loop-swirl.mp4",
  va = "https://persistent.oaistatic.com/canvas/loop-swirl-poster.jpg",
  be = 90,
  Sa = ({
    title: n,
    checkpoints: t,
    ...
    return p.jsx(Z.div, {
      ...
      children: p.jsxs(Z.div, {
        ...
        children: [
          p.jsxs(Z.div, {
            className:
              "bg-token-main-surface-primary absolute overflow-hidden rounded-3xl shadow-2xl",
            initial: !1,
            animate: { width: be, height: be, opacity: r ? 0 : 1 },
            transition: { type: "spring", duration: 0.56, bounce: 0 },
            children: [
              p.jsx("video", {
                muted: !0,
                loop: !0,
  ...
  en = [
    ...
    {
      id: Nt.INSTALLING_PACKAGES,
      label: "Installing packages",
      estimatedTime: 2e3,
    },
    { id: Nt.RUNNING_CODE, label: "Ready", estimatedTime: 1 },
  ],
  Ca = () =>
    ql()
      ? "ios"
  ...
  ka = (
    {
      ...
      unsafeAllowAllNetworkRequests: e = !1,
      networkAccessDeniedMessage: i,
      visuallyHidden: s = !1,
      isCodeUpdating: r = !1,
      enableTransition: o = !1,
      disablePermissions: l = !1,
      title: a,
      onChangeBackgroundColor: c,
    },
    h,
  ) => {
    const [f, u] = w.useState(0),
      [d] = w.useState(() => crypto.randomUUID()),
      {
        pendingFetchRequests: g,
        handleMessageFromRelay: m,
        relayInitPromise: x,
        ...
        networkAccessDeniedMessage: i,
        unsafeAllowAllNetworkRequests: e,
      }),
      S = w.useRef(null),
      [v, k] = br(),
      A = w.useMemo(() => Promise.all([v.promise, x.promise]), [v, x]),
      [O, T] = w.useState(null),
      [X, mt] = w.useState(!1),
      zt = w.useRef(null),
      dt = w.useRef(new Map()),
      et = w.useRef(null),
      q = w.useCallback((N) => {
        zt.current?.postMessage(N);
      }, []),
      lt = w.useCallback(() => {
        const N = dt.current.keys();
        T(null), mt(!1), c?.(null);
        for (const P of N) q({ type: Ye.STOP_CODE, runId: P });
        et.current = null;
      }, [q, c]),
      wt = w.useCallback(() => {
        y(), k(), u((N) => N + 1), T(null), mt(!1), (et.current = null);
      }, [y, k]),
      vt = w.useCallback(
        async function* ({ code: N, language: P }) {
          if (
            (T(Nt.INITIALIZING),
            Ot.count(Tt.WEB_SANDBOX, `${P}.eval`),
            await A,
            dt.current.size !== 0)
          )
            return lt();
          const U = fl(),
            K = new zl();
          dt.current.set(U, K);
          const Mt = { code: N, language: P, type: Ye.RUN_CODE, runId: U };
          (et.current = { runId: U, language: P }), q(Mt);
          for await (const Q of ga(K))
            Q &&
              Q.type === I.ENVIRONMENT_STATUS &&
              (T(Q.status), o || mt(Q.status === Nt.RUNNING_CODE)),
              Q?.type === I.ERROR
                ? Ot.count(Tt.WEB_SANDBOX, `${P}.error`)
                : Q?.type === I.RUN_COMPLETE &&
                  Q.wasFatalError &&
                  Ot.count(Tt.WEB_SANDBOX, `${P}.fatal_runtime_error`),
              Q && !lr([I.READY], Q.type) && (yield Q);
          T(null), mt(!1), dt.current.delete(U);
        },
        [A, o, q, lt],
      ),
      kt = w.useCallback(
        async (N) => {
          await A, q({ type: Ye.PREPARE_ENVIRONMENT, language: N });
        },
        [A, q],
      ),
      ct = (N) => {
        et.current && q({ type: Ye.RUN_CODE, code: N, ...et.current });
      };
    w.useImperativeHandle(h, () => ({
      stop: lt,
      evalAsync: vt,
      updateCode: ct,
      prepareEnvironment: kt,
    })),
      w.useEffect(
        () =>
          gr(window, {
            message: (N) => {
              const { data: P, ports: U } = N,
                { type: K } = P,
                Mt = N.source === b.current?.contentWindow,
                Q = N.source === S.current?.contentWindow;
              if (!Mt && !Q) return;
              if (K === I.ENVIRONMENT_ERROR)
                return (
                  Be.addError("Code execution environment error", P.error),
                  P.error.name === "ServiceWorker" &&
                    Ot.count(
                      Tt.WEB_SANDBOX,
                      "service_worker_connection_failure",
                      [
                        { key: "agent", value: Ca() },
                        { key: "is_share", value: String(n) },
                      ],
                    ),
                  P.runId != null &&
                    P.runId === et.current?.runId &&
                    Ot.count(
                      Tt.WEB_SANDBOX,
                      `${et.current.language}.environment_error`,
                    ),
                  wt()
                );
              if (
                Mt &&
                (P.type === Ce.SW_NOT_SUPPORTED || P.type === Ce.SW_RECONNECT)
              )
                return m(P, U);
              if (
                Mt ||
                !Q ||
                K === Ce.SW_RECONNECT ||
                K === Ce.SW_NOT_SUPPORTED
              )
                return;
              if (((zt.current = U[0]), K === I.READY)) return v.resolve?.();
              if (K === I.SET_BACKGROUND_COLOR) return c?.(P.backgroundColor);
              if (K === I.INSTRUMENT) return da(P);
              const { runId: it } = P,
                _t = it && dt.current.get(it);
              _t
                ? _t.emit("message", P)
                : Be.addError("Code execution error: missing event emitter", {
                    messageData: N.data,
                  });
            },
          }),
      ...
      children: [
        p.jsx(
          "iframe",
          {
            ...
            allow: z,
            ref: b,
            src: `${Gi}/relay.html${tn({ sessionId: d })}`,
          },
          `relay-${f}`,
        ),
        p.jsxs("div", {
          className: R("relative flex", s ? "fixed h-0 w-0" : "h-full w-full"),
          children: [
            !s &&
              O != null &&
              o &&
              p.jsx(Sa, {
                isComplete: O === Nt.RUNNING_CODE,
                onTransitionComplete: () => mt(!0),
            ...
            p.jsx(Z.div, {
              className: R(
                "bg-token-main-surface-primary absolute inset-0 m-auto origin-center overflow-hidden",
                X ? "pointer-events-auto" : "pointer-events-none",
              ),
              animate: {
                opacity: X ? 1 : 0,
                ...(X ? { scale: 1 } : { scale: 0.95 }),
              },
              transition: ft,
              children: p.jsx(
                Z.iframe,
                {
                  ...
                  allow: z,
                  src: `${Gi}/index.html${tn({ sessionId: d })}`,
                  sandbox:
        ...
        g.length > 0 && p.jsx(ua, { title: a, requests: g }),
      ],
    });
  },
  du = w.forwardRef(ka);
...
function Ea(n, t) {
  return Ma(t, { start: n.fromA, end: n.toA }, Oa(n));
}
function Oa(n) {
  const { fromA: t, toA: e, fromB: i, toB: s } = n;
  return s - i - (e - t);
}
function Ta(n) {
  const t = [],
    e = (i, s, r, o) => {
      t.push({ fromA: i, toA: s, fromB: r, toB: o });
    };
...
function Ra(n, t) {
  return {
    ...
    "bg-yellow-400/40 dark:bg-yellow-400/50": n && !t,
    "bg-yellow-400/60 dark:bg-yellow-500/70": t,
    "bg-yellow-100 dark:bg-yellow-400/30": !n && !t,
  };
}
const Na = { "bg-transparent!": !0 };
function La({ isHovered: n, isFocused: t, isCode: e, diffStatus: i }) {
  return R(
    e ? la : oa,
    "cursor-text group is-comment transition-colors",
    { ...(i === yi.REMOVED ? Na : Ra(n, t)) },
...
function Pa(n, t) {
  return n
    .map((e) => {
      const i = t.get(e.id);
      return i ? { ...e, at: i } : null;
    })
    .filter(ar);
}
var vr = ((n) => (
    (n.ASK = "ask"),
    (n.CREATE_TEXTDOC = "create_textdoc"),
    (n.COMMENT = "comment"),
    (n.EDIT = "edit"),
    n
  ))(vr || {}),
  Ba = ((n) => ((n.SELECTION = "selection"), (n.BLOCK = "block"), n))(Ba || {});
function pu(n) {
...
const Ia = mr(() => ({
  ...
  { setState: At, getInitialState: ja } = Ia,
  bi = {
    reset: () => At(ja()),
    startCommentingOn: (n) => At((t) => ({ ...t, commentingOn: n })),
    cancelCommentingOn: () => At((n) => ({ ...n, commentingOn: null })),
    focusComment: (n) => At((t) => ({ ...t, focusedCommentId: n })),
    blurComment: () => At((n) => ({ ...n, focusedCommentId: null })),
    mouseEnterComment: (n) => At((t) => ({ ...t, hoveredCommentId: n })),
    mouseLeaveComment: () => At((n) => ({ ...n, hoveredCommentId: null })),
    mouseEnterBlock: (n) =>
      At((t) => ({ ...t, hoveredBlockCommentLauncherPos: n })),
    mouseLeaveBlock: () =>
      At((n) => ({ ...n, hoveredBlockCommentLauncherPos: null })),
    setVisibleBlockComment_DEBUG_ONLY: (n) =>
      At((t) => ({ ...t, visibleBlockCommentLauncher_DEBUG_ONLY: n })),
  };
class B {
  lineAt(t) {
  ...
  slice(t, e = this.length) {
    [t, e] = ce(this, t, e);
    let i = [];
    return this.decompose(t, e, i, 0), Dt.from(i, e - t);
  }
  eq(t) {
    if (t == this) return !0;
...
class $ extends B {
  ...
  lineInner(t, e, i, s) {
    for (let r = 0; ; r++) {
      let o = this.text[r],
        l = s + o.length;
      if ((e ? i : l) >= t) return new Fa(s, l, i, o);
      (s = l + 1), i++;
    }
  }
  decompose(t, e, i, s) {
    let r =
      t <= 0 && e >= this.length
        ? this
        : new $(sn(this.text, t, e), Math.min(e, this.length) - Math.max(0, t));
    if (s & 1) {
      let o = i.pop(),
        l = ai(r.text, o.text.slice(), 0, r.length);
      if (l.length <= 32) i.push(new $(l, o.length + r.length));
      else {
        let a = l.length >> 1;
        i.push(new $(l.slice(0, a)), new $(l.slice(a)));
      }
    } else i.push(r);
  }
  replace(t, e, i) {
    if (!(i instanceof $)) return super.replace(t, e, i);
    [t, e] = ce(this, t, e);
    let s = ai(this.text, ai(i.text, sn(this.text, 0, t)), e),
      r = this.length + i.length - (e - t);
    return s.length <= 32 ? new $(s, r) : Dt.from($.split(s, []), r);
  }
  sliceString(
    t,
    e = this.length,
...
`,
    ...
    for (let r = 0, o = 0; r <= e && o < this.text.length; o++) {
      let l = this.text[o],
        a = r + l.length;
      r > t && o && (s += i),
        t < a && e > r && (s += l.slice(Math.max(0, t - r), e - r)),
        (r = a + 1);
    }
    return s;
  }
  ...
  static split(t, e) {
    ...
    for (let r of t)
      i.push(r),
        (s += r.length + 1),
        i.length == 32 && (e.push(new $(i, s)), (i = []), (s = -1));
    return s > -1 && e.push(new $(i, s)), e;
  }
}
class Dt extends B {
  constructor(t, e) {
      ...
      for (let s = 0, r = 0; s < this.children.length; s++) {
        ...
        if (t >= r && e <= l) {
          ...
          if (a.lines < c >> 4 && a.lines > c >> 6) {
            ...
            return (h[s] = a), new Dt(h, this.length - (e - t) + i.length);
          }
...
`,
    ...
    for (let r = 0, o = 0; r < this.children.length && o <= e; r++) {
      let l = this.children[r],
        a = o + l.length;
      o > t && r && (s += i),
        t < a && e > o && (s += l.sliceString(t - o, e - o, i)),
        (o = a + 1);
    }
    return s;
  }
  ...
  static from(t, e = t.reduce((i, s) => i + s.length + 1, -1)) {
    ...
    function f(d) {
      let g;
      if (d.lines > r && d instanceof Dt) for (let m of d.children) f(m);
      else
        d.lines > o && (a > o || !a)
          ? (u(), l.push(d))
          : d instanceof $ &&
              a &&
              (g = h[h.length - 1]) instanceof $ &&
              d.lines + g.lines <= 32
            ? ((a += d.lines),
              (c += d.length + 1),
              (h[h.length - 1] = new $(
                g.text.concat(d.text),
                g.length + 1 + d.length,
              )))
            : (a + d.lines > s && u(),
              (a += d.lines),
    ...
    function u() {
      a != 0 &&
        (l.push(h.length == 1 ? h[0] : Dt.from(h, c)),
        (c = -1),
        (a = h.length = 0));
    }
    for (let d of t) f(d);
    return u(), l.length == 1 ? l[0] : new Dt(l, e);
  }
}
B.empty = new $([""], 0);
function Ha(n) {
...
class Oe {
  constructor(t, e = 1) {
    (this.dir = e),
      ...
      (this.nodes = [t]),
      (this.offsets = [
        e > 0 ? 1 : (t instanceof $ ? t.text.length : t.children.length) << 1,
      ]);
  }
  nextInner(t, e) {
    for (this.done = this.lineBreak = !1; ; ) {
      let i = this.nodes.length - 1,
        ...
        r = this.offsets[i],
        o = r >> 1,
        l = s instanceof $ ? s.text.length : s.children.length;
      if (o == (e > 0 ? l : 0)) {
...
`),
        ...
        if (((this.offsets[i] += e), a.length > Math.max(0, t)))
          return (
            (this.value =
              t == 0 ? a : e > 0 ? a.slice(t) : a.slice(0, a.length - t)),
            this
          );
        t -= a.length;
      } else {
        ...
        t > a.length
          ? ((t -= a.length), (this.offsets[i] += e))
          : (e < 0 && this.offsets[i]--,
            this.nodes.push(a),
            this.offsets.push(
              e > 0
                ? 1
                : (a instanceof $ ? a.text.length : a.children.length) << 1,
            ));
      }
    }
  }
...
class Sr {
  ...
  nextInner(t, e) {
    ...
    return (
      (this.pos += (s.length + t) * e),
      (this.value =
        s.length <= i ? s : e < 0 ? s.slice(s.length - i) : s.slice(0, i)),
...
typeof Symbol < "u" &&
  ...
  (Oe.prototype[Symbol.iterator] =
    Sr.prototype[Symbol.iterator] =
    Cr.prototype[Symbol.iterator] =
      function () {
        return this;
      }));
class Fa {
...
function ce(n, t, e) {
  return (
    (t = Math.max(0, Math.min(n.length, t))),
...
function Va(n) {
  for (let t = 1; t < oe.length; t += 2) if (oe[t] > n) return oe[t - 1] <= n;
  return !1;
}
function nn(n) {
...
function Lt(n, t, e = !0, i = !0) {
  return (e ? kr : Wa)(n, t, i);
}
function kr(n, t, e) {
  if (t == n.length) return t;
  t && Mr(n.charCodeAt(t)) && Ar(n.charCodeAt(t - 1)) && t--;
  let i = Te(n, t);
  for (t += Yi(i); t < n.length; ) {
    let s = Te(n, t);
    if (i == rn || s == rn || (e && Va(s))) (t += Yi(s)), (i = s);
    else if (nn(s)) {
      let r = 0,
        o = t - 2;
      for (; o >= 0 && nn(Te(n, o)); ) r++, (o -= 2);
      if (r % 2 == 0) break;
      t += 2;
    } else break;
  }
...
function Te(n, t) {
  ...
  if (!Ar(e) || t + 1 == n.length) return e;
  let i = n.charCodeAt(t + 1);
  return Mr(i) ? ((e - 55296) << 10) + (i - 56320) + 65536 : e;
}
function gu(n) {
  return n <= 65535
...
class jt {
  ...
  composeDesc(t) {
    return this.empty ? t : t.empty ? this : Er(this, t);
  }
  mapDesc(t, e = !1) {
    return t.empty ? this : Zi(this, t, e);
  }
  mapPos(t, e = -1, i = gt.Simple) {
    ...
    for (let o = 0; o < this.sections.length; ) {
      ...
      if (a < 0) {
        ...
        if (
          i != gt.Simple &&
          c >= t &&
          ((i == gt.TrackDel && s < t && c > t) ||
            (i == gt.TrackBefore && s < t) ||
            (i == gt.TrackAfter && c > t))
        )
          return null;
        if (c > t || (c == t && e < 0 && !l))
    ...
    if (t > s)
      throw new RangeError(
        `Position ${t} is out of range for changeset of length ${s}`,
      );
    return r;
  }
  touchesRange(t, e = t) {
...
class J extends jt {
  ...
  apply(t) {
    ...
    return (
      Ji(this, (e, i, s, r, o) => (t = t.replace(s, s + (i - e), o)), !1), t
    );
  }
  mapDesc(t, e = !1) {
  ...
  compose(t) {
    return this.empty ? t : t.empty ? this : Er(this, t, !0);
  }
  map(t, e = !1) {
    return t.empty ? this : Zi(this, t, e, !0);
  }
  iterChanges(t, e = !1) {
    Ji(this, t, e);
  }
  ...
  filter(t) {
    ...
    t: for (let o = 0, l = 0; ; ) {
      ...
      for (; l < a || (l == a && r.len == 0); ) {
        ...
        st(e, h, f), f > 0 && $t(i, e, r.text), r.forward(h), (l += h);
      }
      let c = t[o++];
      for (; l < c; ) {
        if (r.done) break t;
        ...
        st(e, h, -1),
          st(s, h, r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0),
          r.forward(h),
          (l += h);
      }
    }
    return { changes: new J(e, i), filtered: jt.create(s) };
  }
  toJSON() {
    let t = [];
    for (let e = 0; e < this.sections.length; e += 2) {
  ...
  static of(t, e, i) {
    ...
    function c(h) {
      if (Array.isArray(h)) for (let f of h) c(f);
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      if (typeof r == "number") e.push(r, -1);
        ...
        if (r.length == 1) e.push(r[0], 0);
          ...
          (i[s] = B.of(r.slice(1))), e.push(r[0], i[s].length);
        }
      }
    }
    return new J(e, i);
...
function Zi(n, t, e, i = !1) {
  ...
  for (let a = -1; ; )
    if (o.ins == -1 && l.ins == -1) {
      ...
      (o.ins < 0 ||
        a == o.i ||
        (o.off == 0 && (l.len < o.len || (l.len == o.len && !e))))
    ) {
      let c = l.len;
      for (st(s, l.ins, -1); c; ) {
        ...
        o.ins >= 0 &&
          a < o.i &&
          o.len <= h &&
          (st(s, 0, o.ins), r && $t(r, s, o.text), (a = o.i)),
          o.forward(h),
          (c -= h);
      }
      l.next();
      ...
      st(s, c, a < o.i ? o.ins : 0),
        r && a < o.i && $t(r, s, o.text),
        (a = o.i),
        o.forward(o.len - h);
    } else {
...
function Er(n, t, e = !1) {
  ...
  for (let l = !1; ; ) {
    ...
    if (r.ins == 0) st(i, r.len, 0, l), r.next();
    else if (o.len == 0 && !o.done)
      st(i, 0, o.ins, l), s && $t(s, i, o.text), o.next();
    else {
      if (r.done || o.done) throw new Error("Mismatched change set lengths");
      {
        ...
        if (r.ins == -1) {
          ...
          st(i, a, h, l), s && h && $t(s, i, o.text);
        } else
          o.ins == -1
            ? (st(i, r.off ? 0 : r.len, a, l), s && $t(s, i, r.textBit(a)))
            : (st(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, l),
              s && !o.off && $t(s, i, o.text));
        (l = (r.ins > a || (o.ins >= 0 && o.len > a)) && (l || i.length > c)),
          r.forward2(a),
          o.forward(a);
      }
    }
...
class Jt {
  ...
  map(t, e = -1) {
    ...
    return (
      this.empty
        ? (i = s = t.mapPos(this.from, e))
        : ((i = t.mapPos(this.from, 1)), (s = t.mapPos(this.to, -1))),
      i == this.from && s == this.to ? this : new Jt(i, s, this.flags)
    );
  }
  extend(t, e = t) {
  ...
  static normalized(t, e = 0) {
    ...
    for (let s = 1; s < t.length; s++) {
      ...
      if (r.empty ? r.from <= o.to : r.from < o.to) {
        ...
        s <= e && e--,
          t.splice(--s, 2, r.anchor > r.head ? M.range(a, l) : M.range(l, a));
      }
    }
    return new M(t, e);
  }
...
class E {
  ...
  static define(t = {}) {
    return new E(
      ...
      t.compare || (t.combine ? (e, i) => e === i : Hs),
      !!t.static,
      t.enables,
    );
  }
  of(t) {
    return new hi([], this, 0, t);
  }
  compute(t, e) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new hi(t, this, 1, e);
  }
  computeN(t, e) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new hi(t, this, 2, e);
  }
  from(t, e) {
  ...
  dynamicSlot(t) {
    ...
    return {
      ...
      update(f, u) {
        if (
          (a && u.docChanged) ||
          (c && (u.docChanged || u.selection)) ||
          Qi(f, h)
        ) {
          let d = i(f);
          if (l ? !on(d, f.values[o], s) : !s(d, f.values[o]))
      ...
      reconfigure: (f, u) => {
        let d,
          g = u.config.address[r];
        if (g != null) {
          let m = vi(u, g);
          if (
            this.dependencies.every((x) =>
              x instanceof E
                ? u.facet(x) === f.facet(x)
                : x instanceof bt
                  ? u.field(x, !1) == f.field(x, !1)
                  : !0,
            ) ||
            (l ? on((d = i(f)), m, s) : s((d = i(f)), m))
          )
...
function on(n, t, e) {
  ...
  for (let i = 0; i < n.length; i++) if (!e(n[i], t[i])) return !1;
  return !0;
}
function Qi(n, t) {
  let e = !1;
  for (let i of t) De(n, i) & 1 && (e = !0);
  return e;
}
function za(n, t, e) {
  ...
  function l(a) {
    ...
    for (let h = 0; h < i.length; h++) {
      let f = vi(a, i[h]);
      if (s[h] == 2) for (let u of f) c.push(u);
      else c.push(f);
    }
    return t.combine(c);
  }
  return {
    ...
    reconfigure(a, c) {
      let h = Qi(a, i),
        ...
        u = c.facet(t);
      if (f && !h && Hs(e, f)) return (a.values[o] = u), 0;
      let d = l(a);
      return t.compare(d, u) ? ((a.values[o] = u), 0) : ((a.values[o] = d), 1);
    },
  };
}
const ln = E.define({ static: !0 });
class bt {
  constructor(t, e, i, s, r) {
    (this.id = t),
      (this.createF = e),
  ...
  create(t) {
    let e = t.facet(ln).find((i) => i.field == this);
    ...
    return {
      ...
      reconfigure: (i, s) =>
        s.config.address[this.id] != null
          ? ((i.values[e] = s.field(this)), 0)
          : ((i.values[e] = this.create(i)), 1),
    };
  }
  init(t) {
    return [this, ln.of({ field: this, create: t })];
  }
  get extension() {
    return this;
  }
...
const Fs = {
  highest: we(Xt.highest),
  high: we(Xt.high),
  default: we(Xt.default),
  low: we(Xt.low),
  lowest: we(Xt.lowest),
};
class Tr {
...
class Ti {
  ...
  reconfigure(t) {
    return Ti.reconfigure.of({ compartment: this, extension: t });
  }
  get(t) {
  ...
  static resolve(t, e, i) {
    ...
    for (let u in r) {
      let d = r[u],
        g = d[0].facet,
        m = (h && h[u]) || [];
      if (d.every((x) => x.type == 0))
        if (((l[g.id] = (a.length << 1) | 1), Hs(m, d))) a.push(i.facet(g));
        else {
          let x = g.combine(d.map((y) => y.value));
          a.push(i && g.compare(x, i.facet(g)) ? i.facet(g) : x);
        }
      else {
        for (let x of d)
          x.type == 0
            ? ((l[x.id] = (a.length << 1) | 1), a.push(x.value))
            : ((l[x.id] = c.length << 1), c.push((y) => x.dynamicSlot(y)));
        (l[g.id] = c.length << 1), c.push((x) => za(x, g, d));
      }
    }
    let f = c.map((u) => u(l));
    return new wi(t, o, f, l, a, r);
  }
}
function _a(n, t, e) {
  let i = [[], [], [], [], []],
  ...
  function r(o, l) {
    ...
    if (a != null) {
      if (a <= l) return;
      let c = i[a].indexOf(o);
      c > -1 && i[a].splice(c, 1), o instanceof ts && e.delete(o.compartment);
    }
    if ((s.set(o, l), Array.isArray(o))) for (let c of o) r(c, l);
    else if (o instanceof ts) {
      if (e.has(o.compartment))
        throw new RangeError("Duplicate use of compartment in extensions");
      let c = t.get(o.compartment) || o.inner;
      e.set(o.compartment, c), r(c, l);
    } else if (o instanceof Tr) r(o.inner, o.prec);
    else if (o instanceof bt) i[l].push(o), o.provides && r(o.provides, l);
    else if (o instanceof hi)
      i[l].push(o), o.facet.extensions && r(o.facet.extensions, Xt.default);
    else {
      let c = o.extension;
      if (!c)
        throw new Error(
  ...
  return r(n, Xt.default), i.reduce((o, l) => o.concat(l));
}
function De(n, t) {
  if (t & 1) return 2;
  let e = t >> 1,
...
const Dr = E.define(),
  es = E.define({ combine: (n) => n.some((t) => t), static: !0 }),
  Rr = E.define({ combine: (n) => (n.length ? n[0] : void 0), static: !0 }),
  Nr = E.define(),
  Lr = E.define(),
  Pr = E.define(),
  Br = E.define({ combine: (n) => (n.length ? n[0] : !1) });
class xe {
  constructor(t, e) {
...
class _ {
  ...
  map(t) {
    ...
    return e === void 0 ? void 0 : e == this.value ? this : new _(this.type, e);
  }
  is(t) {
    return this.type == t;
  }
...
ot.time = xe.define();
ot.userEvent = xe.define();
ot.addToHistory = xe.define();
ot.remote = xe.define();
function $a(n, t) {
  let e = [];
  for (let i = 0, s = 0; ; ) {
...
function Ir(n, t, e) {
  ...
  return (
    e
      ? ((s = t.changes),
        (r = J.empty(t.changes.length)),
        (o = n.changes.compose(t.changes)))
      : ((s = t.changes.map(n.changes)),
        ...
        (o = n.changes.compose(s))),
    {
      ...
      selection: t.selection
        ...
        : (i = n.selection) === null || i === void 0
          ? void 0
          : i.map(s),
      effects: _.mapEffects(n.effects, s).concat(_.mapEffects(t.effects, r)),
      annotations: n.annotations.length
        ? n.annotations.concat(t.annotations)
        : t.annotations,
...
function is(n, t, e) {
  let i = t.selection,
    s = le(t.annotations);
  return (
    t.userEvent && (s = s.concat(ot.userEvent.of(t.userEvent))),
    {
      changes:
        t.changes instanceof J
          ? t.changes
          : J.of(t.changes || [], e, n.facet(Rr)),
...
function jr(n, t, e) {
  ...
  for (let r = 1; r < t.length; r++) {
    ...
    i = Ir(i, is(n, t[r], o ? i.changes.newLength : n.doc.length), o);
  }
  let s = ot.create(
    n,
    i.changes,
...
function Ua(n) {
  let t = n.startState,
    e = !0;
  for (let s of t.facet(Nr)) {
    let r = s(n);
    if (r === !1) {
      e = !1;
      break;
    }
    Array.isArray(r) && (e = e === !0 ? r : $a(e, r));
  }
  if (e !== !0) {
    let s, r;
  ...
  for (let s = i.length - 1; s >= 0; s--) {
    ...
    r instanceof ot
      ? (n = r)
      : Array.isArray(r) && r.length == 1 && r[0] instanceof ot
        ? (n = r[0])
        : (n = jr(t, le(r), !1));
  }
  return n;
...
function Ga(n) {
  ...
  for (let s = e.length - 1; s >= 0; s--) {
    ...
    r &&
      ...
      (i = Ir(i, is(t, r, n.changes.newLength), !0));
  }
  return i == n
    ? n
    : ot.create(
...
const Ya = [];
function le(n) {
  return n == null ? Ya : Array.isArray(n) ? n : [n];
}
var Bt = (function (n) {
  return (
    (n[(n.Word = 0)] = "Word"),
...
let ss;
try {
  ss = new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {}
function Ja(n) {
  if (ss) return ss.test(n);
  for (let t = 0; t < n.length; t++) {
    let e = n[t];
    if (
      /\w/.test(e) ||
      (e > "" && (e.toUpperCase() != e.toLowerCase() || Xa.test(e)))
    )
      return !0;
  }
  return !1;
...
function Za(n) {
  return (t) => {
    if (!/\S/.test(t)) return Bt.Space;
    if (Ja(t)) return Bt.Word;
    for (let e = 0; e < n.length; e++) if (t.indexOf(n[e]) > -1) return Bt.Word;
    return Bt.Other;
  };
}
class W {
  constructor(t, e, i, s, r, o) {
    (this.config = t),
      ...
      (this.computeSlot = r),
      o && (o._state = this);
    for (let l = 0; l < this.config.dynamicSlots.length; l++) De(this, l << 1);
  ...
  applyTransaction(t) {
    ...
    for (let l of t.effects)
      l.is(Ti.reconfigure)
        ? (e &&
            ((s = new Map()),
            e.compartments.forEach((a, c) => s.set(c, a)),
            (e = null)),
          s.set(l.value.compartment, l.value.extension))
        : l.is(_.reconfigure)
          ? ((e = null), (i = l.value))
          : l.is(_.appendConfig) && ((e = null), (i = le(i).concat(l.value)));
    let r;
    e
      ? (r = t.startState.values.slice())
      : ((e = wi.resolve(i, s, this)),
        (r = new W(
          e,
          this.doc,
          this.selection,
    ...
    new W(e, t.newDoc, o, r, (l, a) => a.update(l, t), t);
  }
  replaceSelection(t) {
    return (
  ...
  changeByRange(t) {
    ...
    for (let l = 1; l < e.ranges.length; l++) {
      ...
      r.push(a.range.map(f)),
        (s = s.compose(h)),
        (o = _.mapEffects(o, h).concat(_.mapEffects(le(a.effects), f)));
    }
    return { changes: s, selection: M.create(r, e.mainIndex), effects: o };
  }
  changes(t = []) {
    return t instanceof J
      ? t
      : J.of(t, this.doc.length, this.facet(W.lineSeparator));
  }
  toText(t) {
    return B.of(t.split(this.facet(W.lineSeparator) || Xi));
  }
  ...
  facet(t) {
    ...
    return e == null ? t.default : (De(this, e), vi(this, e));
  }
  toJSON(t) {
    ...
    if (t)
      for (let i in t) {
        ...
        s instanceof bt &&
          ...
          (e[i] = s.spec.toJSON(this.field(t[i]), this));
      }
    return e;
  }
  ...
  static create(t = {}) {
    let e = wi.resolve(t.extensions || [], new Map()),
      i =
        t.doc instanceof B
          ? t.doc
          : B.of((t.doc || "").split(e.staticFacet(W.lineSeparator) || Xi)),
      s = t.selection
        ? t.selection instanceof M
          ? t.selection
          : M.single(t.selection.anchor, t.selection.head)
        : M.single(0);
    return (
      Or(s, i.length),
      e.staticFacet(es) || (s = s.asSingle()),
      new W(
        e,
        i,
        s,
...
`
  ...
  phrase(t, ...e) {
    for (let i of this.facet(W.phrases))
  ...
  wordAt(t) {
    ...
    for (; o > 0; ) {
      let a = Lt(e, o, !1);
      if (r(e.slice(a, o)) != Bt.Word) break;
      o = a;
    }
    for (; l < s; ) {
      let a = Lt(e, l);
      if (r(e.slice(l, a)) != Bt.Word) break;
      l = a;
    }
    return o == l ? null : M.range(o + i, l + i);
  }
}
W.allowMultipleSelections = es;
W.tabSize = E.define({ combine: (n) => (n.length ? n[0] : 4) });
W.lineSeparator = Rr;
W.readOnly = Br;
W.phrases = E.define({
  compare(n, t) {
...
W.languageData = Dr;
W.changeFilter = Nr;
W.transactionFilter = Lr;
W.transactionExtender = Pr;
Ti.reconfigure = _.define();
function Vs(n, t, e = {}) {
  let i = {};
  for (let s of n)
...
class Ws {
  ...
  findIndex(t, e, i, s = 0) {
    ...
    for (let o = s, l = r.length; ; ) {
      ...
      let a = (o + l) >> 1,
        c =
          r[a] - t || (i ? this.value[a].endSide : this.value[a].startSide) - e;
    ...
    for (let a = 0; a < this.value.length; a++) {
      ...
      if (h == f) {
        ...
        if (
          g == null ||
          ((u = d = g),
          c.startSide != c.endSide && ((d = e.mapPos(h, c.endSide)), d < u))
        )
          continue;
      } else if (
        ((u = e.mapPos(h, c.startSide)),
        (d = e.mapPos(f, c.endSide)),
        u > d || (u == d && c.startSide > 0 && c.endSide <= 0))
      )
        continue;
      (d - u || c.endSide - c.startSide) < 0 ||
        (o < 0 && (o = u),
        c.point && (l = Math.max(l, d - u)),
        i.push(c),
        s.push(u - o),
        r.push(d - o));
    }
    return { mapped: i.length ? new Ws(s, r, i, l) : null, pos: o };
  }
}
class L {
  constructor(t, e, i, s) {
  ...
  update(t) {
    ...
    if ((i && (e = e.slice().sort(ns)), this.isEmpty))
      return e.length ? L.of(e) : this;
    let l = new Hr(this, null, -1).goto(0),
      a = 0,
      c = [],
      h = new Fe();
    for (; l.value || a < e.length; )
      if (
        a < e.length &&
        (l.from - e[a].from || l.startSide - e[a].value.startSide) >= 0
      ) {
        let f = e[a++];
        ...
        (a == e.length || this.chunkEnd(l.chunkIndex) < e[a].from) &&
        (!o ||
        ...
        h.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex])
          ...
          : ((!o || s > l.to || r < l.from || o(l.from, l.to, l.value)) &&
              (h.addInner(l.from, l.to, l.value) ||
                c.push(He.create(l.from, l.to, l.value))),
            l.next());
  ...
  iter(t = 0) {
    return Ve.from([this]).goto(t);
  }
  get isEmpty() {
    return this.nextLayer == this;
  }
  static iter(t, e = 0) {
    return Ve.from(t).goto(e);
  }
  static compare(t, e, i, s, r = -1) {
    let o = t.filter((f) => f.maxPoint > 0 || (!f.isEmpty && f.maxPoint >= r)),
      ...
      c = new ve(o, a, r),
      h = new ve(l, a, r);
    i.iterGaps((f, u, d) => hn(c, f, h, u, d, s)),
      i.empty && i.length == 0 && hn(c, 0, h, 0, 0, s);
  }
  static eq(t, e, i = 0, s) {
    s == null && (s = 999999999);
    ...
    let l = an(r, o),
      a = new ve(r, l, 0).goto(i),
      c = new ve(o, l, 0).goto(i);
    for (;;) {
      if (
        a.to != c.to ||
        !rs(a.active, c.active) ||
        (a.point && (!c.point || !a.point.eq(c.point)))
      )
        return !1;
      if (a.to > s) return !0;
      a.next(), c.next();
          ...
          f =
            o.pointFrom < e
              ...
              : o.point.startSide < 0
                ? h.length
                : Math.min(h.length, a);
        s.point(l, c, o.point, h, f, o.pointRank),
          (a = Math.min(o.openEnd(c), h.length));
  ...
  static of(t, e = !1) {
    let i = new Fe();
    for (let s of t instanceof He ? [t] : e ? Qa(t) : t)
...
function Qa(n) {
  if (n.length > 1)
    for (let t = n[0], e = 1; e < n.length; e++) {
      let i = n[e];
      if (ns(t, i) > 0) return n.slice().sort(ns);
      t = i;
    }
  return n;
}
...
class Fe {
  finishChunk(t) {
    this.chunks.push(new Ws(this.from, this.to, this.value, this.maxPoint)),
  ...
  add(t, e, i) {
    this.addInner(t, e, i) ||
      (this.nextLayer || (this.nextLayer = new Fe())).add(t, e, i);
  }
  addInner(t, e, i) {
...
function an(n, t, e) {
  ...
  for (let r of t)
    for (let o = 0; o < r.chunk.length; o++) {
      ...
      l != null &&
        (e ? e.mapPos(l) : l) == r.chunkPos[o] &&
        !e?.touchesRange(l, l + r.chunk[o].length) &&
        s.add(r.chunk[o]);
    }
  return s;
}
...
class Ve {
  ...
  static from(t, e = null, i = -1) {
    ...
    for (let r = 0; r < t.length; r++)
      for (let o = t[r]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= i && s.push(new Hr(o, e, i, r));
    return s.length == 1 ? s[0] : new Ve(s);
  }
  get startSide() {
    return this.value ? this.value.startSide : 0;
  }
  goto(t, e = -1e9) {
    ...
    for (let i = this.heap.length >> 1; i >= 0; i--) Bi(this.heap, i);
...
class ve {
  ...
  removeActive(t) {
    Xe(this.active, t),
      Xe(this.activeTo, t),
      Xe(this.activeRank, t),
      (this.minActive = cn(this.active, this.activeTo));
  }
  addActive(t) {
    let e = 0,
    ...
    for (
      ...
      (r - this.activeRank[e] || s - this.activeTo[e]) > 0;

    )
      e++;
    Je(this.active, e, i),
      Je(this.activeTo, e, s),
      Je(this.activeRank, e, r),
      t && Je(t, e, this.cursor.from),
      (this.minActive = cn(this.active, this.activeTo));
  }
  next() {
    let t = this.to,
  ...
  for (;;) {
    ...
    if (
      (n.point || e.point
        ? (n.point &&
            e.point &&
            (n.point == e.point || n.point.eq(e.point)) &&
            rs(n.activeForPoint(n.to), e.activeForPoint(e.to))) ||
          r.comparePoint(l, f, n.point, e.point)
        : f > l &&
          !rs(n.active, e.active) &&
          r.compareRange(l, f, n.active, e.active),
      h > o)
    )
      break;
...
const os = "ͼ",
  fn = typeof Symbol > "u" ? "__" + os : Symbol.for(os),
  ls =
    typeof Symbol > "u"
      ? "__styleSet" + Math.floor(Math.random() * 1e8)
      : Symbol("styleSet"),
  un = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {};
class ue {
  constructor(t, e) {
    this.rules = [];
    let { finish: i } = e || {};
      ...
      for (let d in l) {
        ...
        if (/&/.test(d))
          r(
            d
              .split(/,\s*/)
              .map((m) => o.map((x) => m.replace(/&/, x)))
              .reduce((m, x) => m.concat(x)),
            g,
            a,
          );
...
`);
  ...
  static newName() {
    let t = un[fn] || 1;
    return (un[fn] = t + 1), os + t.toString(36);
  }
  static mount(t, e, i) {
    let s = t[ls],
      r = i && i.nonce;
    s ? r && s.setNonce(r) : (s = new ih(t, r)),
...
function We(n) {
  let t;
  return (
    n.nodeType == 11 ? (t = n.getSelection ? n : n.ownerDocument) : (t = n),
    t.getSelection()
  );
}
function as(n, t) {
...
function de(n) {
  return n.nodeType == 3
    ? ie(n, 0, n.nodeValue.length).getClientRects()
    : n.nodeType == 1
      ? n.getClientRects()
      : [];
}
function Re(n, t, e, i) {
  return e ? pn(n, t, e, i, -1) || pn(n, t, e, i, 1) : !1;
}
function ee(n) {
...
function Fr(n, t) {
  ...
  return (
    ((e > 0.995 && e < 1.005) ||
      !isFinite(e) ||
      Math.abs(t.width - n.offsetWidth) < 1) &&
      (e = 1),
    ((i > 0.995 && i < 1.005) ||
      !isFinite(i) ||
      Math.abs(t.height - n.offsetHeight) < 1) &&
      (i = 1),
    { scaleX: e, scaleY: i }
  );
}
function rh(n, t, e, i, s, r, o, l) {
  ...
  for (let h = n, f = !1; h && !f; )
    if (h.nodeType == 1) {
      ...
      if (d) u = nh(c);
        ...
        if (
          (/^(fixed|sticky)$/.test(getComputedStyle(h).position) && (f = !0),
        ...
        ({ scaleX: g, scaleY: m } = Fr(h, b)),
          (u = {
            left: b.left,
            right: b.left + h.clientWidth * g,
            top: b.top,
            bottom: b.top + h.clientHeight * m,
          });
      }
      let x = 0,
        y = 0;
      if (s == "nearest")
        t.top < u.top
          ? ((y = -(u.top - t.top + o)),
            e > 0 &&
              t.bottom > u.bottom + y &&
              (y = t.bottom - u.bottom + y + o))
          : t.bottom > u.bottom &&
            ((y = t.bottom - u.bottom + o),
            e < 0 && t.top - y < u.top && (y = -(u.top + y - t.top + o)));
      else {
      ...
      if (
        (i == "nearest"
          ? t.left < u.left
            ? ((x = -(u.left - t.left + r)),
              e > 0 && t.right > u.right + x && (x = t.right - u.right + x + r))
            : t.right > u.right &&
              ((x = t.right - u.right + r),
              e < 0 && t.left < u.left + x && (x = -(u.left + x - t.left + r)))
          : (x =
              (i == "center"
        ...
        if (d) c.scrollBy(x, y);
          ...
          if (y) {
            let v = h.scrollTop;
            (h.scrollTop += y / m), (S = (h.scrollTop - v) * m);
          }
          if (x) {
            let v = h.scrollLeft;
            (h.scrollLeft += x / g), (b = (h.scrollLeft - v) * g);
          }
          (t = {
            left: t.left - b,
            top: t.top - S,
            ...
            b && Math.abs(b - x) < 1 && (i = "nearest"),
            S && Math.abs(S - y) < 1 && (s = "nearest");
        }
      if (d) break;
      h = h.assignedSlot || h.parentNode;
...
class lh {
  ...
  setRange(t) {
    ...
    this.set(
      e,
      Math.min(t.anchorOffset, e ? Vt(e) : 0),
      i,
      Math.min(t.focusOffset, i ? Vt(i) : 0),
    );
  }
  set(t, e, i, s) {
    (this.anchorNode = t),
...
function hh(n, t) {
  ...
  for (i = Math.min(i, Vt(e)); ; )
    if (i) {
      if (e.nodeType != 1) return !1;
      let s = e.childNodes[i - 1];
      s.contentEditable == "false" ? i-- : ((e = s), (i = Vt(e)));
    } else {
      if (e == n) return !0;
      (i = ee(e)), (e = e.parentNode);
    }
}
function zr(n) {
...
function _r(n, t) {
  for (let e = n, i = t; ; ) {
    ...
    if (e.nodeType == 1 && i > 0) {
      ...
      (e = e.childNodes[i - 1]), (i = Vt(e));
    } else if (e.parentNode && !Si(e)) (i = ee(e)), (e = e.parentNode);
    else return null;
  }
}
function qr(n, t) {
  for (let e = n, i = t; ; ) {
    ...
    } else if (e.parentNode && !Si(e)) (i = ee(e) + 1), (e = e.parentNode);
    else return null;
  }
}
class nt {
  ...
  static before(t, e) {
    return new nt(t.parentNode, ee(t), e);
  }
  static after(t, e) {
    return new nt(t.parentNode, ee(t) + 1, e);
  }
}
const zs = [];
class H {
  ...
  childCursor(t = this.length) {
    return new Kr(this.children, t, this.children.length);
  }
  childPos(t, e = 1) {
...
function $r(n, t, e, i, s, r, o, l, a) {
  ...
  if (
    !(
      ...
      !u &&
      r.length < 2 &&
      h.merge(e, s, r.length ? f : null, e == 0, l, a)
    )
  ) {
    if (i < c.length) {
      let d = c[i];
    ...
    for (
      ...
      ((h.breakAfter = o),
      e > 0 &&
        (!o && r.length && h.merge(e, h.length, r[0], !1, l, 0)
          ? (h.breakAfter = r.shift().breakAfter)
          : (e < h.length ||
              (h.children.length &&
                h.children[h.children.length - 1].length == 0)) &&
            h.merge(e, h.length, null, !1, l, 0),
        t++));
      t < i && r.length;
...
function Ur(n, t, e, i, s, r) {
  let o = n.childCursor(),
    { i: l, off: a } = o.findPos(e, 1),
    { i: c, off: h } = o.findPos(t, -1),
    f = t - e;
  for (let u of i) f += u.length;
  (n.length += f), $r(n, c, h, l, a, i, 0, s, r);
}
let ut =
    typeof navigator < "u"
      ? navigator
      : { userAgent: "", vendor: "", platform: "" },
  hs = typeof document < "u" ? document : { documentElement: { style: {} } };
const cs = /Edge\/(\d+)/.exec(ut.userAgent),
  Gr = /MSIE \d/.test(ut.userAgent),
  fs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(ut.userAgent),
  Ri = !!(Gr || fs || cs),
  xn = !Ri && /gecko\/(\d+)/i.test(ut.userAgent),
  Ii = !Ri && /Chrome\/(\d+)/.exec(ut.userAgent),
  ch = "webkitFontSmoothing" in hs.documentElement.style,
  Yr = !Ri && /Apple Computer/.test(ut.vendor),
  yn = Yr && (/Mobile\/\w+/.test(ut.userAgent) || ut.maxTouchPoints > 2);
var C = {
  mac: yn || /Mac/.test(ut.platform),
  windows: /Win/.test(ut.platform),
  linux: /Linux|X11/.test(ut.platform),
  ie: Ri,
  ie_version: Gr ? hs.documentMode || 6 : fs ? +fs[1] : cs ? +cs[1] : 0,
  gecko: xn,
  gecko_version: xn ? +(/Firefox\/(\d+)/.exec(ut.userAgent) || [0, 0])[1] : 0,
  chrome: !!Ii,
  chrome_version: Ii ? +Ii[1] : 0,
  ios: yn,
  android: /Android\b/.test(ut.userAgent),
  safari: Yr,
  webkit_version: ch
    ? +(/\bAppleWebKit\/(\d+)/.exec(ut.userAgent) || [0, 0])[1]
    : 0,
  tabSize:
    hs.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size",
};
const fh = 256;
class St extends H {
  constructor(t) {
  ...
  split(t) {
    let e = new St(this.text.slice(t));
    return (
...
class Wt extends H {
  ...
  merge(t, e, i, s, r, o) {
    return i &&
      (!(i instanceof Wt && i.mark.eq(this.mark)) ||
        (t && r <= 0) ||
        (e < this.length && o <= 0))
      ? !1
      : (Ur(this, t, e, i ? i.children.slice() : [], r - 1, o - 1),
        this.markDirty(),
        !0);
  }
  split(t) {
...
function uh(n, t, e) {
  ...
  let s = t,
    ...
    o = 0;
  (t == 0 && e < 0) || (t == i && e >= 0)
    ? C.chrome || C.gecko || (t ? (s--, (o = 1)) : r < i && (r++, (o = -1)))
    : e < 0
      ? s--
      : r < i && r++;
  let l = ie(n, s, r).getClientRects();
  ...
  return (
    C.safari &&
      !o &&
      a.width == 0 &&
      (a = Array.prototype.find.call(l, (c) => c.width) || a),
    o ? Di(a, o < 0) : a || null
  );
}
class Zt extends H {
  ...
  split(t) {
    let e = Zt.create(this.widget, this.length - t, this.side);
  ...
  domAtPos(t) {
    return (this.length ? t == 0 : this.side > 0)
      ? nt.before(this.dom)
      : nt.after(this.dom, t == this.length);
  }
  domBoundsAround() {
    return null;
  }
  coordsAt(t, e) {
    ...
    for (
      ...
      (r = s[l]), !(t > 0 ? l == 0 : l == s.length - 1 || r.top < r.bottom);
      l += o ? -1 : 1
    );
    return Di(r, !o);
  }
...
St.prototype.children = Zt.prototype.children = pe.prototype.children = zs;
function Xr(n, t) {
  let e = n.dom,
    { children: i } = n,
    s = 0;
...
function Jr(n, t, e) {
  ...
  t instanceof Wt &&
  s.length &&
  (i = s[s.length - 1]) instanceof Wt &&
  i.mark.eq(t.mark)
    ? Jr(i, t.children[0], e - 1)
    : (s.push(t), t.setParent(n)),
    (n.length += t.length);
}
function Zr(n, t, e) {
  let i = null,
      ...
      g >= h &&
        (d.children.length
          ...
          : (!r || (r.isHidden && e > 0)) &&
              (g > h || (u == g && d.getSide() > 0))
            ? ((r = d), (o = h - u))
            : (u < h || (u == g && d.getSide() < 0 && !d.isHidden)) &&
              ((i = d), (s = h - u))),
        (u = g);
    }
  }
  l(n, t);
  let a = (e < 0 ? i : r) || i || r;
  return a ? a.coordsAt(Math.max(0, a == i ? s : o), e) : dh(n);
}
function dh(n) {
...
class G extends H {
  ...
  merge(t, e, i, s, r, o) {
    ...
    return (
      ...
      Ur(this, t, e, i ? i.children.slice() : [], r, o),
      !0
    );
  }
  split(t) {
  ...
  addLineDeco(t) {
    let e = t.spec.attributes,
      i = t.spec.class;
    e && (this.attrs = us(e, this.attrs || {})),
      i && (this.attrs = us({ class: i }, this.attrs || {}));
  }
  domAtPos(t) {
    return Xr(this, t);
  }
  ...
  sync(t, e) {
    ...
    this.dom
      ...
      : (this.setDOM(document.createElement("div")),
        ...
        (this.prevAttrs = this.attrs ? null : void 0)),
      this.prevAttrs !== void 0 &&
        (ds(this.dom, this.prevAttrs, this.attrs),
        this.dom.classList.add("cm-line"),
        (this.prevAttrs = void 0)),
      super.sync(t, e);
    let s = this.dom.lastChild;
    for (; s && H.get(s) instanceof Wt; ) s = s.lastChild;
    if (
      !s ||
      !this.length ||
      (s.nodeName != "BR" &&
        ((i = H.get(s)) === null || i === void 0 ? void 0 : i.isEditable) ==
          !1 &&
        (!C.ios || !this.children.some((r) => r instanceof St)))
    ) {
...
class Ht extends H {
  ...
  domAtPos(t) {
    return t == 0 ? nt.before(this.dom) : nt.after(this.dom, t == this.length);
  }
  split(t) {
    let e = this.length - t;
    this.length = t;
  ...
  become(t) {
    return t instanceof Ht && t.widget.constructor == this.widget.constructor
...
class F extends fe {
  ...
  static widget(t) {
    ...
    return (
      ...
      new Gt(t, e, e, i, t.widget || null, !1)
    );
  }
  static replace(t) {
    let e = !!t.block,
    ...
    if (t.isBlockGap) (i = -5e8), (s = 4e8);
      ...
      let { start: r, end: o } = Qr(t, e);
      (i = (r ? (e ? -3e8 : -1) : 5e8) - 1),
        (s = (o ? (e ? 2e8 : 1) : -6e8) + 1);
    }
    return new Gt(t, i, s, e, t.widget || null, !0);
  }
  static line(t) {
    return new $e(t);
  }
...
class $e extends F {
  ...
  eq(t) {
    return (
      ...
      Ci(this.spec.attributes, t.spec.attributes)
    );
  }
  range(t, e = t) {
    if (e != t)
...
$e.prototype.mapMode = gt.TrackBefore;
$e.prototype.point = !0;
class Gt extends F {
  constructor(t, e, i, s, r, o) {
    super(e, i, r, t),
...
class Ne {
  ...
  getLine() {
    return (
      this.curLine ||
        (this.content.push((this.curLine = new G())), (this.atCursorPos = !0)),
      this.curLine
    );
  }
  flushBuffer(t = this.bufferMarks) {
    this.pendingBuffer &&
      (this.curLine.append(Ze(new pe(-1), t), t.length),
      (this.pendingBuffer = 0));
  }
  addBlockWidget(t) {
    ...
    this.pendingBuffer && t <= this.bufferMarks.length
      ...
      !this.posCovered() &&
        !(
          t &&
          this.content.length &&
          this.content[this.content.length - 1] instanceof Ht
        ) &&
        this.getLine();
  }
  buildText(t, e, i) {
    for (; t > 0; ) {
      ...
      this.flushBuffer(e.slice(e.length - i)),
        this.getLine().append(
          Ze(new St(this.text.slice(this.textOff, this.textOff + s)), e),
          i,
        ),
        (this.atCursorPos = !0),
        (this.textOff += s),
    ...
    if (i instanceof Gt)
      if (i.block)
        i.startSide > 0 && !this.posCovered() && this.getLine(),
          this.addBlockWidget(new Ht(i.widget || ge.block, l, i));
      else {
        let a = Zt.create(i.widget || ge.inline, l, l ? 0 : i.startSide),
          c =
            this.atCursorPos &&
            !a.isEditable &&
            r <= s.length &&
        ...
        this.pendingBuffer == 2 &&
          ...
          this.flushBuffer(s),
          c &&
            (f.append(Ze(new pe(1), s), r),
            (r = s.length + Math.max(0, r - s.length))),
          f.append(Ze(a, s), r),
          (this.atCursorPos = h),
          (this.pendingBuffer = h ? (t < e || r > s.length ? 1 : 2) : 0),
  ...
  static build(t, e, i, s, r) {
    let o = new Ne(t, e, i, r);
    return (
      (o.openEnd = L.spans(s, e, i, o)),
  ...
  static find(t, e, i, s) {
    ...
    for (let o = 0; o < t.length; o++) {
      ...
      if (l.from <= e && l.to >= e) {
        ...
        (r < 0 ||
          (s != 0 ? (s < 0 ? l.from < e : l.to > e) : t[r].level > l.level)) &&
          (r = o);
      }
    }
...
function bh(n, t, e, i, s) {
  for (let r = 0; r <= i.length; r++) {
    ...
    for (let c = o, h = a, f = a; c < l; c++) {
      let u = eo(n.charCodeAt(c));
      u == 512 ? (u = h) : u == 8 && f == 4 && (u = 16),
        (j[c] = u == 4 ? 2 : u),
        u & 7 && (f = u),
        (h = u);
    }
    for (let c = o, h = a, f = a; c < l; c++) {
      let u = j[c];
      if (u == 128)
        c < l - 1 && h == j[c + 1] && h & 24 ? (u = j[c] = h) : (j[c] = 256);
      else if (u == 64) {
        let d = c + 1;
        for (; d < l && j[d] == 64; ) d++;
        let g = (c && h == 8) || (d < e && j[d] == 8) ? (f == 1 ? 1 : 8) : 256;
        for (let m = c; m < d; m++) j[m] = g;
        c = d - 1;
      } else u == 8 && f == 1 && (j[c] = 1);
      (h = u), u & 7 && (f = u);
    }
...
function wh(n, t, e, i, s) {
  ...
  for (let o = 0, l = 0, a = 0; o <= i.length; o++) {
    ...
    for (let f = c, u, d, g; f < h; f++)
      if ((d = gs[(u = n.charCodeAt(f))]))
        if (d < 0) {
          for (let m = l - 3; m >= 0; m -= 3)
            if (Et[m + 1] == -d) {
              let x = Et[m + 2],
                y = x & 2 ? s : x & 4 ? (x & 1 ? r : s) : 0;
              y && (j[f] = j[Et[m]] = y), (l = m);
              break;
            }
        } else {
          if (Et.length == 189) break;
          (Et[l++] = f), (Et[l++] = u), (Et[l++] = a);
        }
      else if ((g = j[f]) == 2 || g == 1) {
        let m = g == s;
        a = m ? 0 : 1;
    ...
    for (let a = o; a < l; ) {
      ...
      if (c == 256) {
        ...
        let f = r == 1,
          u = (h < t ? j[h] : i) == 1,
          d = f == u ? (f ? 1 : 2) : i;
        for (let g = h, m = s, x = m ? e[m - 1].to : n; g > a; )
          g == x && ((g = e[--m].from), (x = m ? e[m - 1].to : n)),
            (j[--g] = d);
        a = h;
      } else (r = c), a++;
    }
    ...
    for (let a = t, c = 0; a < e; ) {
      ...
      t: for (;;)
        if (c < r.length && g == r[c].from) {
          ...
          let m = r[c];
          if (!h)
            for (let x = m.to, y = c + 1; ; ) {
              if (x == e) break t;
              if (y < r.length && r[y].from == x) x = r[y++].to;
              else {
                if (j[x] == l) break t;
                break;
              }
          ...
          if ((c++, u)) u.push(m);
            ...
            m.from > a && o.push(new Ut(a, m.from, d));
            let x = (m.direction == se) != !(d % 2);
            xs(n, x ? i + 1 : i, s, m.inner, m.from, m.to, o), (a = m.to);
          }
          g = m.to;
        } else {
          if (g == e || (h ? j[g] != l : j[g] == l)) break;
          g++;
        }
      u ? ms(n, a, g, i + 1, s, u, o) : a < g && o.push(new Ut(a, g, d)),
        (a = g);
    }
  else
    for (let a = e, c = r.length; a > t; ) {
      ...
      t: for (;;)
        if (c && g == r[c - 1].to) {
          ...
          let m = r[--c];
          if (!h)
            for (let x = m.from, y = c; ; ) {
              if (x == t) break t;
              if (y && r[y - 1].to == x) x = r[--y].from;
              else {
                if (j[x - 1] == l) break t;
                break;
              }
          ...
          if (u) u.push(m);
            ...
            m.to < a && o.push(new Ut(m.to, a, d));
            let x = (m.direction == se) != !(d % 2);
            xs(n, x ? i + 1 : i, s, m.inner, m.from, m.to, o), (a = m.from);
          }
          g = m.from;
        } else {
          if (g == t || (h ? j[g - 1] != l : j[g - 1] == l)) break;
          g--;
        }
      u ? ms(n, g, a, i + 1, s, u, o) : g < a && o.push(new Ut(g, a, d)),
        (a = g);
    }
}
function xs(n, t, e, i, s, r, o) {
  let l = t % 2 ? 2 : 1;
  bh(n, s, r, i, l), wh(n, s, r, i, l), vh(s, r, i, l), ms(n, s, r, t, e, i, o);
}
function Sh(n, t, e) {
  if (!n) return [new Ut(0, 0, t == _s ? 1 : 0)];
  if (t == se && !e.length && !yh.test(n)) return so(n.length);
  if (e.length) for (; n.length > j.length; ) j[j.length] = 256;
  let i = [],
    s = t == se ? 0 : 1;
  return xs(n, s, s, e, 0, n.length, i), i;
}
function so(n) {
  return [new Ut(0, n, 0)];
}
...
function Ch(n, t, e, i, s) {
  ...
  (h < a.from || h > a.to) && (h = c),
    (no = n.text.slice(Math.min(o, h), Math.max(o, h)));
  let f = l == (s ? t.length - 1 : 0) ? null : t[l + (s ? 1 : -1)];
  return f && h == c && f.level + (s ? 0 : 1) < a.level
    ? M.cursor(f.side(!s, e) + n.from, f.forward(s, e) ? 1 : -1, f.level)
    : M.cursor(h + n.from, a.forward(s, e) ? -1 : 1, a.level);
}
function kh(n, t, e) {
  for (let i = t; i < e; i++) {
    let s = eo(n.charCodeAt(i));
    if (s == 1) return se;
    if (s == 2 || s == 4) return _s;
  }
  return se;
}
const ro = E.define(),
  ...
  ho = E.define(),
  co = E.define(),
  fo = E.define({ combine: (n) => n.some((t) => t) }),
  uo = E.define({ combine: (n) => n.some((t) => t) }),
  po = E.define();
class he {
...
const Qe = _.define({ map: (n, t) => n.map(t) }),
  go = _.define();
function It(n, t, e) {
  let i = n.facet(ao);
  i.length
    ? i[0](t)
    : window.onerror
      ? window.onerror(String(t), e, void 0, void 0, t)
      : e
        ? console.error(e + ":", t)
        : console.error(t);
}
const qt = E.define({ combine: (n) => (n.length ? n[0] : !0) });
let Mh = 0;
const ke = E.define();
class Pt {
  constructor(t, e, i, s, r) {
  ...
  update(t) {
    if (this.value) {
      if (this.mustUpdate) {
        ...
        if (((this.mustUpdate = null), this.value.update))
          try {
            ...
            if (
              (It(e.state, i, "CodeMirror plugin crashed"), this.value.destroy)
            )
              try {
                this.value.destroy();
              } catch {}
      ...
      try {
        ...
        It(t.state, e, "CodeMirror plugin crashed"), this.deactivate();
      }
    return this;
  }
  destroy(t) {
    ...
    if (!((e = this.value) === null || e === void 0) && e.destroy)
      try {
        ...
        It(t.state, i, "CodeMirror plugin crashed");
      }
  }
  deactivate() {
...
class ki {
  constructor(t, e, i) {
    (this.view = t),
      ...
      (this.changes = J.empty(this.startState.doc.length));
    for (let r of i) this.changes = this.changes.compose(r.changes);
    let s = [];
    this.changes.iterChangedRanges((r, o, l, a) => s.push(new xt(r, o, l, a))),
...
class vn extends H {
  ...
  constructor(t) {
    super(),
      ...
      (this.editContextFormatting = F.none),
      ...
      this.updateDeco(),
      this.updateInner([new xt(0, 0, 0, t.state.doc.length)], 0, null);
  }
  update(t) {
    var e;
    ...
    this.view.inputState.composing >= 0 &&
      ...
      (!((e = this.domChanged) === null || e === void 0) && e.newSel
        ? (s = this.domChanged.newSel.head)
        : !Nh(t.changes, this.hasComposition) &&
          !t.selectionSet &&
          (s = t.state.selection.main.head));
    let r = s > -1 ? Eh(this.view, t.changes, s) : null;
  ...
  updateInner(t, e, i) {
    ...
    if (
      ...
      for (let o of this.children)
        o instanceof Ht && o.widget instanceof Sn && r.push(o.dom);
    s.updateGaps(r);
  }
  updateChildren(t, e, i) {
    ...
    for (let o = s.length - 1; ; o--) {
      let l = o >= 0 ? s[o] : null;
      if (!l) break;
      let { fromA: a, toA: c, fromB: h, toB: f } = l,
        u,
        d,
        g,
        m;
      if (i && i.range.fromB < f && i.range.toB > h) {
        ...
        (d = v.breakAtStart), (g = v.openStart), (m = k.openEnd);
        let A = this.compositionView(i);
        k.breakAtStart
          ? (A.breakAfter = 1)
          : k.content.length &&
            A.merge(A.length, A.length, k.content[0], !1, k.openStart, 0) &&
            ((A.breakAfter = k.content[0].breakAfter), k.content.shift()),
          v.content.length &&
            A.merge(0, 0, v.content[v.content.length - 1], !0, 0, v.openEnd) &&
            v.content.pop(),
          (u = v.content.concat(A).concat(k.content));
      } else
        ({
          content: u,
          breakAtStart: d,
      ...
      let { i: x, off: y } = r.findPos(c, 1),
        { i: b, off: S } = r.findPos(a, -1);
      $r(this, b, S, x, y, u, d, g, m);
    }
  ...
  updateEditContextFormatting(t) {
    ...
    for (let e of t.transactions)
      for (let i of e.effects)
        i.is(go) && (this.editContextFormatting = i.value);
  }
  compositionView(t) {
    let e = new St(t.text.nodeValue);
    e.flags |= 8;
    for (let { deco: s } of t.marks) e = new Wt(s, [e], e.length);
    let i = new G();
  ...
  updateSelection(t = !1, e = !1) {
    ...
    let i = this.view.root.activeElement,
      ...
      r =
        !s &&
        ci(this.dom, this.view.observer.selectionRange) &&
    ...
    if (C.gecko && l.empty && !this.hasComposition && Ah(a)) {
    ...
    (o ||
      !h.focusNode ||
      ((!Re(a.node, a.offset, h.anchorNode, h.anchorOffset) ||
        !Re(c.node, c.offset, h.focusNode, h.focusOffset)) &&
        !this.suppressWidgetCursorChange(h, l))) &&
      (this.view.observer.ignore(() => {
        C.android &&
          C.chrome &&
          this.dom.contains(h.focusNode) &&
          Rh(h.focusNode, this.dom) &&
          (this.dom.blur(), this.dom.focus({ preventScroll: !0 }));
        let f = We(this.view.root);
        if (f)
          if (l.empty) {
            if (C.gecko) {
              let u = Oh(a.node, a.offset);
              if (u && u != 3) {
                let d = (u == 1 ? _r : qr)(a.node, a.offset);
                d && (a = new nt(d.node, d.offset));
              }
            }
      ...
      (this.impreciseAnchor = a.precise
        ? null
        : new nt(h.anchorNode, h.anchorOffset)),
      (this.impreciseHead = c.precise
        ? null
        : new nt(h.focusNode, h.focusOffset));
  }
  ...
  moveToLine(t) {
    ...
    return i ? new nt(i.node, i.offset, !0) : t;
  }
  nearest(t) {
    for (let e = t; e; ) {
      let i = H.get(e);
  ...
  domAtPos(t) {
    ...
    for (; e < this.children.length - 1; ) {
      ...
      if (i < s.length || s instanceof G) break;
      e++, (i = 0);
    }
  ...
  coordsAt(t, e) {
    ...
    for (let r = this.length, o = this.children.length - 1; o >= 0; o--) {
      ...
      if (
        ...
        (c < t || l.covers(-1)) &&
        (a > t || l.covers(1)) &&
        (!i || (l instanceof G && !(i instanceof G && e >= 0)))
      )
        (i = l), (s = c);
  ...
  coordsForChar(t) {
    ...
    let r = Lt(s.text, i);
    if (r == i) return null;
    let o = ie(s.dom, i, r).getClientRects();
    ...
    for (let c = 0, h = 0; h < this.children.length; h++) {
      ...
      if (c >= i) {
        ...
        if ((e.push(d.height), o)) {
          ...
          if (m.length) {
            let x = m[m.length - 1],
              y = a ? x.right - d.left : d.right - x.left;
            y > l &&
              ((l = y),
              (this.minWidth = r),
              (this.minWidthFrom = c),
  ...
  childCursor(t = this.length) {
    ...
    return e && (t -= this.children[--e].length), new Kr(this.children, t, e);
  }
  computeBlockGapDeco() {
    let t = [],
  ...
  updateDeco() {
    let t = 1,
      ...
      i = !1,
      s = this.view.state.facet(xo).map((r, o) => {
        let l = typeof r == "function";
        return l && (i = !0), l ? r(this.view) : r;
      });
    for (
      s.length && ((this.dynamicDecorationMap[t++] = i), e.push(L.join(s))),
        this.decorations = [
  ...
  scrollIntoView(t) {
    if (t.isSnapshot) {
      ...
      (this.view.scrollDOM.scrollTop = c.top - t.yMargin),
        (this.view.scrollDOM.scrollLeft = t.xMargin);
      return;
    }
    for (let c of this.view.state.facet(po))
      try {
        if (c(this.view, t.range, t)) return !0;
      } catch (h) {
        It(this.view.state, h, "scroll handler");
      }
    let { range: e } = t,
      i = this.coordsAt(e.head, e.empty ? e.assoc : e.head > e.anchor ? -1 : 1),
      s;
    if (!i) return;
    !e.empty &&
    ...
    rh(
      ...
      t.x,
      t.y,
      Math.max(Math.min(t.xMargin, l), -l),
      Math.max(Math.min(t.yMargin, a), -a),
      this.view.textDirection == Y.LTR,
    );
  }
}
function Ah(n) {
...
function vo(n, t) {
  ...
  let i = _r(e.focusNode, e.focusOffset),
    s = qr(e.focusNode, e.focusOffset),
    r = i || s;
...
function Eh(n, t, e) {
  ...
  for (let f = s.parentNode; ; f = f.parentNode) {
    let u = H.get(f);
    if (u instanceof Wt) h.push({ node: f, deco: u.mark });
    else {
      if (
        u instanceof G ||
...
function Oh(n, t) {
  return n.nodeType != 1
    ? 0
    : (t && n.childNodes[t - 1].contentEditable == "false" ? 1 : 0) |
        (t < n.childNodes.length && n.childNodes[t].contentEditable == "false"
          ? 2
          : 0);
}
let Th = class {
...
function Cn(n, t) {
  return t < n.top
    ? { top: t, left: n.left, right: n.right, bottom: n.bottom }
    : n;
}
function kn(n, t) {
  return t > n.bottom
    ? { top: n.top, left: n.left, right: n.right, bottom: t }
    : n;
}
function bs(n, t, e) {
  let i,
  ...
  for (let g = n.firstChild; g; g = g.nextSibling) {
    ...
    for (let x = 0; x < m.length; x++) {
      let y = m[x];
      s && Hi(s, y) && (y = Cn(kn(y, s.bottom), s.top));
      let b = Ph(t, y),
        S = Bh(e, y);
      if (b == 0 && S == 0) return g.nodeType == 3 ? Mn(g, t, e) : bs(g, t, e);
      if (!i || o > S || (o == S && r > b)) {
        (i = g), (s = y), (r = b), (o = S);
        let v = S ? (e < y.top ? -1 : 1) : b ? (t < y.left ? -1 : 1) : 0;
        l = !v || (v > 0 ? x < m.length - 1 : x > 0);
      }
      b == 0
        ? e > y.bottom && (!h || h.bottom < y.bottom)
          ? ((a = g), (h = y))
          : e < y.top && (!f || f.top > y.top) && ((c = g), (f = y))
        : h && Hi(h, y)
          ? (h = kn(h, y.bottom))
          : f && Hi(f, y) && (f = Cn(f, y.top));
    }
  }
  if (
    (h && h.bottom >= e
  ...
  if (i.nodeType == 3) return Mn(i, u, e);
  if (l && i.contentEditable != "false") return bs(i, u, e);
  let d =
    Array.prototype.indexOf.call(n.childNodes, i) +
    (t >= (s.left + s.right) / 2 ? 1 : 0);
...
function Mn(n, t, e) {
  let i = n.nodeValue.length,
    ...
    o = 0;
  for (let l = 0; l < i; l++) {
    let a = ie(n, l, l + 1).getClientRects();
    for (let c = 0; c < a.length; c++) {
      ...
      if (h.left - 1 <= t && h.right + 1 >= t && f < r) {
        ...
        if (
          ((C.chrome || C.gecko) &&
            ie(n, l).getBoundingClientRect().left == h.right &&
            (d = !u),
          f <= 0)
        )
...
function So(n, t, e, i = -1) {
  ...
  for (
    ...
    (a = n.elementAtHeight(u)), a.type != at.Text;
  ...
  if (d < n.viewport.from)
    return n.viewport.from == 0 ? 0 : e ? null : An(n, o, a, h, f);
  if (d > n.viewport.to)
  ...
  let g = n.dom.ownerDocument,
    ...
    x = m.elementFromPoint(h, f);
  x && !n.contentDOM.contains(x) && (x = null),
    x ||
  ...
  if (
    x &&
    ((s = n.docView.nearest(x)) === null || s === void 0
      ? void 0
      : s.isEditable) != !1
  ) {
    if (g.caretPositionFromPoint) {
      ...
      v &&
        (({ startContainer: y, startOffset: b } = v),
        (!n.contentDOM.contains(y) ||
          (C.safari && Ih(y, b, h)) ||
          (C.chrome && jh(y, b, h))) &&
          (y = void 0));
    }
  ...
  if (!y || !n.docView.dom.contains(y)) {
    let v = G.find(n.docView, d);
    if (!v) return u > a.top + a.height / 2 ? a.to : a.from;
    ({ node: y, offset: b } = bs(v.dom, h, f));
  }
  let S = n.docView.nearest(y);
  if (!S) return null;
  if (
    S.isWidget &&
    ((r = S.dom) === null || r === void 0 ? void 0 : r.nodeType) == 1
  ) {
    let v = S.dom.getBoundingClientRect();
    return t.y < v.top || (t.y <= v.bottom && t.x <= (v.left + v.right) / 2)
      ? S.posAtStart
      : S.posAtEnd;
  } else return S.localPosFromDOM(y, b) + S.posAtStart;
}
function An(n, t, e, i, s) {
  ...
  if (n.lineWrapping && e.height > n.defaultLineHeight * 1.5) {
    let l = n.viewState.heightOracle.textHeight,
      a = Math.floor((s - e.top - (n.defaultLineHeight - l) * 0.5) / l);
    r += a * n.viewState.heightOracle.lineLength;
  }
  let o = n.state.sliceDoc(e.from, e.to);
  return e.from + eh(o, r, n.state.tabSize);
}
function Ih(n, t, e) {
  let i;
  ...
  return ie(n, i - 1, i).getBoundingClientRect().left > e;
}
function jh(n, t, e) {
  if (t != 0) return !1;
  for (let s = n; ; ) {
  ...
  let i =
    n.nodeType == 1
      ...
      : ie(n, 0, Math.max(n.nodeValue.length, 1)).getBoundingClientRect();
  return e - i.left > 5;
}
function ws(n, t) {
  ...
  if (Array.isArray(e.type)) {
    for (let i of e.type)
      if (i.to > t || (i.to == t && (i.to == e.to || i.type == at.Text)))
        return i;
  }
  return e;
}
function Hh(n, t, e, i) {
  let s = ws(n, t.head),
    r =
      !i || s.type != at.Text || !(n.lineWrapping || s.widgetLineBreaks)
        ? null
        : n.coordsAtPos(t.assoc < 0 && t.head > s.from ? t.head - 1 : t.head);
  if (r) {
...
function Vh(n, t, e, i) {
  ...
  for (let d = 0; ; d += 10) {
    let g = l + (u + d) * r,
      m = So(n, { x: f, y: g }, !1, r);
    if (g < a.top || g > a.bottom || (r < 0 ? m < s : m > s)) {
      let x = n.docView.coordsForChar(m),
        y = !x || g < x.top ? -1 : 1;
      return M.cursor(m, y, void 0, o);
    }
  }
}
function fi(n, t, e) {
...
class Wh {
  ...
  constructor(t) {
    (this.view = t),
      ...
      C.safari && t.contentDOM.addEventListener("input", () => null),
      C.gecko && sc(t.contentDOM.ownerDocument);
  }
  handleEvent(t) {
    !Yh(this.view, t) ||
  ...
  keydown(t) {
    ...
    return C.ios &&
      ...
      !t.altKey &&
      !t.metaKey &&
      (((e = Co.find((i) => i.keyCode == t.keyCode)) && !t.ctrlKey) ||
        (_h.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey))
  ...
  for (let i of n) {
    ...
    if (s && s.domEventHandlers)
      for (let r in s.domEventHandlers) {
        ...
        o && e(r).handlers.push(On(i.value, o));
      }
    if (s && s.domEventObservers)
      for (let r in s.domEventObservers) {
        let o = s.domEventObservers[r];
        o && e(r).observers.push(On(i.value, o));
      }
  }
  for (let i in Ct) e(i).handlers.push(Ct[i]);
...
function qh(n, t) {
  return Math.max(
    Math.abs(n.clientX - t.clientX),
    Math.abs(n.clientY - t.clientY),
  );
}
class Kh {
  constructor(t, e, i, s) {
    (this.view = t),
      ...
      (this.scrolling = -1),
      (this.lastEvent = e),
      (this.scrollParents = oh(t.contentDOM)),
      (this.atoms = t.state.facet(Ks).map((o) => o(t)));
    ...
    r.addEventListener("mousemove", (this.move = this.move.bind(this))),
      ...
      (this.multiple = t.state.facet(W.allowMultipleSelections) && $h(t, e)),
      (this.dragging = Gh(t, e) && Oo(e) == 1 ? null : !1);
  }
  start(t) {
  ...
  move(t) {
    ...
    if (this.dragging || (this.dragging == null && qh(this.startEvent, t) < 10))
      return;
    ...
    let a = wo(this.view);
    t.clientX - a.left <= s + ti
      ? (e = -ei(s - t.clientX))
      : t.clientX + a.right >= o - ti && (e = ei(t.clientX - o)),
      t.clientY - a.top <= r + ti
        ? (i = -ei(r - t.clientY))
        : t.clientY + a.bottom >= l - ti && (i = ei(t.clientY - l)),
  ...
  skipAtoms(t) {
    ...
    for (let i = 0; i < t.ranges.length; i++) {
      let s = t.ranges[i],
        r = null;
      if (s.empty) {
        let o = fi(this.atoms, s.from, 0);
        o != s.from && (r = M.cursor(o, -1));
      } else {
        let o = fi(this.atoms, s.from, -1),
          l = fi(this.atoms, s.to, 1);
        (o != s.from || l != s.to) &&
          (r = M.range(s.from == s.anchor ? o : l, s.from == s.head ? o : l));
      }
...
function Yh(n, t) {
  ...
  for (let e = t.target, i; e != n.contentDOM; e = e.parentNode)
    if (!e || e.nodeType == 11 || ((i = H.get(e)) && i.ignoreEvent(t)))
      return !1;
  return !0;
}
const Ct = Object.create(null),
  yt = Object.create(null),
  Mo = (C.ie && C.ie_version < 15) || (C.ios && C.webkit_version < 604);
function Xh(n) {
...
function Ao(n, t) {
  ...
  if (
    vs != null &&
    e.selection.ranges.every((a) => a.empty) &&
    vs == r.toString()
  ) {
    let a = -1;
    i = e.changeByRange((c) => {
      let h = e.doc.lineAt(c.from);
      if (h.from == a) return { range: c };
      a = h.from;
...
Ct.mousedown = (n, t) => {
  if ((n.observer.flush(), n.inputState.lastTouchTime > Date.now() - 2e3))
    return !1;
  let e = null;
  for (let i of n.state.facet(lo)) if (((e = i(n, t)), e)) break;
  if ((!e && t.button == 0 && (e = Qh(n, t)), e)) {
    let i = !n.hasFocus;
    n.inputState.startMouseSelection(new Kh(n, t, e, i)),
      i &&
        n.observer.ignore(() => {
          Vr(n.contentDOM);
...
function Tn(n, t, e, i) {
  ...
  if (i == 2) return Lh(n.state, t, e);
  {
    let s = G.find(n.docView, t),
...
let Eo = (n, t) => n >= t.top && n <= t.bottom,
  Dn = (n, t, e) => Eo(t, e) && n >= e.left && n <= e.right;
function Jh(n, t, e, i) {
  let s = G.find(n.docView, t);
  if (!s) return 1;
  ...
  if (o && Dn(e, i, o)) return -1;
  let l = s.coordsAt(r, 1);
  return l && Dn(e, i, l) ? 1 : o && Eo(i, o) ? -1 : 1;
}
function Rn(n, t) {
  let e = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1);
  return { pos: e, bias: Jh(n, e, t.clientX, t.clientY) };
}
const Zh = C.ie && C.ie_version <= 11;
let Nn = null,
  Ln = 0,
  Pn = 0;
function Oo(n) {
  if (!Zh) return n.detail;
  let t = Nn,
    e = Pn;
  return (
    (Nn = n),
    ...
    (Ln =
      !t ||
      (e > Date.now() - 400 &&
        Math.abs(t.clientX - n.clientX) < 2 &&
        Math.abs(t.clientY - n.clientY) < 2)
        ? (Ln + 1) % 3
        : 1)
  );
}
function Qh(n, t) {
  ...
  return {
    update(r) {
      r.docChanged &&
        ((e.pos = r.changes.mapPos(e.pos)), (s = s.map(r.changes)));
    },
    get(r, o, l) {
      let a = Rn(n, r),
        c,
        h = Tn(n, a.pos, a.bias, i);
      if (e.pos != a.pos && !o) {
        let f = Tn(n, e.pos, e.bias, i),
      ...
      return o
        ...
        : l && i == 1 && s.ranges.length > 1 && (c = tc(s, a.pos))
          ? c
          : l
            ? s.addRange(h)
            : M.create([h]);
...
function tc(n, t) {
  for (let e = 0; e < n.ranges.length; e++) {
    ...
    if (i <= t && s >= t)
      return M.create(
        n.ranges.slice(0, e).concat(n.ranges.slice(e + 1)),
        n.mainIndex == e ? 0 : n.mainIndex - (n.mainIndex > e ? 1 : 0),
      );
  }
  return null;
}
Ct.dragstart = (n, t) => {
  ...
  return (
    ...
    (i.draggedContent = e),
    t.dataTransfer &&
      (t.dataTransfer.setData("Text", n.state.sliceDoc(e.from, e.to)),
...
function Bn(n, t, e, i) {
  ...
  let s = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1),
    ...
    o = i && r && Uh(n, t) ? { from: r.from, to: r.to } : null,
    l = { from: s, insert: e },
...
Ct.drop = (n, t) => {
  ...
  if (e && e.length) {
    let i = Array(e.length),
      ...
      r = () => {
        ++s == e.length &&
          Bn(n, t, i.filter((o) => o != null).join(n.state.lineBreak), !1);
      };
...
Ct.paste = (n, t) => {
  if (n.state.readOnly) return !0;
  n.observer.flush();
  let e = Mo ? null : t.clipboardData;
  return e
    ? (Ao(n, e.getData("text/plain") || e.getData("text/uri-list")), !0)
    : (Xh(n), !1);
};
function ec(n, t) {
...
function ic(n) {
  ...
  if (!t.length) {
    ...
    for (let { from: r } of n.selection.ranges) {
      ...
      o.number > s &&
        (t.push(o.text),
        e.push({ from: o.from, to: Math.min(n.doc.length, o.to + 1) })),
        (s = o.number);
    }
    i = !0;
  }
...
let vs = null;
Ct.copy = Ct.cut = (n, t) => {
  let { text: e, ranges: i, linewise: s } = ic(n.state);
  if (!e && !s) return !1;
  (vs = s ? e : null),
    t.type == "cut" &&
      !n.state.readOnly &&
      n.dispatch({ changes: i, scrollIntoView: !0, userEvent: "delete.cut" });
  let r = Mo ? null : t.clipboardData;
  return r ? (r.clearData(), r.setData("text/plain", e), !0) : (ec(n, e), !1);
};
const To = xe.define();
function Do(n, t) {
  let e = [];
  for (let i of n.facet(co)) {
    let s = i(n, t);
    s && e.push(s);
  }
  return e ? n.update({ effects: e, annotations: To.of(!0) }) : null;
}
function Ro(n) {
  setTimeout(() => {
    let t = n.hasFocus;
...
yt.blur = (n) => {
  n.observer.clearSelectionRange(), Ro(n);
};
...
Ct.beforeinput = (n, t) => {
  ...
  if (
    C.chrome &&
    C.android &&
    (i = Co.find((s) => s.inputType == t.inputType)) &&
  ...
  return (
    C.ios && t.inputType == "deleteContentForward" && n.observer.flushSoon(),
    C.safari &&
      t.inputType == "insertText" &&
      n.inputState.composing >= 0 &&
      setTimeout(() => yt.compositionend(n, t), 20),
    !1
  );
};
const In = new Set();
...
const jn = ["pre-wrap", "normal", "pre-line", "break-spaces"];
class nc {
  constructor(t) {
    (this.lineWrapping = t),
      (this.doc = B.empty),
  ...
  mustRefreshForWrapping(t) {
    return jn.indexOf(t) > -1 != this.lineWrapping;
  }
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      s < 0
        ...
        : this.heightSamples[Math.floor(s * 10)] ||
          ((e = !0), (this.heightSamples[Math.floor(s * 10)] = !0));
    }
    return e;
  }
  refresh(t, e, i, s, r, o) {
    let l = jn.indexOf(t) > -1,
      a =
        Math.round(e) != Math.round(this.lineHeight) || this.lineWrapping != l;
    if (
      ((this.lineWrapping = l),
      (this.lineHeight = e),
      (this.charWidth = i),
...
class ht {
  ...
  setHeight(t, e) {
    this.height != e &&
      (Math.abs(this.height - e) > ui && (t.heightChanged = !0),
      (this.height = e));
  }
  replace(t, e, i) {
    return ht.of(i);
  ...
  applyChanges(t, e, i, s) {
    ...
    for (let l = s.length - 1; l >= 0; l--) {
      let { fromA: a, toA: c, fromB: h, toB: f } = s[l],
        u = r.lineAt(a, V.ByPosNoHeight, i.setDoc(e), 0, 0),
        d = u.to >= c ? u : r.lineAt(c, V.ByPosNoHeight, i, 0, 0);
      for (f += d.to - c, c = d.to; l > 0 && u.from <= s[l - 1].toA; )
        (a = s[l - 1].fromA),
          (h = s[l - 1].fromB),
          l--,
          a < u.from && (u = r.lineAt(a, V.ByPosNoHeight, i, 0, 0));
      (h += u.from - a), (a = u.from);
      let g = $s.build(i.setDoc(o), t, h, f);
      r = r.replace(a, c, g);
    }
  ...
  static of(t) {
    ...
    for (;;)
      if (e == i)
        if (s > r * 2) {
          let l = t[e - 1];
          l.break
            ? t.splice(--e, 1, l.left, null, l.right)
            : t.splice(--e, 1, l.left, l.right),
            (i += 1 + l.break),
            (s -= l.size);
        } else if (r > s * 2) {
          let l = t[i];
          l.break
            ? t.splice(i, 1, l.left, null, l.right)
            : t.splice(i, 1, l.left, l.right),
            (i += 2 + l.break),
            (r -= l.size);
        } else break;
      else if (s < r) {
    ...
    return (
      ...
      new oc(ht.of(t.slice(0, e)), o, ht.of(t.slice(i)))
    );
  }
}
ht.prototype.size = 1;
class No extends ht {
  ...
  blockAt(t, e, i, s) {
    return new Rt(s, this.length, i, this.height, this.deco || 0);
  }
  lineAt(t, e, i, s, r) {
  ...
  updateHeight(t, e = 0, i = !1, s) {
    return (
      s && s.from <= e && s.more && this.setHeight(t, s.heights[s.index++]),
      (this.outdated = !1),
      this
    );
  }
...
class pt extends No {
  ...
  blockAt(t, e, i, s) {
    return new Rt(s, this.length, i, this.height, this.breaks);
  }
  replace(t, e, i) {
    let s = i[0];
    return i.length == 1 &&
      (s instanceof pt || (s instanceof tt && s.flags & 4)) &&
      Math.abs(this.length - s.length) < 10
      ? (s instanceof tt
          ? (s = new pt(s.length, this.height))
...
class tt extends ht {
  ...
  blockAt(t, e, i, s) {
    ...
    if (e.lineWrapping) {
      let c =
        ...
        f = l + h.length * a,
        u = Math.max(i, t - f / 2);
      return new Rt(h.from, h.length, u, f, 0);
    } else {
      let c = Math.max(0, Math.min(o - r, Math.floor((t - i) / l))),
        { from: h, length: f } = e.doc.line(r + c);
      return new Rt(h, f, i + l * c, l, 0);
    }
  }
  lineAt(t, e, i, s, r) {
    if (e == V.ByHeight) return this.blockAt(t, i, s, r);
    if (e == V.ByPosNoHeight) {
      let { from: d, to: g } = i.doc.lineAt(t);
      return new Rt(d, g - d, 0, 0, 0);
    }
    let { firstLine: o, perLine: l, perChar: a } = this.heightMetrics(i, r),
      c = i.doc.lineAt(t),
      h = l + c.length * a,
      f = c.number - o,
      u = s + l * f + a * (c.from - r - f);
    return new Rt(
      c.from,
      c.length,
      Math.max(s, Math.min(u, s + this.height - h)),
      h,
      0,
    );
  }
  forEachLine(t, e, i, s, r, o) {
    ...
    for (let h = t, f = s; h <= e; ) {
      ...
      let d = a + c * u.length;
      o(new Rt(u.from, u.length, f, d, 0)), (f += d), (h = u.to + 1);
    }
  }
  replace(t, e, i) {
    let s = this.length - e;
    if (s > 0) {
      let r = i[i.length - 1];
      r instanceof tt
        ? (i[i.length - 1] = new tt(r.length + s))
        : i.push(null, new tt(s - 1));
    }
    if (t > 0) {
      let r = i[0];
      r instanceof tt
        ? (i[0] = new tt(t + r.length))
        : i.unshift(new tt(t - 1), null);
    }
    return ht.of(i);
  }
  decomposeLeft(t, e) {
  ...
  updateHeight(t, e = 0, i = !1, s) {
    ...
    if (s && s.from <= e + this.length && s.more) {
      let o = [],
        ...
        a = -1;
      for (
        s.from > e && o.push(new tt(s.from - e - 1).updateHeight(t, e));
        l <= r && s.more;
      ...
      return (
        (a < 0 ||
          Math.abs(c.height - this.height) >= ui ||
          Math.abs(a - this.heightMetrics(t, e).perLine) >= ui) &&
          (t.heightChanged = !0),
        c
      );
    } else
...
class oc extends ht {
  ...
  blockAt(t, e, i, s) {
    ...
    return t < r
      ...
      : this.right.blockAt(t, e, r, s + this.left.length + this.break);
  }
  lineAt(t, e, i, s, r) {
    let o = s + this.left.height,
      l = r + this.left.length + this.break,
      a = e == V.ByHeight ? t < o : t < l,
      c = a
        ? this.left.lineAt(t, e, i, s, r)
        : this.right.lineAt(t, e, i, o, l);
    if (this.break || (a ? c.to < l : c.from > l)) return c;
    let h = e == V.ByPosNoHeight ? V.ByPosNoHeight : V.ByPos;
    return a
      ? c.join(this.right.lineAt(l, h, i, o, l))
      : this.left.lineAt(l, h, i, s, r).join(c);
  }
  forEachLine(t, e, i, s, r, o) {
    let l = s + this.left.height,
      a = r + this.left.length + this.break;
    if (this.break)
      t < a && this.left.forEachLine(t, e, i, s, r, o),
        e >= a && this.right.forEachLine(t, e, i, l, a, o);
    else {
      let c = this.lineAt(a, V.ByPos, i, s, r);
      t < c.from && this.left.forEachLine(t, c.from - 1, i, s, r, o),
        c.to >= t && c.from <= e && o(c),
        e > c.to && this.right.forEachLine(c.to + 1, e, i, l, a, o);
    }
  }
  replace(t, e, i) {
  ...
  updateHeight(t, e = 0, i = !1, s) {
    let { left: r, right: o } = this,
      ...
      a = null;
    return (
      s && s.from <= e + r.length && s.more
        ? (a = r = r.updateHeight(t, e, i, s))
        : r.updateHeight(t, e, i),
      s && s.from <= l + o.length && s.more
        ? (a = o = o.updateHeight(t, l, i, s))
        : o.updateHeight(t, l, i),
      a
        ? this.balanced(r, o)
...
function Hn(n, t) {
  let e, i;
  n[t] == null &&
    (e = n[t - 1]) instanceof tt &&
    (i = n[t + 1]) instanceof tt &&
    n.splice(t - 1, 3, new tt(e.length + 1 + i.length));
}
const lc = 5;
class $s {
  constructor(t, e) {
    ...
    if (this.lineStart > -1) {
      ...
      s instanceof pt
        ...
        : (i > this.pos || !this.isCovered) &&
          this.nodes.push(new pt(i - this.pos, -1)),
        (this.writtenTo = i),
        e > i &&
  ...
  point(t, e, i) {
    if (t < e || i.heightRelevant) {
      ...
      let o = e - t;
      i.block
        ? this.addBlock(new No(o, s, i))
        : (o || r || s >= lc) && this.addLineDeco(s, r, o);
  ...
  enterLine() {
    ...
    (this.lineStart = t),
      ...
      this.pos > t && this.nodes.push(new pt(this.pos - t, -1)),
  ...
  finish(t) {
    ...
    this.lineStart > -1 && !(e instanceof pt) && !this.isCovered
      ? this.nodes.push(new pt(0, -1))
      : (this.writtenTo < this.pos || e == null) &&
        this.nodes.push(this.blankContent(this.writtenTo, this.pos));
    let i = t;
    for (let s of this.nodes)
      s instanceof pt && s.updateHeight(this.oracle, i),
        (i += s ? s.length : 1);
    return this.nodes;
  }
    ...
    if (c.nodeType == 1) {
      ...
      if (
        ...
        (r = Math.max(r, u.left)),
          ...
          (l = Math.max(l, u.top)),
          (a = c == n.parentNode ? u.bottom : Math.min(a, u.bottom));
      }
      c =
...
class Vi {
  ...
  draw(t, e) {
    return F.replace({
      widget: new uc(this.size * (e ? t.scaleY : t.scaleX), e),
...
class Fn {
  constructor(t) {
    (this.state = t),
      ...
      (this.defaultTextDirection = Y.LTR),
      (this.visibleRanges = []),
      (this.mustEnforceCursorAssoc = !1);
    let e = t
      .facet(qs)
      .some((i) => typeof i != "function" && i.class == "cm-lineWrapping");
    (this.heightOracle = new nc(e)),
      (this.stateDeco = t.facet(ze).filter((i) => typeof i != "function")),
      (this.heightMap = ht
        .empty()
        .applyChanges(
          this.stateDeco,
  ...
  updateForViewport() {
    ...
    return (
      (this.viewports = t.sort((i, s) => i.from - s.from)), this.updateScaler()
    );
  }
  updateScaler() {
    let t = this.scaler;
    return (
      (this.scaler =
        this.heightMap.height <= 7e6
          ? Vn
          : new Us(this.heightOracle, this.heightMap, this.viewports)),
  ...
  updateViewportLines() {
    (this.viewportLines = []),
      this.heightMap.forEachLine(
        ...
        0,
        (t) => {
          this.viewportLines.push(Ae(t, this.scaler));
        },
      );
  }
  update(t, e = null) {
    ...
    this.stateDeco = this.state.facet(ze).filter((h) => typeof h != "function");
    let s = t.changedRanges,
      r = xt.extendWithRanges(
        s,
        ac(i, this.stateDeco, t ? t.changes : J.empty(this.state.doc.length)),
      ),
    ...
    (this.viewport = a),
      ...
      (c || !t.changes.empty || t.flags & 2) && this.updateViewportLines(),
  ...
  measure(t) {
    ...
    this.scrollTop != d &&
      ...
      (this.scrolledToBottom = zr(t.scrollDOM));
    let g = (this.printing ? fc : cc)(e, this.paddingTop),
      m = g.top - this.pixelViewport.top,
      x = g.bottom - this.pixelViewport.bottom;
    ...
    if (
      ...
      if (
        ...
        o ||
          (s.lineWrapping && Math.abs(b - this.contentDOMWidth) > s.charWidth))
      ) {
        let {
          lineHeight: k,
          charWidth: A,
        ...
        (o = k > 0 && s.refresh(r, k, A, O, b / A, v)),
          o && ((t.docView.minWidth = 0), (c |= 8));
      }
      m > 0 && x > 0
        ? (h = Math.max(m, x))
        : m < 0 && x < 0 && (h = Math.min(m, x)),
        (s.heightChanged = !1);
      for (let k of this.viewports) {
        let A =
          k.from == this.viewport.from
            ? v
            : t.docView.measureVisibleLineHeights(k);
        this.heightMap = (
          o
            ? ht
                .empty()
                .applyChanges(this.stateDeco, B.empty, this.heightOracle, [
                  new xt(0, 0, 0, t.state.doc.length),
                ])
            : this.heightMap
        ).updateHeight(s, 0, o, new rc(k.from, A));
      }
      s.heightChanged && (c |= 2);
    }
    let S =
    ...
    return (
      ...
      (c & 2 || S) && this.updateViewportLines(),
      (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
  ...
  getViewport(t, e) {
    let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)),
      ...
      a = new ii(
        s.lineAt(o - i * 1e3, V.ByHeight, r, 0, 0).from,
        s.lineAt(l + (1 - i) * 1e3, V.ByHeight, r, 0, 0).to,
      );
    if (e) {
      let { head: c } = e.range;
      if (c < a.from || c > a.to) {
        let h = Math.min(
          ...
          f = s.lineAt(c, V.ByPos, r, 0, 0),
          u;
        e.y == "center"
          ? (u = (f.top + f.bottom) / 2 - h / 2)
          : e.y == "start" || (e.y == "nearest" && c < a.from)
            ? (u = f.top)
            : (u = f.bottom - h),
          (a = new ii(
            s.lineAt(u - 1e3 / 2, V.ByHeight, r, 0, 0).from,
            s.lineAt(u + h + 1e3 / 2, V.ByHeight, r, 0, 0).to,
          ));
      }
    }
    return a;
  ...
  mapViewport(t, e) {
    let i = e.mapPos(t.from, -1),
      s = e.mapPos(t.to, 1);
    return new ii(
      this.heightMap.lineAt(i, V.ByPos, this.heightOracle, 0, 0).from,
      this.heightMap.lineAt(s, V.ByPos, this.heightOracle, 0, 0).to,
    );
  }
  viewportIsAppropriate({ from: t, to: e }, i = 0) {
    if (!this.inView) return !0;
    let { top: s } = this.heightMap.lineAt(t, V.ByPos, this.heightOracle, 0, 0),
      ...
      { visibleTop: o, visibleBottom: l } = this;
    return (
      (t == 0 || s <= o - Math.max(10, Math.min(-i, 250))) &&
      (e == this.state.doc.length || r >= l + Math.max(10, Math.min(i, 250))) &&
      s > o - 2 * 1e3 &&
      r < l + 2 * 1e3
    );
  }
  mapLineGaps(t, e) {
    ...
    for (let s of t)
      e.touchesRange(s.from, s.to) ||
        i.push(new Vi(e.mapPos(s.from), e.mapPos(s.to), s.size));
    return i;
  }
  ensureLineGaps(t, e) {
    ...
    let l = [],
      a = (h, f, u, d) => {
        ...
        if (!x) {
          ...
          x = new Vi(h, f, this.gapSize(u, h, f, d));
        }
        l.push(x);
      },
      c = (h) => {
        if (h.length < o || h.type != at.Text) return;
        let f = dc(h.from, h.to, this.stateDeco);
        if (f.total < o) return;
        ...
        if (i) {
          ...
          if (u != null) {
            let b = ni(f, u),
              S = ((this.visibleBottom - this.visibleTop) / 2 + m) / h.height;
            (x = b - S), (y = b + S);
          } else
            (x = (this.visibleTop - h.top - m) / h.height),
              (y = (this.visibleBottom - h.top + m) / h.height);
          (d = si(f, x)), (g = si(f, y));
        } else {
          let m = f.total * this.heightOracle.charWidth,
            x = s * this.heightOracle.charWidth,
            y,
            b;
          if (u != null) {
            let S = ni(f, u),
              v =
                ((this.pixelViewport.right - this.pixelViewport.left) / 2 + x) /
                m;
            (y = S - v), (b = S + v);
          } else
            (y = (this.pixelViewport.left - x) / m),
              (b = (this.pixelViewport.right + x) / m);
          (d = si(f, y)), (g = si(f, b));
        }
  ...
  updateLineGaps(t) {
    Vi.same(t, this.lineGaps) ||
      ((this.lineGaps = t),
      (this.lineGapDeco = F.set(
  ...
  computeVisibleRanges() {
    ...
    let i =
      ...
      this.visibleRanges.some((s, r) => s.from != e[r].from || s.to != e[r].to);
  ...
  lineBlockAt(t) {
    return (
      ...
      Ae(
        this.heightMap.lineAt(t, V.ByPos, this.heightOracle, 0, 0),
        this.scaler,
      )
    );
  }
...
function dc(n, t, e) {
  ...
  return (
    ...
    s < t && (i.push({ from: s, to: t }), (r += t - s)),
    { total: r, ranges: i }
  );
}
function si({ total: n, ranges: t }, e) {
...
class Us {
  constructor(t, e, i) {
    ...
    (this.viewports = i.map(({ from: l, to: a }) => {
      let c = e.lineAt(l, V.ByPos, t, 0, 0).top,
        h = e.lineAt(a, V.ByPos, t, 0, 0).bottom;
      return (
        (s += h - c),
        { from: l, to: a, top: c, bottom: h, domTop: 0, domBottom: 0 }
      );
    })),
...
function Ae(n, t) {
  ...
  return new Rt(
    ...
    e,
    i - e,
    Array.isArray(n._content) ? n._content.map((s) => Ae(s, t)) : n._content,
  );
}
const ri = E.define({ combine: (n) => n.join(" ") }),
  Ss = E.define({ combine: (n) => n.indexOf(!0) > -1 }),
  Cs = ue.newName(),
  Lo = ue.newName(),
  Po = ue.newName(),
  Bo = { "&light": "." + Lo, "&dark": "." + Po };
...
class mc {
  constructor(t, e) {
    (this.points = t),
      (this.text = ""),
      (this.lineSeparator = e.facet(W.lineSeparator));
  }
  append(t) {
    this.text += t;
  }
    ...
    for (let i = 0, s = this.lineSeparator ? null : /\r\n?|\n/g; ; ) {
      ...
      if (
        (this.lineSeparator
          ...
          : (l = s.exec(e)) && ((r = l.index), (o = l[0].length)),
  ...
  findPointInside(t, e) {
    for (let i of this.points)
      (t.nodeType == 3 ? i.node == t : t.contains(i.node)) &&
        (i.pos = this.text.length + (xc(t, i.node, i.offset) ? e : 0));
  }
}
function xc(n, t, e) {
  for (;;) {
    if (!t || e < Vt(t)) return !1;
    if (t == n) return !0;
    (e = ee(t) + 1), (t = t.parentNode);
  }
}
class Wn {
  constructor(t, e) {
  ...
  constructor(t, e, i, s) {
    ...
    if (t.state.readOnly && e > -1) this.newSel = null;
      ...
      a.readRange(this.bounds.startDOM, this.bounds.endDOM),
        (this.text = a.text),
        (this.newSel = Sc(l, this.bounds.from));
    } else {
      let l = t.observer.selectionRange,
        a =
          (r && r.node == l.focusNode && r.offset == l.focusOffset) ||
          !as(t.contentDOM, l.focusNode)
            ? t.state.selection.main.head
            : t.docView.posFromDOM(l.focusNode, l.focusOffset),
        c =
          (o && o.node == l.anchorNode && o.offset == l.anchorOffset) ||
          !as(t.contentDOM, l.anchorNode)
            ? t.state.selection.main.anchor
            : t.docView.posFromDOM(l.anchorNode, l.anchorOffset),
        h = t.viewport;
      if (
        (C.ios || C.chrome) &&
        t.state.selection.main.empty &&
        a != c &&
        (h.from > 0 || h.to < t.state.doc.length)
      ) {
        let f = Math.min(a, c),
          u = Math.max(a, c),
          d = h.from - f,
          g = h.to - u;
        (d == 0 || d == 1 || f == 0) &&
          (g == 0 || g == -1 || u == t.state.doc.length) &&
          ((a = 0), (c = t.state.doc.length));
      }
...
function Io(n, t) {
  ...
  if (t.bounds) {
    let { from: o, to: l } = t.bounds,
      a = s.from,
      c = null;
    (r === 8 || (C.android && t.text.length < l - o)) &&
      ((a = s.to), (c = "end"));
    let h = wc(n.state.doc.sliceString(o, l, Ee), t.text, a - o, c);
    h &&
      (C.chrome &&
        r == 13 &&
        h.toB == h.from + 2 &&
        t.text.slice(h.from, h.toB) == Ee + Ee &&
        h.toB--,
      (e = {
        from: o + h.from,
        to: o + h.toA,
        insert: B.of(t.text.slice(h.from, h.toB).split(Ee)),
      }));
  } else
    i && ((!n.hasFocus && n.state.facet(qt)) || i.main.eq(s)) && (i = null);
  if (!e && !i) return !1;
  if (
    (!e && t.typeOver && !s.empty && i && i.main.empty
      ? (e = {
          from: s.from,
          to: s.to,
      ...
      : e &&
        ...
        ? (e = {
            ...
            insert: n.state.doc
              .slice(s.from, e.from)
              .append(e.insert)
              .append(n.state.doc.slice(e.to, s.to)),
          })
        : (C.mac || C.android) &&
            e &&
            e.from == e.to &&
          ...
          ? (i &&
              e.insert.length == 2 &&
              (i = M.single(i.main.anchor - 1, i.main.head - 1)),
            (e = { from: s.from, to: s.to, insert: B.of([" "]) }))
          : C.chrome &&
            e &&
            e.from == e.to &&
            e.from == s.head &&
 ...
 ` &&
            n.lineWrapping &&
            (i && (i = M.single(i.main.anchor - 1, i.main.head - 1)),
            (e = { from: s.from, to: s.to, insert: B.of([" "]) })),
    e)
  )
    return jo(n, e, i, r);
...
function jo(n, t, e, i = -1) {
  if (C.ios && n.inputState.flushIOSKey(t)) return !0;
  let s = n.state.selection.main;
  if (
    C.android &&
    ((t.to == s.to &&
      (t.from == s.from ||
        (t.from == s.from - 1 && n.state.sliceDoc(t.from, s.from) == " ")) &&
      t.insert.length == 1 &&
      t.insert.lines == 2 &&
      ae(n.contentDOM, "Enter", 13)) ||
      (((t.from == s.from - 1 && t.to == s.to && t.insert.length == 0) ||
        (i == 8 && t.insert.length < t.to - t.from && t.to > s.head)) &&
        ae(n.contentDOM, "Backspace", 8)) ||
      (t.from == s.from &&
        t.to == s.to + 1 &&
        t.insert.length == 0 &&
        ae(n.contentDOM, "Delete", 46)))
  )
    return !0;
  ...
  let o,
    l = () => o || (o = bc(n, t, e));
  return (
    n.state.facet(ho).some((a) => a(n, t.from, t.to, r, l)) || n.dispatch(l()),
    !0
  );
}
function bc(n, t, e) {
  ...
  if (
    ...
    i = s.replaceSelection(
      n.state.toText(
        l + t.insert.sliceString(0, void 0, n.state.lineBreak) + a,
      ),
    );
  } else {
    let l = s.changes(t),
    ...
    if (
      ...
      i = s.changeByRange((g) => {
        ...
        if (
          g.to - g.from != d ||
          n.state.sliceDoc(x, m) != c ||
          (g.to >= h.from && g.from <= h.to)
        )
          return { range: g };
        let y = s.changes({ from: x, to: m, insert: t.insert }),
          b = g.to - r.to;
        return {
          changes: y,
          range: a
            ? M.range(Math.max(0, a.anchor + b), Math.max(0, a.head + b))
            : g.map(y),
        };
      });
...
function vc(n) {
  ...
  return (
    e && (t.push(new Wn(e, i)), (s != e || r != i) && t.push(new Wn(s, r))), t
  );
}
function Sc(n, t) {
...
const Cc = {
  ...
  Wi = C.ie && C.ie_version <= 11;
class kc {
  constructor(t) {
    (this.view = t),
      (this.active = !1),
      (this.editContext = null),
      (this.selectionRange = new lh()),
      ...
      (this.observer = new MutationObserver((e) => {
        ...
        ((C.ie && C.ie_version <= 11) || (C.ios && t.composing)) &&
        e.some(
          (i) =>
      ...
      window.EditContext &&
        ...
        !(C.chrome && C.chrome_version < 126) &&
        ((this.editContext = new Ac(t)),
        t.state.facet(qt) &&
  ...
  onSelectionChange(t) {
    ...
    if (i.state.facet(qt) ? i.root.activeElement != this.dom : !ci(i.dom, s))
      return;
    ...
    s.focusNode &&
    Re(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset)
      ? this.flushSoon()
      : this.flush(!1);
  }
  readSelectionRange() {
    ...
    let i =
      (C.safari &&
        t.root.nodeType == 11 &&
        sh(this.dom.ownerDocument) == this.dom &&
        Mc(this.view, e)) ||
      e;
    ...
    if (!this.delayedAndroidKey) {
      let s = () => {
        ...
        r &&
          ...
          !this.flush() && r.force && ae(this.dom, r.key, r.keyCode));
      };
  ...
  readChange() {
    let { from: t, to: e, typeOver: i } = this.processRecords(),
      s = this.selectionChanged && ci(this.dom, this.selectionRange);
  ...
  readMutation(t) {
    ...
    if (
      ...
      let i = zn(e, t.previousSibling || t.target.previousSibling, -1),
        s = zn(e, t.nextSibling || t.target.nextSibling, 1);
      return {
  ...
  update(t) {
    this.editContext &&
      ...
      t.startState.facet(qt) != t.state.facet(qt) &&
        (t.view.contentDOM.editContext = t.state.facet(qt)
...
function _n(n, t) {
  ...
  return (
    Re(o.node, o.offset, s, r) && ([e, i, s, r] = [s, r, e, i]),
    { anchorNode: e, anchorOffset: i, focusNode: s, focusOffset: r }
  );
}
function Mc(n, t) {
...
`),
      ...
      (this.handlers.textformatupdate = (i) => {
        ...
        for (let r of i.getTextFormats()) {
          ...
          if (o != "None" && l != "None") {
            ...
            s.push(
              F.mark({ attributes: { style: a } }).range(
        ...
        t.dispatch({ effects: go.of(F.set(s)) });
      }),
  ...
  applyEdits(t) {
    ...
    return (
      t.changes.iterChanges((r, o, l, a, c) => {
        if (i) return;
        let h = c.length - (o - r);
        if (s && o >= s.to)
    ...
    !this.applyEdits(t) || !this.rangeIsValid(t.state)
      ? ((this.pendingContextChange = null),
        ...
        this.editContext.updateText(
          ...
          t.state.doc.sliceString(this.from, this.to),
        ),
...
class D {
  ...
  constructor(t = {}) {
    ...
    (this.dispatchTransactions =
      ...
      (e && ((i) => i.forEach((s) => e(s, this)))) ||
      ((i) => this.update(i))),
      (this.dispatch = this.dispatch.bind(this)),
      (this._root = t.root || ah(t.parent) || document),
      (this.viewState = new Fn(t.state || W.create(t))),
      t.scrollTo &&
        t.scrollTo.is(Qe) &&
        (this.viewState.scrollTarget = t.scrollTo.value.clip(
          this.viewState.state,
        )),
      (this.plugins = this.state.facet(ke).map((i) => new ji(i)));
    for (let i of this.plugins) i.update(this);
    (this.observer = new kc(this)),
      (this.inputState = new Wh(this)),
      this.inputState.ensureHandlers(this.plugins),
      (this.docView = new vn(this)),
      this.mountStyles(),
      this.updateAttrs(),
      (this.updateState = 0),
      this.requestMeasure();
  ...
  update(t) {
    ...
    let o = this.hasFocus,
      l = 0,
      a = null;
    t.some((u) => u.annotation(To))
      ? ((this.inputState.notifiedFocused = o), (l = 1))
      : o != this.inputState.notifiedFocused &&
        ((this.inputState.notifiedFocused = o), (a = Do(r, o)), a || (l = 1));
      ...
      (c
        ? (this.observer.clearDelayedAndroidKey(),
          ...
          ((h && !this.state.doc.eq(r.doc)) ||
            ...
            (h = null))
        : this.observer.clear(),
      r.facet(W.phrases) != this.state.facet(W.phrases))
    )
      return this.setState(r);
    (s = ki.create(this, r, t)), (s.flags |= l);
    ...
    try {
      ...
      for (let u of t) {
        if ((f && (f = f.map(u.changes)), u.scrollIntoView)) {
          ...
          f = new he(
            d.empty ? d : M.cursor(d.head, d.head > d.anchor ? -1 : 1),
          );
        }
        for (let d of u.effects) d.is(Qe) && (f = d.value.clip(this.state));
      }
      this.viewState.update(s, f),
        (this.bidiCache = Mi.update(this.bidiCache, s.changes)),
        s.empty || (this.updatePlugins(s), this.inputState.update(s)),
        (e = this.docView.update(s)),
        this.state.facet(Me) != this.styleModules && this.mountStyles(),
        (i = this.updateAttrs()),
    ...
    if (
      (s.startState.facet(ri) != s.state.facet(ri) &&
    ...
    (a || h) &&
      Promise.resolve().then(() => {
        a && this.state == a.startState && this.dispatch(a),
          h && !Io(this, h) && c.force && ae(this.contentDOM, c.key, c.keyCode);
      });
  }
  setState(t) {
    if (this.updateState != 0)
    ...
    try {
      ...
      (this.viewState = new Fn(t)),
        (this.plugins = t.facet(ke).map((i) => new ji(i))),
  ...
  measure(t = !0) {
    ...
    try {
      for (let l = 0; ; l++) {
        if (o < 0)
          if (zr(i)) (r = -1), (o = this.viewState.heightMap.height);
          else {
        ...
        let h = c.map((d) => {
            try {
              ...
              return It(this.state, g), qn;
            }
          }),
          f = ki.create(this, this.state, []),
          u = !1;
        (f.flags |= a),
          e ? (e.flags |= a) : (e = f),
          (this.updateState = 2),
    ...
    if (e && !e.empty) for (let l of this.state.facet(ys)) l(e);
  }
  get themeClasses() {
    return (
      Cs + " " + (this.state.facet(Ss) ? Po : Lo) + " " + this.state.facet(ri)
    );
  }
  updateAttrs() {
    let t = Kn(this, mo, {
    ...
    this.state.readOnly && (e["aria-readonly"] = "true"), Kn(this, qs, e);
    let i = this.observer.ignore(() => {
      let s = ds(this.contentDOM, this.contentAttrs, e),
        r = ds(this.dom, this.editorAttrs, t);
      return s || r;
    });
  ...
  mountStyles() {
    this.styleModules = this.state.facet(Me);
    let t = this.state.facet(D.cspNonce);
    ue.mount(
      this.root,
      this.styleModules.concat(gc).reverse(),
      t ? { nonce: t } : void 0,
    );
  }
  readMeasured() {
  ...
  plugin(t) {
    ...
    return (
      (e === void 0 || (e && e.spec != t)) &&
        this.pluginMap.set(
          t,
          (e = this.plugins.find((i) => i.spec == t) || null),
        ),
  ...
  moveByChar(t, e, i) {
    return Fi(this, t, En(this, t, e, i));
  }
  moveByGroup(t, e) {
    return Fi(
      this,
      t,
      En(this, t, e, (i) => Fh(this, t.head, i)),
    );
  }
  visualLineSide(t, e) {
  ...
  moveToLineBoundary(t, e, i = !0) {
    return Hh(this, t, e, i);
  }
  moveVertically(t, e, i) {
    return Fi(this, t, Vh(this, t, e, i));
  }
  domAtPos(t) {
  ...
  posAtCoords(t, e = !0) {
    return this.readMeasured(), So(this, t, e);
  }
  coordsAtPos(t, e = 1) {
    this.readMeasured();
    ...
    let s = this.state.doc.lineAt(t),
      r = this.bidiSpans(s),
      o = r[Ut.find(r, t - s.from, -1, e)];
    return Di(i, (o.dir == Y.LTR) == e > 0);
  }
  coordsForChar(t) {
  ...
  bidiSpans(t) {
    if (t.length > Ec) return so(t.length);
    ...
    for (let r of this.bidiCache)
      if (
        r.from == t.from &&
        r.dir == e &&
        (r.fresh || io(r.isolates, (i = wn(this, t))))
      )
        return r.order;
    i || (i = wn(this, t));
    let s = Sh(t.text, e, i);
    return this.bidiCache.push(new Mi(t.from, t.to, e, i, !0, s)), s;
  }
  get hasFocus() {
    var t;
    return (
  ...
  focus() {
    this.observer.ignore(() => {
      Vr(this.contentDOM), this.docView.updateSelection();
    });
  }
  setRoot(t) {
    this._root != t &&
  ...
  scrollSnapshot() {
    ...
    return Qe.of(new he(M.cursor(i.from), "start", "start", i.top - t, e, !0));
  }
  setTabFocusMode(t) {
    t == null
  ...
  static domEventHandlers(t) {
    return Pt.define(() => ({}), { eventHandlers: t });
  }
  static domEventObservers(t) {
    return Pt.define(() => ({}), { eventObservers: t });
  }
  static theme(t, e) {
    let i = ue.newName(),
      s = [ri.of(i), Me.of(ks(`.${i}`, t))];
    return e && e.dark && s.push(Ss.of(!0)), s;
  }
  static baseTheme(t) {
    return Fs.lowest(Me.of(ks("." + Cs, t, Bo)));
  }
  static findFromDOM(t) {
    ...
    let i = t.querySelector(".cm-content"),
      s = (i && H.get(i)) || H.get(t);
    return (
      ((e = s?.rootView) === null || e === void 0 ? void 0 : e.view) || null
    );
  }
}
D.styleModule = Me;
D.inputHandler = ho;
D.scrollHandler = po;
D.focusChangeEffect = co;
D.perLineTextDirection = fo;
D.exceptionSink = ao;
D.updateListener = ys;
D.editable = qt;
D.mouseSelectionStyle = lo;
D.dragMovesSelection = oo;
D.clickAddsSelectionRange = ro;
D.decorations = ze;
D.outerDecorations = xo;
D.atomicRanges = Ks;
D.bidiIsolatedRanges = yo;
D.scrollMargins = bo;
D.darkTheme = Ss;
D.cspNonce = E.define({ combine: (n) => (n.length ? n[0] : "") });
D.contentAttributes = qs;
D.editorAttributes = mo;
D.lineWrapping = D.contentAttributes.of({ class: "cm-lineWrapping" });
D.announce = _.define();
const Ec = 4096,
  qn = {};
class Mi {
  ...
  static update(t, e) {
    ...
    let i = [],
      s = t.length ? t[t.length - 1].dir : Y.LTR;
...
const Oc = C.mac ? "mac" : C.windows ? "win" : C.linux ? "linux" : "key";
function Tc(n, t) {
  const e = n.split(/-(?!$)/);
  let i = e[e.length - 1];
  i == "Space" && (i = " ");
...
const Dc = Fs.default(
    D.domEventHandlers({
      keydown(n, t) {
        return Bc(Nc(t.state), n, t, "editor");
      },
    }),
  ),
  Rc = E.define({ enables: Dc }),
  $n = new WeakMap();
function Nc(n) {
  let t = n.facet(Rc),
    e = $n.get(t);
  return e || $n.set(t, (e = Pc(t.reduce((i, s) => i.concat(s), [])))), e;
}
let Kt = null;
const Lc = 4e3;
function Pc(n, t = Oc) {
  let e = Object.create(null),
    ...
    r = (o, l, a, c, h) => {
      ...
      let d = e[o] || (e[o] = Object.create(null)),
        g = l.split(/ (?!$)/).map((y) => Tc(y, t));
      for (let y = 1; y < g.length; y++) {
        let b = g.slice(0, y).join(" ");
        s(b, !0),
          d[b] ||
            (d[b] = {
              preventDefault: !0,
              ...
              run: [
                (S) => {
                  let v = (Kt = { view: S, prefix: b, scope: o });
                  return (
                    setTimeout(() => {
                      Kt == v && (Kt = null);
                    }, Lc),
      ...
      a && x.run.push(a),
        c && (x.preventDefault = !0),
        h && (x.stopPropagation = !0);
    };
  for (let o of n) {
    ...
    if (o.any)
      for (let c of l) {
        ...
        let { any: f } = o;
        for (let u in h) h[u].run.push((d) => f(d, Ms));
      }
    let a = o[t] || o.key;
    if (a)
      for (let c of l)
        r(c, a, o.run, o.preventDefault, o.stopPropagation),
          o.shift &&
            r(c, "Shift-" + a, o.shift, o.preventDefault, o.stopPropagation);
  }
  return e;
}
let Ms = null;
function Bc(n, t, e, i) {
  ...
  Kt &&
    ...
    Kt.scope == i &&
    ((l = Kt.prefix + " "),
    ko.indexOf(t.keyCode) < 0 && ((c = !0), (Kt = null)));
  let f = new Set(),
    u = (x) => {
      if (x) {
        for (let y of x.run)
        ...
        x.preventDefault && (x.stopPropagation && (h = !0), (c = !0));
      }
      return !1;
    },
    d = n[i],
        ...
        : o &&
          ...
          ? (u(d[l + oi(g, t, !0)]) ||
              (t.shiftKey &&
                ...
                u(d[l + oi(m, t, !1)]))) &&
            (a = !0)
          : o && t.shiftKey && u(d[l + oi(s, t, !0)]) && (a = !0),
      !a && u(d._any) && (a = !0)),
    c && (a = !0),
...
class Ue {
  ...
  static forRange(t, e, i) {
    if (i.empty) {
      ...
      let r = Ho(t);
      return [
        new Ue(e, s.left - r.left, s.top - r.top, null, s.bottom - s.top),
      ];
    } else return Ic(t, e, i);
  }
}
function Ho(n) {
  ...
  return {
    left:
      (n.textDirection == Y.LTR
        ? t.left
        : t.right - n.scrollDOM.clientWidth * n.scaleX) -
...
function Ic(n, t, e) {
  ...
  let i = Math.max(e.from, n.viewport.from),
    ...
    d = ws(n, i),
    g = ws(n, s),
    m = d.type == at.Text ? d : null,
    x = g.type == at.Text ? g : null;
  if (
    (m && (n.lineWrapping || d.widgetLineBreaks) && (m = Un(n, i, 1, m)),
    x && (n.lineWrapping || g.widgetLineBreaks) && (x = Un(n, s, -1, x)),
    m && x && m.from == x.from && m.to == x.to)
  )
    return b(S(e.from, e.to, m));
  {
    let k = m ? S(e.from, null, m) : v(d, !1),
      A = x ? S(null, e.to, x) : v(g, !0),
      O = [];
    return (
      (m || d).to < (x || g).from - (m && x ? 1 : 0) ||
      (d.widgetLineBreaks > 1 && k.bottom + n.defaultLineHeight / 2 < A.top)
        ? O.push(y(f, k.bottom, u, A.top))
        : k.bottom < A.top &&
          n.elementAtHeight((k.bottom + A.top) / 2).type == at.Text &&
          (k.bottom = A.top = (k.bottom + A.top) / 2),
      b(k).concat(O).concat(b(A))
    );
  }
  function y(k, A, O, T) {
    return new Ue(t, k - a.left, A - a.top - 0.01, O - k, T - A + 0.01);
  }
  function b({ top: k, bottom: A, horizontal: O }) {
    let T = [];
    for (let X = 0; X < O.length; X += 2) T.push(y(O[X], k, O[X + 1], A));
    return T;
  }
  function S(k, A, O) {
    let T = 1e9,
      X = -1e9,
      mt = [];
    function zt(q, lt, wt, vt, kt) {
      let ct = n.coordsAtPos(q, q == O.to ? -2 : 2),
        ft = n.coordsAtPos(wt, wt == O.from ? 2 : -2);
      !ct ||
        !ft ||
        ((T = Math.min(ct.top, ft.top, T)),
        (X = Math.max(ct.bottom, ft.bottom, X)),
        kt == Y.LTR
          ? mt.push(r && lt ? f : ct.left, r && vt ? u : ft.right)
          : mt.push(!r && vt ? f : ft.left, !r && lt ? u : ct.right));
    }
    let dt = k ?? O.from,
      et = A ?? O.to;
    for (let q of n.visibleRanges)
      if (q.to > dt && q.from < et)
        for (let lt = Math.max(q.from, dt), wt = Math.min(q.to, et); ; ) {
          let vt = n.state.doc.lineAt(lt);
          for (let kt of n.bidiSpans(vt)) {
            let ct = kt.from + vt.from,
              ft = kt.to + vt.from;
            if (ct >= wt) break;
            ft > lt &&
              zt(
          ...
          if (((lt = vt.to + 1), lt >= wt)) break;
        }
    return (
      mt.length == 0 && zt(dt, k == null, et, A == null, n.textDirection),
      { top: T, bottom: X, horizontal: mt }
    );
  }
  function v(k, A) {
    let O = l.top + (A ? k.top : k.bottom);
...
class Hc {
  ...
  update(t) {
    t.startState.facet(di) != t.state.facet(di) && this.setOrder(t.state),
...
const di = E.define();
function Fo(n) {
  return [Pt.define((t) => new Hc(t, n)), di.of(n)];
}
const Vo = !C.ios,
  _e = E.define({
    combine(n) {
...
function xu(n = {}) {
  return [_e.of(n), Fc, Vc, Wc, uo.of(!0)];
}
function Wo(n) {
  return n.startState.facet(_e) != n.state.facet(_e);
}
const Fc = Fo({
  above: !0,
  markers(n) {
    ...
    for (let s of t.selection.ranges) {
      ...
      if (s.empty ? !r || Vo : e.drawRangeCursor) {
        let o = r
            ? "cm-cursor cm-cursor-primary"
            : "cm-cursor cm-cursor-secondary",
          l = s.empty ? s : M.cursor(s.head, s.head > s.anchor ? -1 : 1);
        for (let a of Ue.forRange(n, o, l)) i.push(a);
      }
    }
    return i;
  },
  update(n, t) {
    ...
    let e = Wo(n);
    return e && Gn(n.state, t), n.docChanged || n.selectionSet || e;
  },
  mount(n, t) {
    Gn(t.state, n);
  },
...
function Gn(n, t) {
  t.style.animationDuration = n.facet(_e).cursorBlinkRate + "ms";
}
const Vc = Fo({
    above: !1,
    markers(n) {
      return n.state.selection.ranges
        .map((t) =>
          t.empty ? [] : Ue.forRange(n, "cm-selectionBackground", t),
        )
        .reduce((t, e) => t.concat(e));
    },
    update(n, t) {
      return n.docChanged || n.selectionSet || n.viewportChanged || Wo(n);
    },
...
Vo &&
  (As[".cm-line"].caretColor = As[".cm-content"].caretColor =
    "transparent !important");
const Wc = Fs.highest(D.theme(As));
function Yn(n, t, e, i, s) {
  t.lastIndex = 0;
  for (let r = n.iterRange(e, i), o = e, l; !r.next().done; o += r.value.length)
    if (!r.lineBreak) for (; (l = t.exec(r.value)); ) s(o + l.index, l);
}
function zc(n, t) {
...
class _c {
  ...
  createDeco(t) {
    let e = new Fe(),
      i = e.add.bind(e);
    for (let { from: s, to: r } of zc(t, this.maxLength))
      Yn(t.state.doc, this.regexp, s, r, (o, l) => this.addMatch(l, t, o, i));
    return e.finish();
  }
  updateDeco(t, e) {
    let i = 1e9,
    ...
    return (
      t.docChanged &&
        t.changes.iterChanges((r, o, l, a) => {
          a > t.view.viewport.from &&
            l < t.view.viewport.to &&
      ...
      if (l > o) {
        ...
        if (a == c)
          for (
            ...
            this.addMatch(d, t, d.index + a.from, g);
        else
          Yn(t.state.doc, this.regexp, h, f, (m, x) =>
            this.addMatch(x, t, m, g),
          );
        e = e.update({
          filterFrom: h,
          filterTo: f,
...
function $c() {
  var n;
  if (zi == null && typeof document < "u" && document.body) {
    let t = document.body.style;
    zi = ((n = t.tabSize) !== null && n !== void 0 ? n : t.MozTabSize) != null;
  }
  return zi || !1;
}
const pi = E.define({
  combine(n) {
    let t = Vs(n, { render: null, specialChars: qc, addSpecialChars: null });
    return (
      (t.replaceTabs = !$c()) &&
        (t.specialChars = new RegExp("	|" + t.specialChars.source, Es)),
      t.addSpecialChars &&
      ...
      class {
        constructor(n) {
          (this.view = n),
            ...
            (this.decorator = this.makeDecorator(n.state.facet(pi))),
          ...
          return new _c({
            ...
            decoration: (t, e, i) => {
              ...
              return (
                ...
                (this.decorationCache[r] = F.replace({ widget: new Xc(n, r) }))
              );
            },
...
const Gc = "•";
function Yc(n) {
  return n >= 32 ? Gc : n == 10 ? "␤" : String.fromCharCode(9216 + n);
}
class Xc extends ye {
  constructor(t, e) {
  ...
  toDOM(t) {
    let e = Yc(this.code),
      i =
        ...
        " " +
        (Kc[this.code] || "0x" + this.code.toString(16)),
  ...
  return Pt.fromClass(
    class {
      constructor(t) {
        (this.view = t),
          (this.placeholder = n
            ? F.set([F.widget({ widget: new Zc(n), side: 1 }).range(0)])
            : F.none);
      }
      get decorations() {
  ...
  update(t, e) {
    ...
    for (let a = 0; a < r.length; a++) {
      ...
      if (c) {
        ...
        if (h < 0)
          (o[a] = this.createTooltipView(c, a ? o[a - 1] : null)),
            l && (l[a] = !!c.above);
        else {
    ...
    return (
      e && (l.forEach((a, c) => (e[c] = a)), (e.length = l.length)),
      (this.input = s),
      (this.tooltips = r),
      (this.tooltipViews = o),
      !0
...
const _i = E.define({
    combine: (n) => {
      ...
      return {
        position: C.ios
          ? "absolute"
          : ((t = n.find((s) => s.position)) === null || t === void 0
              ? void 0
              : t.position) || "fixed",
        parent:
          ((e = n.find((s) => s.parent)) === null || e === void 0
            ? void 0
            : e.parent) || null,
        tooltipSpace:
    ...
    class {
      ...
      readMeasure() {
        ...
        if (this.position == "fixed" && this.manager.tooltipViews.length) {
          ...
          if (C.gecko) i = s.offsetParent != this.container.ownerDocument.body;
          else if (s.style.top == Se && s.style.left == "0px") {
        ...
        if (i || this.position == "absolute")
          if (this.parent) {
            ...
            s.width &&
              s.height &&
              ((t = s.width / this.parent.offsetWidth),
        ...
        return {
          ...
          space: this.view.state.facet(_i).tooltipSpace(this.view),
          scaleX: t,
          scaleY: e,
          makeAbsolute: i,
        };
      ...
      writeMeasure(n) {
        ...
        for (let l = 0; l < this.manager.tooltips.length; l++) {
          ...
          if (
            !f ||
            f.bottom <= Math.max(e.top, i.top) ||
            f.top >= Math.min(e.bottom, i.bottom) ||
            f.right < Math.max(e.left, i.left) - 0.1 ||
            f.left > Math.min(e.right, i.right) + 0.1
          ) {
            h.style.top = Se;
            continue;
          }
          let d = a.arrow ? c.dom.querySelector(".cm-tooltip-arrow") : null,
            g = d ? 7 : 0,
            m = u.right - u.left,
            x = (t = Jn.get(c)) !== null && t !== void 0 ? t : u.bottom - u.top,
            y = c.offset || sf,
            b = this.view.textDirection == Y.LTR,
            S =
              u.width > i.right - i.left
                ? b
                  ...
                  : i.right - u.width
                : b
                  ? Math.min(f.left - (d ? 14 : 0) + y.x, i.right - m)
                  : Math.max(i.left, f.left - m + (d ? 14 : 0) - y.x),
            v = this.above[l];
          !a.strictSide &&
            (v
              ? f.top - (u.bottom - u.top) - y.y < i.top
              : f.bottom + (u.bottom - u.top) + y.y > i.bottom) &&
            v == i.bottom - f.bottom > f.top - i.top &&
            (v = this.above[l] = !v);
          let k = (v ? f.top - i.top : i.bottom - f.bottom) - g;
          if (k < x && c.resize !== !1) {
            if (k < this.view.defaultLineHeight) {
              h.style.top = Se;
              continue;
            }
            Jn.set(c, x), (h.style.height = (x = k) / r + "px");
          } else h.style.height && (h.style.height = "");
          let A = v ? f.top - x - g - y.y : f.bottom + g + y.y,
            O = S + m;
          if (c.overlap !== !0)
            for (let T of o)
              T.left < O &&
                ...
                T.top < A + x &&
                T.bottom > A &&
                (A = v ? T.top - x - 2 - g : T.bottom + g + 2);
          if (
            (this.position == "absolute"
              ? ((h.style.top = (A - n.parent.top) / r + "px"),
                (h.style.left = (S - n.parent.left) / s + "px"))
              : ((h.style.top = A / r + "px"), (h.style.left = S / s + "px")),
            d)
          ) {
            let T = f.left + (b ? y.x : -y.x) - (S + 14 - 7);
            d.style.left = T / s + "px";
          }
          c.overlap !== !0 &&
            o.push({ left: S, top: A, right: O, bottom: A + x }),
            h.classList.toggle("cm-tooltip-above", v),
            h.classList.toggle("cm-tooltip-below", !v),
      ...
      maybeMeasure() {
        if (
          ...
          for (let n of this.manager.tooltipViews) n.dom.style.top = Se;
      }
    },
    {
      eventObservers: {
...
Yt.prototype.mapMode = gt.TrackBefore;
...
const gi = E.define(),
  ...
  Le = E.define();
function vu(n) {
  return [_o(), Le.of(Object.assign(Object.assign({}, rf), n))];
}
const Zn = E.define({ combine: (n) => n.some((t) => t) });
function _o(n) {
  return [of];
}
const of = Pt.fromClass(
  class {
    constructor(n) {
      (this.view = n),
        ...
        (this.gutters = n.state.facet(Le).map((t) => new tr(n, t)));
      for (let t of this.gutters) this.dom.appendChild(t.dom);
      (this.fixed = !n.state.facet(Zn)),
    ...
    update(n) {
      ...
      n.geometryChanged &&
        (this.dom.style.minHeight =
          this.view.contentHeight / this.view.scaleY + "px"),
        this.view.state.facet(Zn) != !this.fixed &&
    ...
    syncGutters(n) {
      ...
      n && this.dom.remove();
      let e = L.iter(this.view.state.facet(gi), this.view.viewport.from),
        i = [],
        s = this.gutters.map(
          (r) => new lf(r, this.view.viewport, -this.view.documentPadding.top),
        );
  ...
  {
    provide: (n) =>
      D.scrollMargins.of((t) => {
        let e = t.plugin(n);
        return !e || e.gutters.length == 0 || !e.fixed
          ? null
          : t.textDirection == Y.LTR
...
class lf {
  constructor(t, e, i) {
    (this.gutter = t),
      (this.height = i),
      (this.i = 0),
      (this.cursor = L.iter(t.markers, e.from));
  }
  addElement(t, e, i) {
    let { gutter: s } = this,
  ...
  line(t, e, i) {
    let s = [];
    Os(this.cursor, s, e.from), i.length && (s = s.concat(i));
...
class tr {
  constructor(t, e) {
    ...
    (this.markers = Qn(e.markers(t))),
      e.initialSpacer &&
        ((this.spacer = new qo(t, 0, 0, [e.initialSpacer(t)])),
  ...
  update(t) {
    ...
    return (
      !L.eq(this.markers, e, i.from, i.to) ||
      (this.config.lineMarkerChange ? this.config.lineMarkerChange(t) : !1)
    );
  }
  destroy() {
...
class qo {
  ...
  update(t, e, i, s) {
    this.height != e && ((this.height = e), (this.dom.style.height = e + "px")),
      this.above != i &&
        (this.dom.style.marginTop = (this.above = i) ? i + "px" : ""),
      af(this.markers, s) || this.setMarkers(t, s);
  }
  setMarkers(t, e) {
    ...
    for (let r = 0, o = 0; ; ) {
      ...
      if (!a) break;
      a.toDOM &&
        (c ? (s = s.nextSibling) : this.dom.insertBefore(a.toDOM(t), s)),
        c && o++;
    }
...
const cf = Le.compute([re], (n) => ({
  class: "cm-lineNumbers",
  renderEmptyElements: !1,
  markers(t) {
    return t.state.facet(hf);
  },
  lineMarker(t, e, i) {
    return i.some((s) => s.toDOM)
      ? null
      : new qi(Ki(t, t.state.doc.lineAt(e.from).number));
  },
  widgetMarker: () => null,
  lineMarkerChange: (t) => t.startState.facet(re) != t.state.facet(re),
  initialSpacer(t) {
    return new qi(Ki(t, er(t.state.doc.lines)));
  },
  updateSpacer(t, e) {
    let i = Ki(e.view, er(e.view.state.doc.lines));
    return i == t.number ? t : new qi(i);
  },
  domEventHandlers: n.facet(re).domEventHandlers,
}));
function Su(n = {}) {
  return [re.of(n), _o(), cf];
}
function er(n) {
  let t = 9;
  for (; t < n; ) t = t * 10 + 9;
...
const ff = new (class extends Yt {
    constructor() {
      super(...arguments), (this.elementClass = "cm-activeLineGutter");
    }
  })(),
  uf = gi.compute(["selection"], (n) => {
    let t = [],
      e = -1;
    for (let i of n.selection.ranges) {
      let s = n.doc.lineAt(i.head).from;
      s > e && ((e = s), t.push(ff.range(s)));
    }
    return L.of(t);
  });
function Cu() {
...
const Ts = bt.define({
    ...
    update(n, t) {
      for (const e of t.effects) if (e.is(Ko)) return e.value;
      return n;
    },
  }),
  Ds = bt.define({
    ...
    update(n, t) {
      for (const o of t.effects) if (o.is(df)) return o.value;
      const e = n,
        i = mf(e),
        s = Aa(t, i);
      return Da(i, s) ? e : Pa(e, s);
    },
  }),
  Rs = bt.define({
    create() {
    ...
    update(n, t) {
      for (const e of t.effects) if (e.is(pf)) return e.value;
      return n;
    },
  }),
  Ns = bt.define({
    ...
    update(n, t) {
      for (const e of t.effects) if (e.is(gf)) return e.value;
      return n;
    },
  });
function ir(n) {
  if (!n || n.to - n.from === 0) return F.none;
  const t = F.mark({ class: aa.code });
  return F.set([t.range(n.from, n.to)]);
}
function sr(n, t, e) {
  if (n.length === 0) return F.none;
  const s = [...n]
    .sort((r, o) => r.at.start - o.at.start)
    .map((r) => {
...
const xf = bt.define({
    create(n) {
      const t = n.field(Ts, !1);
      return ir(t ?? null);
    },
    update(n, t) {
      const e = t.state.field(Ts, !1);
      return ir(e ?? null);
    },
  ...
  yf = bt.define({
    create(n) {
      const t = n.field(Ds, !1),
        e = n.field(Rs, !1),
        i = n.field(Ns, !1);
      return sr(t ?? [], e ?? null, i ?? null);
    },
    update(n, t) {
      const e = t.state.field(Ds, !1),
        i = t.state.field(Rs, !1),
        s = t.state.field(Ns, !1);
      return sr(e ?? [], i ?? null, s ?? null);
    },
    provide: (n) => D.decorations.from(n),
  });
function bf(n) {
  n.state.selection.main.empty && n.dispatch({ effects: Ko.of(null) });
}
function $o(n) {
  let t = n.dataset.commentId;
  for (let e = 0; e < 10 && !t && n.parentElement; e++)
    (n = n.parentElement), (t = n.dataset.commentId);
  return t;
}
function wf(n) {
  const t = n.target,
...
function ku(n, t = null, e = null) {
  return [
    ...
    xf,
    yf,
    D.updateListener.of((i) => {
      i.selectionSet && bf(i.view);
    }),
    D.domEventHandlers({ click: wf, mouseover: vf }),
  ];
}
const Sf = ({ onClose: n, title: t, actions: e, showBorder: i = !1 }) =>
    p.jsxs("div", {
      className: R(
        "bg-token-main-surface-primary flex items-center justify-between border-b py-2 ps-2 pe-2.5",
        { "border-token-border-xlight": i, "border-transparent": !i },
      ),
      children: [
        p.jsx("div", {
          className:
            "text-token-text-primary flex items-center gap-2 ps-4 text-sm select-none",
          children: t,
        }),
        p.jsxs("div", {
          className: "flex items-center gap-2",
          children: [
            e.map(({ tooltip: s, icon: r, onClick: o }, l) => {
              const a = p.jsx(
                Qt,
                {
                  size: "small",
              ...
              return s ? p.jsx(Is, { label: s, children: a }, l) : a;
            }),
            p.jsx(Qt, {
              size: "small",
              color: "ghost",
  ...
  Cf = ({ onDrag: n, onDragEnd: t, onDoubleClick: e }) =>
    p.jsx(Z.div, {
      drag: "y",
      className:
        "bg-token-text-quaternary absolute top-[-2px] z-10 h-[4px] w-full cursor-ns-resize opacity-0",
      whileHover: { opacity: 0.5 },
      whileDrag: { opacity: 0.75, height: "8px", top: "-4px" },
      transition: { type: "tween", duration: 0.1 },
      style: { x: 0, y: 0, transform: "translateY(0px)" },
      dragMomentum: !1,
      dragSnapToOrigin: !1,
      dragElastic: !1,
  ...
  kf = ({
    ...
    p.jsxs(Z.div, {
      ...
      className:
        "border-token-border-default bg-token-main-surface-primary absolute end-2 bottom-2 flex w-fit max-w-80 flex-col gap-4 rounded-xl border px-4 py-4 shadow-xl",
      children: [
        p.jsxs("div", {
        ...
        p.jsxs("div", {
          ...
          children: [
            ...
            p.jsx(Qt, {
              ...
              color: "primary",
              onClick: e,
              children: p.jsx(rt, { id: "HRfYX0", defaultMessage: "Fix bug" }),
            }),
          ],
        }),
      ],
    }),
  Uo = (n, { name: t, message: e, line: i, stack: s }) => {
    const r =
      i != null
        ? `
...
${s.join("")}${r}`;
  ...
  $i = new ha({ capacity: 5 }),
  Mf = async (n, t, e) => {
    const i = Uo(t, e.error),
      s = Ei($i.get(i));
    if ($i.get(i)) return s;
    const { hint: r } = await pr.safePost("/textdoc/{textdoc_id}/code/hint", {
      parameters: { path: { textdoc_id: n } },
      requestBody: { error: i, line: e.error.line ?? -1 },
    });
    return $i.set(i, r), r;
  },
  Go = (n) => lr([I.ERROR, I.LOG, I.OUTPUT], n.type),
  Yo = (n) => n.type === I.OUTPUT && Xo(n.output),
  Xo = (n) => typeof n == "string" && n.startsWith("data:image/png;"),
  Pe = ({
    as: n = "li",
    contentBefore: t,
    contentAfter: e,
    ...
    return p.jsxs(f, {
      ...
      className: R(
        "bg-token-main-surface-primary flex items-start justify-between py-1.5 ps-6 pe-4 font-mono text-sm whitespace-pre",
        r && "border-token-border-xlight border-b",
        l && "sticky top-0 z-10",
        h && "cursor-pointer",
        h && s && "hover:bg-red-500/10",
        h && !s && "hover:bg-gray-50 dark:hover:bg-gray-700",
        s && o && "bg-red-500/10",
      ),
      onClick: h ? a : void 0,
      children: [
        ...
        p.jsx("div", {
          className:
            "flex min-h-6 min-w-0 flex-1 items-start justify-start gap-2 leading-6",
          children: c,
        }),
        e &&
          p.jsx("div", {
  ...
  switch (n) {
    case "dark_gray":
      return {
        ...
        hover:
          "cursor-pointer hover:text-token-text-primary group-hover:text-token-text-primary",
      };
    case "light_gray":
      return {
        normal: "text-gray-400",
        hover:
          "cursor-pointer hover:text-token-text-secondary group-hover:text-token-text-secondary",
      };
    case "error":
      return {
        normal: "text-red-500",
...
function Gs({
  ...
  return p.jsxs("div", {
    className: R(
      "relative inline-block h-[20px] w-[20px] shrink-0 transition-opacity",
      t,
      o,
      r.normal,
    ),
    ...
    children: [
      n
        ? p.jsx(ca, { className: "h-[20px] w-[20px] shrink-0" })
        : p.jsx(Af, { className: "h-[20px] w-[20px] shrink-0" }),
      p.jsx("span", {
        className: R(
...
function Ys() {
  return p.jsx(Gs, { theme: "light_gray", children: p.jsx(Oi, {}) });
}
function Of({ count: n, isLoading: t, onClick: e, isError: i = !1 }) {
  return t
    ? p.jsx(Ys, {})
    : p.jsx(Gs, { onClick: e, theme: i ? "error" : "dark_gray", children: n });
}
function Mu({ isLoading: n = !1, onClick: t }) {
  return n
    ? p.jsx(Ys, {})
    : p.jsx(Gs, { isClickable: !0, onClick: t, theme: "light_gray" });
}
const Jo = { type: "spring", bounce: 0.12, duration: 0.5 },
  Zo = "opacity-50",
  Tf = ({
    position: n = "absolute",
    count: t,
    ...
    p.jsx(Z.div, {
      className: R("flex", n, li.collapsedComment),
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      style: { translateY: e },
      transition: Jo,
      exit: { opacity: 0 },
      children: p.jsx(Of, { count: t, isLoading: i, onClick: s, isError: r }),
    }),
  Df = ({ isFocused: n, isHovered: t }) => {
    const e =
        n || t
          ? "grow font-medium text-token-text-primary transition-colors"
          : "grow font-medium text-token-text-secondary transition-colors",
    ...
    return p.jsxs(p.Fragment, {
      children: [
        ...
        p.jsx("span", { className: e, children: "ChatGPT" }),
      ],
    });
  },
  Rf = ({
    comment: { diffStatus: n, content: t },
    isFocused: e,
    isSomeCommentFocused: i,
    isHovered: s,
  }) => {
    const r = n === yi.REMOVED;
    return p.jsx("div", {
      className: R("text-token-text-primary mt-2 transition-all", {
        "opacity-80": !e && !i && !s && !r,
        "opacity-40": !e && i && !s && !r,
        [Zo]: r,
      }),
      children: p.jsx(El, { text: t }),
    });
  },
  Nf = (
    {
    ...
    const [y, b] = w.useState(!1),
      S = s.diffStatus === yi.ADDED,
      v = s.diffStatus === yi.REMOVED,
      k = s.diffStatus != null,
      A = () => {
        b(!0), l?.();
      },
    ...
    return p.jsx(Z.div, {
      ref: x,
      className: R(t, li.expandedComment, {
        "cursor-default": u,
        "cursor-pointer": !u,
        [li.expandedCommentFocused]: u,
        [li.expandedCommentHovered]: m,
      }),
      style: { left: e, right: i },
      initial: r ? !1 : { translateY: f, scale: 0.85, opacity: 0 },
      animate: r ? void 0 : { translateY: f, scale: u ? 1 : 0.97, opacity: 1 },
      exit: r ? void 0 : { scale: 0.85, opacity: 0, filter: "blur(16px)" },
      transition: Jo,
      onClick: o,
      ...
      children: p.jsxs("div", {
        className: R(
          "flex min-h-8 flex-col overflow-hidden rounded-2xl border p-4 pt-2 text-start text-sm transition-all",
          {
            "border-transparent bg-gray-50 dark:bg-gray-800": !u && !m,
            "border-token-border-default bg-token-main-surface-primary":
              m && !u,
            "border-token-border-default bg-token-main-surface-primary shadow-xl":
              u || (y && !d),
            "relative after:absolute after:start-0 after:top-0 after:bottom-0 after:w-1":
              k,
        ...
        children: [
          p.jsxs("div", {
            className: R("flex h-8 flex-row items-center gap-2.5", { [Zo]: v }),
            children: [
              p.jsx(Df, { isFocused: u, isHovered: m }),
              p.jsx("button", {
                className: R(
                  "text-token-text-secondary -me-1 rounded-full bg-transparent p-1",
                  {
                    "hover:text-token-text-primary cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700":
                      !g,
                ...
                children: p.jsx(Xl, { className: "icon-sm" }),
              }),
            ],
          }),
          p.jsx(Rf, {
          ...
          p.jsx(qe, {
            ...
            children:
              X &&
              p.jsx(Z.div, {
                initial: r ? !1 : { opacity: 0, height: 0 },
                animate: {
                  opacity: 1,
                  height: "auto",
                  transition: {
                    opacity: { delay: 0.14, duration: 0.2 },
                    height: { bounce: 0, duration: 0.2 },
                  },
                },
                exit: r
                  ? void 0
        ...
        gr(document, {
          mousedown: ({ target: d }) => {
            d instanceof HTMLElement &&
              !d.closest("[data-comment-id]") &&
              !u.current?.contains(d) &&
              bi.blurComment();
          },
        }),
      ),
...
var Ft = ((n) => (
  (n.LOADING = "loading"), (n.READY = "ready"), (n.RESOLVED = "resolved"), n
))(Ft || {});
const tl = ({ hint: n, onClickFix: t, isOpen: e, onOpenChange: i }) => {
  ...
  Ni = (n) => Array.isArray(n) || te(n) || n instanceof Map || n instanceof Set,
  Li = (n) =>
    n == null ||
    typeof n == "string" ||
    typeof n == "number" ||
    typeof n == "boolean",
  el = (n) => (te(n) ? Object.entries(n) : Array.from(n.entries())),
  il = (n) => `${typeof n}:${typeof n == "object" ? JSON.stringify(n) : n}`,
  Pf = ({ isPreview: n = !1, value: t }) => {
    const [e, i] = w.useState(!1);
    return Li(t)
      ? p.jsx(Pi, { value: t, depth: 0 })
      : Ni(t)
        ? p.jsxs("span", {
            className: R(
              "relative z-0 max-w-full font-mono text-sm leading-6",
              e && "w-full flex-auto",
            ),
            children: [
              p.jsxs("span", {
                role: "button",
                className:
                  "group/row flex flex-wrap items-center gap-x-1 italic",
                onClick: () => i(!e),
                children: [
                  !n && p.jsx(ll, { isExpanded: e }),
                  p.jsx(nl, { value: t, depth: 0 }),
                  p.jsx(Ps, { value: t }),
                ],
              }),
              e &&
                ...
                p.jsx("div", {
                  className: "ps-6",
                  children: p.jsx(rl, { value: t, depth: 0 }),
                }),
            ],
          })
        : p.jsx("span", { className: "truncate", children: String(t) });
  },
  sl = ({ value: n, depth: t = 0 }) =>
    Ni(n)
      ? p.jsx(rl, { depth: t, value: n })
      : Li(n)
        ? p.jsx(Pi, { depth: t, value: n })
        : p.jsx("span", { className: "truncate", children: String(n) }),
  nl = ({ value: n, depth: t = 0 }) => {
    const e = Array.isArray(n),
      i = el(n);
    return p.jsxs("div", {
      className: "inline-flex max-w-fit min-w-0 grow basis-0",
      children: [
        !te(n) && p.jsx(Ls, { isShort: !0, isSecondary: !0, collection: n }),
        e ? "[" : "{",
        p.jsx("span", {
          className:
            "inline-flex max-w-fit min-w-0 shrink grow basis-0 overflow-hidden",
          children: i.map(([s, r], o) => {
            let l = null;
            return (
              Ni(r)
                ? (l = p.jsx(Ls, { collection: r }))
                : Li(r)
                  ? (l = p.jsx(Pi, { truncate: !0, depth: t + 1, value: r }))
                  : (l = p.jsx(sl, { depth: t + 1, value: r })),
              p.jsxs(
                w.Fragment,
                {
                  children: [
                    (te(n) || n instanceof Map) &&
                      p.jsx("span", {
                        className:
                          "text-token-text-secondary min-w-[2em] shrink truncate whitespace-pre",
                        children: p.jsx(ol, { value: n, propertyKey: s }),
                      }),
                    l,
                    o < i.length - 1 &&
                      p.jsx("span", {
  ...
  rl = ({ value: n, depth: t = 0 }) => {
    const [e, i] = w.useState(() => new Set()),
      s = el(n);
    return p.jsx("ol", {
      ...
      children: s.map(([r, o]) => {
        ...
        return p.jsxs(
          ...
          {
            className: R(
              "flex ps-1 whitespace-nowrap",
              c && "flex-col",
              !c && "group/row flex-wrap",
            ),
            ...
            children: [
              p.jsxs("span", {
                ...
                className: R(
                  "group/row z-10 -ms-1 min-w-0 items-center gap-x-1",
                  c ? "flex" : "inline-flex",
                ),
                children: [
                  c &&
                    p.jsxs(p.Fragment, {
                      children: [
                        p.jsx(Bf, {}),
                        p.jsx(ll, { shiftLeft: !0, isExpanded: a }),
                      ],
                    }),
                  p.jsx("span", {
                    className: R(
                      "font-bold",
                      (te(n) || Array.isArray(n)) &&
                        "text-red-900 dark:text-blue-400",
                    ),
                    children: p.jsx(ol, { value: n, propertyKey: r }),
                  }),
                  c && !a && p.jsx(nl, { value: o, depth: t + 1 }),
                  c && a && p.jsx(Ls, { isSecondary: !0, collection: o }),
                  c && p.jsx(Ps, { value: o }),
                ],
              }),
              (!c || a) && p.jsx(sl, { value: o, depth: t + 1 }),
  ...
  Pi = ({ value: n, truncate: t = !1 }) =>
    typeof n == "string"
      ? p.jsxs("span", {
          className: R(
            "dark:text-blue-75 text-red-500",
            t &&
              "max-w-fit min-w-[2em] shrink-0 grow basis-0 overflow-hidden text-ellipsis whitespace-nowrap",
            !t && "break-words break-all whitespace-normal",
          ),
          children: ["'", n, "'"],
        })
      : p.jsx("span", {
          className: R(
            ...
            n == null
              ...
              : "dark:text-brand-purple-600 text-blue-500",
          ),
          children: String(n),
        }),
  Bf = () =>
    p.jsx("span", {
      className:
        "absolute start-0 end-0 z-[-1] h-6 rounded-md group-hover/row:bg-gray-50 dark:group-hover/row:bg-gray-700",
    }),
  Ls = ({ collection: n, isSecondary: t = !1, isShort: e = !1 }) => {
    let i = null;
    return (
      Array.isArray(n) && n.length > 0
        ? (i = e ? `(${n.length})` : `Array(${n.length})`)
        : n instanceof Set
          ? (i = `Set(${n.size})`)
          : n instanceof Map
            ? (i = `Map(${n.size})`)
      ...
      : n instanceof Map
        ? p.jsxs("span", {
            ...
            children: [
              ...
              p.jsx(Lf, { className: "icon-sm text-token-text-secondary" }),
            ],
          })
        : null,
  ll = ({ isExpanded: n, shiftLeft: t = !1 }) =>
    p.jsx("button", {
      className: R(
        "flex h-5 shrink-0 items-center overflow-hidden",
        t && "ms-[-16px]",
      ),
      children: p.jsx(cr, {
        className: R(
          "icon-sm text-token-text-secondary transition-transform",
          n && "rotate-90",
        ),
      }),
    }),
  Ps = ({ value: n }) => {
    const t = fr(),
      e = () => {
        Pl(JSON.stringify(n), t);
      };
    return p.jsx("span", {
      className: R(
        "text-token-text-secondary relative inline-block h-4 self-center opacity-0 transition-opacity",
        "group-hover/row:opacity-100 group-hover/row:delay-500",
        "hover:after:bg-token-main-surface-tertiary after:pointer-events-none after:absolute after:inset-[-4px] after:z-0 after:rounded-lg after:content-['']",
      ),
      children: p.jsx(Ll, {
  ...
  If = "module:",
  Bs = ({ log: n, isDisabled: t = !1, onClick: e }) =>
    p.jsx("div", {
      ...
      children:
        ...
        p.jsxs("button", {
          ...
          className:
            "text-token-text-tertiary select-none enabled:hover:underline",
          disabled: t,
          children: [If, n.line],
        }),
    }),
  jf = ({ isPreview: n = !1, log: t, level: e }) =>
    p.jsxs("span", {
      className: R(
        "text-token-text-primary flex min-w-0 flex-wrap gap-1",
        n ? "shrink truncate" : "whitespace-pre-wrap",
        e === "warn" && "text-yellow-600",
      ),
      children: [
        e === "warn" && "[warn]: ",
        typeof t == "string"
          ? t
          : t.map((i, s) => p.jsx(Pf, { isPreview: n, value: i }, s)),
      ],
    }),
  al = ({ error: n, isPreview: t = !1, isResolved: e = !1 }) => {
    const i = n.name + ":";
    return p.jsxs("span", {
      className: R(
        "whitespace-pre-wrap",
        e ? "text-token-text-primary" : "text-red-500",
      ),
      children: [
        p.jsx("span", { className: "font-semibold", children: i }),
        " ",
        n.message,
        p.jsx("div", {
          children:
...
`)
  ...
  Hf = ({ output: n, isPreview: t = !1 }) => {
    const e = me();
    return n == null
      ? null
      : Xo(n)
        ? p.jsx("img", {
            alt: e.formatMessage(Vf.imgAlt),
            className: R(
              t && "border-token-border-xlight h-6 rounded-lg border",
            ),
            src: n,
          })
        : p.jsx("span", {
  ...
  Xs = ({ log: n, isHintResolved: t, isPreview: e = !1 }) => {
    switch (n.type) {
      case I.LOG:
        return p.jsx(jf, { isPreview: e, ...n });
      case I.ERROR:
        return p.jsx(al, { isPreview: e, isResolved: t, ...n });
      case I.OUTPUT:
        return p.jsx(Hf, { isPreview: e, ...n });
      default:
        return null;
    }
  },
  Ff = ({
    ...
    const [r, o] = w.useState(!1);
    if (n.type === I.RUN_COMPLETE) return null;
    const l = s?.status === Ft.RESOLVED,
      a = n.type === I.ERROR && s?.status === Ft.READY;
    return p.jsx(Pe, {
      hasHint: a,
      isHintOpen: r,
      bottomBorder: !0,
      onClick: s && !l && (() => o(!0)),
      contentBefore: p.jsx(tl, {
        hint: s,
        isOpen: r,
        onOpenChange: o,
        onClickFix: (c) => n.type === I.ERROR && s && e?.(c, s.id, n.error),
      }),
      contentAfter: p.jsx(Bs, { log: n, isDisabled: t, onClick: i }),
      children: p.jsx(Xs, { log: n, isHintResolved: l }),
    });
  },
  Vf = rr({
    imgAlt: { id: "L6t7Yb", defaultMessage: "Plot" },
    ranCode: { id: "ffa9Nt", defaultMessage: "Ran code" },
    askForHelp: { id: "wMZco9", defaultMessage: "Ask ChatGPT for help" },
    askForFix: { id: "A9pxgT", defaultMessage: "Fix it for me" },
  }),
  Wf = ({ timestamp: n, duration: t }) => {
    const [, e] = w.useState(0);
    w.useEffect(() => {
      setInterval(() => {
        e((r) => r + 1);
      }, 5e3);
      ...
      children: p.jsx("span", {
        ...
        children:
          s >= 60
            ...
            : p.jsx(rt, { id: "bRCEFN", defaultMessage: "Just now" }),
      }),
    });
  },
  hl = ({ isComplete: n, timestamp: t, duration: e }) =>
    n && t != null && e != null
      ? p.jsx(Wf, { timestamp: t, duration: e })
      : n && e == null
        ? p.jsx("span", {
            className: "text-token-text-tertiary",
            children: p.jsx(rt, { id: "EMebM9", defaultMessage: "Stopped" }),
          })
        : p.jsx(Oi, { gap: 2 }),
  zf = (n) => {
    switch (n) {
      case Nt.INITIALIZING:
        return p.jsx(rt, {
          id: "J183Z0",
          defaultMessage: "initializing environment",
        });
      case Nt.INSTALLING_PACKAGES:
        return p.jsx(rt, {
          id: "21sQ8o",
          defaultMessage: "installing packages",
        });
      case Nt.RUNNING_CODE:
        return p.jsx(rt, { id: "nHITHk", defaultMessage: "running code" });
    }
  },
  mi = ({ message: n, isComplete: t, statusLogs: e }) => {
    const i = Ui(e);
    return p.jsxs("span", {
      className: "flex items-center",
      children: [
        ...
        !t &&
          ...
          p.jsxs(Z.span, {
            ...
            children: [zf(i.status), p.jsx(Oi, { gap: 2, size: 2 })],
          }),
      ],
    });
  },
    ...
    return (
      w.useEffect(() => {
        ...
        const m = new IntersectionObserver(
          (x) => {
            x[0].intersectionRatio === 0 ? f(!0) : f(!1);
          },
          { threshold: 0 },
        );
        return m.observe(g), () => m.unobserve(g);
      }, []),
      p.jsxs("li", {
        ...
        children: [
          ...
          p.jsxs(Pe, {
            ...
            onClick: () => d(),
            children: [
              p.jsx(mi, { isComplete: r, message: xi.run, statusLogs: l }),
              !a &&
                e &&
                p.jsx(Xs, { isPreview: !0, isHintResolved: i, log: e }),
            ],
          }),
          a && n,
        ],
  ...
  qf = ({
    ...
    const [l, a] = w.useState(!1),
      c = n.filter((b) => b.type === I.ENVIRONMENT_STATUS),
      h = n.filter(Go),
      f = Ui(n),
      u = f?.type === I.RUN_COMPLETE,
      d = u ? f.duration : null,
      g = h[0];
    if (u) {
      if (h.length === 0)
      ...
      if (h.length === 1 && g?.type === I.ERROR) {
        ...
        return p.jsxs(Pe, {
          ...
          contentAfter: p.jsx(Bs, { log: g, isDisabled: s, onClick: e }),
          onClick: b && b.status !== Ft.RESOLVED && (() => a(!0)),
          children: [
            p.jsx(mi, { isComplete: u, message: xi.run, statusLogs: c }),
            p.jsx(al, { isResolved: b?.status === Ft.RESOLVED, ...g }),
          ],
        });
      } else if (h.length === 1 && g && !Yo(h[0]))
        return p.jsxs(Pe, {
          bottomBorder: !0,
          contentBefore: o,
          contentAfter: p.jsx(Bs, { log: g, isDisabled: s, onClick: e }),
    ...
    const m = Ui(h.filter((b) => b.type !== I.RUN_COMPLETE)),
      y = (m && i.get(m.id))?.status === Ft.RESOLVED;
    return p.jsx(_f, {
      statusLogs: c,
      firstLog: g ?? null,
      lastLog: m ?? null,
  ...
  xi = rr({
    success: { id: "laZI5H", defaultMessage: "Run successfully" },
    run: { id: "o7dgBT", defaultMessage: "Run" },
  }),
  Kf = `You're a professional developer highly skilled in debugging. The user ran the textdoc's code, and an error was thrown.
Please think carefully about how to fix the error`,
  $f = (n, t, e) => {
    const i = Uo(n, e);
    return `
${Kf}, and then rewrite the textdoc to fix it.
...
${i}`.trim();
  ...
  Uf = ({
    ...
    const c = a.size > 0,
      h = w.useMemo(() => Object.entries(Hl(n, "runId")), [n]),
      f = h.some(([, u]) => {
        const d = u.filter(Go);
        return d.length > 1 || (d.length === 1 && Yo(d[0]));
      });
    return p.jsxs(p.Fragment, {
      children: [
        p.jsx(Sf, {
        ...
        p.jsx("div", {
          ref: t,
          className:
            "bg-token-main-surface-primary flex flex-1 flex-col-reverse overflow-auto",
          children: p.jsx("ol", {
            className: "flex flex-1 flex-col justify-start pb-4",
            children: p.jsx(qe, {
              children: h.map(([u, d], g) =>
                p.jsx(
                  qf,
                  {
                    runMessages: d,
  ...
  Gf = (
    ...
    const [f, u] = w.useState(!1),
      [d, g] = w.useState(!1),
      [m, x] = w.useState([]),
      [y, b] = w.useState(0),
      [S, v] = w.useState(null),
      [k, A] = w.useState(null),
      [O, T] = w.useState(() => new Map()),
      [X, mt] = w.useState(320),
      zt = w.useRef(null),
      dt = me();
    w.useEffect(() => A(null), [t]);
    const et = m.filter((z) =>
      [I.LOG, I.ERROR, I.OUTPUT].includes(z.type),
    ).length;
    w.useEffect(() => {
      s && b(et);
    }, [s]);
    const q = w.useMemo(() => {
        for (let z = m.length - 1; z >= 0; z--) {
          const N = m[z];
          if (N.runId !== k) return null;
          if (N.type === I.ERROR) return N;
        }
        return null;
      }, [m, k]),
      lt = (z, N, P) => {
        const U = O.get(N);
        if (U) {
          const { id: K, content: Mt } = U;
          T((Q) => {
            const it = new Map(Q);
            return it.set(K, { id: K, content: Mt, status: Ft.RESOLVED }), it;
          });
        }
        v(N),
          a({
            sourceEvent: z,
            action: vr.EDIT,
            userMessageType: jl.CONSOLE,
            content: $f(t, U?.content ?? null, P),
          });
      },
      wt = async (z, N) => {
        if (!r) {
          T((P) => {
            const U = new Map(P);
            return U.set(z, { id: z, status: Ft.LOADING, content: "" }), U;
          });
          try {
            const P = await Mf(i, t, N);
            T((U) => {
              const K = new Map(U);
              return K.set(z, { id: z, status: Ft.READY, content: P }), K;
            });
          } catch {
            T((U) => {
              const K = new Map(U);
      ...
      vt = async (z, N) => {
        ...
        K && c?.(!0),
          g(!0),
          x((it) => it.map((_t) => ({ ..._t, isStale: !0 })));
        let Mt = !1;
        const Q = Ie(n.current).evalAsync({ code: N, language: P });
        for await (const it of Q) {
          if (
            (it.type === I.RUN_START &&
              requestAnimationFrame(() => {
                zt.current?.scrollTo({ top: 0, behavior: "smooth" });
              }),
            it.type === I.ERROR)
          ) {
            if (it.line != null) {
              const { line: _t } = it;
              requestAnimationFrame(() => l(_t));
            }
            (Mt = !0), wt(it.id, it);
          }
          A(it.runId), x((_t) => [..._t, { ...it, isStale: !1 }]);
        }
        Mt && c?.(!0), g(!1);
      };
    w.useImperativeHandle(h, () => ({
        ...
        ft &&
          p.jsx(
            Z.button,
            {
              ...
              transition: { type: "spring", bounce: 0.12, duration: 0.3 },
              className:
                "bg-token-main-surface-primary hover:bg-token-main-surface-secondary absolute end-2 bottom-2 flex items-center gap-2 rounded-full px-3 py-1.5 shadow-lg",
              onClick: () => c?.(!0),
              children: p.jsxs("span", {
                className:
                  "text-token-text-secondary flex items-center gap-1 text-sm",
                children: [
                  p.jsx(Bl, { className: "icon-sm" }),
                  p.jsx(rt, {
                    id: "etzFTa",
                    defaultMessage:
        ...
        s &&
          p.jsxs(
            Z.div,
            {
              ...
              className:
                "border-token-border-default relative z-10 w-full border-t shadow-[0px_0px_32px_rgba(0,0,0,0.08)]",
              children: [
                p.jsx(Cf, {
                  onDragEnd: () => u(!1),
                  onDrag: ({ delta: { y: z } }) => {
...
class Jf extends Xf {
  ...
  unistNodeToProseMirrorNodes({ schema: t, convertedChildren: e, attrs: i }) {
    return e.map((s) =>
      s.mark(s.marks.concat([t.marks[this.proseMirrorMarkName()].create(i)])),
    );
  }
...
function Ai(n) {
  if (n.type.name !== "text") {
    const { start: s, end: r } = n.attrs;
    return s == null || r == null ? null : { start: s, end: r };
  }
  const t = n.marks.find((s) => s.type.name === Jf.proseMirrorMarkName());
  if (!t) return null;
  const { start: e, end: i } = t.attrs;
  return e == null || i == null ? null : { start: e, end: i };
}
function Zf(n, t) {
  const { parent: e, textOffset: i } = t,
    s = n.nodeAt(t.pos);
  if (!s) return Ie(Ai(e)).end;
  const { start: r } = Ie(Ai(s));
  return r + i;
}
function Qf(n, t) {
  const e = n.nodeAt(t.pos);
  if (e) {
    const { start: i } = Ie(Ai(e));
    return i + t.textOffset;
  }
  return Ie(Ai(t.parent)).end;
}
function Tu(n, t) {
  const e = new Map();
  for (const [i, s] of t) {
    const r = Zf(n, n.resolve(s.start)),
      o = Qf(n, n.resolve(s.end));
    e.set(i, { start: r, end: o });
  }
  return e;
}
const tu = w.createContext(() => null),
  eu = w.createContext(null),
  iu = w.createContext(0),
  Du = () => w.useContext(tu),
  Ru = () => w.useContext(eu),
  Nu = () => w.useContext(iu),
  su = w.createContext(() => null),
  nu = w.createContext(null),
  Lu = w.createContext(0),
  Pu = () => w.useContext(su),
  Bu = () => w.useContext(nu),
  ru = mr((n) => ({
    currentTime: 0,
    setCurrentTime: (t) => n(() => ({ currentTime: t })),
    isOpen: !1,
    openSidebar: () => n({ isOpen: !0 }),
    closeSidebar: () => n({ isOpen: !1 }),
    hoveringSpeakerId: null,
    setHoveringSpeakerId: (t) => n({ hoveringSpeakerId: t }),
    editingSpeaker: null,
    setEditingSpeaker: (t) => n({ editingSpeaker: t }),
    speakers: new Map(),
    setSpeakers: (t) => n({ speakers: t }),
  })),
  Iu = (n) => (t) =>
    Zl.findNode(t, ({ message: e }) => {
      const i = e.metadata?.canvas;
      return i?.create_source === Fl.HIVE && i.textdoc_id === n && !!i.hive_id;
    })?.message.metadata?.canvas?.hive_id,
  nr = (n, t) => Math.floor((n.getTime() - t.getTime()) / 1e3),
  ju = (n) => {
    const t = Math.floor(n / 3600),
      e = Math.floor((n % 3600) / 60),
      i = n % 60,
      s = t.toString().padStart(2, "0"),
      r = e.toString().padStart(2, "0"),
      o = i.toString().padStart(2, "0");
    return t > 0 ? `${s}:${r}:${o}` : `${r}:${o}`;
  },
  Hu = (n) => {
    const t = new Date(n.start),
      { setSpeakers: e } = ru.getState(),
      i = n.transcripts ?? [],
      s = i.flatMap((a) => a.speakers ?? []),
      r = new Map(
        s.map((a) => [
          a.id,
          {
    ...
    return (
      ...
      i
        ...
        .map((a) => {
          const c = a.start ? nr(new Date(a.start), t) : void 0,
            h = a.end ? nr(new Date(a.end), t) : void 0;
          return {
        ...
        .sort((a, c) => {
          const h = a.range.min ?? 0,
            f = c.range.min ?? 0;
          return h - f;
        })
    );
  },
  Fu = () => Jl.checkGate("1804926979");
export {
  ku as $,
  xe as A,
  Bt as B,
...
//# sourceMappingURL=l5e8sk6z3i8aaal6.js.map
