import { j as e, M as d } from "./lip667d8t42poxum.js";
import { bG as m, bH as c, an as l, bI as u } from "./bek4a02po1hapmml.js";
import { F as t, c as x } from "./hgyrt6j47bbfyjrt.js";
...
function v({ label: o, description: s, collapsed: r, onClick: n, htmlFor: a }) {
  const i = e.jsx("label", {
    htmlFor: a,
  ...
  return e.jsxs("div", {
    ...
    children: [
      r !== void 0 &&
        (r
          ? e.jsx(c, { className: "icon-sm" })
          : e.jsx(m, { className: "icon-sm" })),
      s
        ? e.jsx(l, { label: s, side: "top", children: i })
...
function k({
  ...
  const a = "metadata" in o ? o.metadata?.domain : void 0;
  return e.jsxs("div", {
    className: x(
    ...
    children: [
      ...
      e.jsx("div", { className: "bg-token-border-medium w-px" }),
      e.jsx("button", {
        disabled: r,
        className:
          "flex h-9 w-9 items-center justify-center rounded-lg rounded-s-none",
        children: e.jsx(u, { className: "icon-sm" }),
      }),
    ],
  });
}
export { h as F, k as G, v as a, j as b, g as c };
//# sourceMappingURL=k0g5mx2a360e3t03.js.map
